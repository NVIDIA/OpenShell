...
//! Sessionless MCP requests through the sandbox's HTTP forward proxy.
//!
...
assert proxy, "sandbox HTTP proxy must be configured"
# All calls in this test must take the explicit forward proxy path.
os.environ["no_proxy"] = ""
os.environ["NO_PROXY"] = ""
