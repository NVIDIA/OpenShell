...
(`0632785d932b870c2a9d44650e8573053e7f463f0a803033649ff90078d433c4`).
Portable UI policy adds an optional `SandboxPolicy.ui` message at tag 7 and a
capability flag without changing existing wire fields. The checked-in pre-UI
policy fixture still decodes with `ui` absent, preserving legacy behavior;
no stored-row rewrite is needed. Older writers do not preserve unknown UI
fields, so policy writes must use a UI-aware gateway once UI policy is enabled.
Delete preconditions are additive request fields at tags 4 and 5; the upstream
workspace selector remains at tag 3. They do not change persisted payloads.
...
enums (`69fdc72cc033f37704e8aa4b089dc799990b52cb9cdd5c13decef67fb662177d`).
