...
driver/runtime identity recorded at provisioning before minting a JWT. The
...
namespace, immutable Sandbox CR UID, and supervisor Pod UID. The bootstrap path accepts
