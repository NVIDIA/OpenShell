...
retain their target and generation for idempotent recovery. If cold creation
succeeds but its response is lost, recovery reads the driver-validated live
runtime identity and persists that binding before completing the allocation.
