...
run_suite() {
  ...
  expect_output_not_contains "hides codex profile" "codex" "${CLI[@]}" profile list
  expect_output_not_contains "hides google cloud profile" "google-cloud" "${CLI[@]}" profile list
