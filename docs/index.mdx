...
<Note>
New in OpenShell 0.1.0 is a [stable release cadence](/reference/support-matrix#releases), an updated [security architecture](/about/architecture), and an expanded [extension surface](/extensibility/overview), along with much more.
...
Refer to [Run Your First Agent](/about/run-an-agent) for the complete image,
...
<Card title="Run Your First Agent" href="/about/run-an-agent">
...
<Card title="Inference" href="/sandboxes/inference-routing">
...
<Card title="Policies" href="/sandboxes/policies">
