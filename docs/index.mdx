...
<Note>
New in OpenShell 0.1.0: a [stable release cadence](/reference/support-matrix#releases), new [isolation primitives](/about/architecture), and an expanded [extension surface](/extensibility/overview), along with much more.
