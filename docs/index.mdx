...
<Card title="Inference Providers" href="/sandboxes/inference-routing">

Attach credential-bound profiles for native cloud, local, or self-hosted inference endpoints.
