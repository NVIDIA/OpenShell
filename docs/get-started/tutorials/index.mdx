...
<Card title="Okta OBO Token Exchange" href="/get-started/tutorials/okta-obo">

Configure delegated Okta access on behalf of the logged-in OpenShell user with token exchange.
</Card>

<Card title="XAA.dev Sample XAA" href="/get-started/tutorials/xaa-dev">

Run the sample 2-step Cross App Access flow through OpenShell with `xaa.dev` and the Todo0 resource API.
</Card>
