...
<Card title="Okta Gateway Login" href="/get-started/tutorials/okta-gateway-login">

Configure an Okta-protected gateway and sign in from the CLI with a native app and PKCE.
</Card>
