...
slug: "get-started/tutorials/run-pi"
...
[sandbox policy](/sandboxes/policies) instead of giving the workload broad
access. Refer to [Profiles](/providers/profiles) for credential and endpoint
configuration.
...
- To give Pi access to source control, package registries, or tool servers, add
  the corresponding provider profiles or a reviewed [sandbox policy](/sandboxes/policies).
- To understand image, resource, upload, and lifecycle options, refer to
  [Sandboxes](/sandboxes/manage-sandboxes).
- To configure another model service, refer to [Profiles](/providers/profiles).
