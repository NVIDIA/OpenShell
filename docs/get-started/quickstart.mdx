...
If you prefer Homebrew, tap this repository and install the stable track:
...
Install `nvidia/openshell/openshell-dev` instead to track the development release.
