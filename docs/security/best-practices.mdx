...
| Recommendation | Leave disabled unless a trusted Kubernetes deployment requires it to run OpenShell. Prefer RuntimeClass or user namespace isolation when the cluster supports it. |
