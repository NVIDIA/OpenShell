...
| What you can change | Enable cluster-wide through Helm or gateway config. Override sandboxes created from a named template through Kubernetes driver config. |
