...
| Recommendation | Use local mTLS user authentication only for single-user Docker, Podman, and VM gateways. Use OIDC RBAC or a trusted access proxy for Kubernetes and shared deployments. |
