...
Provider attach and detach update the persisted sandbox provider list. The gateway pushes provider environment and effective policy changes to running sandboxes over the supervisor session.
