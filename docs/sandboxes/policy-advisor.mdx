...
|---|---|
| `link_local_reach` | The proposal reaches a host in `169.254.0.0/16` or `fe80::/10` (the cloud-metadata range, which serves credentials regardless of sandbox state). Unconditional. |
