...
The full reasoning model lives in [`crates/openshell-prover/README.md`](https://github.com/NVIDIA/OpenShell/blob/main/crates/openshell-prover/README.md). Provider profiles composed in via [Provider profiles](/sandboxes/providers-v2) are part of the effective policy the prover reasons over.
