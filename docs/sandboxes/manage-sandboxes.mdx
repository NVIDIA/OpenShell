...
<Note>
For remote or non-loopback gateways, browser service URLs remain HTTPS and require normal gateway authentication. Endpoint readiness and remote/public domains are follow-up work.
