...
To pin one or more Docker CDI devices, repeat `--gpu-id`:

```shell
openshell sandbox create --gpu --gpu-id 0 -- claude
openshell sandbox create --gpu --gpu-id nvidia.com/gpu=1 -- claude
```
