...
Use the terminal to spot blocked connections marked `action=deny` and provider API activity. If a connection is blocked unexpectedly, add the host to your network policy. Refer to [Policies](/sandboxes/policies) for the workflow.
