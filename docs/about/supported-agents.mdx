...
| [NemoClaw](https://github.com/NVIDIA/NemoClaw) | [NemoClaw](https://github.com/NVIDIA/NemoClaw) | Blueprint-managed | OpenShell-backed agent stack. Follow the NemoClaw repository for setup. |
