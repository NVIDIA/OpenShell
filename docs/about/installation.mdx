...
Kubernetes deployments use the OpenShell Helm chart. For step-by-step installation, refer to [Get Started on Kubernetes](/reference/kubernetes/setup). For chart values and packaging details, refer to the [Helm chart README](https://github.com/NVIDIA/OpenShell/blob/main/deploy/helm/openshell/README.md).
