...
auto-discovered XDG config; no config is also a successful result. Debian keeps
its bare service invocation and gateway.env semantics. Snap gives a nonempty
