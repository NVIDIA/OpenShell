...
| Apple Container | The gateway is configured to create Apple Container lightweight VM sandboxes through Apple's `container` CLI. | macOS on Apple silicon with Apple Container installed and running. |
