...
The gateway supports interceptor bindings for selected sandbox, provider, service exposure, policy configuration, policy analysis, and draft policy mutation RPCs. Read the interceptor manifest and gateway startup diagnostics when selecting bindings. Unknown, streaming, read-only, and non-allowlisted RPCs cannot be intercepted.
