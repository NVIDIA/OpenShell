...
The [protocol example](https://github.com/NVIDIA/OpenShell/tree/main/examples/supervisor-middleware-protocol)
demonstrates all V1 hooks in one service, including header-only response changes,
whole-body and unit-local streaming transformations, trailers, and typed blocks.
Each example includes a policy, local fixture, and smoke launcher.
