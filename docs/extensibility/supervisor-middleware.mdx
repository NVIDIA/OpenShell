...
The [HTTP response transform example](https://github.com/NVIDIA/OpenShell/tree/main/examples/supervisor-middleware-response-transform) implements the raw response gRPC contract and demonstrates all three response body modes, framing repair, and body-derived trailers.
