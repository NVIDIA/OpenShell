...
description: "Optionally configure Keycloak to delegate authentication to the OpenShift OAuth server so cluster users can log in with their existing credentials."
