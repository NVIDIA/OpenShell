...
Provider attach and detach update the persisted sandbox provider list. Running sandboxes receive provider environment and effective policy revisions over the supervisor configuration stream.
