...
[Profiles](/how-it-works/providers/profiles) for the profile format and custom
profile workflow.
</Info>
...
[Profiles](/how-it-works/providers/profiles#attach-and-detach-providers) for details.
...
rewrite. Refer to [Profiles](/how-it-works/providers/profiles#understand-static-credential-endpoint-binding)
...
[Profiles](/how-it-works/providers/profiles#provider-profiles) for the profile workflow
and schema.
...
ships example profiles for GitHub, PyPI, Slack, and the major inference and agent
...
[Inference](/how-it-works/inference) for complete examples
...
- To manage workspace access for providers, refer to [Workspaces](/how-it-works/workspaces).
- To control what the agent can access, refer to [Policies](/how-it-works/policies/overview).
- To use the default workload image, refer to [Sandboxes](/how-it-works/sandboxes/overview#default-workload-image).
- To view the complete field reference for the policy YAML, refer to the [Policy Schema Reference](/how-it-works/policies/schema).
