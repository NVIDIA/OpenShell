...
Effect](/how-it-works/policies/manage-policies#how-changes-take-effect).
...
AWS credentials. Refer to [AWS SigV4](/how-it-works/providers/aws) and [Static
Credential Endpoint
...
Refer to [Binary
Matching](/how-it-works/policies/network-rules#binary-matching).
