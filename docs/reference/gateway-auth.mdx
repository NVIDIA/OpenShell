...
Reflection advertises only `openshell.v1.OpenShell` and
`openshell.inference.v1.Inference`. It does not advertise internal driver,
interceptor, or middleware services. Callback-only compute-driver listeners do
not serve reflection.
