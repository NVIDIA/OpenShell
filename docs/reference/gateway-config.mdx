...
image_pull_policy  = "IfNotPresent"
# Use the image's non-root OCI USER for agent children. This is the default.
identity_source    = "image"
# For operator-controlled external or shared storage, select "fixed" and set
# both IDs. There is no implicit 10001:10001 local-driver identity.
