...
# Optional pre-JWT authentication exchange. This is gateway-owned and does not
# depend on which compute driver is selected.
...
type                 = "kubernetes_service_account"
service_account_name = "openshell-sandbox"
# Shared mode accepts one namespace. Managed mode instead uses
# namespace_prefix = "openshell-<gateway-id>-". Operator mode uses exactly one
# of namespace_label or namespace_file.
namespace            = "agents"
