...
[openshell.drivers.kubernetes.warm_pooling.profiles]
# Optional ConfigMap-backed reconciler for admin-declared warm pools.
enabled = true
namespace = "openshell"
label_selector = "openshell.ai/warm-pool-profile=true"
max_replicas = 100
