...
# Target OCSF schema version for JSONL downgrade. When set, the JSONL layer
# strips fields and profiles that don't exist in the target version. Empty or
# unset means no downgrade. Use "1.1" for AWS Security Lake, "1.3" for Splunk.
