...
# container installs nftables rules that exempt the effective sidecar UID, and
# in cni-sidecar topology the OpenShell CNI plugin installs equivalent rules, so
