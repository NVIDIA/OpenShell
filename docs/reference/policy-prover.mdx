...
model scope, checked policy version, modeled domains, and assumptions. An
exceeding result also includes a filesystem or network counterexample.
Automation should use `result` and `reason_code` instead of parsing the
