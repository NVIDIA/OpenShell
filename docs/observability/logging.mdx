...
|---|---|---|---|
| `EVENT` | Base Event | 0 | Unix socket relay and relay-control notifications without network endpoints |
...
relay-control notifications moved from `NET:*` to `EVENT` because they do not
have a network endpoint.
