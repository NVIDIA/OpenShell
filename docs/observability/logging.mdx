...
MXC ETW process-launch events record the executable name but omit command-line arguments from both OCSF JSON and shorthand. Arguments can legitimately contain credentials, signed URLs, or PII.
