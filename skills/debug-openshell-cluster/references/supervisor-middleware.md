...
| Gateway rejects middleware before serving health | Missing peer metadata, incompatible protocol major, or unmet `required_capabilities` | Gateway and middleware startup logs; compare `PeerMetadata`; upgrade the middleware before the gateway |
