...
The OpenShell Go SDK exposes 13 interfaces through the sub-client pattern. You access each interface through a typed accessor on the `Client`.
...
- **[Sandbox Templates](sandbox-templates.md)**: Manage reusable template definitions used by `CreateFromTemplate`.
