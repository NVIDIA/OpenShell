...
type Sandbox struct {
	...
	// Read-only provenance for sandboxes created from a named template.
	CreatedFromTemplate *SandboxTemplateProvenance `protobuf:"bytes,4,opt,name=created_from_template,json=createdFromTemplate,proto3" json:"created_from_template,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *Sandbox) GetCreatedFromTemplate() *SandboxTemplateProvenance {
	if x != nil {
		return x.CreatedFromTemplate
	}
	return nil
}

// Resolved desired sandbox configuration stored by the gateway.
type SandboxSpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Portable workload shape used to provision the sandbox.
	Workload *SandboxWorkloadConfig `protobuf:"bytes,12,opt,name=workload,proto3" json:"workload,omitempty"`
	// Driver-keyed opaque config envelope resolved at create time.
	DriverConfig *structpb.Struct `protobuf:"bytes,13,opt,name=driver_config,json=driverConfig,proto3" json:"driver_config,omitempty"`
	// Required sandbox policy configuration.
	Policy *sandboxv1.SandboxPolicy `protobuf:"bytes,14,opt,name=policy,proto3" json:"policy,omitempty"`
	// Provider names to attach to this sandbox.
	Providers     []string `protobuf:"bytes,15,rep,name=providers,proto3" json:"providers,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SandboxSpec) GetWorkload() *SandboxWorkloadConfig {
	if x != nil {
		return x.Workload
	}
	return nil
...
func (x *SandboxSpec) GetDriverConfig() *structpb.Struct {
	if x != nil {
...
// Reusable sandbox template resource scoped to a workspace.
type SandboxTemplate struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Kubernetes-style metadata (id, name, labels, timestamps, resource version).
	Metadata *datamodelv1.ObjectMeta `protobuf:"bytes,1,opt,name=metadata,proto3" json:"metadata,omitempty"`
	// Desired reusable workload shape.
	Spec          *SandboxTemplateSpec `protobuf:"bytes,2,opt,name=spec,proto3" json:"spec,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SandboxTemplate) GetMetadata() *datamodelv1.ObjectMeta {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *SandboxTemplate) GetSpec() *SandboxTemplateSpec {
	if x != nil {
		return x.Spec
	}
	return nil
...
func (x *SandboxTemplateSpec) Reset() {
	*x = SandboxTemplateSpec{}
	mi := &file_openshell_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SandboxTemplateSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SandboxTemplateSpec) ProtoMessage() {}

func (x *SandboxTemplateSpec) ProtoReflect() protoreflect.Message {
	mi := &file_openshell_proto_msgTypes[17]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SandboxTemplateSpec.ProtoReflect.Descriptor instead.
func (*SandboxTemplateSpec) Descriptor() ([]byte, []int) {
	return file_openshell_proto_rawDescGZIP(), []int{17}
}

func (x *SandboxTemplateSpec) GetWorkload() *SandboxWorkloadConfig {
	if x != nil {
		return x.Workload
	}
	return nil
...
func (x *SandboxTemplateSpec) GetDriverConfig() *structpb.Struct {
	if x != nil {
		return x.DriverConfig
	}
	return nil
...
func (x *SandboxTemplateSpec) GetDesiredServiceLevel() *SandboxServiceLevel {
	if x != nil {
...
func (x *SandboxTemplateProvenance) Reset() {
	*x = SandboxTemplateProvenance{}
	mi := &file_openshell_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SandboxTemplateProvenance) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SandboxTemplateProvenance) ProtoMessage() {}

func (x *SandboxTemplateProvenance) ProtoReflect() protoreflect.Message {
	mi := &file_openshell_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SandboxTemplateProvenance.ProtoReflect.Descriptor instead.
func (*SandboxTemplateProvenance) Descriptor() ([]byte, []int) {
	return file_openshell_proto_rawDescGZIP(), []int{20}
}

func (x *SandboxTemplateProvenance) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
type CreateSandboxRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Types that are valid to be assigned to WorkloadSource:
	//
	//	*CreateSandboxRequest_Workload
	//	*CreateSandboxRequest_WorkloadTemplateName
	WorkloadSource isCreateSandboxRequest_WorkloadSource `protobuf_oneof:"workload_source"`
	// Required sandbox policy configuration.
	Policy *sandboxv1.SandboxPolicy `protobuf:"bytes,8,opt,name=policy,proto3" json:"policy,omitempty"`
	// Provider names to attach to this sandbox.
...
func (x *CreateSandboxRequest) GetWorkloadSource() isCreateSandboxRequest_WorkloadSource {
	if x != nil {
		return x.WorkloadSource
	}
	return nil
}

func (x *CreateSandboxRequest) GetWorkload() *SandboxWorkloadConfig {
	if x != nil {
		if x, ok := x.WorkloadSource.(*CreateSandboxRequest_Workload); ok {
			return x.Workload
		}
	}
	return nil
...
func (x *CreateSandboxRequest) GetWorkloadTemplateName() string {
	if x != nil {
		if x, ok := x.WorkloadSource.(*CreateSandboxRequest_WorkloadTemplateName); ok {
...
func (x *CreateSandboxRequest) GetPolicy() *sandboxv1.SandboxPolicy {
	if x != nil {
		return x.Policy
	}
	return nil
...
func (x *CreateSandboxRequest) GetProviders() []string {
	if x != nil {
		return x.Providers
	}
	return nil
...
type isCreateSandboxRequest_WorkloadSource interface {
	isCreateSandboxRequest_WorkloadSource()
}

type CreateSandboxRequest_Workload struct {
	// Inline portable workload config for this sandbox.
	Workload *SandboxWorkloadConfig `protobuf:"bytes,6,opt,name=workload,proto3,oneof"`
}

type CreateSandboxRequest_WorkloadTemplateName struct {
	// Workspace-scoped template name to resolve at creation time.
	WorkloadTemplateName string `protobuf:"bytes,7,opt,name=workload_template_name,json=workloadTemplateName,proto3,oneof"`
}

func (*CreateSandboxRequest_Workload) isCreateSandboxRequest_WorkloadSource() {}

func (*CreateSandboxRequest_WorkloadTemplateName) isCreateSandboxRequest_WorkloadSource() {}
...
func (x *CreateSandboxTemplateRequest) GetTemplate() *SandboxTemplate {
	if x != nil {
		return x.Template
	}
	return nil
...
func (x *SandboxTemplateResponse) GetTemplate() *SandboxTemplate {
	if x != nil {
		return x.Template
	}
	return nil
...
var file_openshell_proto_msgTypes = make([]protoimpl.MessageInfo, 217)
var file_openshell_proto_goTypes = []any{
	...
	(PolicyStatus)(0),                                    // 3: openshell.v1.PolicyStatus
	(ServiceStatus)(0),                                   // 4: openshell.v1.ServiceStatus
	...
	(*RefreshSandboxTokenRequest)(nil),                   // 8: openshell.v1.RefreshSandboxTokenRequest
	(*RefreshSandboxTokenResponse)(nil),                  // 9: openshell.v1.RefreshSandboxTokenResponse
	(*HealthRequest)(nil),                                // 10: openshell.v1.HealthRequest
	(*HealthResponse)(nil),                               // 11: openshell.v1.HealthResponse
	(*GetCurrentUserRequest)(nil),                        // 12: openshell.v1.GetCurrentUserRequest
	(*GetCurrentUserResponse)(nil),                       // 13: openshell.v1.GetCurrentUserResponse
	(*GetGatewayInfoRequest)(nil),                        // 14: openshell.v1.GetGatewayInfoRequest
	(*GetGatewayInfoResponse)(nil),                       // 15: openshell.v1.GetGatewayInfoResponse
	(*ComputeDriverInfo)(nil),                            // 16: openshell.v1.ComputeDriverInfo
	(*ComputeDriverCapabilities)(nil),                    // 17: openshell.v1.ComputeDriverCapabilities
	(*Sandbox)(nil),                                      // 18: openshell.v1.Sandbox
	(*SandboxSpec)(nil),                                  // 19: openshell.v1.SandboxSpec
	(*SandboxWorkloadConfig)(nil),                        // 20: openshell.v1.SandboxWorkloadConfig
	(*SandboxResources)(nil),                             // 21: openshell.v1.SandboxResources
	(*SandboxTemplate)(nil),                              // 22: openshell.v1.SandboxTemplate
	(*SandboxTemplateSpec)(nil),                          // 23: openshell.v1.SandboxTemplateSpec
	(*SandboxServiceLevel)(nil),                          // 24: openshell.v1.SandboxServiceLevel
	(*SandboxStartup)(nil),                               // 25: openshell.v1.SandboxStartup
	(*SandboxTemplateProvenance)(nil),                    // 26: openshell.v1.SandboxTemplateProvenance
	...
	(*CreateSandboxTemplateRequest)(nil),                 // 31: openshell.v1.CreateSandboxTemplateRequest
	(*GetSandboxTemplateRequest)(nil),                    // 32: openshell.v1.GetSandboxTemplateRequest
	(*ListSandboxTemplatesRequest)(nil),                  // 33: openshell.v1.ListSandboxTemplatesRequest
	(*DeleteSandboxTemplateRequest)(nil),                 // 34: openshell.v1.DeleteSandboxTemplateRequest
	(*SandboxTemplateResponse)(nil),                      // 35: openshell.v1.SandboxTemplateResponse
	(*ListSandboxTemplatesResponse)(nil),                 // 36: openshell.v1.ListSandboxTemplatesResponse
	(*DeleteSandboxTemplateResponse)(nil),                // 37: openshell.v1.DeleteSandboxTemplateResponse
	...
	(*GetProviderRefreshStatusRequest)(nil),              // 98: openshell.v1.GetProviderRefreshStatusRequest
	(*GetProviderRefreshStatusResponse)(nil),             // 99: openshell.v1.GetProviderRefreshStatusResponse
	(*ConfigureProviderRefreshRequest)(nil),              // 100: openshell.v1.ConfigureProviderRefreshRequest
	(*ConfigureProviderRefreshResponse)(nil),             // 101: openshell.v1.ConfigureProviderRefreshResponse
	(*RotateProviderCredentialRequest)(nil),              // 102: openshell.v1.RotateProviderCredentialRequest
	(*RotateProviderCredentialResponse)(nil),             // 103: openshell.v1.RotateProviderCredentialResponse
	(*DeleteProviderRefreshRequest)(nil),                 // 104: openshell.v1.DeleteProviderRefreshRequest
	(*DeleteProviderRefreshResponse)(nil),                // 105: openshell.v1.DeleteProviderRefreshResponse
	(*ProviderProfile)(nil),                              // 106: openshell.v1.ProviderProfile
	(*StoredProviderProfile)(nil),                        // 107: openshell.v1.StoredProviderProfile
	(*ProviderProfileResponse)(nil),                      // 108: openshell.v1.ProviderProfileResponse
	(*ListProviderProfilesResponse)(nil),                 // 109: openshell.v1.ListProviderProfilesResponse
	(*ImportProviderProfilesRequest)(nil),                // 110: openshell.v1.ImportProviderProfilesRequest
	(*ImportProviderProfilesResponse)(nil),               // 111: openshell.v1.ImportProviderProfilesResponse
	(*UpdateProviderProfilesRequest)(nil),                // 112: openshell.v1.UpdateProviderProfilesRequest
	...
	(*LintProviderProfilesResponse)(nil),                 // 115: openshell.v1.LintProviderProfilesResponse
	(*DeleteProviderResponse)(nil),                       // 116: openshell.v1.DeleteProviderResponse
	(*DeleteProviderProfileRequest)(nil),                 // 117: openshell.v1.DeleteProviderProfileRequest
	(*DeleteProviderProfileResponse)(nil),                // 118: openshell.v1.DeleteProviderProfileResponse
	(*GetSandboxProviderEnvironmentRequest)(nil),         // 119: openshell.v1.GetSandboxProviderEnvironmentRequest
	(*StaticCredentialEndpointBinding)(nil),              // 120: openshell.v1.StaticCredentialEndpointBinding
	(*StaticCredentialBinding)(nil),                      // 121: openshell.v1.StaticCredentialBinding
	(*GetSandboxProviderEnvironmentResponse)(nil),        // 122: openshell.v1.GetSandboxProviderEnvironmentResponse
	(*UpdateConfigRequest)(nil),                          // 123: openshell.v1.UpdateConfigRequest
	(*PolicyMergeOperation)(nil),                         // 124: openshell.v1.PolicyMergeOperation
	(*AddNetworkRule)(nil),                               // 125: openshell.v1.AddNetworkRule
	(*RemoveNetworkEndpoint)(nil),                        // 126: openshell.v1.RemoveNetworkEndpoint
	(*RemoveNetworkRule)(nil),                            // 127: openshell.v1.RemoveNetworkRule
	(*AddDenyRules)(nil),                                 // 128: openshell.v1.AddDenyRules
	(*AddAllowRules)(nil),                                // 129: openshell.v1.AddAllowRules
	(*RemoveNetworkBinary)(nil),                          // 130: openshell.v1.RemoveNetworkBinary
	(*UpdateConfigResponse)(nil),                         // 131: openshell.v1.UpdateConfigResponse
	(*GetSandboxPolicyStatusRequest)(nil),                // 132: openshell.v1.GetSandboxPolicyStatusRequest
	(*GetSandboxPolicyStatusResponse)(nil),               // 133: openshell.v1.GetSandboxPolicyStatusResponse
	(*ListSandboxPoliciesRequest)(nil),                   // 134: openshell.v1.ListSandboxPoliciesRequest
	(*ListSandboxPoliciesResponse)(nil),                  // 135: openshell.v1.ListSandboxPoliciesResponse
	(*ReportPolicyStatusRequest)(nil),                    // 136: openshell.v1.ReportPolicyStatusRequest
	(*ReportPolicyStatusResponse)(nil),                   // 137: openshell.v1.ReportPolicyStatusResponse
	(*SandboxPolicyRevision)(nil),                        // 138: openshell.v1.SandboxPolicyRevision
	(*GetSandboxLogsRequest)(nil),                        // 139: openshell.v1.GetSandboxLogsRequest
	(*PushSandboxLogsRequest)(nil),                       // 140: openshell.v1.PushSandboxLogsRequest
	(*PushSandboxLogsResponse)(nil),                      // 141: openshell.v1.PushSandboxLogsResponse
	(*GetSandboxLogsResponse)(nil),                       // 142: openshell.v1.GetSandboxLogsResponse
	(*SupervisorMessage)(nil),                            // 143: openshell.v1.SupervisorMessage
	(*GatewayMessage)(nil),                               // 144: openshell.v1.GatewayMessage
	(*SupervisorHello)(nil),                              // 145: openshell.v1.SupervisorHello
	(*SessionAccepted)(nil),                              // 146: openshell.v1.SessionAccepted
	(*SessionRejected)(nil),                              // 147: openshell.v1.SessionRejected
	(*SupervisorHeartbeat)(nil),                          // 148: openshell.v1.SupervisorHeartbeat
	(*GatewayHeartbeat)(nil),                             // 149: openshell.v1.GatewayHeartbeat
	(*RelayOpen)(nil),                                    // 150: openshell.v1.RelayOpen
	(*SshRelayTarget)(nil),                               // 151: openshell.v1.SshRelayTarget
	(*TcpRelayTarget)(nil),                               // 152: openshell.v1.TcpRelayTarget
	(*RelayInit)(nil),                                    // 153: openshell.v1.RelayInit
	(*RelayFrame)(nil),                                   // 154: openshell.v1.RelayFrame
	(*RelayOpenResult)(nil),                              // 155: openshell.v1.RelayOpenResult
	(*RelayClose)(nil),                                   // 156: openshell.v1.RelayClose
	(*L7RequestSample)(nil),                              // 157: openshell.v1.L7RequestSample
	(*DenialSummary)(nil),                                // 158: openshell.v1.DenialSummary
	(*DenialGroupCount)(nil),                             // 159: openshell.v1.DenialGroupCount
	(*NetworkActivitySummary)(nil),                       // 160: openshell.v1.NetworkActivitySummary
	(*PolicyChunk)(nil),                                  // 161: openshell.v1.PolicyChunk
	(*DraftPolicyUpdate)(nil),                            // 162: openshell.v1.DraftPolicyUpdate
	(*SubmitPolicyAnalysisRequest)(nil),                  // 163: openshell.v1.SubmitPolicyAnalysisRequest
	(*SubmitPolicyAnalysisResponse)(nil),                 // 164: openshell.v1.SubmitPolicyAnalysisResponse
	(*GetDraftPolicyRequest)(nil),                        // 165: openshell.v1.GetDraftPolicyRequest
	(*GetDraftPolicyResponse)(nil),                       // 166: openshell.v1.GetDraftPolicyResponse
	(*ApproveDraftChunkRequest)(nil),                     // 167: openshell.v1.ApproveDraftChunkRequest
	(*ApproveDraftChunkResponse)(nil),                    // 168: openshell.v1.ApproveDraftChunkResponse
	(*RejectDraftChunkRequest)(nil),                      // 169: openshell.v1.RejectDraftChunkRequest
	(*RejectDraftChunkResponse)(nil),                     // 170: openshell.v1.RejectDraftChunkResponse
	(*ApproveAllDraftChunksRequest)(nil),                 // 171: openshell.v1.ApproveAllDraftChunksRequest
	(*ApproveAllDraftChunksResponse)(nil),                // 172: openshell.v1.ApproveAllDraftChunksResponse
	(*EditDraftChunkRequest)(nil),                        // 173: openshell.v1.EditDraftChunkRequest
	(*EditDraftChunkResponse)(nil),                       // 174: openshell.v1.EditDraftChunkResponse
	(*UndoDraftChunkRequest)(nil),                        // 175: openshell.v1.UndoDraftChunkRequest
	(*UndoDraftChunkResponse)(nil),                       // 176: openshell.v1.UndoDraftChunkResponse
	(*ClearDraftChunksRequest)(nil),                      // 177: openshell.v1.ClearDraftChunksRequest
	(*ClearDraftChunksResponse)(nil),                     // 178: openshell.v1.ClearDraftChunksResponse
	(*GetDraftHistoryRequest)(nil),                       // 179: openshell.v1.GetDraftHistoryRequest
	(*DraftHistoryEntry)(nil),                            // 180: openshell.v1.DraftHistoryEntry
	(*GetDraftHistoryResponse)(nil),                      // 181: openshell.v1.GetDraftHistoryResponse
	(*PolicyRevisionPayload)(nil),                        // 182: openshell.v1.PolicyRevisionPayload
	(*DraftChunkPayload)(nil),                            // 183: openshell.v1.DraftChunkPayload
	(*StoredPolicyRevision)(nil),                         // 184: openshell.v1.StoredPolicyRevision
	(*StoredDraftChunk)(nil),                             // 185: openshell.v1.StoredDraftChunk
	(*CreateWorkspaceRequest)(nil),                       // 186: openshell.v1.CreateWorkspaceRequest
	(*CreateWorkspaceResponse)(nil),                      // 187: openshell.v1.CreateWorkspaceResponse
	(*GetWorkspaceRequest)(nil),                          // 188: openshell.v1.GetWorkspaceRequest
	(*GetWorkspaceResponse)(nil),                         // 189: openshell.v1.GetWorkspaceResponse
	(*ListWorkspacesRequest)(nil),                        // 190: openshell.v1.ListWorkspacesRequest
	(*ListWorkspacesResponse)(nil),                       // 191: openshell.v1.ListWorkspacesResponse
	(*DeleteWorkspaceRequest)(nil),                       // 192: openshell.v1.DeleteWorkspaceRequest
	(*DeleteWorkspaceResponse)(nil),                      // 193: openshell.v1.DeleteWorkspaceResponse
	(*WorkspaceMember)(nil),                              // 194: openshell.v1.WorkspaceMember
	(*AddWorkspaceMemberRequest)(nil),                    // 195: openshell.v1.AddWorkspaceMemberRequest
	(*AddWorkspaceMemberResponse)(nil),                   // 196: openshell.v1.AddWorkspaceMemberResponse
	(*RemoveWorkspaceMemberRequest)(nil),                 // 197: openshell.v1.RemoveWorkspaceMemberRequest
	(*RemoveWorkspaceMemberResponse)(nil),                // 198: openshell.v1.RemoveWorkspaceMemberResponse
	(*ListWorkspaceMembersRequest)(nil),                  // 199: openshell.v1.ListWorkspaceMembersRequest
	...
	nil,                                                  // 202: openshell.v1.SandboxWorkloadConfig.EnvironmentEntry
	nil,                                                  // 203: openshell.v1.PlatformEvent.MetadataEntry
	nil,                                                  // 204: openshell.v1.CreateSandboxRequest.LabelsEntry
	nil,                                                  // 205: openshell.v1.CreateSandboxRequest.AnnotationsEntry
	nil,                                                  // 206: openshell.v1.ExecSandboxRequest.EnvironmentEntry
	nil,                                                  // 207: openshell.v1.SandboxLogLine.FieldsEntry
	nil,                                                  // 208: openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	nil,                                                  // 209: openshell.v1.StoredProviderCredentialRefreshState.MaterialEntry
	nil,                                                  // 210: openshell.v1.StoredProviderCredentialRefreshState.AdditionalOutputKeysEntry
	nil,                                                  // 211: openshell.v1.ConfigureProviderRefreshRequest.MaterialEntry
	nil,                                                  // 212: openshell.v1.ProviderProfile.AnnotationsEntry
	nil,                                                  // 213: openshell.v1.GetSandboxProviderEnvironmentResponse.EnvironmentEntry
	nil,                                                  // 214: openshell.v1.GetSandboxProviderEnvironmentResponse.CredentialExpiresAtMsEntry
	nil,                                                  // 215: openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry
	nil,                                                  // 216: openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry
	nil,                                                  // 217: openshell.v1.UpdateConfigRequest.AnnotationsEntry
	nil,                                                  // 218: openshell.v1.UpdateConfigResponse.AnnotationsEntry
	nil,                                                  // 219: openshell.v1.SandboxPolicyRevision.ProvenanceEntry
	nil,                                                  // 220: openshell.v1.PolicyRevisionPayload.ProvenanceEntry
	nil,                                                  // 221: openshell.v1.StoredPolicyRevision.ProvenanceEntry
	nil,                                                  // 222: openshell.v1.CreateWorkspaceRequest.LabelsEntry
	(*datamodelv1.ObjectMeta)(nil),                       // 223: openshell.datamodel.v1.ObjectMeta
	(*structpb.Struct)(nil),                              // 224: google.protobuf.Struct
	(*sandboxv1.SandboxPolicy)(nil),                      // 225: openshell.sandbox.v1.SandboxPolicy
	(*durationpb.Duration)(nil),                          // 226: google.protobuf.Duration
	(*datamodelv1.Provider)(nil),                         // 227: openshell.datamodel.v1.Provider
	(*sandboxv1.NetworkEndpoint)(nil),                    // 228: openshell.sandbox.v1.NetworkEndpoint
	(*sandboxv1.NetworkBinary)(nil),                      // 229: openshell.sandbox.v1.NetworkBinary
	(*sandboxv1.SettingValue)(nil),                       // 230: openshell.sandbox.v1.SettingValue
	(*sandboxv1.NetworkPolicyRule)(nil),                  // 231: openshell.sandbox.v1.NetworkPolicyRule
	(*sandboxv1.L7DenyRule)(nil),                         // 232: openshell.sandbox.v1.L7DenyRule
	(*sandboxv1.L7Rule)(nil),                             // 233: openshell.sandbox.v1.L7Rule
	(*datamodelv1.Workspace)(nil),                        // 234: openshell.datamodel.v1.Workspace
	(*sandboxv1.GetSandboxConfigRequest)(nil),            // 235: openshell.sandbox.v1.GetSandboxConfigRequest
	(*sandboxv1.GetGatewayConfigRequest)(nil),            // 236: openshell.sandbox.v1.GetGatewayConfigRequest
	(*sandboxv1.GetSandboxConfigResponse)(nil),           // 237: openshell.sandbox.v1.GetSandboxConfigResponse
	(*sandboxv1.GetGatewayConfigResponse)(nil),           // 238: openshell.sandbox.v1.GetGatewayConfigResponse
}
var file_openshell_proto_depIdxs = []int32{
	...
	4,   // 1: openshell.v1.HealthResponse.status:type_name -> openshell.v1.ServiceStatus
	4,   // 2: openshell.v1.GetGatewayInfoResponse.status:type_name -> openshell.v1.ServiceStatus
	16,  // 3: openshell.v1.GetGatewayInfoResponse.compute_drivers:type_name -> openshell.v1.ComputeDriverInfo
	17,  // 4: openshell.v1.ComputeDriverInfo.capabilities:type_name -> openshell.v1.ComputeDriverCapabilities
	223, // 5: openshell.v1.Sandbox.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	19,  // 6: openshell.v1.Sandbox.spec:type_name -> openshell.v1.SandboxSpec
	27,  // 7: openshell.v1.Sandbox.status:type_name -> openshell.v1.SandboxStatus
	26,  // 8: openshell.v1.Sandbox.created_from_template:type_name -> openshell.v1.SandboxTemplateProvenance
	20,  // 9: openshell.v1.SandboxSpec.workload:type_name -> openshell.v1.SandboxWorkloadConfig
	224, // 10: openshell.v1.SandboxSpec.driver_config:type_name -> google.protobuf.Struct
	225, // 11: openshell.v1.SandboxSpec.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	202, // 12: openshell.v1.SandboxWorkloadConfig.environment:type_name -> openshell.v1.SandboxWorkloadConfig.EnvironmentEntry
	21,  // 13: openshell.v1.SandboxWorkloadConfig.resources:type_name -> openshell.v1.SandboxResources
	223, // 14: openshell.v1.SandboxTemplate.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	23,  // 15: openshell.v1.SandboxTemplate.spec:type_name -> openshell.v1.SandboxTemplateSpec
	20,  // 16: openshell.v1.SandboxTemplateSpec.workload:type_name -> openshell.v1.SandboxWorkloadConfig
	224, // 17: openshell.v1.SandboxTemplateSpec.driver_config:type_name -> google.protobuf.Struct
	24,  // 18: openshell.v1.SandboxTemplateSpec.desired_service_level:type_name -> openshell.v1.SandboxServiceLevel
	25,  // 19: openshell.v1.SandboxServiceLevel.startup:type_name -> openshell.v1.SandboxStartup
	226, // 20: openshell.v1.SandboxStartup.ready_within:type_name -> google.protobuf.Duration
	28,  // 21: openshell.v1.SandboxStatus.conditions:type_name -> openshell.v1.SandboxCondition
	0,   // 22: openshell.v1.SandboxStatus.phase:type_name -> openshell.v1.SandboxPhase
	203, // 23: openshell.v1.PlatformEvent.metadata:type_name -> openshell.v1.PlatformEvent.MetadataEntry
	20,  // 24: openshell.v1.CreateSandboxRequest.workload:type_name -> openshell.v1.SandboxWorkloadConfig
	225, // 25: openshell.v1.CreateSandboxRequest.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	204, // 26: openshell.v1.CreateSandboxRequest.labels:type_name -> openshell.v1.CreateSandboxRequest.LabelsEntry
	205, // 27: openshell.v1.CreateSandboxRequest.annotations:type_name -> openshell.v1.CreateSandboxRequest.AnnotationsEntry
	22,  // 28: openshell.v1.CreateSandboxTemplateRequest.template:type_name -> openshell.v1.SandboxTemplate
	22,  // 29: openshell.v1.SandboxTemplateResponse.template:type_name -> openshell.v1.SandboxTemplate
	22,  // 30: openshell.v1.ListSandboxTemplatesResponse.templates:type_name -> openshell.v1.SandboxTemplate
	18,  // 31: openshell.v1.SandboxResponse.sandbox:type_name -> openshell.v1.Sandbox
	18,  // 32: openshell.v1.ListSandboxesResponse.sandboxes:type_name -> openshell.v1.Sandbox
	227, // 33: openshell.v1.ListSandboxProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	18,  // 34: openshell.v1.AttachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	18,  // 35: openshell.v1.DetachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	61,  // 36: openshell.v1.ListServicesResponse.services:type_name -> openshell.v1.ServiceEndpointResponse
	223, // 37: openshell.v1.ServiceEndpoint.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	60,  // 38: openshell.v1.ServiceEndpointResponse.endpoint:type_name -> openshell.v1.ServiceEndpoint
	206, // 39: openshell.v1.ExecSandboxRequest.environment:type_name -> openshell.v1.ExecSandboxRequest.EnvironmentEntry
	...
	151, // 43: openshell.v1.TcpForwardInit.ssh:type_name -> openshell.v1.SshRelayTarget
	152, // 44: openshell.v1.TcpForwardInit.tcp:type_name -> openshell.v1.TcpRelayTarget
	...
	223, // 48: openshell.v1.SshSession.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	18,  // 49: openshell.v1.SandboxStreamEvent.sandbox:type_name -> openshell.v1.Sandbox
	...
	162, // 53: openshell.v1.SandboxStreamEvent.draft_policy_update:type_name -> openshell.v1.DraftPolicyUpdate
	207, // 54: openshell.v1.SandboxLogLine.fields:type_name -> openshell.v1.SandboxLogLine.FieldsEntry
	227, // 55: openshell.v1.CreateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	227, // 56: openshell.v1.UpdateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	208, // 57: openshell.v1.UpdateProviderRequest.credential_expires_at_ms:type_name -> openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	227, // 58: openshell.v1.ProviderResponse.provider:type_name -> openshell.datamodel.v1.Provider
	227, // 59: openshell.v1.ListProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	106, // 60: openshell.v1.ProviderProfileImportItem.profile:type_name -> openshell.v1.ProviderProfile
	...
	94,  // 62: openshell.v1.ProviderProfileCredential.refresh:type_name -> openshell.v1.ProviderCredentialRefresh
	90,  // 63: openshell.v1.ProviderProfileCredential.token_grant:type_name -> openshell.v1.ProviderCredentialTokenGrant
	1,   // 64: openshell.v1.ProviderCredentialRefresh.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	92,  // 65: openshell.v1.ProviderCredentialRefresh.material:type_name -> openshell.v1.ProviderCredentialRefreshMaterial
	93,  // 66: openshell.v1.ProviderCredentialRefresh.additional_outputs:type_name -> openshell.v1.ProviderCredentialRefreshOutput
	1,   // 67: openshell.v1.ProviderCredentialRefreshStatus.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	223, // 68: openshell.v1.StoredProviderCredentialRefreshState.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	1,   // 69: openshell.v1.StoredProviderCredentialRefreshState.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	209, // 70: openshell.v1.StoredProviderCredentialRefreshState.material:type_name -> openshell.v1.StoredProviderCredentialRefreshState.MaterialEntry
	210, // 71: openshell.v1.StoredProviderCredentialRefreshState.additional_output_keys:type_name -> openshell.v1.StoredProviderCredentialRefreshState.AdditionalOutputKeysEntry
	95,  // 72: openshell.v1.GetProviderRefreshStatusResponse.credentials:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	1,   // 73: openshell.v1.ConfigureProviderRefreshRequest.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	211, // 74: openshell.v1.ConfigureProviderRefreshRequest.material:type_name -> openshell.v1.ConfigureProviderRefreshRequest.MaterialEntry
	95,  // 75: openshell.v1.ConfigureProviderRefreshResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	95,  // 76: openshell.v1.RotateProviderCredentialResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	2,   // 77: openshell.v1.ProviderProfile.category:type_name -> openshell.v1.ProviderProfileCategory
	91,  // 78: openshell.v1.ProviderProfile.credentials:type_name -> openshell.v1.ProviderProfileCredential
	228, // 79: openshell.v1.ProviderProfile.endpoints:type_name -> openshell.sandbox.v1.NetworkEndpoint
	229, // 80: openshell.v1.ProviderProfile.binaries:type_name -> openshell.sandbox.v1.NetworkBinary
	96,  // 81: openshell.v1.ProviderProfile.discovery:type_name -> openshell.v1.ProviderProfileDiscovery
	212, // 82: openshell.v1.ProviderProfile.annotations:type_name -> openshell.v1.ProviderProfile.AnnotationsEntry
	223, // 83: openshell.v1.StoredProviderProfile.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	106, // 84: openshell.v1.StoredProviderProfile.profile:type_name -> openshell.v1.ProviderProfile
	106, // 85: openshell.v1.ProviderProfileResponse.profile:type_name -> openshell.v1.ProviderProfile
	106, // 86: openshell.v1.ListProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	87,  // 87: openshell.v1.ImportProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	88,  // 88: openshell.v1.ImportProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	106, // 89: openshell.v1.ImportProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	87,  // 90: openshell.v1.UpdateProviderProfilesRequest.profile:type_name -> openshell.v1.ProviderProfileImportItem
	88,  // 91: openshell.v1.UpdateProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	106, // 92: openshell.v1.UpdateProviderProfilesResponse.profile:type_name -> openshell.v1.ProviderProfile
	87,  // 93: openshell.v1.LintProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	88,  // 94: openshell.v1.LintProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	120, // 95: openshell.v1.StaticCredentialBinding.endpoints:type_name -> openshell.v1.StaticCredentialEndpointBinding
	...
	214, // 97: openshell.v1.GetSandboxProviderEnvironmentResponse.credential_expires_at_ms:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.CredentialExpiresAtMsEntry
	215, // 98: openshell.v1.GetSandboxProviderEnvironmentResponse.dynamic_credentials:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry
	216, // 99: openshell.v1.GetSandboxProviderEnvironmentResponse.static_credential_bindings:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry
	225, // 100: openshell.v1.UpdateConfigRequest.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	230, // 101: openshell.v1.UpdateConfigRequest.setting_value:type_name -> openshell.sandbox.v1.SettingValue
	124, // 102: openshell.v1.UpdateConfigRequest.merge_operations:type_name -> openshell.v1.PolicyMergeOperation
	217, // 103: openshell.v1.UpdateConfigRequest.annotations:type_name -> openshell.v1.UpdateConfigRequest.AnnotationsEntry
	125, // 104: openshell.v1.PolicyMergeOperation.add_rule:type_name -> openshell.v1.AddNetworkRule
	126, // 105: openshell.v1.PolicyMergeOperation.remove_endpoint:type_name -> openshell.v1.RemoveNetworkEndpoint
	127, // 106: openshell.v1.PolicyMergeOperation.remove_rule:type_name -> openshell.v1.RemoveNetworkRule
	128, // 107: openshell.v1.PolicyMergeOperation.add_deny_rules:type_name -> openshell.v1.AddDenyRules
	129, // 108: openshell.v1.PolicyMergeOperation.add_allow_rules:type_name -> openshell.v1.AddAllowRules
	130, // 109: openshell.v1.PolicyMergeOperation.remove_binary:type_name -> openshell.v1.RemoveNetworkBinary
	231, // 110: openshell.v1.AddNetworkRule.rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	232, // 111: openshell.v1.AddDenyRules.deny_rules:type_name -> openshell.sandbox.v1.L7DenyRule
	233, // 112: openshell.v1.AddAllowRules.rules:type_name -> openshell.sandbox.v1.L7Rule
	218, // 113: openshell.v1.UpdateConfigResponse.annotations:type_name -> openshell.v1.UpdateConfigResponse.AnnotationsEntry
	138, // 114: openshell.v1.GetSandboxPolicyStatusResponse.revision:type_name -> openshell.v1.SandboxPolicyRevision
	138, // 115: openshell.v1.ListSandboxPoliciesResponse.revisions:type_name -> openshell.v1.SandboxPolicyRevision
	3,   // 116: openshell.v1.ReportPolicyStatusRequest.status:type_name -> openshell.v1.PolicyStatus
	3,   // 117: openshell.v1.SandboxPolicyRevision.status:type_name -> openshell.v1.PolicyStatus
	225, // 118: openshell.v1.SandboxPolicyRevision.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	219, // 119: openshell.v1.SandboxPolicyRevision.provenance:type_name -> openshell.v1.SandboxPolicyRevision.ProvenanceEntry
	76,  // 120: openshell.v1.PushSandboxLogsRequest.logs:type_name -> openshell.v1.SandboxLogLine
	76,  // 121: openshell.v1.GetSandboxLogsResponse.logs:type_name -> openshell.v1.SandboxLogLine
	145, // 122: openshell.v1.SupervisorMessage.hello:type_name -> openshell.v1.SupervisorHello
	148, // 123: openshell.v1.SupervisorMessage.heartbeat:type_name -> openshell.v1.SupervisorHeartbeat
	155, // 124: openshell.v1.SupervisorMessage.relay_open_result:type_name -> openshell.v1.RelayOpenResult
	156, // 125: openshell.v1.SupervisorMessage.relay_close:type_name -> openshell.v1.RelayClose
	146, // 126: openshell.v1.GatewayMessage.session_accepted:type_name -> openshell.v1.SessionAccepted
	147, // 127: openshell.v1.GatewayMessage.session_rejected:type_name -> openshell.v1.SessionRejected
	149, // 128: openshell.v1.GatewayMessage.heartbeat:type_name -> openshell.v1.GatewayHeartbeat
	150, // 129: openshell.v1.GatewayMessage.relay_open:type_name -> openshell.v1.RelayOpen
	156, // 130: openshell.v1.GatewayMessage.relay_close:type_name -> openshell.v1.RelayClose
	151, // 131: openshell.v1.RelayOpen.ssh:type_name -> openshell.v1.SshRelayTarget
	152, // 132: openshell.v1.RelayOpen.tcp:type_name -> openshell.v1.TcpRelayTarget
	153, // 133: openshell.v1.RelayFrame.init:type_name -> openshell.v1.RelayInit
	157, // 134: openshell.v1.DenialSummary.l7_request_samples:type_name -> openshell.v1.L7RequestSample
	159, // 135: openshell.v1.NetworkActivitySummary.denials_by_group:type_name -> openshell.v1.DenialGroupCount
	231, // 136: openshell.v1.PolicyChunk.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	158, // 137: openshell.v1.SubmitPolicyAnalysisRequest.summaries:type_name -> openshell.v1.DenialSummary
	161, // 138: openshell.v1.SubmitPolicyAnalysisRequest.proposed_chunks:type_name -> openshell.v1.PolicyChunk
	160, // 139: openshell.v1.SubmitPolicyAnalysisRequest.network_activity_summaries:type_name -> openshell.v1.NetworkActivitySummary
	161, // 140: openshell.v1.GetDraftPolicyResponse.chunks:type_name -> openshell.v1.PolicyChunk
	231, // 141: openshell.v1.EditDraftChunkRequest.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	180, // 142: openshell.v1.GetDraftHistoryResponse.entries:type_name -> openshell.v1.DraftHistoryEntry
	225, // 143: openshell.v1.PolicyRevisionPayload.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	220, // 144: openshell.v1.PolicyRevisionPayload.provenance:type_name -> openshell.v1.PolicyRevisionPayload.ProvenanceEntry
	231, // 145: openshell.v1.DraftChunkPayload.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	221, // 146: openshell.v1.StoredPolicyRevision.provenance:type_name -> openshell.v1.StoredPolicyRevision.ProvenanceEntry
	222, // 147: openshell.v1.CreateWorkspaceRequest.labels:type_name -> openshell.v1.CreateWorkspaceRequest.LabelsEntry
	234, // 148: openshell.v1.CreateWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	234, // 149: openshell.v1.GetWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	234, // 150: openshell.v1.ListWorkspacesResponse.workspaces:type_name -> openshell.datamodel.v1.Workspace
	223, // 151: openshell.v1.WorkspaceMember.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	5,   // 152: openshell.v1.WorkspaceMember.role:type_name -> openshell.v1.WorkspaceRole
	5,   // 153: openshell.v1.AddWorkspaceMemberRequest.role:type_name -> openshell.v1.WorkspaceRole
	194, // 154: openshell.v1.AddWorkspaceMemberResponse.member:type_name -> openshell.v1.WorkspaceMember
	194, // 155: openshell.v1.ListWorkspaceMembersResponse.members:type_name -> openshell.v1.WorkspaceMember
	91,  // 156: openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry.value:type_name -> openshell.v1.ProviderProfileCredential
	121, // 157: openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry.value:type_name -> openshell.v1.StaticCredentialBinding
	10,  // 158: openshell.v1.OpenShell.Health:input_type -> openshell.v1.HealthRequest
	12,  // 159: openshell.v1.OpenShell.GetCurrentUser:input_type -> openshell.v1.GetCurrentUserRequest
	14,  // 160: openshell.v1.OpenShell.GetGatewayInfo:input_type -> openshell.v1.GetGatewayInfoRequest
	30,  // 161: openshell.v1.OpenShell.CreateSandbox:input_type -> openshell.v1.CreateSandboxRequest
	38,  // 162: openshell.v1.OpenShell.GetSandbox:input_type -> openshell.v1.GetSandboxRequest
	39,  // 163: openshell.v1.OpenShell.ListSandboxes:input_type -> openshell.v1.ListSandboxesRequest
	31,  // 164: openshell.v1.OpenShell.CreateSandboxTemplate:input_type -> openshell.v1.CreateSandboxTemplateRequest
	32,  // 165: openshell.v1.OpenShell.GetSandboxTemplate:input_type -> openshell.v1.GetSandboxTemplateRequest
	33,  // 166: openshell.v1.OpenShell.ListSandboxTemplates:input_type -> openshell.v1.ListSandboxTemplatesRequest
	34,  // 167: openshell.v1.OpenShell.DeleteSandboxTemplate:input_type -> openshell.v1.DeleteSandboxTemplateRequest
	40,  // 168: openshell.v1.OpenShell.ListSandboxProviders:input_type -> openshell.v1.ListSandboxProvidersRequest
	41,  // 169: openshell.v1.OpenShell.AttachSandboxProvider:input_type -> openshell.v1.AttachSandboxProviderRequest
	42,  // 170: openshell.v1.OpenShell.DetachSandboxProvider:input_type -> openshell.v1.DetachSandboxProviderRequest
	43,  // 171: openshell.v1.OpenShell.DeleteSandbox:input_type -> openshell.v1.DeleteSandboxRequest
	44,  // 172: openshell.v1.OpenShell.StopSandbox:input_type -> openshell.v1.StopSandboxRequest
	45,  // 173: openshell.v1.OpenShell.StartSandbox:input_type -> openshell.v1.StartSandboxRequest
	52,  // 174: openshell.v1.OpenShell.CreateSshSession:input_type -> openshell.v1.CreateSshSessionRequest
	54,  // 175: openshell.v1.OpenShell.ExposeService:input_type -> openshell.v1.ExposeServiceRequest
	55,  // 176: openshell.v1.OpenShell.GetService:input_type -> openshell.v1.GetServiceRequest
	56,  // 177: openshell.v1.OpenShell.ListServices:input_type -> openshell.v1.ListServicesRequest
	58,  // 178: openshell.v1.OpenShell.DeleteService:input_type -> openshell.v1.DeleteServiceRequest
	62,  // 179: openshell.v1.OpenShell.RevokeSshSession:input_type -> openshell.v1.RevokeSshSessionRequest
	64,  // 180: openshell.v1.OpenShell.ExecSandbox:input_type -> openshell.v1.ExecSandboxRequest
	70,  // 181: openshell.v1.OpenShell.ForwardTcp:input_type -> openshell.v1.TcpForwardFrame
	71,  // 182: openshell.v1.OpenShell.ExecSandboxInteractive:input_type -> openshell.v1.ExecSandboxInput
	78,  // 183: openshell.v1.OpenShell.CreateProvider:input_type -> openshell.v1.CreateProviderRequest
	79,  // 184: openshell.v1.OpenShell.GetProvider:input_type -> openshell.v1.GetProviderRequest
	80,  // 185: openshell.v1.OpenShell.ListProviders:input_type -> openshell.v1.ListProvidersRequest
	85,  // 186: openshell.v1.OpenShell.ListProviderProfiles:input_type -> openshell.v1.ListProviderProfilesRequest
	86,  // 187: openshell.v1.OpenShell.GetProviderProfile:input_type -> openshell.v1.GetProviderProfileRequest
	110, // 188: openshell.v1.OpenShell.ImportProviderProfiles:input_type -> openshell.v1.ImportProviderProfilesRequest
	112, // 189: openshell.v1.OpenShell.UpdateProviderProfiles:input_type -> openshell.v1.UpdateProviderProfilesRequest
	114, // 190: openshell.v1.OpenShell.LintProviderProfiles:input_type -> openshell.v1.LintProviderProfilesRequest
	81,  // 191: openshell.v1.OpenShell.UpdateProvider:input_type -> openshell.v1.UpdateProviderRequest
	98,  // 192: openshell.v1.OpenShell.GetProviderRefreshStatus:input_type -> openshell.v1.GetProviderRefreshStatusRequest
	100, // 193: openshell.v1.OpenShell.ConfigureProviderRefresh:input_type -> openshell.v1.ConfigureProviderRefreshRequest
	102, // 194: openshell.v1.OpenShell.RotateProviderCredential:input_type -> openshell.v1.RotateProviderCredentialRequest
	104, // 195: openshell.v1.OpenShell.DeleteProviderRefresh:input_type -> openshell.v1.DeleteProviderRefreshRequest
	82,  // 196: openshell.v1.OpenShell.DeleteProvider:input_type -> openshell.v1.DeleteProviderRequest
	117, // 197: openshell.v1.OpenShell.DeleteProviderProfile:input_type -> openshell.v1.DeleteProviderProfileRequest
	235, // 198: openshell.v1.OpenShell.GetSandboxConfig:input_type -> openshell.sandbox.v1.GetSandboxConfigRequest
	236, // 199: openshell.v1.OpenShell.GetGatewayConfig:input_type -> openshell.sandbox.v1.GetGatewayConfigRequest
	123, // 200: openshell.v1.OpenShell.UpdateConfig:input_type -> openshell.v1.UpdateConfigRequest
	132, // 201: openshell.v1.OpenShell.GetSandboxPolicyStatus:input_type -> openshell.v1.GetSandboxPolicyStatusRequest
	134, // 202: openshell.v1.OpenShell.ListSandboxPolicies:input_type -> openshell.v1.ListSandboxPoliciesRequest
	136, // 203: openshell.v1.OpenShell.ReportPolicyStatus:input_type -> openshell.v1.ReportPolicyStatusRequest
	119, // 204: openshell.v1.OpenShell.GetSandboxProviderEnvironment:input_type -> openshell.v1.GetSandboxProviderEnvironmentRequest
	139, // 205: openshell.v1.OpenShell.GetSandboxLogs:input_type -> openshell.v1.GetSandboxLogsRequest
	140, // 206: openshell.v1.OpenShell.PushSandboxLogs:input_type -> openshell.v1.PushSandboxLogsRequest
	143, // 207: openshell.v1.OpenShell.ConnectSupervisor:input_type -> openshell.v1.SupervisorMessage
	154, // 208: openshell.v1.OpenShell.RelayStream:input_type -> openshell.v1.RelayFrame
	74,  // 209: openshell.v1.OpenShell.WatchSandbox:input_type -> openshell.v1.WatchSandboxRequest
	163, // 210: openshell.v1.OpenShell.SubmitPolicyAnalysis:input_type -> openshell.v1.SubmitPolicyAnalysisRequest
	165, // 211: openshell.v1.OpenShell.GetDraftPolicy:input_type -> openshell.v1.GetDraftPolicyRequest
	167, // 212: openshell.v1.OpenShell.ApproveDraftChunk:input_type -> openshell.v1.ApproveDraftChunkRequest
	169, // 213: openshell.v1.OpenShell.RejectDraftChunk:input_type -> openshell.v1.RejectDraftChunkRequest
	171, // 214: openshell.v1.OpenShell.ApproveAllDraftChunks:input_type -> openshell.v1.ApproveAllDraftChunksRequest
	173, // 215: openshell.v1.OpenShell.EditDraftChunk:input_type -> openshell.v1.EditDraftChunkRequest
	175, // 216: openshell.v1.OpenShell.UndoDraftChunk:input_type -> openshell.v1.UndoDraftChunkRequest
	177, // 217: openshell.v1.OpenShell.ClearDraftChunks:input_type -> openshell.v1.ClearDraftChunksRequest
	179, // 218: openshell.v1.OpenShell.GetDraftHistory:input_type -> openshell.v1.GetDraftHistoryRequest
	6,   // 219: openshell.v1.OpenShell.IssueSandboxToken:input_type -> openshell.v1.IssueSandboxTokenRequest
	8,   // 220: openshell.v1.OpenShell.RefreshSandboxToken:input_type -> openshell.v1.RefreshSandboxTokenRequest
	186, // 221: openshell.v1.OpenShell.CreateWorkspace:input_type -> openshell.v1.CreateWorkspaceRequest
	188, // 222: openshell.v1.OpenShell.GetWorkspace:input_type -> openshell.v1.GetWorkspaceRequest
	190, // 223: openshell.v1.OpenShell.ListWorkspaces:input_type -> openshell.v1.ListWorkspacesRequest
	192, // 224: openshell.v1.OpenShell.DeleteWorkspace:input_type -> openshell.v1.DeleteWorkspaceRequest
	195, // 225: openshell.v1.OpenShell.AddWorkspaceMember:input_type -> openshell.v1.AddWorkspaceMemberRequest
	197, // 226: openshell.v1.OpenShell.RemoveWorkspaceMember:input_type -> openshell.v1.RemoveWorkspaceMemberRequest
	199, // 227: openshell.v1.OpenShell.ListWorkspaceMembers:input_type -> openshell.v1.ListWorkspaceMembersRequest
	11,  // 228: openshell.v1.OpenShell.Health:output_type -> openshell.v1.HealthResponse
	13,  // 229: openshell.v1.OpenShell.GetCurrentUser:output_type -> openshell.v1.GetCurrentUserResponse
	15,  // 230: openshell.v1.OpenShell.GetGatewayInfo:output_type -> openshell.v1.GetGatewayInfoResponse
	46,  // 231: openshell.v1.OpenShell.CreateSandbox:output_type -> openshell.v1.SandboxResponse
	46,  // 232: openshell.v1.OpenShell.GetSandbox:output_type -> openshell.v1.SandboxResponse
	47,  // 233: openshell.v1.OpenShell.ListSandboxes:output_type -> openshell.v1.ListSandboxesResponse
	35,  // 234: openshell.v1.OpenShell.CreateSandboxTemplate:output_type -> openshell.v1.SandboxTemplateResponse
	35,  // 235: openshell.v1.OpenShell.GetSandboxTemplate:output_type -> openshell.v1.SandboxTemplateResponse
	36,  // 236: openshell.v1.OpenShell.ListSandboxTemplates:output_type -> openshell.v1.ListSandboxTemplatesResponse
	37,  // 237: openshell.v1.OpenShell.DeleteSandboxTemplate:output_type -> openshell.v1.DeleteSandboxTemplateResponse
	48,  // 238: openshell.v1.OpenShell.ListSandboxProviders:output_type -> openshell.v1.ListSandboxProvidersResponse
	49,  // 239: openshell.v1.OpenShell.AttachSandboxProvider:output_type -> openshell.v1.AttachSandboxProviderResponse
	50,  // 240: openshell.v1.OpenShell.DetachSandboxProvider:output_type -> openshell.v1.DetachSandboxProviderResponse
	51,  // 241: openshell.v1.OpenShell.DeleteSandbox:output_type -> openshell.v1.DeleteSandboxResponse
	46,  // 242: openshell.v1.OpenShell.StopSandbox:output_type -> openshell.v1.SandboxResponse
	46,  // 243: openshell.v1.OpenShell.StartSandbox:output_type -> openshell.v1.SandboxResponse
	53,  // 244: openshell.v1.OpenShell.CreateSshSession:output_type -> openshell.v1.CreateSshSessionResponse
	61,  // 245: openshell.v1.OpenShell.ExposeService:output_type -> openshell.v1.ServiceEndpointResponse
	61,  // 246: openshell.v1.OpenShell.GetService:output_type -> openshell.v1.ServiceEndpointResponse
	57,  // 247: openshell.v1.OpenShell.ListServices:output_type -> openshell.v1.ListServicesResponse
	59,  // 248: openshell.v1.OpenShell.DeleteService:output_type -> openshell.v1.DeleteServiceResponse
	63,  // 249: openshell.v1.OpenShell.RevokeSshSession:output_type -> openshell.v1.RevokeSshSessionResponse
	68,  // 250: openshell.v1.OpenShell.ExecSandbox:output_type -> openshell.v1.ExecSandboxEvent
	70,  // 251: openshell.v1.OpenShell.ForwardTcp:output_type -> openshell.v1.TcpForwardFrame
	68,  // 252: openshell.v1.OpenShell.ExecSandboxInteractive:output_type -> openshell.v1.ExecSandboxEvent
	83,  // 253: openshell.v1.OpenShell.CreateProvider:output_type -> openshell.v1.ProviderResponse
	83,  // 254: openshell.v1.OpenShell.GetProvider:output_type -> openshell.v1.ProviderResponse
	84,  // 255: openshell.v1.OpenShell.ListProviders:output_type -> openshell.v1.ListProvidersResponse
	109, // 256: openshell.v1.OpenShell.ListProviderProfiles:output_type -> openshell.v1.ListProviderProfilesResponse
	108, // 257: openshell.v1.OpenShell.GetProviderProfile:output_type -> openshell.v1.ProviderProfileResponse
	111, // 258: openshell.v1.OpenShell.ImportProviderProfiles:output_type -> openshell.v1.ImportProviderProfilesResponse
	113, // 259: openshell.v1.OpenShell.UpdateProviderProfiles:output_type -> openshell.v1.UpdateProviderProfilesResponse
	115, // 260: openshell.v1.OpenShell.LintProviderProfiles:output_type -> openshell.v1.LintProviderProfilesResponse
	83,  // 261: openshell.v1.OpenShell.UpdateProvider:output_type -> openshell.v1.ProviderResponse
	99,  // 262: openshell.v1.OpenShell.GetProviderRefreshStatus:output_type -> openshell.v1.GetProviderRefreshStatusResponse
	101, // 263: openshell.v1.OpenShell.ConfigureProviderRefresh:output_type -> openshell.v1.ConfigureProviderRefreshResponse
	103, // 264: openshell.v1.OpenShell.RotateProviderCredential:output_type -> openshell.v1.RotateProviderCredentialResponse
	105, // 265: openshell.v1.OpenShell.DeleteProviderRefresh:output_type -> openshell.v1.DeleteProviderRefreshResponse
	116, // 266: openshell.v1.OpenShell.DeleteProvider:output_type -> openshell.v1.DeleteProviderResponse
	118, // 267: openshell.v1.OpenShell.DeleteProviderProfile:output_type -> openshell.v1.DeleteProviderProfileResponse
	237, // 268: openshell.v1.OpenShell.GetSandboxConfig:output_type -> openshell.sandbox.v1.GetSandboxConfigResponse
	238, // 269: openshell.v1.OpenShell.GetGatewayConfig:output_type -> openshell.sandbox.v1.GetGatewayConfigResponse
	131, // 270: openshell.v1.OpenShell.UpdateConfig:output_type -> openshell.v1.UpdateConfigResponse
	133, // 271: openshell.v1.OpenShell.GetSandboxPolicyStatus:output_type -> openshell.v1.GetSandboxPolicyStatusResponse
	135, // 272: openshell.v1.OpenShell.ListSandboxPolicies:output_type -> openshell.v1.ListSandboxPoliciesResponse
	137, // 273: openshell.v1.OpenShell.ReportPolicyStatus:output_type -> openshell.v1.ReportPolicyStatusResponse
	122, // 274: openshell.v1.OpenShell.GetSandboxProviderEnvironment:output_type -> openshell.v1.GetSandboxProviderEnvironmentResponse
	142, // 275: openshell.v1.OpenShell.GetSandboxLogs:output_type -> openshell.v1.GetSandboxLogsResponse
	141, // 276: openshell.v1.OpenShell.PushSandboxLogs:output_type -> openshell.v1.PushSandboxLogsResponse
	144, // 277: openshell.v1.OpenShell.ConnectSupervisor:output_type -> openshell.v1.GatewayMessage
	154, // 278: openshell.v1.OpenShell.RelayStream:output_type -> openshell.v1.RelayFrame
	75,  // 279: openshell.v1.OpenShell.WatchSandbox:output_type -> openshell.v1.SandboxStreamEvent
	164, // 280: openshell.v1.OpenShell.SubmitPolicyAnalysis:output_type -> openshell.v1.SubmitPolicyAnalysisResponse
	166, // 281: openshell.v1.OpenShell.GetDraftPolicy:output_type -> openshell.v1.GetDraftPolicyResponse
	168, // 282: openshell.v1.OpenShell.ApproveDraftChunk:output_type -> openshell.v1.ApproveDraftChunkResponse
	170, // 283: openshell.v1.OpenShell.RejectDraftChunk:output_type -> openshell.v1.RejectDraftChunkResponse
	172, // 284: openshell.v1.OpenShell.ApproveAllDraftChunks:output_type -> openshell.v1.ApproveAllDraftChunksResponse
	174, // 285: openshell.v1.OpenShell.EditDraftChunk:output_type -> openshell.v1.EditDraftChunkResponse
	176, // 286: openshell.v1.OpenShell.UndoDraftChunk:output_type -> openshell.v1.UndoDraftChunkResponse
	178, // 287: openshell.v1.OpenShell.ClearDraftChunks:output_type -> openshell.v1.ClearDraftChunksResponse
	181, // 288: openshell.v1.OpenShell.GetDraftHistory:output_type -> openshell.v1.GetDraftHistoryResponse
	7,   // 289: openshell.v1.OpenShell.IssueSandboxToken:output_type -> openshell.v1.IssueSandboxTokenResponse
	9,   // 290: openshell.v1.OpenShell.RefreshSandboxToken:output_type -> openshell.v1.RefreshSandboxTokenResponse
	187, // 291: openshell.v1.OpenShell.CreateWorkspace:output_type -> openshell.v1.CreateWorkspaceResponse
	189, // 292: openshell.v1.OpenShell.GetWorkspace:output_type -> openshell.v1.GetWorkspaceResponse
	191, // 293: openshell.v1.OpenShell.ListWorkspaces:output_type -> openshell.v1.ListWorkspacesResponse
	193, // 294: openshell.v1.OpenShell.DeleteWorkspace:output_type -> openshell.v1.DeleteWorkspaceResponse
	196, // 295: openshell.v1.OpenShell.AddWorkspaceMember:output_type -> openshell.v1.AddWorkspaceMemberResponse
	198, // 296: openshell.v1.OpenShell.RemoveWorkspaceMember:output_type -> openshell.v1.RemoveWorkspaceMemberResponse
	200, // 297: openshell.v1.OpenShell.ListWorkspaceMembers:output_type -> openshell.v1.ListWorkspaceMembersResponse
...
func file_openshell_proto_init() {
	...
	file_openshell_proto_msgTypes[24].OneofWrappers = []any{
		(*CreateSandboxRequest_Workload)(nil),
		(*CreateSandboxRequest_WorkloadTemplateName)(nil),
	}
	...
	file_openshell_proto_msgTypes[64].OneofWrappers = []any{
	...
	file_openshell_proto_msgTypes[94].OneofWrappers = []any{}
	file_openshell_proto_msgTypes[118].OneofWrappers = []any{
	...
	file_openshell_proto_msgTypes[137].OneofWrappers = []any{
	...
	file_openshell_proto_msgTypes[138].OneofWrappers = []any{
