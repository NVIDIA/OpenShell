...
var file_openshell_proto_msgTypes = make([]protoimpl.MessageInfo, 221)
var file_openshell_proto_goTypes = []any{
	...
	(*CpuResourceRequirements)(nil),                      // 24: openshell.v1.CpuResourceRequirements
	(*MemoryResourceRequirements)(nil),                   // 25: openshell.v1.MemoryResourceRequirements
	...
	(*GetSandboxProviderEnvironmentResponse)(nil),        // 117: openshell.v1.GetSandboxProviderEnvironmentResponse
	...
	(*SessionRejected)(nil),                              // 144: openshell.v1.SessionRejected
	(*SupervisorHeartbeat)(nil),                          // 145: openshell.v1.SupervisorHeartbeat
	(*GatewayHeartbeat)(nil),                             // 146: openshell.v1.GatewayHeartbeat
	(*ReportMainProcessExitRequest)(nil),                 // 147: openshell.v1.ReportMainProcessExitRequest
	(*ReportMainProcessExitResponse)(nil),                // 148: openshell.v1.ReportMainProcessExitResponse
	(*FinalizeMainProcessExitRequest)(nil),               // 149: openshell.v1.FinalizeMainProcessExitRequest
	(*FinalizeMainProcessExitResponse)(nil),              // 150: openshell.v1.FinalizeMainProcessExitResponse
	(*RelayOpen)(nil),                                    // 151: openshell.v1.RelayOpen
	(*SshRelayTarget)(nil),                               // 152: openshell.v1.SshRelayTarget
	(*TcpRelayTarget)(nil),                               // 153: openshell.v1.TcpRelayTarget
	(*RelayInit)(nil),                                    // 154: openshell.v1.RelayInit
	(*RelayFrame)(nil),                                   // 155: openshell.v1.RelayFrame
	(*RelayOpenResult)(nil),                              // 156: openshell.v1.RelayOpenResult
	(*RelayClose)(nil),                                   // 157: openshell.v1.RelayClose
	(*L7RequestSample)(nil),                              // 158: openshell.v1.L7RequestSample
	(*DenialSummary)(nil),                                // 159: openshell.v1.DenialSummary
	(*DenialGroupCount)(nil),                             // 160: openshell.v1.DenialGroupCount
	(*NetworkActivitySummary)(nil),                       // 161: openshell.v1.NetworkActivitySummary
	(*PolicyChunk)(nil),                                  // 162: openshell.v1.PolicyChunk
	(*DraftPolicyUpdate)(nil),                            // 163: openshell.v1.DraftPolicyUpdate
	(*SubmitPolicyAnalysisRequest)(nil),                  // 164: openshell.v1.SubmitPolicyAnalysisRequest
	(*SubmitPolicyAnalysisResponse)(nil),                 // 165: openshell.v1.SubmitPolicyAnalysisResponse
	(*GetDraftPolicyRequest)(nil),                        // 166: openshell.v1.GetDraftPolicyRequest
	(*GetDraftPolicyResponse)(nil),                       // 167: openshell.v1.GetDraftPolicyResponse
	(*ApproveDraftChunkRequest)(nil),                     // 168: openshell.v1.ApproveDraftChunkRequest
	(*ApproveDraftChunkResponse)(nil),                    // 169: openshell.v1.ApproveDraftChunkResponse
	(*RejectDraftChunkRequest)(nil),                      // 170: openshell.v1.RejectDraftChunkRequest
	(*RejectDraftChunkResponse)(nil),                     // 171: openshell.v1.RejectDraftChunkResponse
	(*DraftChunkApproval)(nil),                           // 172: openshell.v1.DraftChunkApproval
	...
	nil,                                                  // 204: openshell.v1.SandboxSpec.EnvironmentEntry
	nil,                                                  // 205: openshell.v1.SandboxTemplate.LabelsEntry
	nil,                                                  // 206: openshell.v1.SandboxTemplate.AnnotationsEntry
	nil,                                                  // 207: openshell.v1.SandboxTemplate.EnvironmentEntry
	nil,                                                  // 208: openshell.v1.PlatformEvent.MetadataEntry
	nil,                                                  // 209: openshell.v1.CreateSandboxRequest.LabelsEntry
	nil,                                                  // 210: openshell.v1.CreateSandboxRequest.AnnotationsEntry
	nil,                                                  // 211: openshell.v1.ExecSandboxRequest.EnvironmentEntry
	nil,                                                  // 212: openshell.v1.SandboxLogLine.FieldsEntry
	nil,                                                  // 213: openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	nil,                                                  // 214: openshell.v1.StoredProviderCredentialRefreshState.MaterialEntry
	nil,                                                  // 215: openshell.v1.StoredProviderCredentialRefreshState.AdditionalOutputKeysEntry
	nil,                                                  // 216: openshell.v1.StoredProviderCredentialRefreshState.SecretMaterialHandlesEntry
	nil,                                                  // 217: openshell.v1.ConfigureProviderRefreshRequest.MaterialEntry
	nil,                                                  // 218: openshell.v1.ProviderProfile.AnnotationsEntry
	nil,                                                  // 219: openshell.v1.GetSandboxProviderEnvironmentResponse.EnvironmentEntry
	nil,                                                  // 220: openshell.v1.GetSandboxProviderEnvironmentResponse.CredentialExpiresAtMsEntry
	nil,                                                  // 221: openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry
	nil,                                                  // 222: openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry
	nil,                                                  // 223: openshell.v1.UpdateConfigRequest.AnnotationsEntry
	nil,                                                  // 224: openshell.v1.UpdateConfigResponse.AnnotationsEntry
	nil,                                                  // 225: openshell.v1.SandboxPolicyRevision.ProvenanceEntry
	nil,                                                  // 226: openshell.v1.PolicyRevisionPayload.ProvenanceEntry
	nil,                                                  // 227: openshell.v1.StoredPolicyRevision.ProvenanceEntry
	nil,                                                  // 228: openshell.v1.CreateWorkspaceRequest.LabelsEntry
	(*datamodelv1.ObjectMeta)(nil),                       // 229: openshell.datamodel.v1.ObjectMeta
	(*sandboxv1.SandboxPolicy)(nil),                      // 230: openshell.sandbox.v1.SandboxPolicy
	(*structpb.Struct)(nil),                              // 231: google.protobuf.Struct
	(*datamodelv1.Provider)(nil),                         // 232: openshell.datamodel.v1.Provider
...
var file_openshell_proto_depIdxs = []int32{
	...
	229, // 5: openshell.v1.Sandbox.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	...
	204, // 8: openshell.v1.SandboxSpec.environment:type_name -> openshell.v1.SandboxSpec.EnvironmentEntry
	26,  // 9: openshell.v1.SandboxSpec.template:type_name -> openshell.v1.SandboxTemplate
	230, // 10: openshell.v1.SandboxSpec.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	...
	24,  // 13: openshell.v1.ResourceRequirements.cpu:type_name -> openshell.v1.CpuResourceRequirements
	25,  // 14: openshell.v1.ResourceRequirements.memory:type_name -> openshell.v1.MemoryResourceRequirements
	205, // 15: openshell.v1.SandboxTemplate.labels:type_name -> openshell.v1.SandboxTemplate.LabelsEntry
	206, // 16: openshell.v1.SandboxTemplate.annotations:type_name -> openshell.v1.SandboxTemplate.AnnotationsEntry
	207, // 17: openshell.v1.SandboxTemplate.environment:type_name -> openshell.v1.SandboxTemplate.EnvironmentEntry
	231, // 18: openshell.v1.SandboxTemplate.resources:type_name -> google.protobuf.Struct
	231, // 19: openshell.v1.SandboxTemplate.driver_config:type_name -> google.protobuf.Struct
	...
	208, // 22: openshell.v1.PlatformEvent.metadata:type_name -> openshell.v1.PlatformEvent.MetadataEntry
	21,  // 23: openshell.v1.CreateSandboxRequest.spec:type_name -> openshell.v1.SandboxSpec
	209, // 24: openshell.v1.CreateSandboxRequest.labels:type_name -> openshell.v1.CreateSandboxRequest.LabelsEntry
	210, // 25: openshell.v1.CreateSandboxRequest.annotations:type_name -> openshell.v1.CreateSandboxRequest.AnnotationsEntry
	20,  // 26: openshell.v1.SandboxResponse.sandbox:type_name -> openshell.v1.Sandbox
	20,  // 27: openshell.v1.ListSandboxesResponse.sandboxes:type_name -> openshell.v1.Sandbox
	232, // 28: openshell.v1.ListSandboxProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	20,  // 29: openshell.v1.AttachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	20,  // 30: openshell.v1.DetachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	54,  // 31: openshell.v1.ListServicesResponse.services:type_name -> openshell.v1.ServiceEndpointResponse
	229, // 32: openshell.v1.ServiceEndpoint.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	53,  // 33: openshell.v1.ServiceEndpointResponse.endpoint:type_name -> openshell.v1.ServiceEndpoint
	211, // 34: openshell.v1.ExecSandboxRequest.environment:type_name -> openshell.v1.ExecSandboxRequest.EnvironmentEntry
	58,  // 35: openshell.v1.ExecSandboxEvent.stdout:type_name -> openshell.v1.ExecSandboxStdout
	59,  // 36: openshell.v1.ExecSandboxEvent.stderr:type_name -> openshell.v1.ExecSandboxStderr
	60,  // 37: openshell.v1.ExecSandboxEvent.exit:type_name -> openshell.v1.ExecSandboxExit
	152, // 38: openshell.v1.TcpForwardInit.ssh:type_name -> openshell.v1.SshRelayTarget
	153, // 39: openshell.v1.TcpForwardInit.tcp:type_name -> openshell.v1.TcpRelayTarget
	62,  // 40: openshell.v1.TcpForwardFrame.init:type_name -> openshell.v1.TcpForwardInit
	57,  // 41: openshell.v1.ExecSandboxInput.start:type_name -> openshell.v1.ExecSandboxRequest
	65,  // 42: openshell.v1.ExecSandboxInput.resize:type_name -> openshell.v1.ExecSandboxWindowResize
	229, // 43: openshell.v1.SshSession.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	20,  // 44: openshell.v1.SandboxStreamEvent.sandbox:type_name -> openshell.v1.Sandbox
	69,  // 45: openshell.v1.SandboxStreamEvent.log:type_name -> openshell.v1.SandboxLogLine
	29,  // 46: openshell.v1.SandboxStreamEvent.event:type_name -> openshell.v1.PlatformEvent
	70,  // 47: openshell.v1.SandboxStreamEvent.warning:type_name -> openshell.v1.SandboxStreamWarning
	163, // 48: openshell.v1.SandboxStreamEvent.draft_policy_update:type_name -> openshell.v1.DraftPolicyUpdate
	212, // 49: openshell.v1.SandboxLogLine.fields:type_name -> openshell.v1.SandboxLogLine.FieldsEntry
	232, // 50: openshell.v1.CreateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	232, // 51: openshell.v1.UpdateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	213, // 52: openshell.v1.UpdateProviderRequest.credential_expires_at_ms:type_name -> openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	232, // 53: openshell.v1.ProviderResponse.provider:type_name -> openshell.datamodel.v1.Provider
	232, // 54: openshell.v1.ListProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	101, // 55: openshell.v1.ProviderProfileImportItem.profile:type_name -> openshell.v1.ProviderProfile
	82,  // 56: openshell.v1.ProviderCredentialTokenGrant.audience_overrides:type_name -> openshell.v1.ProviderCredentialTokenGrantAudienceOverride
	1,   // 57: openshell.v1.ProviderCredentialTokenGrant.grant_type:type_name -> openshell.v1.ProviderCredentialTokenGrantType
	83,  // 58: openshell.v1.ProviderCredentialTokenGrant.subject_token:type_name -> openshell.v1.ProviderCredentialTokenGrantSubjectToken
	88,  // 59: openshell.v1.ProviderProfileCredential.refresh:type_name -> openshell.v1.ProviderCredentialRefresh
	84,  // 60: openshell.v1.ProviderProfileCredential.token_grant:type_name -> openshell.v1.ProviderCredentialTokenGrant
	2,   // 61: openshell.v1.ProviderCredentialRefresh.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	86,  // 62: openshell.v1.ProviderCredentialRefresh.material:type_name -> openshell.v1.ProviderCredentialRefreshMaterial
	87,  // 63: openshell.v1.ProviderCredentialRefresh.additional_outputs:type_name -> openshell.v1.ProviderCredentialRefreshOutput
	2,   // 64: openshell.v1.ProviderCredentialRefreshStatus.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	7,   // 65: openshell.v1.ProviderCredentialRefreshStatus.recovery_action:type_name -> openshell.v1.ProviderCredentialRefreshRecoveryAction
	229, // 66: openshell.v1.StoredProviderCredentialRefreshState.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	2,   // 67: openshell.v1.StoredProviderCredentialRefreshState.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	214, // 68: openshell.v1.StoredProviderCredentialRefreshState.material:type_name -> openshell.v1.StoredProviderCredentialRefreshState.MaterialEntry
	215, // 69: openshell.v1.StoredProviderCredentialRefreshState.additional_output_keys:type_name -> openshell.v1.StoredProviderCredentialRefreshState.AdditionalOutputKeysEntry
	216, // 70: openshell.v1.StoredProviderCredentialRefreshState.secret_material_handles:type_name -> openshell.v1.StoredProviderCredentialRefreshState.SecretMaterialHandlesEntry
	92,  // 71: openshell.v1.StoredProviderCredentialRefreshState.pending_secret_deletions:type_name -> openshell.v1.StoredRefreshMaterialDeletion
	7,   // 72: openshell.v1.StoredProviderCredentialRefreshState.recovery_action:type_name -> openshell.v1.ProviderCredentialRefreshRecoveryAction
	233, // 73: openshell.v1.StoredRefreshMaterialDeletion.handle:type_name -> openshell.datamodel.v1.CredentialHandle
	89,  // 74: openshell.v1.GetProviderRefreshStatusResponse.credentials:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	2,   // 75: openshell.v1.ConfigureProviderRefreshRequest.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	217, // 76: openshell.v1.ConfigureProviderRefreshRequest.material:type_name -> openshell.v1.ConfigureProviderRefreshRequest.MaterialEntry
	89,  // 77: openshell.v1.ConfigureProviderRefreshResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	89,  // 78: openshell.v1.RotateProviderCredentialResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	3,   // 79: openshell.v1.ProviderProfile.category:type_name -> openshell.v1.ProviderProfileCategory
	85,  // 80: openshell.v1.ProviderProfile.credentials:type_name -> openshell.v1.ProviderProfileCredential
	234, // 81: openshell.v1.ProviderProfile.endpoints:type_name -> openshell.sandbox.v1.NetworkEndpoint
	235, // 82: openshell.v1.ProviderProfile.binaries:type_name -> openshell.sandbox.v1.NetworkBinary
	90,  // 83: openshell.v1.ProviderProfile.discovery:type_name -> openshell.v1.ProviderProfileDiscovery
	218, // 84: openshell.v1.ProviderProfile.annotations:type_name -> openshell.v1.ProviderProfile.AnnotationsEntry
	229, // 85: openshell.v1.StoredProviderProfile.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	101, // 86: openshell.v1.StoredProviderProfile.profile:type_name -> openshell.v1.ProviderProfile
	101, // 87: openshell.v1.ProviderProfileResponse.profile:type_name -> openshell.v1.ProviderProfile
	101, // 88: openshell.v1.ListProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	80,  // 89: openshell.v1.ImportProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	81,  // 90: openshell.v1.ImportProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	101, // 91: openshell.v1.ImportProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	80,  // 92: openshell.v1.UpdateProviderProfilesRequest.profile:type_name -> openshell.v1.ProviderProfileImportItem
	81,  // 93: openshell.v1.UpdateProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	101, // 94: openshell.v1.UpdateProviderProfilesResponse.profile:type_name -> openshell.v1.ProviderProfile
	80,  // 95: openshell.v1.LintProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	81,  // 96: openshell.v1.LintProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	115, // 97: openshell.v1.StaticCredentialBinding.endpoints:type_name -> openshell.v1.StaticCredentialEndpointBinding
	...
	220, // 99: openshell.v1.GetSandboxProviderEnvironmentResponse.credential_expires_at_ms:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.CredentialExpiresAtMsEntry
	221, // 100: openshell.v1.GetSandboxProviderEnvironmentResponse.dynamic_credentials:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry
	222, // 101: openshell.v1.GetSandboxProviderEnvironmentResponse.static_credential_bindings:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry
	230, // 102: openshell.v1.UpdateConfigRequest.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	236, // 103: openshell.v1.UpdateConfigRequest.setting_value:type_name -> openshell.sandbox.v1.SettingValue
	121, // 104: openshell.v1.UpdateConfigRequest.merge_operations:type_name -> openshell.v1.PolicyMergeOperation
	223, // 105: openshell.v1.UpdateConfigRequest.annotations:type_name -> openshell.v1.UpdateConfigRequest.AnnotationsEntry
	122, // 106: openshell.v1.PolicyMergeOperation.add_rule:type_name -> openshell.v1.AddNetworkRule
	123, // 107: openshell.v1.PolicyMergeOperation.remove_endpoint:type_name -> openshell.v1.RemoveNetworkEndpoint
	124, // 108: openshell.v1.PolicyMergeOperation.remove_rule:type_name -> openshell.v1.RemoveNetworkRule
	125, // 109: openshell.v1.PolicyMergeOperation.add_deny_rules:type_name -> openshell.v1.AddDenyRules
	126, // 110: openshell.v1.PolicyMergeOperation.add_allow_rules:type_name -> openshell.v1.AddAllowRules
	127, // 111: openshell.v1.PolicyMergeOperation.remove_binary:type_name -> openshell.v1.RemoveNetworkBinary
	237, // 112: openshell.v1.AddNetworkRule.rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	238, // 113: openshell.v1.AddDenyRules.deny_rules:type_name -> openshell.sandbox.v1.L7DenyRule
	239, // 114: openshell.v1.AddAllowRules.rules:type_name -> openshell.sandbox.v1.L7Rule
	224, // 115: openshell.v1.UpdateConfigResponse.annotations:type_name -> openshell.v1.UpdateConfigResponse.AnnotationsEntry
	135, // 116: openshell.v1.GetSandboxPolicyStatusResponse.revision:type_name -> openshell.v1.SandboxPolicyRevision
	135, // 117: openshell.v1.ListSandboxPoliciesResponse.revisions:type_name -> openshell.v1.SandboxPolicyRevision
	4,   // 118: openshell.v1.ReportPolicyStatusRequest.status:type_name -> openshell.v1.PolicyStatus
	4,   // 119: openshell.v1.SandboxPolicyRevision.status:type_name -> openshell.v1.PolicyStatus
	230, // 120: openshell.v1.SandboxPolicyRevision.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	225, // 121: openshell.v1.SandboxPolicyRevision.provenance:type_name -> openshell.v1.SandboxPolicyRevision.ProvenanceEntry
	69,  // 122: openshell.v1.PushSandboxLogsRequest.logs:type_name -> openshell.v1.SandboxLogLine
	69,  // 123: openshell.v1.GetSandboxLogsResponse.logs:type_name -> openshell.v1.SandboxLogLine
	142, // 124: openshell.v1.SupervisorMessage.hello:type_name -> openshell.v1.SupervisorHello
	145, // 125: openshell.v1.SupervisorMessage.heartbeat:type_name -> openshell.v1.SupervisorHeartbeat
	156, // 126: openshell.v1.SupervisorMessage.relay_open_result:type_name -> openshell.v1.RelayOpenResult
	157, // 127: openshell.v1.SupervisorMessage.relay_close:type_name -> openshell.v1.RelayClose
	143, // 128: openshell.v1.GatewayMessage.session_accepted:type_name -> openshell.v1.SessionAccepted
	144, // 129: openshell.v1.GatewayMessage.session_rejected:type_name -> openshell.v1.SessionRejected
	146, // 130: openshell.v1.GatewayMessage.heartbeat:type_name -> openshell.v1.GatewayHeartbeat
	151, // 131: openshell.v1.GatewayMessage.relay_open:type_name -> openshell.v1.RelayOpen
	157, // 132: openshell.v1.GatewayMessage.relay_close:type_name -> openshell.v1.RelayClose
	152, // 133: openshell.v1.RelayOpen.ssh:type_name -> openshell.v1.SshRelayTarget
	153, // 134: openshell.v1.RelayOpen.tcp:type_name -> openshell.v1.TcpRelayTarget
	154, // 135: openshell.v1.RelayFrame.init:type_name -> openshell.v1.RelayInit
	158, // 136: openshell.v1.DenialSummary.l7_request_samples:type_name -> openshell.v1.L7RequestSample
	160, // 137: openshell.v1.NetworkActivitySummary.denials_by_group:type_name -> openshell.v1.DenialGroupCount
	237, // 138: openshell.v1.PolicyChunk.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	230, // 139: openshell.v1.PolicyChunk.current_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	230, // 140: openshell.v1.PolicyChunk.candidate_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	159, // 141: openshell.v1.SubmitPolicyAnalysisRequest.summaries:type_name -> openshell.v1.DenialSummary
	162, // 142: openshell.v1.SubmitPolicyAnalysisRequest.proposed_chunks:type_name -> openshell.v1.PolicyChunk
	161, // 143: openshell.v1.SubmitPolicyAnalysisRequest.network_activity_summaries:type_name -> openshell.v1.NetworkActivitySummary
	162, // 144: openshell.v1.GetDraftPolicyResponse.chunks:type_name -> openshell.v1.PolicyChunk
	172, // 145: openshell.v1.ApproveAllDraftChunksRequest.approvals:type_name -> openshell.v1.DraftChunkApproval
	237, // 146: openshell.v1.EditDraftChunkRequest.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	182, // 147: openshell.v1.GetDraftHistoryResponse.entries:type_name -> openshell.v1.DraftHistoryEntry
	230, // 148: openshell.v1.PolicyRevisionPayload.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	226, // 149: openshell.v1.PolicyRevisionPayload.provenance:type_name -> openshell.v1.PolicyRevisionPayload.ProvenanceEntry
	237, // 150: openshell.v1.DraftChunkPayload.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	230, // 151: openshell.v1.DraftChunkPayload.current_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	230, // 152: openshell.v1.DraftChunkPayload.candidate_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	227, // 153: openshell.v1.StoredPolicyRevision.provenance:type_name -> openshell.v1.StoredPolicyRevision.ProvenanceEntry
	230, // 154: openshell.v1.StoredDraftChunk.current_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	230, // 155: openshell.v1.StoredDraftChunk.candidate_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	228, // 156: openshell.v1.CreateWorkspaceRequest.labels:type_name -> openshell.v1.CreateWorkspaceRequest.LabelsEntry
	240, // 157: openshell.v1.CreateWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	240, // 158: openshell.v1.GetWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	240, // 159: openshell.v1.ListWorkspacesResponse.workspaces:type_name -> openshell.datamodel.v1.Workspace
	229, // 160: openshell.v1.WorkspaceMember.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	6,   // 161: openshell.v1.WorkspaceMember.role:type_name -> openshell.v1.WorkspaceRole
	6,   // 162: openshell.v1.AddWorkspaceMemberRequest.role:type_name -> openshell.v1.WorkspaceRole
	196, // 163: openshell.v1.AddWorkspaceMemberResponse.member:type_name -> openshell.v1.WorkspaceMember
	196, // 164: openshell.v1.ListWorkspaceMembersResponse.members:type_name -> openshell.v1.WorkspaceMember
	233, // 165: openshell.v1.StoredProviderCredentialRefreshState.SecretMaterialHandlesEntry.value:type_name -> openshell.datamodel.v1.CredentialHandle
	85,  // 166: openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry.value:type_name -> openshell.v1.ProviderProfileCredential
	116, // 167: openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry.value:type_name -> openshell.v1.StaticCredentialBinding
	12,  // 168: openshell.v1.OpenShell.Health:input_type -> openshell.v1.HealthRequest
	14,  // 169: openshell.v1.OpenShell.GetCurrentUser:input_type -> openshell.v1.GetCurrentUserRequest
	16,  // 170: openshell.v1.OpenShell.GetGatewayInfo:input_type -> openshell.v1.GetGatewayInfoRequest
	30,  // 171: openshell.v1.OpenShell.CreateSandbox:input_type -> openshell.v1.CreateSandboxRequest
	31,  // 172: openshell.v1.OpenShell.GetSandbox:input_type -> openshell.v1.GetSandboxRequest
	32,  // 173: openshell.v1.OpenShell.ListSandboxes:input_type -> openshell.v1.ListSandboxesRequest
	33,  // 174: openshell.v1.OpenShell.ListSandboxProviders:input_type -> openshell.v1.ListSandboxProvidersRequest
	34,  // 175: openshell.v1.OpenShell.AttachSandboxProvider:input_type -> openshell.v1.AttachSandboxProviderRequest
	35,  // 176: openshell.v1.OpenShell.DetachSandboxProvider:input_type -> openshell.v1.DetachSandboxProviderRequest
	36,  // 177: openshell.v1.OpenShell.DeleteSandbox:input_type -> openshell.v1.DeleteSandboxRequest
	37,  // 178: openshell.v1.OpenShell.StopSandbox:input_type -> openshell.v1.StopSandboxRequest
	38,  // 179: openshell.v1.OpenShell.StartSandbox:input_type -> openshell.v1.StartSandboxRequest
	45,  // 180: openshell.v1.OpenShell.CreateSshSession:input_type -> openshell.v1.CreateSshSessionRequest
	47,  // 181: openshell.v1.OpenShell.ExposeService:input_type -> openshell.v1.ExposeServiceRequest
	48,  // 182: openshell.v1.OpenShell.GetService:input_type -> openshell.v1.GetServiceRequest
	49,  // 183: openshell.v1.OpenShell.ListServices:input_type -> openshell.v1.ListServicesRequest
	51,  // 184: openshell.v1.OpenShell.DeleteService:input_type -> openshell.v1.DeleteServiceRequest
	55,  // 185: openshell.v1.OpenShell.RevokeSshSession:input_type -> openshell.v1.RevokeSshSessionRequest
	57,  // 186: openshell.v1.OpenShell.ExecSandbox:input_type -> openshell.v1.ExecSandboxRequest
	63,  // 187: openshell.v1.OpenShell.ForwardTcp:input_type -> openshell.v1.TcpForwardFrame
	64,  // 188: openshell.v1.OpenShell.ExecSandboxInteractive:input_type -> openshell.v1.ExecSandboxInput
	71,  // 189: openshell.v1.OpenShell.CreateProvider:input_type -> openshell.v1.CreateProviderRequest
	72,  // 190: openshell.v1.OpenShell.GetProvider:input_type -> openshell.v1.GetProviderRequest
	73,  // 191: openshell.v1.OpenShell.ListProviders:input_type -> openshell.v1.ListProvidersRequest
	78,  // 192: openshell.v1.OpenShell.ListProviderProfiles:input_type -> openshell.v1.ListProviderProfilesRequest
	79,  // 193: openshell.v1.OpenShell.GetProviderProfile:input_type -> openshell.v1.GetProviderProfileRequest
	105, // 194: openshell.v1.OpenShell.ImportProviderProfiles:input_type -> openshell.v1.ImportProviderProfilesRequest
	107, // 195: openshell.v1.OpenShell.UpdateProviderProfiles:input_type -> openshell.v1.UpdateProviderProfilesRequest
	109, // 196: openshell.v1.OpenShell.LintProviderProfiles:input_type -> openshell.v1.LintProviderProfilesRequest
	74,  // 197: openshell.v1.OpenShell.UpdateProvider:input_type -> openshell.v1.UpdateProviderRequest
	93,  // 198: openshell.v1.OpenShell.GetProviderRefreshStatus:input_type -> openshell.v1.GetProviderRefreshStatusRequest
	95,  // 199: openshell.v1.OpenShell.ConfigureProviderRefresh:input_type -> openshell.v1.ConfigureProviderRefreshRequest
	97,  // 200: openshell.v1.OpenShell.RotateProviderCredential:input_type -> openshell.v1.RotateProviderCredentialRequest
	99,  // 201: openshell.v1.OpenShell.DeleteProviderRefresh:input_type -> openshell.v1.DeleteProviderRefreshRequest
	75,  // 202: openshell.v1.OpenShell.DeleteProvider:input_type -> openshell.v1.DeleteProviderRequest
	112, // 203: openshell.v1.OpenShell.DeleteProviderProfile:input_type -> openshell.v1.DeleteProviderProfileRequest
	241, // 204: openshell.v1.OpenShell.GetSandboxConfig:input_type -> openshell.sandbox.v1.GetSandboxConfigRequest
	242, // 205: openshell.v1.OpenShell.GetGatewayConfig:input_type -> openshell.sandbox.v1.GetGatewayConfigRequest
	120, // 206: openshell.v1.OpenShell.UpdateConfig:input_type -> openshell.v1.UpdateConfigRequest
	129, // 207: openshell.v1.OpenShell.GetSandboxPolicyStatus:input_type -> openshell.v1.GetSandboxPolicyStatusRequest
	131, // 208: openshell.v1.OpenShell.ListSandboxPolicies:input_type -> openshell.v1.ListSandboxPoliciesRequest
	133, // 209: openshell.v1.OpenShell.ReportPolicyStatus:input_type -> openshell.v1.ReportPolicyStatusRequest
	114, // 210: openshell.v1.OpenShell.GetSandboxProviderEnvironment:input_type -> openshell.v1.GetSandboxProviderEnvironmentRequest
	118, // 211: openshell.v1.OpenShell.ExchangeProviderSubjectToken:input_type -> openshell.v1.ExchangeProviderSubjectTokenRequest
	136, // 212: openshell.v1.OpenShell.GetSandboxLogs:input_type -> openshell.v1.GetSandboxLogsRequest
	137, // 213: openshell.v1.OpenShell.PushSandboxLogs:input_type -> openshell.v1.PushSandboxLogsRequest
	140, // 214: openshell.v1.OpenShell.ConnectSupervisor:input_type -> openshell.v1.SupervisorMessage
	147, // 215: openshell.v1.OpenShell.ReportMainProcessExit:input_type -> openshell.v1.ReportMainProcessExitRequest
	149, // 216: openshell.v1.OpenShell.FinalizeMainProcessExit:input_type -> openshell.v1.FinalizeMainProcessExitRequest
	155, // 217: openshell.v1.OpenShell.RelayStream:input_type -> openshell.v1.RelayFrame
	67,  // 218: openshell.v1.OpenShell.WatchSandbox:input_type -> openshell.v1.WatchSandboxRequest
	164, // 219: openshell.v1.OpenShell.SubmitPolicyAnalysis:input_type -> openshell.v1.SubmitPolicyAnalysisRequest
	166, // 220: openshell.v1.OpenShell.GetDraftPolicy:input_type -> openshell.v1.GetDraftPolicyRequest
	168, // 221: openshell.v1.OpenShell.ApproveDraftChunk:input_type -> openshell.v1.ApproveDraftChunkRequest
	170, // 222: openshell.v1.OpenShell.RejectDraftChunk:input_type -> openshell.v1.RejectDraftChunkRequest
	173, // 223: openshell.v1.OpenShell.ApproveAllDraftChunks:input_type -> openshell.v1.ApproveAllDraftChunksRequest
	175, // 224: openshell.v1.OpenShell.EditDraftChunk:input_type -> openshell.v1.EditDraftChunkRequest
	177, // 225: openshell.v1.OpenShell.UndoDraftChunk:input_type -> openshell.v1.UndoDraftChunkRequest
	179, // 226: openshell.v1.OpenShell.ClearDraftChunks:input_type -> openshell.v1.ClearDraftChunksRequest
	181, // 227: openshell.v1.OpenShell.GetDraftHistory:input_type -> openshell.v1.GetDraftHistoryRequest
	...
	188, // 230: openshell.v1.OpenShell.CreateWorkspace:input_type -> openshell.v1.CreateWorkspaceRequest
	190, // 231: openshell.v1.OpenShell.GetWorkspace:input_type -> openshell.v1.GetWorkspaceRequest
	192, // 232: openshell.v1.OpenShell.ListWorkspaces:input_type -> openshell.v1.ListWorkspacesRequest
	194, // 233: openshell.v1.OpenShell.DeleteWorkspace:input_type -> openshell.v1.DeleteWorkspaceRequest
	197, // 234: openshell.v1.OpenShell.AddWorkspaceMember:input_type -> openshell.v1.AddWorkspaceMemberRequest
	199, // 235: openshell.v1.OpenShell.RemoveWorkspaceMember:input_type -> openshell.v1.RemoveWorkspaceMemberRequest
	201, // 236: openshell.v1.OpenShell.ListWorkspaceMembers:input_type -> openshell.v1.ListWorkspaceMembersRequest
	13,  // 237: openshell.v1.OpenShell.Health:output_type -> openshell.v1.HealthResponse
	15,  // 238: openshell.v1.OpenShell.GetCurrentUser:output_type -> openshell.v1.GetCurrentUserResponse
	17,  // 239: openshell.v1.OpenShell.GetGatewayInfo:output_type -> openshell.v1.GetGatewayInfoResponse
	39,  // 240: openshell.v1.OpenShell.CreateSandbox:output_type -> openshell.v1.SandboxResponse
	39,  // 241: openshell.v1.OpenShell.GetSandbox:output_type -> openshell.v1.SandboxResponse
	40,  // 242: openshell.v1.OpenShell.ListSandboxes:output_type -> openshell.v1.ListSandboxesResponse
	41,  // 243: openshell.v1.OpenShell.ListSandboxProviders:output_type -> openshell.v1.ListSandboxProvidersResponse
	42,  // 244: openshell.v1.OpenShell.AttachSandboxProvider:output_type -> openshell.v1.AttachSandboxProviderResponse
	43,  // 245: openshell.v1.OpenShell.DetachSandboxProvider:output_type -> openshell.v1.DetachSandboxProviderResponse
	44,  // 246: openshell.v1.OpenShell.DeleteSandbox:output_type -> openshell.v1.DeleteSandboxResponse
	39,  // 247: openshell.v1.OpenShell.StopSandbox:output_type -> openshell.v1.SandboxResponse
	39,  // 248: openshell.v1.OpenShell.StartSandbox:output_type -> openshell.v1.SandboxResponse
	46,  // 249: openshell.v1.OpenShell.CreateSshSession:output_type -> openshell.v1.CreateSshSessionResponse
	54,  // 250: openshell.v1.OpenShell.ExposeService:output_type -> openshell.v1.ServiceEndpointResponse
	54,  // 251: openshell.v1.OpenShell.GetService:output_type -> openshell.v1.ServiceEndpointResponse
	50,  // 252: openshell.v1.OpenShell.ListServices:output_type -> openshell.v1.ListServicesResponse
	52,  // 253: openshell.v1.OpenShell.DeleteService:output_type -> openshell.v1.DeleteServiceResponse
	56,  // 254: openshell.v1.OpenShell.RevokeSshSession:output_type -> openshell.v1.RevokeSshSessionResponse
	61,  // 255: openshell.v1.OpenShell.ExecSandbox:output_type -> openshell.v1.ExecSandboxEvent
	63,  // 256: openshell.v1.OpenShell.ForwardTcp:output_type -> openshell.v1.TcpForwardFrame
	61,  // 257: openshell.v1.OpenShell.ExecSandboxInteractive:output_type -> openshell.v1.ExecSandboxEvent
	76,  // 258: openshell.v1.OpenShell.CreateProvider:output_type -> openshell.v1.ProviderResponse
	76,  // 259: openshell.v1.OpenShell.GetProvider:output_type -> openshell.v1.ProviderResponse
	77,  // 260: openshell.v1.OpenShell.ListProviders:output_type -> openshell.v1.ListProvidersResponse
	104, // 261: openshell.v1.OpenShell.ListProviderProfiles:output_type -> openshell.v1.ListProviderProfilesResponse
	103, // 262: openshell.v1.OpenShell.GetProviderProfile:output_type -> openshell.v1.ProviderProfileResponse
	106, // 263: openshell.v1.OpenShell.ImportProviderProfiles:output_type -> openshell.v1.ImportProviderProfilesResponse
	108, // 264: openshell.v1.OpenShell.UpdateProviderProfiles:output_type -> openshell.v1.UpdateProviderProfilesResponse
	110, // 265: openshell.v1.OpenShell.LintProviderProfiles:output_type -> openshell.v1.LintProviderProfilesResponse
	76,  // 266: openshell.v1.OpenShell.UpdateProvider:output_type -> openshell.v1.ProviderResponse
	94,  // 267: openshell.v1.OpenShell.GetProviderRefreshStatus:output_type -> openshell.v1.GetProviderRefreshStatusResponse
	96,  // 268: openshell.v1.OpenShell.ConfigureProviderRefresh:output_type -> openshell.v1.ConfigureProviderRefreshResponse
	98,  // 269: openshell.v1.OpenShell.RotateProviderCredential:output_type -> openshell.v1.RotateProviderCredentialResponse
	100, // 270: openshell.v1.OpenShell.DeleteProviderRefresh:output_type -> openshell.v1.DeleteProviderRefreshResponse
	111, // 271: openshell.v1.OpenShell.DeleteProvider:output_type -> openshell.v1.DeleteProviderResponse
	113, // 272: openshell.v1.OpenShell.DeleteProviderProfile:output_type -> openshell.v1.DeleteProviderProfileResponse
	243, // 273: openshell.v1.OpenShell.GetSandboxConfig:output_type -> openshell.sandbox.v1.GetSandboxConfigResponse
	244, // 274: openshell.v1.OpenShell.GetGatewayConfig:output_type -> openshell.sandbox.v1.GetGatewayConfigResponse
	128, // 275: openshell.v1.OpenShell.UpdateConfig:output_type -> openshell.v1.UpdateConfigResponse
	130, // 276: openshell.v1.OpenShell.GetSandboxPolicyStatus:output_type -> openshell.v1.GetSandboxPolicyStatusResponse
	132, // 277: openshell.v1.OpenShell.ListSandboxPolicies:output_type -> openshell.v1.ListSandboxPoliciesResponse
	134, // 278: openshell.v1.OpenShell.ReportPolicyStatus:output_type -> openshell.v1.ReportPolicyStatusResponse
	117, // 279: openshell.v1.OpenShell.GetSandboxProviderEnvironment:output_type -> openshell.v1.GetSandboxProviderEnvironmentResponse
	119, // 280: openshell.v1.OpenShell.ExchangeProviderSubjectToken:output_type -> openshell.v1.ExchangeProviderSubjectTokenResponse
	139, // 281: openshell.v1.OpenShell.GetSandboxLogs:output_type -> openshell.v1.GetSandboxLogsResponse
	138, // 282: openshell.v1.OpenShell.PushSandboxLogs:output_type -> openshell.v1.PushSandboxLogsResponse
	141, // 283: openshell.v1.OpenShell.ConnectSupervisor:output_type -> openshell.v1.GatewayMessage
	148, // 284: openshell.v1.OpenShell.ReportMainProcessExit:output_type -> openshell.v1.ReportMainProcessExitResponse
	150, // 285: openshell.v1.OpenShell.FinalizeMainProcessExit:output_type -> openshell.v1.FinalizeMainProcessExitResponse
	155, // 286: openshell.v1.OpenShell.RelayStream:output_type -> openshell.v1.RelayFrame
	68,  // 287: openshell.v1.OpenShell.WatchSandbox:output_type -> openshell.v1.SandboxStreamEvent
	165, // 288: openshell.v1.OpenShell.SubmitPolicyAnalysis:output_type -> openshell.v1.SubmitPolicyAnalysisResponse
	167, // 289: openshell.v1.OpenShell.GetDraftPolicy:output_type -> openshell.v1.GetDraftPolicyResponse
	169, // 290: openshell.v1.OpenShell.ApproveDraftChunk:output_type -> openshell.v1.ApproveDraftChunkResponse
	171, // 291: openshell.v1.OpenShell.RejectDraftChunk:output_type -> openshell.v1.RejectDraftChunkResponse
	174, // 292: openshell.v1.OpenShell.ApproveAllDraftChunks:output_type -> openshell.v1.ApproveAllDraftChunksResponse
	176, // 293: openshell.v1.OpenShell.EditDraftChunk:output_type -> openshell.v1.EditDraftChunkResponse
	178, // 294: openshell.v1.OpenShell.UndoDraftChunk:output_type -> openshell.v1.UndoDraftChunkResponse
	180, // 295: openshell.v1.OpenShell.ClearDraftChunks:output_type -> openshell.v1.ClearDraftChunksResponse
	183, // 296: openshell.v1.OpenShell.GetDraftHistory:output_type -> openshell.v1.GetDraftHistoryResponse
	...
	189, // 299: openshell.v1.OpenShell.CreateWorkspace:output_type -> openshell.v1.CreateWorkspaceResponse
	191, // 300: openshell.v1.OpenShell.GetWorkspace:output_type -> openshell.v1.GetWorkspaceResponse
	193, // 301: openshell.v1.OpenShell.ListWorkspaces:output_type -> openshell.v1.ListWorkspacesResponse
	195, // 302: openshell.v1.OpenShell.DeleteWorkspace:output_type -> openshell.v1.DeleteWorkspaceResponse
	198, // 303: openshell.v1.OpenShell.AddWorkspaceMember:output_type -> openshell.v1.AddWorkspaceMemberResponse
	200, // 304: openshell.v1.OpenShell.RemoveWorkspaceMember:output_type -> openshell.v1.RemoveWorkspaceMemberResponse
	202, // 305: openshell.v1.OpenShell.ListWorkspaceMembers:output_type -> openshell.v1.ListWorkspaceMembersResponse
...
func file_openshell_proto_init() {
	...
	file_openshell_proto_msgTypes[113].OneofWrappers = []any{
