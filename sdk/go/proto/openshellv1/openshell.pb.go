...
type DisruptionProtectionSupport int32

const (
	DisruptionProtectionSupport_DISRUPTION_PROTECTION_SUPPORT_UNSPECIFIED  DisruptionProtectionSupport = 0
	DisruptionProtectionSupport_DISRUPTION_PROTECTION_SUPPORT_UNSUPPORTED  DisruptionProtectionSupport = 1
	DisruptionProtectionSupport_DISRUPTION_PROTECTION_SUPPORT_APPROXIMATED DisruptionProtectionSupport = 2
	DisruptionProtectionSupport_DISRUPTION_PROTECTION_SUPPORT_SUPPORTED    DisruptionProtectionSupport = 3
)

// Enum value maps for DisruptionProtectionSupport.
var (
	DisruptionProtectionSupport_name = map[int32]string{
		0: "DISRUPTION_PROTECTION_SUPPORT_UNSPECIFIED",
		1: "DISRUPTION_PROTECTION_SUPPORT_UNSUPPORTED",
		2: "DISRUPTION_PROTECTION_SUPPORT_APPROXIMATED",
		3: "DISRUPTION_PROTECTION_SUPPORT_SUPPORTED",
	}
	DisruptionProtectionSupport_value = map[string]int32{
		"DISRUPTION_PROTECTION_SUPPORT_UNSPECIFIED":  0,
		"DISRUPTION_PROTECTION_SUPPORT_UNSUPPORTED":  1,
		"DISRUPTION_PROTECTION_SUPPORT_APPROXIMATED": 2,
		"DISRUPTION_PROTECTION_SUPPORT_SUPPORTED":    3,
	}
)

func (x DisruptionProtectionSupport) Enum() *DisruptionProtectionSupport {
	p := new(DisruptionProtectionSupport)
	*p = x
	return p
}

func (x DisruptionProtectionSupport) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DisruptionProtectionSupport) Descriptor() protoreflect.EnumDescriptor {
	return file_openshell_proto_enumTypes[0].Descriptor()
}

func (DisruptionProtectionSupport) Type() protoreflect.EnumType {
	return &file_openshell_proto_enumTypes[0]
}

func (x DisruptionProtectionSupport) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DisruptionProtectionSupport.Descriptor instead.
func (DisruptionProtectionSupport) EnumDescriptor() ([]byte, []int) {
...
type ComputeDriverCapabilities struct {
	...
	// Driver and operator support for voluntary-disruption protection.
	DisruptionProtection *DisruptionProtectionCapability `protobuf:"bytes,4,opt,name=disruption_protection,json=disruptionProtection,proto3" json:"disruption_protection,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *ComputeDriverCapabilities) GetDisruptionProtection() *DisruptionProtectionCapability {
	if x != nil {
		return x.DisruptionProtection
	}
	return nil
}
...
type DisruptionProtectionCapability struct {
	state   protoimpl.MessageState      `protogen:"open.v1"`
	Support DisruptionProtectionSupport `protobuf:"varint,1,opt,name=support,proto3,enum=openshell.v1.DisruptionProtectionSupport" json:"support,omitempty"`
	// Whether the platform administrator currently allows new requests.
	Enabled bool `protobuf:"varint,2,opt,name=enabled,proto3" json:"enabled,omitempty"`
	// Maximum request accepted by this driver instance when enabled.
...
func (x *DisruptionProtectionCapability) Reset() {
	*x = DisruptionProtectionCapability{}
	mi := &file_openshell_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DisruptionProtectionCapability) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DisruptionProtectionCapability) ProtoMessage() {}

func (x *DisruptionProtectionCapability) ProtoReflect() protoreflect.Message {
	mi := &file_openshell_proto_msgTypes[16]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DisruptionProtectionCapability.ProtoReflect.Descriptor instead.
func (*DisruptionProtectionCapability) Descriptor() ([]byte, []int) {
	return file_openshell_proto_rawDescGZIP(), []int{16}
}

func (x *DisruptionProtectionCapability) GetSupport() DisruptionProtectionSupport {
	if x != nil {
		return x.Support
	}
	return DisruptionProtectionSupport_DISRUPTION_PROTECTION_SUPPORT_UNSPECIFIED
}

func (x *DisruptionProtectionCapability) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *DisruptionProtectionCapability) GetMaxDuration() *durationpb.Duration {
	if x != nil {
...
type SandboxSpec struct {
	...
	// Optional create-time request to prevent platform-initiated voluntary
	// disruption for a bounded interval. This does not protect against node
	// failure, resource pressure, direct deletion, or workload failure.
	DisruptionProtection *DisruptionProtectionRequest `protobuf:"bytes,14,opt,name=disruption_protection,json=disruptionProtection,proto3" json:"disruption_protection,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}
...
func (x *SandboxSpec) GetDisruptionProtection() *DisruptionProtectionRequest {
	if x != nil {
		return x.DisruptionProtection
	}
	return nil
...
type DisruptionProtectionRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *DisruptionProtectionRequest) Reset() {
	*x = DisruptionProtectionRequest{}
	mi := &file_openshell_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DisruptionProtectionRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DisruptionProtectionRequest) ProtoMessage() {}

func (x *DisruptionProtectionRequest) ProtoReflect() protoreflect.Message {
	mi := &file_openshell_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DisruptionProtectionRequest.ProtoReflect.Descriptor instead.
func (*DisruptionProtectionRequest) Descriptor() ([]byte, []int) {
	return file_openshell_proto_rawDescGZIP(), []int{19}
}

func (x *DisruptionProtectionRequest) GetDuration() *durationpb.Duration {
	if x != nil {
		return x.Duration
	}
	return nil
...
const file_openshell_proto_rawDesc = "" +
	...
	"\fcapabilities\x18\x02 \x01(\v2'.openshell.v1.ComputeDriverCapabilitiesR\fcapabilities\"\x9f\x02\n" +
	"\x19ComputeDriverCapabilities\x12\x1f\n" +
	"\vdriver_name\x18\x01 \x01(\tR\n" +
	"driverName\x12%\n" +
	"\x0edriver_version\x18\x02 \x01(\tR\rdriverVersion\x12W\n" +
	"\x15resource_capabilities\x18\x03 \x01(\v2\".openshell.v1.ResourceCapabilitiesR\x14resourceCapabilities\x12a\n" +
	"\x15disruption_protection\x18\x04 \x01(\v2,.openshell.v1.DisruptionProtectionCapabilityR\x14disruptionProtection\"\xca\x01\n" +
	...
	"\x19count_selection_supported\x18\x02 \x01(\bR\x17countSelectionSupported\"\xbd\x01\n" +
	"\x1eDisruptionProtectionCapability\x12C\n" +
	"\asupport\x18\x01 \x01(\x0e2).openshell.v1.DisruptionProtectionSupportR\asupport\x12\x18\n" +
	"\aenabled\x18\x02 \x01(\bR\aenabled\x12<\n" +
	"\fmax_duration\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\vmaxDuration\"\xce\x02\n" +
	"\aSandbox\x12>\n" +
	...
	"\x1ecreated_from_workload_template\x18\x14 \x01(\v2/.openshell.v1.SandboxWorkloadTemplateProvenanceR\x1bcreatedFromWorkloadTemplateJ\x04\b\x04\x10\x05J\x04\b\x05\x10\x06R\x05phaseR\x16current_policy_version\"\xe3\x04\n" +
	...
	"\x15disruption_protection\x18\x0e \x01(\v2).openshell.v1.DisruptionProtectionRequestR\x14disruptionProtection\x1a>\n" +
	"\x10EnvironmentEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01J\x04\b\n" +
	"\x10\vJ\x04\b\v\x10\fR\n" +
	"gpu_deviceR\x16proposal_approval_mode\"T\n" +
	"\x1bDisruptionProtectionRequest\x125\n" +
	"\bduration\x18\x01 \x01(\v2\x19.google.protobuf.DurationR\bduration\"O\n" +
	...
	"\x05token\x18\x02 \x01(\tB\x04\x88\xb5\x18\x01R\x05token\x12\"\n" +
	"\rexpires_at_ms\x18\x03 \x01(\x03R\vexpiresAtMs*\xd8\x01\n" +
	"\x1bDisruptionProtectionSupport\x12-\n" +
	")DISRUPTION_PROTECTION_SUPPORT_UNSPECIFIED\x10\x00\x12-\n" +
	")DISRUPTION_PROTECTION_SUPPORT_UNSUPPORTED\x10\x01\x12.\n" +
	"*DISRUPTION_PROTECTION_SUPPORT_APPROXIMATED\x10\x02\x12+\n" +
	"'DISRUPTION_PROTECTION_SUPPORT_SUPPORTED\x10\x03*\xa6\x02\n" +
...
var file_openshell_proto_msgTypes = make([]protoimpl.MessageInfo, 240)
var file_openshell_proto_goTypes = []any{
	(DisruptionProtectionSupport)(0),                     // 0: openshell.v1.DisruptionProtectionSupport
	(SandboxPhase)(0),                                    // 1: openshell.v1.SandboxPhase
	(ProviderCredentialTokenGrantType)(0),                // 2: openshell.v1.ProviderCredentialTokenGrantType
	(ProviderCredentialRefreshStrategy)(0),               // 3: openshell.v1.ProviderCredentialRefreshStrategy
	(ProviderProfileCategory)(0),                         // 4: openshell.v1.ProviderProfileCategory
	...
	(*DisruptionProtectionCapability)(nil),               // 25: openshell.v1.DisruptionProtectionCapability
	(*Sandbox)(nil),                                      // 26: openshell.v1.Sandbox
	(*SandboxSpec)(nil),                                  // 27: openshell.v1.SandboxSpec
	(*DisruptionProtectionRequest)(nil),                  // 28: openshell.v1.DisruptionProtectionRequest
	...
	(*StoredProviderCredentialRefreshState)(nil),         // 110: openshell.v1.StoredProviderCredentialRefreshState
	(*StoredRefreshMaterialDeletion)(nil),                // 111: openshell.v1.StoredRefreshMaterialDeletion
	...
	(*StoredProviderProfile)(nil),                        // 121: openshell.v1.StoredProviderProfile
	...
	(*ExchangeProviderSubjectTokenRequest)(nil),          // 137: openshell.v1.ExchangeProviderSubjectTokenRequest
	(*ExchangeProviderSubjectTokenResponse)(nil),         // 138: openshell.v1.ExchangeProviderSubjectTokenResponse
	(*UpdateConfigRequest)(nil),                          // 139: openshell.v1.UpdateConfigRequest
	(*PolicyMergeOperation)(nil),                         // 140: openshell.v1.PolicyMergeOperation
	(*AddNetworkRule)(nil),                               // 141: openshell.v1.AddNetworkRule
	(*RemoveNetworkEndpoint)(nil),                        // 142: openshell.v1.RemoveNetworkEndpoint
	(*RemoveNetworkRule)(nil),                            // 143: openshell.v1.RemoveNetworkRule
	(*AddDenyRules)(nil),                                 // 144: openshell.v1.AddDenyRules
	(*AddAllowRules)(nil),                                // 145: openshell.v1.AddAllowRules
	(*RemoveNetworkBinary)(nil),                          // 146: openshell.v1.RemoveNetworkBinary
	(*UpdateConfigResponse)(nil),                         // 147: openshell.v1.UpdateConfigResponse
	(*GetSandboxPolicyStatusRequest)(nil),                // 148: openshell.v1.GetSandboxPolicyStatusRequest
	(*GetSandboxPolicyStatusResponse)(nil),               // 149: openshell.v1.GetSandboxPolicyStatusResponse
	(*ListSandboxPoliciesRequest)(nil),                   // 150: openshell.v1.ListSandboxPoliciesRequest
	(*ListSandboxPoliciesResponse)(nil),                  // 151: openshell.v1.ListSandboxPoliciesResponse
	(*ReportPolicyStatusRequest)(nil),                    // 152: openshell.v1.ReportPolicyStatusRequest
	(*ReportPolicyStatusResponse)(nil),                   // 153: openshell.v1.ReportPolicyStatusResponse
	(*SandboxPolicyRevision)(nil),                        // 154: openshell.v1.SandboxPolicyRevision
	(*GetSandboxLogsRequest)(nil),                        // 155: openshell.v1.GetSandboxLogsRequest
	(*PushSandboxLogsRequest)(nil),                       // 156: openshell.v1.PushSandboxLogsRequest
	(*PushSandboxLogsResponse)(nil),                      // 157: openshell.v1.PushSandboxLogsResponse
	(*GetSandboxLogsResponse)(nil),                       // 158: openshell.v1.GetSandboxLogsResponse
	(*SupervisorMessage)(nil),                            // 159: openshell.v1.SupervisorMessage
	(*GatewayMessage)(nil),                               // 160: openshell.v1.GatewayMessage
	(*SupervisorHello)(nil),                              // 161: openshell.v1.SupervisorHello
	(*SessionAccepted)(nil),                              // 162: openshell.v1.SessionAccepted
	(*SessionRejected)(nil),                              // 163: openshell.v1.SessionRejected
	(*SupervisorHeartbeat)(nil),                          // 164: openshell.v1.SupervisorHeartbeat
	(*GatewayHeartbeat)(nil),                             // 165: openshell.v1.GatewayHeartbeat
	(*ReportMainProcessExitRequest)(nil),                 // 166: openshell.v1.ReportMainProcessExitRequest
	(*ReportMainProcessExitResponse)(nil),                // 167: openshell.v1.ReportMainProcessExitResponse
	(*FinalizeMainProcessExitRequest)(nil),               // 168: openshell.v1.FinalizeMainProcessExitRequest
	(*FinalizeMainProcessExitResponse)(nil),              // 169: openshell.v1.FinalizeMainProcessExitResponse
	(*RelayOpen)(nil),                                    // 170: openshell.v1.RelayOpen
	(*SshRelayTarget)(nil),                               // 171: openshell.v1.SshRelayTarget
	(*TcpRelayTarget)(nil),                               // 172: openshell.v1.TcpRelayTarget
	(*RelayInit)(nil),                                    // 173: openshell.v1.RelayInit
	(*RelayFrame)(nil),                                   // 174: openshell.v1.RelayFrame
	(*RelayOpenResult)(nil),                              // 175: openshell.v1.RelayOpenResult
	(*RelayClose)(nil),                                   // 176: openshell.v1.RelayClose
	(*L7RequestSample)(nil),                              // 177: openshell.v1.L7RequestSample
	(*DenialSummary)(nil),                                // 178: openshell.v1.DenialSummary
	(*DenialGroupCount)(nil),                             // 179: openshell.v1.DenialGroupCount
	(*NetworkActivitySummary)(nil),                       // 180: openshell.v1.NetworkActivitySummary
	(*PolicyChunk)(nil),                                  // 181: openshell.v1.PolicyChunk
	(*DraftPolicyUpdate)(nil),                            // 182: openshell.v1.DraftPolicyUpdate
	(*SubmitPolicyAnalysisRequest)(nil),                  // 183: openshell.v1.SubmitPolicyAnalysisRequest
	(*SubmitPolicyAnalysisResponse)(nil),                 // 184: openshell.v1.SubmitPolicyAnalysisResponse
	(*GetDraftPolicyRequest)(nil),                        // 185: openshell.v1.GetDraftPolicyRequest
	(*GetDraftPolicyResponse)(nil),                       // 186: openshell.v1.GetDraftPolicyResponse
	(*ApproveDraftChunkRequest)(nil),                     // 187: openshell.v1.ApproveDraftChunkRequest
	(*ApproveDraftChunkResponse)(nil),                    // 188: openshell.v1.ApproveDraftChunkResponse
	(*RejectDraftChunkRequest)(nil),                      // 189: openshell.v1.RejectDraftChunkRequest
	(*RejectDraftChunkResponse)(nil),                     // 190: openshell.v1.RejectDraftChunkResponse
	(*DraftChunkApproval)(nil),                           // 191: openshell.v1.DraftChunkApproval
	(*ApproveAllDraftChunksRequest)(nil),                 // 192: openshell.v1.ApproveAllDraftChunksRequest
	(*ApproveAllDraftChunksResponse)(nil),                // 193: openshell.v1.ApproveAllDraftChunksResponse
	(*EditDraftChunkRequest)(nil),                        // 194: openshell.v1.EditDraftChunkRequest
	(*EditDraftChunkResponse)(nil),                       // 195: openshell.v1.EditDraftChunkResponse
	(*UndoDraftChunkRequest)(nil),                        // 196: openshell.v1.UndoDraftChunkRequest
	(*UndoDraftChunkResponse)(nil),                       // 197: openshell.v1.UndoDraftChunkResponse
	(*ClearDraftChunksRequest)(nil),                      // 198: openshell.v1.ClearDraftChunksRequest
	(*ClearDraftChunksResponse)(nil),                     // 199: openshell.v1.ClearDraftChunksResponse
	(*GetDraftHistoryRequest)(nil),                       // 200: openshell.v1.GetDraftHistoryRequest
	(*DraftHistoryEntry)(nil),                            // 201: openshell.v1.DraftHistoryEntry
	(*GetDraftHistoryResponse)(nil),                      // 202: openshell.v1.GetDraftHistoryResponse
	(*PolicyRevisionPayload)(nil),                        // 203: openshell.v1.PolicyRevisionPayload
	(*DraftChunkPayload)(nil),                            // 204: openshell.v1.DraftChunkPayload
	(*StoredPolicyRevision)(nil),                         // 205: openshell.v1.StoredPolicyRevision
	(*StoredDraftChunk)(nil),                             // 206: openshell.v1.StoredDraftChunk
	(*CreateWorkspaceRequest)(nil),                       // 207: openshell.v1.CreateWorkspaceRequest
	(*CreateWorkspaceResponse)(nil),                      // 208: openshell.v1.CreateWorkspaceResponse
	(*GetWorkspaceRequest)(nil),                          // 209: openshell.v1.GetWorkspaceRequest
	(*GetWorkspaceResponse)(nil),                         // 210: openshell.v1.GetWorkspaceResponse
	(*ListWorkspacesRequest)(nil),                        // 211: openshell.v1.ListWorkspacesRequest
	(*ListWorkspacesResponse)(nil),                       // 212: openshell.v1.ListWorkspacesResponse
	(*DeleteWorkspaceRequest)(nil),                       // 213: openshell.v1.DeleteWorkspaceRequest
	(*DeleteWorkspaceResponse)(nil),                      // 214: openshell.v1.DeleteWorkspaceResponse
	(*WorkspaceMember)(nil),                              // 215: openshell.v1.WorkspaceMember
	(*AddWorkspaceMemberRequest)(nil),                    // 216: openshell.v1.AddWorkspaceMemberRequest
	(*AddWorkspaceMemberResponse)(nil),                   // 217: openshell.v1.AddWorkspaceMemberResponse
	(*RemoveWorkspaceMemberRequest)(nil),                 // 218: openshell.v1.RemoveWorkspaceMemberRequest
	(*RemoveWorkspaceMemberResponse)(nil),                // 219: openshell.v1.RemoveWorkspaceMemberResponse
	(*ListWorkspaceMembersRequest)(nil),                  // 220: openshell.v1.ListWorkspaceMembersRequest
	...
	nil,                                                  // 223: openshell.v1.SandboxSpec.EnvironmentEntry
	nil,                                                  // 224: openshell.v1.SandboxTemplate.LabelsEntry
	nil,                                                  // 225: openshell.v1.SandboxTemplate.AnnotationsEntry
	nil,                                                  // 226: openshell.v1.SandboxTemplate.EnvironmentEntry
	nil,                                                  // 227: openshell.v1.SandboxWorkloadConfig.EnvironmentEntry
	nil,                                                  // 228: openshell.v1.PlatformEvent.MetadataEntry
	nil,                                                  // 229: openshell.v1.CreateSandboxRequest.LabelsEntry
	nil,                                                  // 230: openshell.v1.CreateSandboxRequest.AnnotationsEntry
	nil,                                                  // 231: openshell.v1.ExecSandboxRequest.EnvironmentEntry
	nil,                                                  // 232: openshell.v1.SandboxLogLine.FieldsEntry
	nil,                                                  // 233: openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	nil,                                                  // 234: openshell.v1.StoredProviderCredentialRefreshState.MaterialEntry
	nil,                                                  // 235: openshell.v1.StoredProviderCredentialRefreshState.AdditionalOutputKeysEntry
	nil,                                                  // 236: openshell.v1.StoredProviderCredentialRefreshState.SecretMaterialHandlesEntry
	...
	nil,                                                  // 240: openshell.v1.GetSandboxProviderEnvironmentResponse.CredentialExpiresAtMsEntry
	...
	nil,                                                  // 246: openshell.v1.PolicyRevisionPayload.ProvenanceEntry
	nil,                                                  // 247: openshell.v1.StoredPolicyRevision.ProvenanceEntry
	nil,                                                  // 248: openshell.v1.CreateWorkspaceRequest.LabelsEntry
	(*durationpb.Duration)(nil),                          // 249: google.protobuf.Duration
	(*datamodelv1.ObjectMeta)(nil),                       // 250: openshell.datamodel.v1.ObjectMeta
	(*sandboxv1.SandboxPolicy)(nil),                      // 251: openshell.sandbox.v1.SandboxPolicy
	(*structpb.Struct)(nil),                              // 252: google.protobuf.Struct
	(*datamodelv1.Provider)(nil),                         // 253: openshell.datamodel.v1.Provider
	(*datamodelv1.CredentialHandle)(nil),                 // 254: openshell.datamodel.v1.CredentialHandle
	(*sandboxv1.NetworkEndpoint)(nil),                    // 255: openshell.sandbox.v1.NetworkEndpoint
	(*sandboxv1.NetworkBinary)(nil),                      // 256: openshell.sandbox.v1.NetworkBinary
	(*sandboxv1.SettingValue)(nil),                       // 257: openshell.sandbox.v1.SettingValue
	(*sandboxv1.NetworkPolicyRule)(nil),                  // 258: openshell.sandbox.v1.NetworkPolicyRule
	(*sandboxv1.L7DenyRule)(nil),                         // 259: openshell.sandbox.v1.L7DenyRule
	(*sandboxv1.L7Rule)(nil),                             // 260: openshell.sandbox.v1.L7Rule
...
var file_openshell_proto_depIdxs = []int32{
	...
	6,   // 1: openshell.v1.HealthResponse.status:type_name -> openshell.v1.ServiceStatus
	6,   // 2: openshell.v1.GetGatewayInfoResponse.status:type_name -> openshell.v1.ServiceStatus
	...
	25,  // 6: openshell.v1.ComputeDriverCapabilities.disruption_protection:type_name -> openshell.v1.DisruptionProtectionCapability
	22,  // 7: openshell.v1.ResourceCapabilities.cpu:type_name -> openshell.v1.CpuResourceCapabilities
	23,  // 8: openshell.v1.ResourceCapabilities.memory:type_name -> openshell.v1.MemoryResourceCapabilities
	24,  // 9: openshell.v1.ResourceCapabilities.gpu:type_name -> openshell.v1.GpuResourceCapabilities
	0,   // 10: openshell.v1.DisruptionProtectionCapability.support:type_name -> openshell.v1.DisruptionProtectionSupport
	249, // 11: openshell.v1.DisruptionProtectionCapability.max_duration:type_name -> google.protobuf.Duration
	250, // 12: openshell.v1.Sandbox.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	...
	223, // 16: openshell.v1.SandboxSpec.environment:type_name -> openshell.v1.SandboxSpec.EnvironmentEntry
	31,  // 17: openshell.v1.SandboxSpec.template:type_name -> openshell.v1.SandboxTemplate
	251, // 18: openshell.v1.SandboxSpec.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	29,  // 19: openshell.v1.SandboxSpec.resource_requirements:type_name -> openshell.v1.ResourceRequirements
	28,  // 20: openshell.v1.SandboxSpec.disruption_protection:type_name -> openshell.v1.DisruptionProtectionRequest
	249, // 21: openshell.v1.DisruptionProtectionRequest.duration:type_name -> google.protobuf.Duration
	30,  // 22: openshell.v1.ResourceRequirements.gpu:type_name -> openshell.v1.GpuResourceRequirements
	224, // 23: openshell.v1.SandboxTemplate.labels:type_name -> openshell.v1.SandboxTemplate.LabelsEntry
	225, // 24: openshell.v1.SandboxTemplate.annotations:type_name -> openshell.v1.SandboxTemplate.AnnotationsEntry
	226, // 25: openshell.v1.SandboxTemplate.environment:type_name -> openshell.v1.SandboxTemplate.EnvironmentEntry
	252, // 26: openshell.v1.SandboxTemplate.resources:type_name -> google.protobuf.Struct
	252, // 27: openshell.v1.SandboxTemplate.driver_config:type_name -> google.protobuf.Struct
	250, // 28: openshell.v1.SandboxWorkloadTemplate.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	33,  // 29: openshell.v1.SandboxWorkloadTemplate.spec:type_name -> openshell.v1.SandboxWorkloadTemplateSpec
	34,  // 30: openshell.v1.SandboxWorkloadTemplateSpec.workload:type_name -> openshell.v1.SandboxWorkloadConfig
	252, // 31: openshell.v1.SandboxWorkloadTemplateSpec.driver_config:type_name -> google.protobuf.Struct
	36,  // 32: openshell.v1.SandboxWorkloadTemplateSpec.desired_service_level:type_name -> openshell.v1.SandboxServiceLevel
	227, // 33: openshell.v1.SandboxWorkloadConfig.environment:type_name -> openshell.v1.SandboxWorkloadConfig.EnvironmentEntry
	35,  // 34: openshell.v1.SandboxWorkloadConfig.resources:type_name -> openshell.v1.SandboxResources
	30,  // 35: openshell.v1.SandboxResources.gpu:type_name -> openshell.v1.GpuResourceRequirements
	37,  // 36: openshell.v1.SandboxServiceLevel.startup:type_name -> openshell.v1.SandboxStartup
	249, // 37: openshell.v1.SandboxStartup.ready_within:type_name -> google.protobuf.Duration
	40,  // 38: openshell.v1.SandboxStatus.conditions:type_name -> openshell.v1.SandboxCondition
	1,   // 39: openshell.v1.SandboxStatus.phase:type_name -> openshell.v1.SandboxPhase
	228, // 40: openshell.v1.PlatformEvent.metadata:type_name -> openshell.v1.PlatformEvent.MetadataEntry
	27,  // 41: openshell.v1.CreateSandboxRequest.spec:type_name -> openshell.v1.SandboxSpec
	229, // 42: openshell.v1.CreateSandboxRequest.labels:type_name -> openshell.v1.CreateSandboxRequest.LabelsEntry
	230, // 43: openshell.v1.CreateSandboxRequest.annotations:type_name -> openshell.v1.CreateSandboxRequest.AnnotationsEntry
	32,  // 44: openshell.v1.CreateSandboxTemplateRequest.template:type_name -> openshell.v1.SandboxWorkloadTemplate
	32,  // 45: openshell.v1.SandboxTemplateResponse.template:type_name -> openshell.v1.SandboxWorkloadTemplate
	32,  // 46: openshell.v1.ListSandboxTemplatesResponse.templates:type_name -> openshell.v1.SandboxWorkloadTemplate
	26,  // 47: openshell.v1.SandboxResponse.sandbox:type_name -> openshell.v1.Sandbox
	26,  // 48: openshell.v1.ListSandboxesResponse.sandboxes:type_name -> openshell.v1.Sandbox
	253, // 49: openshell.v1.ListSandboxProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	26,  // 50: openshell.v1.AttachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	26,  // 51: openshell.v1.DetachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	73,  // 52: openshell.v1.ListServicesResponse.services:type_name -> openshell.v1.ServiceEndpointResponse
	250, // 53: openshell.v1.ServiceEndpoint.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	72,  // 54: openshell.v1.ServiceEndpointResponse.endpoint:type_name -> openshell.v1.ServiceEndpoint
	231, // 55: openshell.v1.ExecSandboxRequest.environment:type_name -> openshell.v1.ExecSandboxRequest.EnvironmentEntry
	77,  // 56: openshell.v1.ExecSandboxEvent.stdout:type_name -> openshell.v1.ExecSandboxStdout
	78,  // 57: openshell.v1.ExecSandboxEvent.stderr:type_name -> openshell.v1.ExecSandboxStderr
	79,  // 58: openshell.v1.ExecSandboxEvent.exit:type_name -> openshell.v1.ExecSandboxExit
	171, // 59: openshell.v1.TcpForwardInit.ssh:type_name -> openshell.v1.SshRelayTarget
	172, // 60: openshell.v1.TcpForwardInit.tcp:type_name -> openshell.v1.TcpRelayTarget
	81,  // 61: openshell.v1.TcpForwardFrame.init:type_name -> openshell.v1.TcpForwardInit
	76,  // 62: openshell.v1.ExecSandboxInput.start:type_name -> openshell.v1.ExecSandboxRequest
	84,  // 63: openshell.v1.ExecSandboxInput.resize:type_name -> openshell.v1.ExecSandboxWindowResize
	250, // 64: openshell.v1.SshSession.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	26,  // 65: openshell.v1.SandboxStreamEvent.sandbox:type_name -> openshell.v1.Sandbox
	88,  // 66: openshell.v1.SandboxStreamEvent.log:type_name -> openshell.v1.SandboxLogLine
	41,  // 67: openshell.v1.SandboxStreamEvent.event:type_name -> openshell.v1.PlatformEvent
	89,  // 68: openshell.v1.SandboxStreamEvent.warning:type_name -> openshell.v1.SandboxStreamWarning
	182, // 69: openshell.v1.SandboxStreamEvent.draft_policy_update:type_name -> openshell.v1.DraftPolicyUpdate
	232, // 70: openshell.v1.SandboxLogLine.fields:type_name -> openshell.v1.SandboxLogLine.FieldsEntry
	253, // 71: openshell.v1.CreateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	253, // 72: openshell.v1.UpdateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	233, // 73: openshell.v1.UpdateProviderRequest.credential_expires_at_ms:type_name -> openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	253, // 74: openshell.v1.ProviderResponse.provider:type_name -> openshell.datamodel.v1.Provider
	253, // 75: openshell.v1.ListProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	120, // 76: openshell.v1.ProviderProfileImportItem.profile:type_name -> openshell.v1.ProviderProfile
	101, // 77: openshell.v1.ProviderCredentialTokenGrant.audience_overrides:type_name -> openshell.v1.ProviderCredentialTokenGrantAudienceOverride
	2,   // 78: openshell.v1.ProviderCredentialTokenGrant.grant_type:type_name -> openshell.v1.ProviderCredentialTokenGrantType
	102, // 79: openshell.v1.ProviderCredentialTokenGrant.subject_token:type_name -> openshell.v1.ProviderCredentialTokenGrantSubjectToken
	107, // 80: openshell.v1.ProviderProfileCredential.refresh:type_name -> openshell.v1.ProviderCredentialRefresh
	103, // 81: openshell.v1.ProviderProfileCredential.token_grant:type_name -> openshell.v1.ProviderCredentialTokenGrant
	3,   // 82: openshell.v1.ProviderCredentialRefresh.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	105, // 83: openshell.v1.ProviderCredentialRefresh.material:type_name -> openshell.v1.ProviderCredentialRefreshMaterial
	106, // 84: openshell.v1.ProviderCredentialRefresh.additional_outputs:type_name -> openshell.v1.ProviderCredentialRefreshOutput
	3,   // 85: openshell.v1.ProviderCredentialRefreshStatus.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	8,   // 86: openshell.v1.ProviderCredentialRefreshStatus.recovery_action:type_name -> openshell.v1.ProviderCredentialRefreshRecoveryAction
	250, // 87: openshell.v1.StoredProviderCredentialRefreshState.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	3,   // 88: openshell.v1.StoredProviderCredentialRefreshState.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	234, // 89: openshell.v1.StoredProviderCredentialRefreshState.material:type_name -> openshell.v1.StoredProviderCredentialRefreshState.MaterialEntry
	235, // 90: openshell.v1.StoredProviderCredentialRefreshState.additional_output_keys:type_name -> openshell.v1.StoredProviderCredentialRefreshState.AdditionalOutputKeysEntry
	236, // 91: openshell.v1.StoredProviderCredentialRefreshState.secret_material_handles:type_name -> openshell.v1.StoredProviderCredentialRefreshState.SecretMaterialHandlesEntry
	111, // 92: openshell.v1.StoredProviderCredentialRefreshState.pending_secret_deletions:type_name -> openshell.v1.StoredRefreshMaterialDeletion
	8,   // 93: openshell.v1.StoredProviderCredentialRefreshState.recovery_action:type_name -> openshell.v1.ProviderCredentialRefreshRecoveryAction
	254, // 94: openshell.v1.StoredRefreshMaterialDeletion.handle:type_name -> openshell.datamodel.v1.CredentialHandle
	108, // 95: openshell.v1.GetProviderRefreshStatusResponse.credentials:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	3,   // 96: openshell.v1.ConfigureProviderRefreshRequest.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	237, // 97: openshell.v1.ConfigureProviderRefreshRequest.material:type_name -> openshell.v1.ConfigureProviderRefreshRequest.MaterialEntry
	108, // 98: openshell.v1.ConfigureProviderRefreshResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	108, // 99: openshell.v1.RotateProviderCredentialResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	4,   // 100: openshell.v1.ProviderProfile.category:type_name -> openshell.v1.ProviderProfileCategory
	104, // 101: openshell.v1.ProviderProfile.credentials:type_name -> openshell.v1.ProviderProfileCredential
	255, // 102: openshell.v1.ProviderProfile.endpoints:type_name -> openshell.sandbox.v1.NetworkEndpoint
	256, // 103: openshell.v1.ProviderProfile.binaries:type_name -> openshell.sandbox.v1.NetworkBinary
	109, // 104: openshell.v1.ProviderProfile.discovery:type_name -> openshell.v1.ProviderProfileDiscovery
	238, // 105: openshell.v1.ProviderProfile.annotations:type_name -> openshell.v1.ProviderProfile.AnnotationsEntry
	250, // 106: openshell.v1.StoredProviderProfile.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	120, // 107: openshell.v1.StoredProviderProfile.profile:type_name -> openshell.v1.ProviderProfile
	120, // 108: openshell.v1.ProviderProfileResponse.profile:type_name -> openshell.v1.ProviderProfile
	120, // 109: openshell.v1.ListProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	99,  // 110: openshell.v1.ImportProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	100, // 111: openshell.v1.ImportProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	120, // 112: openshell.v1.ImportProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	99,  // 113: openshell.v1.UpdateProviderProfilesRequest.profile:type_name -> openshell.v1.ProviderProfileImportItem
	100, // 114: openshell.v1.UpdateProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	120, // 115: openshell.v1.UpdateProviderProfilesResponse.profile:type_name -> openshell.v1.ProviderProfile
	99,  // 116: openshell.v1.LintProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	100, // 117: openshell.v1.LintProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	134, // 118: openshell.v1.StaticCredentialBinding.endpoints:type_name -> openshell.v1.StaticCredentialEndpointBinding
	239, // 119: openshell.v1.GetSandboxProviderEnvironmentResponse.environment:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.EnvironmentEntry
	240, // 120: openshell.v1.GetSandboxProviderEnvironmentResponse.credential_expires_at_ms:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.CredentialExpiresAtMsEntry
	241, // 121: openshell.v1.GetSandboxProviderEnvironmentResponse.dynamic_credentials:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry
	242, // 122: openshell.v1.GetSandboxProviderEnvironmentResponse.static_credential_bindings:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry
	251, // 123: openshell.v1.UpdateConfigRequest.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	257, // 124: openshell.v1.UpdateConfigRequest.setting_value:type_name -> openshell.sandbox.v1.SettingValue
	140, // 125: openshell.v1.UpdateConfigRequest.merge_operations:type_name -> openshell.v1.PolicyMergeOperation
	243, // 126: openshell.v1.UpdateConfigRequest.annotations:type_name -> openshell.v1.UpdateConfigRequest.AnnotationsEntry
	141, // 127: openshell.v1.PolicyMergeOperation.add_rule:type_name -> openshell.v1.AddNetworkRule
	142, // 128: openshell.v1.PolicyMergeOperation.remove_endpoint:type_name -> openshell.v1.RemoveNetworkEndpoint
	143, // 129: openshell.v1.PolicyMergeOperation.remove_rule:type_name -> openshell.v1.RemoveNetworkRule
	144, // 130: openshell.v1.PolicyMergeOperation.add_deny_rules:type_name -> openshell.v1.AddDenyRules
	145, // 131: openshell.v1.PolicyMergeOperation.add_allow_rules:type_name -> openshell.v1.AddAllowRules
	146, // 132: openshell.v1.PolicyMergeOperation.remove_binary:type_name -> openshell.v1.RemoveNetworkBinary
	258, // 133: openshell.v1.AddNetworkRule.rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	259, // 134: openshell.v1.AddDenyRules.deny_rules:type_name -> openshell.sandbox.v1.L7DenyRule
	260, // 135: openshell.v1.AddAllowRules.rules:type_name -> openshell.sandbox.v1.L7Rule
	244, // 136: openshell.v1.UpdateConfigResponse.annotations:type_name -> openshell.v1.UpdateConfigResponse.AnnotationsEntry
	154, // 137: openshell.v1.GetSandboxPolicyStatusResponse.revision:type_name -> openshell.v1.SandboxPolicyRevision
	154, // 138: openshell.v1.ListSandboxPoliciesResponse.revisions:type_name -> openshell.v1.SandboxPolicyRevision
	5,   // 139: openshell.v1.ReportPolicyStatusRequest.status:type_name -> openshell.v1.PolicyStatus
	5,   // 140: openshell.v1.SandboxPolicyRevision.status:type_name -> openshell.v1.PolicyStatus
	251, // 141: openshell.v1.SandboxPolicyRevision.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	245, // 142: openshell.v1.SandboxPolicyRevision.provenance:type_name -> openshell.v1.SandboxPolicyRevision.ProvenanceEntry
	88,  // 143: openshell.v1.PushSandboxLogsRequest.logs:type_name -> openshell.v1.SandboxLogLine
	88,  // 144: openshell.v1.GetSandboxLogsResponse.logs:type_name -> openshell.v1.SandboxLogLine
	161, // 145: openshell.v1.SupervisorMessage.hello:type_name -> openshell.v1.SupervisorHello
	164, // 146: openshell.v1.SupervisorMessage.heartbeat:type_name -> openshell.v1.SupervisorHeartbeat
	175, // 147: openshell.v1.SupervisorMessage.relay_open_result:type_name -> openshell.v1.RelayOpenResult
	176, // 148: openshell.v1.SupervisorMessage.relay_close:type_name -> openshell.v1.RelayClose
	162, // 149: openshell.v1.GatewayMessage.session_accepted:type_name -> openshell.v1.SessionAccepted
	163, // 150: openshell.v1.GatewayMessage.session_rejected:type_name -> openshell.v1.SessionRejected
	165, // 151: openshell.v1.GatewayMessage.heartbeat:type_name -> openshell.v1.GatewayHeartbeat
	170, // 152: openshell.v1.GatewayMessage.relay_open:type_name -> openshell.v1.RelayOpen
	176, // 153: openshell.v1.GatewayMessage.relay_close:type_name -> openshell.v1.RelayClose
	171, // 154: openshell.v1.RelayOpen.ssh:type_name -> openshell.v1.SshRelayTarget
	172, // 155: openshell.v1.RelayOpen.tcp:type_name -> openshell.v1.TcpRelayTarget
	173, // 156: openshell.v1.RelayFrame.init:type_name -> openshell.v1.RelayInit
	177, // 157: openshell.v1.DenialSummary.l7_request_samples:type_name -> openshell.v1.L7RequestSample
	179, // 158: openshell.v1.NetworkActivitySummary.denials_by_group:type_name -> openshell.v1.DenialGroupCount
	258, // 159: openshell.v1.PolicyChunk.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	251, // 160: openshell.v1.PolicyChunk.current_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	251, // 161: openshell.v1.PolicyChunk.candidate_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	178, // 162: openshell.v1.SubmitPolicyAnalysisRequest.summaries:type_name -> openshell.v1.DenialSummary
	181, // 163: openshell.v1.SubmitPolicyAnalysisRequest.proposed_chunks:type_name -> openshell.v1.PolicyChunk
	180, // 164: openshell.v1.SubmitPolicyAnalysisRequest.network_activity_summaries:type_name -> openshell.v1.NetworkActivitySummary
	181, // 165: openshell.v1.GetDraftPolicyResponse.chunks:type_name -> openshell.v1.PolicyChunk
	191, // 166: openshell.v1.ApproveAllDraftChunksRequest.approvals:type_name -> openshell.v1.DraftChunkApproval
	258, // 167: openshell.v1.EditDraftChunkRequest.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	201, // 168: openshell.v1.GetDraftHistoryResponse.entries:type_name -> openshell.v1.DraftHistoryEntry
	251, // 169: openshell.v1.PolicyRevisionPayload.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	246, // 170: openshell.v1.PolicyRevisionPayload.provenance:type_name -> openshell.v1.PolicyRevisionPayload.ProvenanceEntry
	258, // 171: openshell.v1.DraftChunkPayload.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	251, // 172: openshell.v1.DraftChunkPayload.current_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	251, // 173: openshell.v1.DraftChunkPayload.candidate_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	247, // 174: openshell.v1.StoredPolicyRevision.provenance:type_name -> openshell.v1.StoredPolicyRevision.ProvenanceEntry
	251, // 175: openshell.v1.StoredDraftChunk.current_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	251, // 176: openshell.v1.StoredDraftChunk.candidate_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	248, // 177: openshell.v1.CreateWorkspaceRequest.labels:type_name -> openshell.v1.CreateWorkspaceRequest.LabelsEntry
	261, // 178: openshell.v1.CreateWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	261, // 179: openshell.v1.GetWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	261, // 180: openshell.v1.ListWorkspacesResponse.workspaces:type_name -> openshell.datamodel.v1.Workspace
	250, // 181: openshell.v1.WorkspaceMember.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	7,   // 182: openshell.v1.WorkspaceMember.role:type_name -> openshell.v1.WorkspaceRole
	7,   // 183: openshell.v1.AddWorkspaceMemberRequest.role:type_name -> openshell.v1.WorkspaceRole
	215, // 184: openshell.v1.AddWorkspaceMemberResponse.member:type_name -> openshell.v1.WorkspaceMember
	215, // 185: openshell.v1.ListWorkspaceMembersResponse.members:type_name -> openshell.v1.WorkspaceMember
	254, // 186: openshell.v1.StoredProviderCredentialRefreshState.SecretMaterialHandlesEntry.value:type_name -> openshell.datamodel.v1.CredentialHandle
	104, // 187: openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry.value:type_name -> openshell.v1.ProviderProfileCredential
	135, // 188: openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry.value:type_name -> openshell.v1.StaticCredentialBinding
	13,  // 189: openshell.v1.OpenShell.Health:input_type -> openshell.v1.HealthRequest
	15,  // 190: openshell.v1.OpenShell.GetCurrentUser:input_type -> openshell.v1.GetCurrentUserRequest
	17,  // 191: openshell.v1.OpenShell.GetGatewayInfo:input_type -> openshell.v1.GetGatewayInfoRequest
	42,  // 192: openshell.v1.OpenShell.CreateSandbox:input_type -> openshell.v1.CreateSandboxRequest
	50,  // 193: openshell.v1.OpenShell.GetSandbox:input_type -> openshell.v1.GetSandboxRequest
	51,  // 194: openshell.v1.OpenShell.ListSandboxes:input_type -> openshell.v1.ListSandboxesRequest
	43,  // 195: openshell.v1.OpenShell.CreateSandboxTemplate:input_type -> openshell.v1.CreateSandboxTemplateRequest
	44,  // 196: openshell.v1.OpenShell.GetSandboxTemplate:input_type -> openshell.v1.GetSandboxTemplateRequest
	45,  // 197: openshell.v1.OpenShell.ListSandboxTemplates:input_type -> openshell.v1.ListSandboxTemplatesRequest
	46,  // 198: openshell.v1.OpenShell.DeleteSandboxTemplate:input_type -> openshell.v1.DeleteSandboxTemplateRequest
	52,  // 199: openshell.v1.OpenShell.ListSandboxProviders:input_type -> openshell.v1.ListSandboxProvidersRequest
	53,  // 200: openshell.v1.OpenShell.AttachSandboxProvider:input_type -> openshell.v1.AttachSandboxProviderRequest
	54,  // 201: openshell.v1.OpenShell.DetachSandboxProvider:input_type -> openshell.v1.DetachSandboxProviderRequest
	55,  // 202: openshell.v1.OpenShell.DeleteSandbox:input_type -> openshell.v1.DeleteSandboxRequest
	56,  // 203: openshell.v1.OpenShell.StopSandbox:input_type -> openshell.v1.StopSandboxRequest
	57,  // 204: openshell.v1.OpenShell.StartSandbox:input_type -> openshell.v1.StartSandboxRequest
	64,  // 205: openshell.v1.OpenShell.CreateSshSession:input_type -> openshell.v1.CreateSshSessionRequest
	66,  // 206: openshell.v1.OpenShell.ExposeService:input_type -> openshell.v1.ExposeServiceRequest
	67,  // 207: openshell.v1.OpenShell.GetService:input_type -> openshell.v1.GetServiceRequest
	68,  // 208: openshell.v1.OpenShell.ListServices:input_type -> openshell.v1.ListServicesRequest
	70,  // 209: openshell.v1.OpenShell.DeleteService:input_type -> openshell.v1.DeleteServiceRequest
	74,  // 210: openshell.v1.OpenShell.RevokeSshSession:input_type -> openshell.v1.RevokeSshSessionRequest
	76,  // 211: openshell.v1.OpenShell.ExecSandbox:input_type -> openshell.v1.ExecSandboxRequest
	82,  // 212: openshell.v1.OpenShell.ForwardTcp:input_type -> openshell.v1.TcpForwardFrame
	83,  // 213: openshell.v1.OpenShell.ExecSandboxInteractive:input_type -> openshell.v1.ExecSandboxInput
	90,  // 214: openshell.v1.OpenShell.CreateProvider:input_type -> openshell.v1.CreateProviderRequest
	91,  // 215: openshell.v1.OpenShell.GetProvider:input_type -> openshell.v1.GetProviderRequest
	92,  // 216: openshell.v1.OpenShell.ListProviders:input_type -> openshell.v1.ListProvidersRequest
	97,  // 217: openshell.v1.OpenShell.ListProviderProfiles:input_type -> openshell.v1.ListProviderProfilesRequest
	98,  // 218: openshell.v1.OpenShell.GetProviderProfile:input_type -> openshell.v1.GetProviderProfileRequest
	124, // 219: openshell.v1.OpenShell.ImportProviderProfiles:input_type -> openshell.v1.ImportProviderProfilesRequest
	126, // 220: openshell.v1.OpenShell.UpdateProviderProfiles:input_type -> openshell.v1.UpdateProviderProfilesRequest
	128, // 221: openshell.v1.OpenShell.LintProviderProfiles:input_type -> openshell.v1.LintProviderProfilesRequest
	93,  // 222: openshell.v1.OpenShell.UpdateProvider:input_type -> openshell.v1.UpdateProviderRequest
	112, // 223: openshell.v1.OpenShell.GetProviderRefreshStatus:input_type -> openshell.v1.GetProviderRefreshStatusRequest
	114, // 224: openshell.v1.OpenShell.ConfigureProviderRefresh:input_type -> openshell.v1.ConfigureProviderRefreshRequest
	116, // 225: openshell.v1.OpenShell.RotateProviderCredential:input_type -> openshell.v1.RotateProviderCredentialRequest
	118, // 226: openshell.v1.OpenShell.DeleteProviderRefresh:input_type -> openshell.v1.DeleteProviderRefreshRequest
	94,  // 227: openshell.v1.OpenShell.DeleteProvider:input_type -> openshell.v1.DeleteProviderRequest
	131, // 228: openshell.v1.OpenShell.DeleteProviderProfile:input_type -> openshell.v1.DeleteProviderProfileRequest
	262, // 229: openshell.v1.OpenShell.GetSandboxConfig:input_type -> openshell.sandbox.v1.GetSandboxConfigRequest
	263, // 230: openshell.v1.OpenShell.GetGatewayConfig:input_type -> openshell.sandbox.v1.GetGatewayConfigRequest
	139, // 231: openshell.v1.OpenShell.UpdateConfig:input_type -> openshell.v1.UpdateConfigRequest
	148, // 232: openshell.v1.OpenShell.GetSandboxPolicyStatus:input_type -> openshell.v1.GetSandboxPolicyStatusRequest
	150, // 233: openshell.v1.OpenShell.ListSandboxPolicies:input_type -> openshell.v1.ListSandboxPoliciesRequest
	152, // 234: openshell.v1.OpenShell.ReportPolicyStatus:input_type -> openshell.v1.ReportPolicyStatusRequest
	133, // 235: openshell.v1.OpenShell.GetSandboxProviderEnvironment:input_type -> openshell.v1.GetSandboxProviderEnvironmentRequest
	137, // 236: openshell.v1.OpenShell.ExchangeProviderSubjectToken:input_type -> openshell.v1.ExchangeProviderSubjectTokenRequest
	155, // 237: openshell.v1.OpenShell.GetSandboxLogs:input_type -> openshell.v1.GetSandboxLogsRequest
	156, // 238: openshell.v1.OpenShell.PushSandboxLogs:input_type -> openshell.v1.PushSandboxLogsRequest
	159, // 239: openshell.v1.OpenShell.ConnectSupervisor:input_type -> openshell.v1.SupervisorMessage
	166, // 240: openshell.v1.OpenShell.ReportMainProcessExit:input_type -> openshell.v1.ReportMainProcessExitRequest
	168, // 241: openshell.v1.OpenShell.FinalizeMainProcessExit:input_type -> openshell.v1.FinalizeMainProcessExitRequest
	174, // 242: openshell.v1.OpenShell.RelayStream:input_type -> openshell.v1.RelayFrame
	86,  // 243: openshell.v1.OpenShell.WatchSandbox:input_type -> openshell.v1.WatchSandboxRequest
	183, // 244: openshell.v1.OpenShell.SubmitPolicyAnalysis:input_type -> openshell.v1.SubmitPolicyAnalysisRequest
	185, // 245: openshell.v1.OpenShell.GetDraftPolicy:input_type -> openshell.v1.GetDraftPolicyRequest
	187, // 246: openshell.v1.OpenShell.ApproveDraftChunk:input_type -> openshell.v1.ApproveDraftChunkRequest
	189, // 247: openshell.v1.OpenShell.RejectDraftChunk:input_type -> openshell.v1.RejectDraftChunkRequest
	192, // 248: openshell.v1.OpenShell.ApproveAllDraftChunks:input_type -> openshell.v1.ApproveAllDraftChunksRequest
	194, // 249: openshell.v1.OpenShell.EditDraftChunk:input_type -> openshell.v1.EditDraftChunkRequest
	196, // 250: openshell.v1.OpenShell.UndoDraftChunk:input_type -> openshell.v1.UndoDraftChunkRequest
	198, // 251: openshell.v1.OpenShell.ClearDraftChunks:input_type -> openshell.v1.ClearDraftChunksRequest
	200, // 252: openshell.v1.OpenShell.GetDraftHistory:input_type -> openshell.v1.GetDraftHistoryRequest
	9,   // 253: openshell.v1.OpenShell.IssueSandboxToken:input_type -> openshell.v1.IssueSandboxTokenRequest
	11,  // 254: openshell.v1.OpenShell.RefreshSandboxToken:input_type -> openshell.v1.RefreshSandboxTokenRequest
	207, // 255: openshell.v1.OpenShell.CreateWorkspace:input_type -> openshell.v1.CreateWorkspaceRequest
	209, // 256: openshell.v1.OpenShell.GetWorkspace:input_type -> openshell.v1.GetWorkspaceRequest
	211, // 257: openshell.v1.OpenShell.ListWorkspaces:input_type -> openshell.v1.ListWorkspacesRequest
	213, // 258: openshell.v1.OpenShell.DeleteWorkspace:input_type -> openshell.v1.DeleteWorkspaceRequest
	216, // 259: openshell.v1.OpenShell.AddWorkspaceMember:input_type -> openshell.v1.AddWorkspaceMemberRequest
	218, // 260: openshell.v1.OpenShell.RemoveWorkspaceMember:input_type -> openshell.v1.RemoveWorkspaceMemberRequest
	220, // 261: openshell.v1.OpenShell.ListWorkspaceMembers:input_type -> openshell.v1.ListWorkspaceMembersRequest
	14,  // 262: openshell.v1.OpenShell.Health:output_type -> openshell.v1.HealthResponse
	16,  // 263: openshell.v1.OpenShell.GetCurrentUser:output_type -> openshell.v1.GetCurrentUserResponse
	18,  // 264: openshell.v1.OpenShell.GetGatewayInfo:output_type -> openshell.v1.GetGatewayInfoResponse
	58,  // 265: openshell.v1.OpenShell.CreateSandbox:output_type -> openshell.v1.SandboxResponse
	58,  // 266: openshell.v1.OpenShell.GetSandbox:output_type -> openshell.v1.SandboxResponse
	59,  // 267: openshell.v1.OpenShell.ListSandboxes:output_type -> openshell.v1.ListSandboxesResponse
	47,  // 268: openshell.v1.OpenShell.CreateSandboxTemplate:output_type -> openshell.v1.SandboxTemplateResponse
	47,  // 269: openshell.v1.OpenShell.GetSandboxTemplate:output_type -> openshell.v1.SandboxTemplateResponse
	48,  // 270: openshell.v1.OpenShell.ListSandboxTemplates:output_type -> openshell.v1.ListSandboxTemplatesResponse
	49,  // 271: openshell.v1.OpenShell.DeleteSandboxTemplate:output_type -> openshell.v1.DeleteSandboxTemplateResponse
	60,  // 272: openshell.v1.OpenShell.ListSandboxProviders:output_type -> openshell.v1.ListSandboxProvidersResponse
	61,  // 273: openshell.v1.OpenShell.AttachSandboxProvider:output_type -> openshell.v1.AttachSandboxProviderResponse
	62,  // 274: openshell.v1.OpenShell.DetachSandboxProvider:output_type -> openshell.v1.DetachSandboxProviderResponse
	63,  // 275: openshell.v1.OpenShell.DeleteSandbox:output_type -> openshell.v1.DeleteSandboxResponse
	58,  // 276: openshell.v1.OpenShell.StopSandbox:output_type -> openshell.v1.SandboxResponse
	58,  // 277: openshell.v1.OpenShell.StartSandbox:output_type -> openshell.v1.SandboxResponse
	65,  // 278: openshell.v1.OpenShell.CreateSshSession:output_type -> openshell.v1.CreateSshSessionResponse
	73,  // 279: openshell.v1.OpenShell.ExposeService:output_type -> openshell.v1.ServiceEndpointResponse
	73,  // 280: openshell.v1.OpenShell.GetService:output_type -> openshell.v1.ServiceEndpointResponse
	69,  // 281: openshell.v1.OpenShell.ListServices:output_type -> openshell.v1.ListServicesResponse
	71,  // 282: openshell.v1.OpenShell.DeleteService:output_type -> openshell.v1.DeleteServiceResponse
	75,  // 283: openshell.v1.OpenShell.RevokeSshSession:output_type -> openshell.v1.RevokeSshSessionResponse
	80,  // 284: openshell.v1.OpenShell.ExecSandbox:output_type -> openshell.v1.ExecSandboxEvent
	82,  // 285: openshell.v1.OpenShell.ForwardTcp:output_type -> openshell.v1.TcpForwardFrame
	80,  // 286: openshell.v1.OpenShell.ExecSandboxInteractive:output_type -> openshell.v1.ExecSandboxEvent
	95,  // 287: openshell.v1.OpenShell.CreateProvider:output_type -> openshell.v1.ProviderResponse
	95,  // 288: openshell.v1.OpenShell.GetProvider:output_type -> openshell.v1.ProviderResponse
	96,  // 289: openshell.v1.OpenShell.ListProviders:output_type -> openshell.v1.ListProvidersResponse
	123, // 290: openshell.v1.OpenShell.ListProviderProfiles:output_type -> openshell.v1.ListProviderProfilesResponse
	122, // 291: openshell.v1.OpenShell.GetProviderProfile:output_type -> openshell.v1.ProviderProfileResponse
	125, // 292: openshell.v1.OpenShell.ImportProviderProfiles:output_type -> openshell.v1.ImportProviderProfilesResponse
	127, // 293: openshell.v1.OpenShell.UpdateProviderProfiles:output_type -> openshell.v1.UpdateProviderProfilesResponse
	129, // 294: openshell.v1.OpenShell.LintProviderProfiles:output_type -> openshell.v1.LintProviderProfilesResponse
	95,  // 295: openshell.v1.OpenShell.UpdateProvider:output_type -> openshell.v1.ProviderResponse
	113, // 296: openshell.v1.OpenShell.GetProviderRefreshStatus:output_type -> openshell.v1.GetProviderRefreshStatusResponse
	115, // 297: openshell.v1.OpenShell.ConfigureProviderRefresh:output_type -> openshell.v1.ConfigureProviderRefreshResponse
	117, // 298: openshell.v1.OpenShell.RotateProviderCredential:output_type -> openshell.v1.RotateProviderCredentialResponse
	119, // 299: openshell.v1.OpenShell.DeleteProviderRefresh:output_type -> openshell.v1.DeleteProviderRefreshResponse
	130, // 300: openshell.v1.OpenShell.DeleteProvider:output_type -> openshell.v1.DeleteProviderResponse
	132, // 301: openshell.v1.OpenShell.DeleteProviderProfile:output_type -> openshell.v1.DeleteProviderProfileResponse
	264, // 302: openshell.v1.OpenShell.GetSandboxConfig:output_type -> openshell.sandbox.v1.GetSandboxConfigResponse
	265, // 303: openshell.v1.OpenShell.GetGatewayConfig:output_type -> openshell.sandbox.v1.GetGatewayConfigResponse
	147, // 304: openshell.v1.OpenShell.UpdateConfig:output_type -> openshell.v1.UpdateConfigResponse
	149, // 305: openshell.v1.OpenShell.GetSandboxPolicyStatus:output_type -> openshell.v1.GetSandboxPolicyStatusResponse
	151, // 306: openshell.v1.OpenShell.ListSandboxPolicies:output_type -> openshell.v1.ListSandboxPoliciesResponse
	153, // 307: openshell.v1.OpenShell.ReportPolicyStatus:output_type -> openshell.v1.ReportPolicyStatusResponse
	136, // 308: openshell.v1.OpenShell.GetSandboxProviderEnvironment:output_type -> openshell.v1.GetSandboxProviderEnvironmentResponse
	138, // 309: openshell.v1.OpenShell.ExchangeProviderSubjectToken:output_type -> openshell.v1.ExchangeProviderSubjectTokenResponse
	158, // 310: openshell.v1.OpenShell.GetSandboxLogs:output_type -> openshell.v1.GetSandboxLogsResponse
	157, // 311: openshell.v1.OpenShell.PushSandboxLogs:output_type -> openshell.v1.PushSandboxLogsResponse
	160, // 312: openshell.v1.OpenShell.ConnectSupervisor:output_type -> openshell.v1.GatewayMessage
	167, // 313: openshell.v1.OpenShell.ReportMainProcessExit:output_type -> openshell.v1.ReportMainProcessExitResponse
	169, // 314: openshell.v1.OpenShell.FinalizeMainProcessExit:output_type -> openshell.v1.FinalizeMainProcessExitResponse
	174, // 315: openshell.v1.OpenShell.RelayStream:output_type -> openshell.v1.RelayFrame
	87,  // 316: openshell.v1.OpenShell.WatchSandbox:output_type -> openshell.v1.SandboxStreamEvent
	184, // 317: openshell.v1.OpenShell.SubmitPolicyAnalysis:output_type -> openshell.v1.SubmitPolicyAnalysisResponse
	186, // 318: openshell.v1.OpenShell.GetDraftPolicy:output_type -> openshell.v1.GetDraftPolicyResponse
	188, // 319: openshell.v1.OpenShell.ApproveDraftChunk:output_type -> openshell.v1.ApproveDraftChunkResponse
	190, // 320: openshell.v1.OpenShell.RejectDraftChunk:output_type -> openshell.v1.RejectDraftChunkResponse
	193, // 321: openshell.v1.OpenShell.ApproveAllDraftChunks:output_type -> openshell.v1.ApproveAllDraftChunksResponse
	195, // 322: openshell.v1.OpenShell.EditDraftChunk:output_type -> openshell.v1.EditDraftChunkResponse
	197, // 323: openshell.v1.OpenShell.UndoDraftChunk:output_type -> openshell.v1.UndoDraftChunkResponse
	199, // 324: openshell.v1.OpenShell.ClearDraftChunks:output_type -> openshell.v1.ClearDraftChunksResponse
	202, // 325: openshell.v1.OpenShell.GetDraftHistory:output_type -> openshell.v1.GetDraftHistoryResponse
	10,  // 326: openshell.v1.OpenShell.IssueSandboxToken:output_type -> openshell.v1.IssueSandboxTokenResponse
	12,  // 327: openshell.v1.OpenShell.RefreshSandboxToken:output_type -> openshell.v1.RefreshSandboxTokenResponse
	208, // 328: openshell.v1.OpenShell.CreateWorkspace:output_type -> openshell.v1.CreateWorkspaceResponse
	210, // 329: openshell.v1.OpenShell.GetWorkspace:output_type -> openshell.v1.GetWorkspaceResponse
	212, // 330: openshell.v1.OpenShell.ListWorkspaces:output_type -> openshell.v1.ListWorkspacesResponse
	214, // 331: openshell.v1.OpenShell.DeleteWorkspace:output_type -> openshell.v1.DeleteWorkspaceResponse
	217, // 332: openshell.v1.OpenShell.AddWorkspaceMember:output_type -> openshell.v1.AddWorkspaceMemberResponse
	219, // 333: openshell.v1.OpenShell.RemoveWorkspaceMember:output_type -> openshell.v1.RemoveWorkspaceMemberResponse
	221, // 334: openshell.v1.OpenShell.ListWorkspaceMembers:output_type -> openshell.v1.ListWorkspaceMembersResponse
...
func file_openshell_proto_init() {
	...
	file_openshell_proto_msgTypes[161].OneofWrappers = []any{
		(*RelayOpen_Ssh)(nil),
		(*RelayOpen_Tcp)(nil),
	}
