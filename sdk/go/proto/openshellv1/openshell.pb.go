...
type SupervisorActivationMessage struct {
	...
	// Human-readable sandbox name, if known.
	SandboxName string `protobuf:"bytes,2,opt,name=sandbox_name,json=sandboxName,proto3" json:"sandbox_name,omitempty"`
	// Gateway-minted JWT bound to the sandbox UUID.
	Token string `protobuf:"bytes,3,opt,name=token,proto3" json:"token,omitempty"`
	// Absolute expiry of the issued token, milliseconds since the epoch. 0 means
	// the token is non-expiring.
	TokenExpiresAtMs int64 `protobuf:"varint,4,opt,name=token_expires_at_ms,json=tokenExpiresAtMs,proto3" json:"token_expires_at_ms,omitempty"`
	// Reserved for future activation-time metadata. The phase-1 cold path leaves
	// this empty.
	StartupMetadata map[string]string `protobuf:"bytes,5,rep,name=startup_metadata,json=startupMetadata,proto3" json:"startup_metadata,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
var file_openshell_proto_goTypes = []any{
	...
	(*RegisterSupervisorRequest)(nil),                    // 10: openshell.v1.RegisterSupervisorRequest
	(*SupervisorActivationMessage)(nil),                  // 11: openshell.v1.SupervisorActivationMessage
	...
	(*StoredProviderCredentialRefreshState)(nil),         // 111: openshell.v1.StoredProviderCredentialRefreshState
	(*StoredRefreshMaterialDeletion)(nil),                // 112: openshell.v1.StoredRefreshMaterialDeletion
	...
	(*StoredProviderProfile)(nil),                        // 122: openshell.v1.StoredProviderProfile
	...
	(*ExchangeProviderSubjectTokenRequest)(nil),          // 138: openshell.v1.ExchangeProviderSubjectTokenRequest
	(*ExchangeProviderSubjectTokenResponse)(nil),         // 139: openshell.v1.ExchangeProviderSubjectTokenResponse
	(*UpdateConfigRequest)(nil),                          // 140: openshell.v1.UpdateConfigRequest
	(*PolicyMergeOperation)(nil),                         // 141: openshell.v1.PolicyMergeOperation
	(*AddNetworkRule)(nil),                               // 142: openshell.v1.AddNetworkRule
	(*RemoveNetworkEndpoint)(nil),                        // 143: openshell.v1.RemoveNetworkEndpoint
	(*RemoveNetworkRule)(nil),                            // 144: openshell.v1.RemoveNetworkRule
	(*AddDenyRules)(nil),                                 // 145: openshell.v1.AddDenyRules
	(*AddAllowRules)(nil),                                // 146: openshell.v1.AddAllowRules
	(*RemoveNetworkBinary)(nil),                          // 147: openshell.v1.RemoveNetworkBinary
	(*UpdateConfigResponse)(nil),                         // 148: openshell.v1.UpdateConfigResponse
	(*GetSandboxPolicyStatusRequest)(nil),                // 149: openshell.v1.GetSandboxPolicyStatusRequest
	(*GetSandboxPolicyStatusResponse)(nil),               // 150: openshell.v1.GetSandboxPolicyStatusResponse
	(*ListSandboxPoliciesRequest)(nil),                   // 151: openshell.v1.ListSandboxPoliciesRequest
	(*ListSandboxPoliciesResponse)(nil),                  // 152: openshell.v1.ListSandboxPoliciesResponse
	(*ReportPolicyStatusRequest)(nil),                    // 153: openshell.v1.ReportPolicyStatusRequest
	(*ReportPolicyStatusResponse)(nil),                   // 154: openshell.v1.ReportPolicyStatusResponse
	...
	(*PolicyRevisionPayload)(nil),                        // 204: openshell.v1.PolicyRevisionPayload
	(*DraftChunkPayload)(nil),                            // 205: openshell.v1.DraftChunkPayload
	(*StoredPolicyRevision)(nil),                         // 206: openshell.v1.StoredPolicyRevision
	(*StoredDraftChunk)(nil),                             // 207: openshell.v1.StoredDraftChunk
	(*CreateWorkspaceRequest)(nil),                       // 208: openshell.v1.CreateWorkspaceRequest
	(*CreateWorkspaceResponse)(nil),                      // 209: openshell.v1.CreateWorkspaceResponse
	(*GetWorkspaceRequest)(nil),                          // 210: openshell.v1.GetWorkspaceRequest
	(*GetWorkspaceResponse)(nil),                         // 211: openshell.v1.GetWorkspaceResponse
	(*ListWorkspacesRequest)(nil),                        // 212: openshell.v1.ListWorkspacesRequest
	(*ListWorkspacesResponse)(nil),                       // 213: openshell.v1.ListWorkspacesResponse
	(*DeleteWorkspaceRequest)(nil),                       // 214: openshell.v1.DeleteWorkspaceRequest
	(*DeleteWorkspaceResponse)(nil),                      // 215: openshell.v1.DeleteWorkspaceResponse
	(*WorkspaceMember)(nil),                              // 216: openshell.v1.WorkspaceMember
	(*AddWorkspaceMemberRequest)(nil),                    // 217: openshell.v1.AddWorkspaceMemberRequest
	(*AddWorkspaceMemberResponse)(nil),                   // 218: openshell.v1.AddWorkspaceMemberResponse
	(*RemoveWorkspaceMemberRequest)(nil),                 // 219: openshell.v1.RemoveWorkspaceMemberRequest
	(*RemoveWorkspaceMemberResponse)(nil),                // 220: openshell.v1.RemoveWorkspaceMemberResponse
	(*ListWorkspaceMembersRequest)(nil),                  // 221: openshell.v1.ListWorkspaceMembersRequest
	...
	nil,                                                  // 224: openshell.v1.SupervisorActivationMessage.StartupMetadataEntry
	nil,                                                  // 225: openshell.v1.SandboxSpec.EnvironmentEntry
	nil,                                                  // 226: openshell.v1.SandboxTemplate.LabelsEntry
	nil,                                                  // 227: openshell.v1.SandboxTemplate.AnnotationsEntry
	nil,                                                  // 228: openshell.v1.SandboxTemplate.EnvironmentEntry
	nil,                                                  // 229: openshell.v1.SandboxWorkloadConfig.EnvironmentEntry
	nil,                                                  // 230: openshell.v1.PlatformEvent.MetadataEntry
	nil,                                                  // 231: openshell.v1.CreateSandboxRequest.LabelsEntry
	nil,                                                  // 232: openshell.v1.CreateSandboxRequest.AnnotationsEntry
	nil,                                                  // 233: openshell.v1.ExecSandboxRequest.EnvironmentEntry
	nil,                                                  // 234: openshell.v1.SandboxLogLine.FieldsEntry
	nil,                                                  // 235: openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	nil,                                                  // 236: openshell.v1.StoredProviderCredentialRefreshState.MaterialEntry
	nil,                                                  // 237: openshell.v1.StoredProviderCredentialRefreshState.AdditionalOutputKeysEntry
	nil,                                                  // 238: openshell.v1.StoredProviderCredentialRefreshState.SecretMaterialHandlesEntry
	nil,                                                  // 239: openshell.v1.ConfigureProviderRefreshRequest.MaterialEntry
	nil,                                                  // 240: openshell.v1.ProviderProfile.AnnotationsEntry
	nil,                                                  // 241: openshell.v1.GetSandboxProviderEnvironmentResponse.EnvironmentEntry
	nil,                                                  // 242: openshell.v1.GetSandboxProviderEnvironmentResponse.CredentialExpiresAtMsEntry
	nil,                                                  // 243: openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry
	nil,                                                  // 244: openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry
	nil,                                                  // 245: openshell.v1.UpdateConfigRequest.AnnotationsEntry
	nil,                                                  // 246: openshell.v1.UpdateConfigResponse.AnnotationsEntry
	nil,                                                  // 247: openshell.v1.SandboxPolicyRevision.ProvenanceEntry
	nil,                                                  // 248: openshell.v1.PolicyRevisionPayload.ProvenanceEntry
	nil,                                                  // 249: openshell.v1.StoredPolicyRevision.ProvenanceEntry
	nil,                                                  // 250: openshell.v1.CreateWorkspaceRequest.LabelsEntry
	(*datamodelv1.ObjectMeta)(nil),                       // 251: openshell.datamodel.v1.ObjectMeta
	(*sandboxv1.SandboxPolicy)(nil),                      // 252: openshell.sandbox.v1.SandboxPolicy
	(*structpb.Struct)(nil),                              // 253: google.protobuf.Struct
	(*durationpb.Duration)(nil),                          // 254: google.protobuf.Duration
	(*datamodelv1.Provider)(nil),                         // 255: openshell.datamodel.v1.Provider
	(*datamodelv1.CredentialHandle)(nil),                 // 256: openshell.datamodel.v1.CredentialHandle
	(*sandboxv1.NetworkEndpoint)(nil),                    // 257: openshell.sandbox.v1.NetworkEndpoint
	(*sandboxv1.NetworkBinary)(nil),                      // 258: openshell.sandbox.v1.NetworkBinary
	(*sandboxv1.SettingValue)(nil),                       // 259: openshell.sandbox.v1.SettingValue
	(*sandboxv1.NetworkPolicyRule)(nil),                  // 260: openshell.sandbox.v1.NetworkPolicyRule
	(*sandboxv1.L7DenyRule)(nil),                         // 261: openshell.sandbox.v1.L7DenyRule
	(*sandboxv1.L7Rule)(nil),                             // 262: openshell.sandbox.v1.L7Rule
	(*datamodelv1.Workspace)(nil),                        // 263: openshell.datamodel.v1.Workspace
	(*sandboxv1.GetSandboxConfigRequest)(nil),            // 264: openshell.sandbox.v1.GetSandboxConfigRequest
	(*sandboxv1.GetGatewayConfigRequest)(nil),            // 265: openshell.sandbox.v1.GetGatewayConfigRequest
	(*sandboxv1.GetSandboxConfigResponse)(nil),           // 266: openshell.sandbox.v1.GetSandboxConfigResponse
	(*sandboxv1.GetGatewayConfigResponse)(nil),           // 267: openshell.sandbox.v1.GetGatewayConfigResponse
}
var file_openshell_proto_depIdxs = []int32{
	224, // 0: openshell.v1.SupervisorActivationMessage.startup_metadata:type_name -> openshell.v1.SupervisorActivationMessage.StartupMetadataEntry
	223, // 1: openshell.v1.RefreshSandboxTokenResponse.extension_credentials:type_name -> openshell.v1.ExtensionServiceCredential
	5,   // 2: openshell.v1.HealthResponse.status:type_name -> openshell.v1.ServiceStatus
	5,   // 3: openshell.v1.GetGatewayInfoResponse.status:type_name -> openshell.v1.ServiceStatus
	20,  // 4: openshell.v1.GetGatewayInfoResponse.compute_drivers:type_name -> openshell.v1.ComputeDriverInfo
	21,  // 5: openshell.v1.ComputeDriverInfo.capabilities:type_name -> openshell.v1.ComputeDriverCapabilities
	22,  // 6: openshell.v1.ComputeDriverCapabilities.resource_capabilities:type_name -> openshell.v1.ResourceCapabilities
	23,  // 7: openshell.v1.ResourceCapabilities.cpu:type_name -> openshell.v1.CpuResourceCapabilities
	24,  // 8: openshell.v1.ResourceCapabilities.memory:type_name -> openshell.v1.MemoryResourceCapabilities
	25,  // 9: openshell.v1.ResourceCapabilities.gpu:type_name -> openshell.v1.GpuResourceCapabilities
	251, // 10: openshell.v1.Sandbox.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	27,  // 11: openshell.v1.Sandbox.spec:type_name -> openshell.v1.SandboxSpec
	38,  // 12: openshell.v1.Sandbox.status:type_name -> openshell.v1.SandboxStatus
	37,  // 13: openshell.v1.Sandbox.created_from_workload_template:type_name -> openshell.v1.SandboxWorkloadTemplateProvenance
	225, // 14: openshell.v1.SandboxSpec.environment:type_name -> openshell.v1.SandboxSpec.EnvironmentEntry
	30,  // 15: openshell.v1.SandboxSpec.template:type_name -> openshell.v1.SandboxTemplate
	252, // 16: openshell.v1.SandboxSpec.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	28,  // 17: openshell.v1.SandboxSpec.resource_requirements:type_name -> openshell.v1.ResourceRequirements
	29,  // 18: openshell.v1.ResourceRequirements.gpu:type_name -> openshell.v1.GpuResourceRequirements
	226, // 19: openshell.v1.SandboxTemplate.labels:type_name -> openshell.v1.SandboxTemplate.LabelsEntry
	227, // 20: openshell.v1.SandboxTemplate.annotations:type_name -> openshell.v1.SandboxTemplate.AnnotationsEntry
	228, // 21: openshell.v1.SandboxTemplate.environment:type_name -> openshell.v1.SandboxTemplate.EnvironmentEntry
	253, // 22: openshell.v1.SandboxTemplate.resources:type_name -> google.protobuf.Struct
	253, // 23: openshell.v1.SandboxTemplate.driver_config:type_name -> google.protobuf.Struct
	251, // 24: openshell.v1.SandboxWorkloadTemplate.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	32,  // 25: openshell.v1.SandboxWorkloadTemplate.spec:type_name -> openshell.v1.SandboxWorkloadTemplateSpec
	33,  // 26: openshell.v1.SandboxWorkloadTemplateSpec.workload:type_name -> openshell.v1.SandboxWorkloadConfig
	253, // 27: openshell.v1.SandboxWorkloadTemplateSpec.driver_config:type_name -> google.protobuf.Struct
	35,  // 28: openshell.v1.SandboxWorkloadTemplateSpec.desired_service_level:type_name -> openshell.v1.SandboxServiceLevel
	229, // 29: openshell.v1.SandboxWorkloadConfig.environment:type_name -> openshell.v1.SandboxWorkloadConfig.EnvironmentEntry
	34,  // 30: openshell.v1.SandboxWorkloadConfig.resources:type_name -> openshell.v1.SandboxResources
	29,  // 31: openshell.v1.SandboxResources.gpu:type_name -> openshell.v1.GpuResourceRequirements
	36,  // 32: openshell.v1.SandboxServiceLevel.startup:type_name -> openshell.v1.SandboxStartup
	254, // 33: openshell.v1.SandboxStartup.ready_within:type_name -> google.protobuf.Duration
	...
	230, // 36: openshell.v1.PlatformEvent.metadata:type_name -> openshell.v1.PlatformEvent.MetadataEntry
	27,  // 37: openshell.v1.CreateSandboxRequest.spec:type_name -> openshell.v1.SandboxSpec
	231, // 38: openshell.v1.CreateSandboxRequest.labels:type_name -> openshell.v1.CreateSandboxRequest.LabelsEntry
	232, // 39: openshell.v1.CreateSandboxRequest.annotations:type_name -> openshell.v1.CreateSandboxRequest.AnnotationsEntry
	31,  // 40: openshell.v1.CreateSandboxTemplateRequest.template:type_name -> openshell.v1.SandboxWorkloadTemplate
	31,  // 41: openshell.v1.SandboxTemplateResponse.template:type_name -> openshell.v1.SandboxWorkloadTemplate
	31,  // 42: openshell.v1.ListSandboxTemplatesResponse.templates:type_name -> openshell.v1.SandboxWorkloadTemplate
	26,  // 43: openshell.v1.SandboxResponse.sandbox:type_name -> openshell.v1.Sandbox
	26,  // 44: openshell.v1.ListSandboxesResponse.sandboxes:type_name -> openshell.v1.Sandbox
	255, // 45: openshell.v1.ListSandboxProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	26,  // 46: openshell.v1.AttachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	26,  // 47: openshell.v1.DetachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	74,  // 48: openshell.v1.ListServicesResponse.services:type_name -> openshell.v1.ServiceEndpointResponse
	251, // 49: openshell.v1.ServiceEndpoint.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	73,  // 50: openshell.v1.ServiceEndpointResponse.endpoint:type_name -> openshell.v1.ServiceEndpoint
	233, // 51: openshell.v1.ExecSandboxRequest.environment:type_name -> openshell.v1.ExecSandboxRequest.EnvironmentEntry
	78,  // 52: openshell.v1.ExecSandboxEvent.stdout:type_name -> openshell.v1.ExecSandboxStdout
	79,  // 53: openshell.v1.ExecSandboxEvent.stderr:type_name -> openshell.v1.ExecSandboxStderr
	80,  // 54: openshell.v1.ExecSandboxEvent.exit:type_name -> openshell.v1.ExecSandboxExit
	172, // 55: openshell.v1.TcpForwardInit.ssh:type_name -> openshell.v1.SshRelayTarget
	173, // 56: openshell.v1.TcpForwardInit.tcp:type_name -> openshell.v1.TcpRelayTarget
	82,  // 57: openshell.v1.TcpForwardFrame.init:type_name -> openshell.v1.TcpForwardInit
	77,  // 58: openshell.v1.ExecSandboxInput.start:type_name -> openshell.v1.ExecSandboxRequest
	85,  // 59: openshell.v1.ExecSandboxInput.resize:type_name -> openshell.v1.ExecSandboxWindowResize
	251, // 60: openshell.v1.SshSession.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	26,  // 61: openshell.v1.SandboxStreamEvent.sandbox:type_name -> openshell.v1.Sandbox
	89,  // 62: openshell.v1.SandboxStreamEvent.log:type_name -> openshell.v1.SandboxLogLine
	40,  // 63: openshell.v1.SandboxStreamEvent.event:type_name -> openshell.v1.PlatformEvent
	90,  // 64: openshell.v1.SandboxStreamEvent.warning:type_name -> openshell.v1.SandboxStreamWarning
	183, // 65: openshell.v1.SandboxStreamEvent.draft_policy_update:type_name -> openshell.v1.DraftPolicyUpdate
	234, // 66: openshell.v1.SandboxLogLine.fields:type_name -> openshell.v1.SandboxLogLine.FieldsEntry
	255, // 67: openshell.v1.CreateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	255, // 68: openshell.v1.UpdateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	235, // 69: openshell.v1.UpdateProviderRequest.credential_expires_at_ms:type_name -> openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	255, // 70: openshell.v1.ProviderResponse.provider:type_name -> openshell.datamodel.v1.Provider
	255, // 71: openshell.v1.ListProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	121, // 72: openshell.v1.ProviderProfileImportItem.profile:type_name -> openshell.v1.ProviderProfile
	102, // 73: openshell.v1.ProviderCredentialTokenGrant.audience_overrides:type_name -> openshell.v1.ProviderCredentialTokenGrantAudienceOverride
	1,   // 74: openshell.v1.ProviderCredentialTokenGrant.grant_type:type_name -> openshell.v1.ProviderCredentialTokenGrantType
	103, // 75: openshell.v1.ProviderCredentialTokenGrant.subject_token:type_name -> openshell.v1.ProviderCredentialTokenGrantSubjectToken
	108, // 76: openshell.v1.ProviderProfileCredential.refresh:type_name -> openshell.v1.ProviderCredentialRefresh
	104, // 77: openshell.v1.ProviderProfileCredential.token_grant:type_name -> openshell.v1.ProviderCredentialTokenGrant
	2,   // 78: openshell.v1.ProviderCredentialRefresh.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	106, // 79: openshell.v1.ProviderCredentialRefresh.material:type_name -> openshell.v1.ProviderCredentialRefreshMaterial
	107, // 80: openshell.v1.ProviderCredentialRefresh.additional_outputs:type_name -> openshell.v1.ProviderCredentialRefreshOutput
	2,   // 81: openshell.v1.ProviderCredentialRefreshStatus.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	7,   // 82: openshell.v1.ProviderCredentialRefreshStatus.recovery_action:type_name -> openshell.v1.ProviderCredentialRefreshRecoveryAction
	251, // 83: openshell.v1.StoredProviderCredentialRefreshState.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	2,   // 84: openshell.v1.StoredProviderCredentialRefreshState.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	236, // 85: openshell.v1.StoredProviderCredentialRefreshState.material:type_name -> openshell.v1.StoredProviderCredentialRefreshState.MaterialEntry
	237, // 86: openshell.v1.StoredProviderCredentialRefreshState.additional_output_keys:type_name -> openshell.v1.StoredProviderCredentialRefreshState.AdditionalOutputKeysEntry
	238, // 87: openshell.v1.StoredProviderCredentialRefreshState.secret_material_handles:type_name -> openshell.v1.StoredProviderCredentialRefreshState.SecretMaterialHandlesEntry
	112, // 88: openshell.v1.StoredProviderCredentialRefreshState.pending_secret_deletions:type_name -> openshell.v1.StoredRefreshMaterialDeletion
	7,   // 89: openshell.v1.StoredProviderCredentialRefreshState.recovery_action:type_name -> openshell.v1.ProviderCredentialRefreshRecoveryAction
	256, // 90: openshell.v1.StoredRefreshMaterialDeletion.handle:type_name -> openshell.datamodel.v1.CredentialHandle
	109, // 91: openshell.v1.GetProviderRefreshStatusResponse.credentials:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	2,   // 92: openshell.v1.ConfigureProviderRefreshRequest.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	239, // 93: openshell.v1.ConfigureProviderRefreshRequest.material:type_name -> openshell.v1.ConfigureProviderRefreshRequest.MaterialEntry
	109, // 94: openshell.v1.ConfigureProviderRefreshResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	109, // 95: openshell.v1.RotateProviderCredentialResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	3,   // 96: openshell.v1.ProviderProfile.category:type_name -> openshell.v1.ProviderProfileCategory
	105, // 97: openshell.v1.ProviderProfile.credentials:type_name -> openshell.v1.ProviderProfileCredential
	257, // 98: openshell.v1.ProviderProfile.endpoints:type_name -> openshell.sandbox.v1.NetworkEndpoint
	258, // 99: openshell.v1.ProviderProfile.binaries:type_name -> openshell.sandbox.v1.NetworkBinary
	110, // 100: openshell.v1.ProviderProfile.discovery:type_name -> openshell.v1.ProviderProfileDiscovery
	240, // 101: openshell.v1.ProviderProfile.annotations:type_name -> openshell.v1.ProviderProfile.AnnotationsEntry
	251, // 102: openshell.v1.StoredProviderProfile.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	121, // 103: openshell.v1.StoredProviderProfile.profile:type_name -> openshell.v1.ProviderProfile
	121, // 104: openshell.v1.ProviderProfileResponse.profile:type_name -> openshell.v1.ProviderProfile
	121, // 105: openshell.v1.ListProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	100, // 106: openshell.v1.ImportProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	101, // 107: openshell.v1.ImportProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	121, // 108: openshell.v1.ImportProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	100, // 109: openshell.v1.UpdateProviderProfilesRequest.profile:type_name -> openshell.v1.ProviderProfileImportItem
	101, // 110: openshell.v1.UpdateProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	121, // 111: openshell.v1.UpdateProviderProfilesResponse.profile:type_name -> openshell.v1.ProviderProfile
	100, // 112: openshell.v1.LintProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	101, // 113: openshell.v1.LintProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	135, // 114: openshell.v1.StaticCredentialBinding.endpoints:type_name -> openshell.v1.StaticCredentialEndpointBinding
	...
	242, // 116: openshell.v1.GetSandboxProviderEnvironmentResponse.credential_expires_at_ms:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.CredentialExpiresAtMsEntry
	243, // 117: openshell.v1.GetSandboxProviderEnvironmentResponse.dynamic_credentials:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry
	244, // 118: openshell.v1.GetSandboxProviderEnvironmentResponse.static_credential_bindings:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry
	252, // 119: openshell.v1.UpdateConfigRequest.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	259, // 120: openshell.v1.UpdateConfigRequest.setting_value:type_name -> openshell.sandbox.v1.SettingValue
	141, // 121: openshell.v1.UpdateConfigRequest.merge_operations:type_name -> openshell.v1.PolicyMergeOperation
	245, // 122: openshell.v1.UpdateConfigRequest.annotations:type_name -> openshell.v1.UpdateConfigRequest.AnnotationsEntry
	142, // 123: openshell.v1.PolicyMergeOperation.add_rule:type_name -> openshell.v1.AddNetworkRule
	143, // 124: openshell.v1.PolicyMergeOperation.remove_endpoint:type_name -> openshell.v1.RemoveNetworkEndpoint
	144, // 125: openshell.v1.PolicyMergeOperation.remove_rule:type_name -> openshell.v1.RemoveNetworkRule
	145, // 126: openshell.v1.PolicyMergeOperation.add_deny_rules:type_name -> openshell.v1.AddDenyRules
	146, // 127: openshell.v1.PolicyMergeOperation.add_allow_rules:type_name -> openshell.v1.AddAllowRules
	147, // 128: openshell.v1.PolicyMergeOperation.remove_binary:type_name -> openshell.v1.RemoveNetworkBinary
	260, // 129: openshell.v1.AddNetworkRule.rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	261, // 130: openshell.v1.AddDenyRules.deny_rules:type_name -> openshell.sandbox.v1.L7DenyRule
	262, // 131: openshell.v1.AddAllowRules.rules:type_name -> openshell.sandbox.v1.L7Rule
	246, // 132: openshell.v1.UpdateConfigResponse.annotations:type_name -> openshell.v1.UpdateConfigResponse.AnnotationsEntry
	155, // 133: openshell.v1.GetSandboxPolicyStatusResponse.revision:type_name -> openshell.v1.SandboxPolicyRevision
	155, // 134: openshell.v1.ListSandboxPoliciesResponse.revisions:type_name -> openshell.v1.SandboxPolicyRevision
	4,   // 135: openshell.v1.ReportPolicyStatusRequest.status:type_name -> openshell.v1.PolicyStatus
	4,   // 136: openshell.v1.SandboxPolicyRevision.status:type_name -> openshell.v1.PolicyStatus
	252, // 137: openshell.v1.SandboxPolicyRevision.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	247, // 138: openshell.v1.SandboxPolicyRevision.provenance:type_name -> openshell.v1.SandboxPolicyRevision.ProvenanceEntry
	89,  // 139: openshell.v1.PushSandboxLogsRequest.logs:type_name -> openshell.v1.SandboxLogLine
	89,  // 140: openshell.v1.GetSandboxLogsResponse.logs:type_name -> openshell.v1.SandboxLogLine
	162, // 141: openshell.v1.SupervisorMessage.hello:type_name -> openshell.v1.SupervisorHello
	165, // 142: openshell.v1.SupervisorMessage.heartbeat:type_name -> openshell.v1.SupervisorHeartbeat
	176, // 143: openshell.v1.SupervisorMessage.relay_open_result:type_name -> openshell.v1.RelayOpenResult
	177, // 144: openshell.v1.SupervisorMessage.relay_close:type_name -> openshell.v1.RelayClose
	163, // 145: openshell.v1.GatewayMessage.session_accepted:type_name -> openshell.v1.SessionAccepted
	164, // 146: openshell.v1.GatewayMessage.session_rejected:type_name -> openshell.v1.SessionRejected
	166, // 147: openshell.v1.GatewayMessage.heartbeat:type_name -> openshell.v1.GatewayHeartbeat
	171, // 148: openshell.v1.GatewayMessage.relay_open:type_name -> openshell.v1.RelayOpen
	177, // 149: openshell.v1.GatewayMessage.relay_close:type_name -> openshell.v1.RelayClose
	172, // 150: openshell.v1.RelayOpen.ssh:type_name -> openshell.v1.SshRelayTarget
	173, // 151: openshell.v1.RelayOpen.tcp:type_name -> openshell.v1.TcpRelayTarget
	174, // 152: openshell.v1.RelayFrame.init:type_name -> openshell.v1.RelayInit
	178, // 153: openshell.v1.DenialSummary.l7_request_samples:type_name -> openshell.v1.L7RequestSample
	180, // 154: openshell.v1.NetworkActivitySummary.denials_by_group:type_name -> openshell.v1.DenialGroupCount
	260, // 155: openshell.v1.PolicyChunk.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	252, // 156: openshell.v1.PolicyChunk.current_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	252, // 157: openshell.v1.PolicyChunk.candidate_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	179, // 158: openshell.v1.SubmitPolicyAnalysisRequest.summaries:type_name -> openshell.v1.DenialSummary
	182, // 159: openshell.v1.SubmitPolicyAnalysisRequest.proposed_chunks:type_name -> openshell.v1.PolicyChunk
	181, // 160: openshell.v1.SubmitPolicyAnalysisRequest.network_activity_summaries:type_name -> openshell.v1.NetworkActivitySummary
	182, // 161: openshell.v1.GetDraftPolicyResponse.chunks:type_name -> openshell.v1.PolicyChunk
	192, // 162: openshell.v1.ApproveAllDraftChunksRequest.approvals:type_name -> openshell.v1.DraftChunkApproval
	260, // 163: openshell.v1.EditDraftChunkRequest.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	202, // 164: openshell.v1.GetDraftHistoryResponse.entries:type_name -> openshell.v1.DraftHistoryEntry
	252, // 165: openshell.v1.PolicyRevisionPayload.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	248, // 166: openshell.v1.PolicyRevisionPayload.provenance:type_name -> openshell.v1.PolicyRevisionPayload.ProvenanceEntry
	260, // 167: openshell.v1.DraftChunkPayload.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	252, // 168: openshell.v1.DraftChunkPayload.current_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	252, // 169: openshell.v1.DraftChunkPayload.candidate_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	249, // 170: openshell.v1.StoredPolicyRevision.provenance:type_name -> openshell.v1.StoredPolicyRevision.ProvenanceEntry
	252, // 171: openshell.v1.StoredDraftChunk.current_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	252, // 172: openshell.v1.StoredDraftChunk.candidate_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	250, // 173: openshell.v1.CreateWorkspaceRequest.labels:type_name -> openshell.v1.CreateWorkspaceRequest.LabelsEntry
	263, // 174: openshell.v1.CreateWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	263, // 175: openshell.v1.GetWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	263, // 176: openshell.v1.ListWorkspacesResponse.workspaces:type_name -> openshell.datamodel.v1.Workspace
	251, // 177: openshell.v1.WorkspaceMember.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	6,   // 178: openshell.v1.WorkspaceMember.role:type_name -> openshell.v1.WorkspaceRole
	6,   // 179: openshell.v1.AddWorkspaceMemberRequest.role:type_name -> openshell.v1.WorkspaceRole
	216, // 180: openshell.v1.AddWorkspaceMemberResponse.member:type_name -> openshell.v1.WorkspaceMember
	216, // 181: openshell.v1.ListWorkspaceMembersResponse.members:type_name -> openshell.v1.WorkspaceMember
	256, // 182: openshell.v1.StoredProviderCredentialRefreshState.SecretMaterialHandlesEntry.value:type_name -> openshell.datamodel.v1.CredentialHandle
	105, // 183: openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry.value:type_name -> openshell.v1.ProviderProfileCredential
	136, // 184: openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry.value:type_name -> openshell.v1.StaticCredentialBinding
	...
	41,  // 188: openshell.v1.OpenShell.CreateSandbox:input_type -> openshell.v1.CreateSandboxRequest
	49,  // 189: openshell.v1.OpenShell.BeginRootfsTarStaging:input_type -> openshell.v1.BeginRootfsTarStagingRequest
	51,  // 190: openshell.v1.OpenShell.GetSandbox:input_type -> openshell.v1.GetSandboxRequest
	52,  // 191: openshell.v1.OpenShell.ListSandboxes:input_type -> openshell.v1.ListSandboxesRequest
	42,  // 192: openshell.v1.OpenShell.CreateSandboxTemplate:input_type -> openshell.v1.CreateSandboxTemplateRequest
	43,  // 193: openshell.v1.OpenShell.GetSandboxTemplate:input_type -> openshell.v1.GetSandboxTemplateRequest
	44,  // 194: openshell.v1.OpenShell.ListSandboxTemplates:input_type -> openshell.v1.ListSandboxTemplatesRequest
	45,  // 195: openshell.v1.OpenShell.DeleteSandboxTemplate:input_type -> openshell.v1.DeleteSandboxTemplateRequest
	53,  // 196: openshell.v1.OpenShell.ListSandboxProviders:input_type -> openshell.v1.ListSandboxProvidersRequest
	54,  // 197: openshell.v1.OpenShell.AttachSandboxProvider:input_type -> openshell.v1.AttachSandboxProviderRequest
	55,  // 198: openshell.v1.OpenShell.DetachSandboxProvider:input_type -> openshell.v1.DetachSandboxProviderRequest
	56,  // 199: openshell.v1.OpenShell.DeleteSandbox:input_type -> openshell.v1.DeleteSandboxRequest
	57,  // 200: openshell.v1.OpenShell.StopSandbox:input_type -> openshell.v1.StopSandboxRequest
	58,  // 201: openshell.v1.OpenShell.StartSandbox:input_type -> openshell.v1.StartSandboxRequest
	65,  // 202: openshell.v1.OpenShell.CreateSshSession:input_type -> openshell.v1.CreateSshSessionRequest
	67,  // 203: openshell.v1.OpenShell.ExposeService:input_type -> openshell.v1.ExposeServiceRequest
	68,  // 204: openshell.v1.OpenShell.GetService:input_type -> openshell.v1.GetServiceRequest
	69,  // 205: openshell.v1.OpenShell.ListServices:input_type -> openshell.v1.ListServicesRequest
	71,  // 206: openshell.v1.OpenShell.DeleteService:input_type -> openshell.v1.DeleteServiceRequest
	75,  // 207: openshell.v1.OpenShell.RevokeSshSession:input_type -> openshell.v1.RevokeSshSessionRequest
	77,  // 208: openshell.v1.OpenShell.ExecSandbox:input_type -> openshell.v1.ExecSandboxRequest
	83,  // 209: openshell.v1.OpenShell.ForwardTcp:input_type -> openshell.v1.TcpForwardFrame
	84,  // 210: openshell.v1.OpenShell.ExecSandboxInteractive:input_type -> openshell.v1.ExecSandboxInput
	91,  // 211: openshell.v1.OpenShell.CreateProvider:input_type -> openshell.v1.CreateProviderRequest
	92,  // 212: openshell.v1.OpenShell.GetProvider:input_type -> openshell.v1.GetProviderRequest
	93,  // 213: openshell.v1.OpenShell.ListProviders:input_type -> openshell.v1.ListProvidersRequest
	98,  // 214: openshell.v1.OpenShell.ListProviderProfiles:input_type -> openshell.v1.ListProviderProfilesRequest
	99,  // 215: openshell.v1.OpenShell.GetProviderProfile:input_type -> openshell.v1.GetProviderProfileRequest
	125, // 216: openshell.v1.OpenShell.ImportProviderProfiles:input_type -> openshell.v1.ImportProviderProfilesRequest
	127, // 217: openshell.v1.OpenShell.UpdateProviderProfiles:input_type -> openshell.v1.UpdateProviderProfilesRequest
	129, // 218: openshell.v1.OpenShell.LintProviderProfiles:input_type -> openshell.v1.LintProviderProfilesRequest
	94,  // 219: openshell.v1.OpenShell.UpdateProvider:input_type -> openshell.v1.UpdateProviderRequest
	113, // 220: openshell.v1.OpenShell.GetProviderRefreshStatus:input_type -> openshell.v1.GetProviderRefreshStatusRequest
	115, // 221: openshell.v1.OpenShell.ConfigureProviderRefresh:input_type -> openshell.v1.ConfigureProviderRefreshRequest
	117, // 222: openshell.v1.OpenShell.RotateProviderCredential:input_type -> openshell.v1.RotateProviderCredentialRequest
	119, // 223: openshell.v1.OpenShell.DeleteProviderRefresh:input_type -> openshell.v1.DeleteProviderRefreshRequest
	95,  // 224: openshell.v1.OpenShell.DeleteProvider:input_type -> openshell.v1.DeleteProviderRequest
	132, // 225: openshell.v1.OpenShell.DeleteProviderProfile:input_type -> openshell.v1.DeleteProviderProfileRequest
	264, // 226: openshell.v1.OpenShell.GetSandboxConfig:input_type -> openshell.sandbox.v1.GetSandboxConfigRequest
	265, // 227: openshell.v1.OpenShell.GetGatewayConfig:input_type -> openshell.sandbox.v1.GetGatewayConfigRequest
	140, // 228: openshell.v1.OpenShell.UpdateConfig:input_type -> openshell.v1.UpdateConfigRequest
	149, // 229: openshell.v1.OpenShell.GetSandboxPolicyStatus:input_type -> openshell.v1.GetSandboxPolicyStatusRequest
	151, // 230: openshell.v1.OpenShell.ListSandboxPolicies:input_type -> openshell.v1.ListSandboxPoliciesRequest
	153, // 231: openshell.v1.OpenShell.ReportPolicyStatus:input_type -> openshell.v1.ReportPolicyStatusRequest
	134, // 232: openshell.v1.OpenShell.GetSandboxProviderEnvironment:input_type -> openshell.v1.GetSandboxProviderEnvironmentRequest
	138, // 233: openshell.v1.OpenShell.ExchangeProviderSubjectToken:input_type -> openshell.v1.ExchangeProviderSubjectTokenRequest
	156, // 234: openshell.v1.OpenShell.GetSandboxLogs:input_type -> openshell.v1.GetSandboxLogsRequest
	157, // 235: openshell.v1.OpenShell.PushSandboxLogs:input_type -> openshell.v1.PushSandboxLogsRequest
	160, // 236: openshell.v1.OpenShell.ConnectSupervisor:input_type -> openshell.v1.SupervisorMessage
	167, // 237: openshell.v1.OpenShell.ReportMainProcessExit:input_type -> openshell.v1.ReportMainProcessExitRequest
	169, // 238: openshell.v1.OpenShell.FinalizeMainProcessExit:input_type -> openshell.v1.FinalizeMainProcessExitRequest
	175, // 239: openshell.v1.OpenShell.RelayStream:input_type -> openshell.v1.RelayFrame
	87,  // 240: openshell.v1.OpenShell.WatchSandbox:input_type -> openshell.v1.WatchSandboxRequest
	184, // 241: openshell.v1.OpenShell.SubmitPolicyAnalysis:input_type -> openshell.v1.SubmitPolicyAnalysisRequest
	186, // 242: openshell.v1.OpenShell.GetDraftPolicy:input_type -> openshell.v1.GetDraftPolicyRequest
	188, // 243: openshell.v1.OpenShell.ApproveDraftChunk:input_type -> openshell.v1.ApproveDraftChunkRequest
	190, // 244: openshell.v1.OpenShell.RejectDraftChunk:input_type -> openshell.v1.RejectDraftChunkRequest
	193, // 245: openshell.v1.OpenShell.ApproveAllDraftChunks:input_type -> openshell.v1.ApproveAllDraftChunksRequest
	195, // 246: openshell.v1.OpenShell.EditDraftChunk:input_type -> openshell.v1.EditDraftChunkRequest
	197, // 247: openshell.v1.OpenShell.UndoDraftChunk:input_type -> openshell.v1.UndoDraftChunkRequest
	199, // 248: openshell.v1.OpenShell.ClearDraftChunks:input_type -> openshell.v1.ClearDraftChunksRequest
	201, // 249: openshell.v1.OpenShell.GetDraftHistory:input_type -> openshell.v1.GetDraftHistoryRequest
	8,   // 250: openshell.v1.OpenShell.IssueSandboxToken:input_type -> openshell.v1.IssueSandboxTokenRequest
	10,  // 251: openshell.v1.OpenShell.RegisterSupervisor:input_type -> openshell.v1.RegisterSupervisorRequest
	12,  // 252: openshell.v1.OpenShell.RefreshSandboxToken:input_type -> openshell.v1.RefreshSandboxTokenRequest
	208, // 253: openshell.v1.OpenShell.CreateWorkspace:input_type -> openshell.v1.CreateWorkspaceRequest
	210, // 254: openshell.v1.OpenShell.GetWorkspace:input_type -> openshell.v1.GetWorkspaceRequest
	212, // 255: openshell.v1.OpenShell.ListWorkspaces:input_type -> openshell.v1.ListWorkspacesRequest
	214, // 256: openshell.v1.OpenShell.DeleteWorkspace:input_type -> openshell.v1.DeleteWorkspaceRequest
	217, // 257: openshell.v1.OpenShell.AddWorkspaceMember:input_type -> openshell.v1.AddWorkspaceMemberRequest
	219, // 258: openshell.v1.OpenShell.RemoveWorkspaceMember:input_type -> openshell.v1.RemoveWorkspaceMemberRequest
	221, // 259: openshell.v1.OpenShell.ListWorkspaceMembers:input_type -> openshell.v1.ListWorkspaceMembersRequest
	15,  // 260: openshell.v1.OpenShell.Health:output_type -> openshell.v1.HealthResponse
	17,  // 261: openshell.v1.OpenShell.GetCurrentUser:output_type -> openshell.v1.GetCurrentUserResponse
	19,  // 262: openshell.v1.OpenShell.GetGatewayInfo:output_type -> openshell.v1.GetGatewayInfoResponse
	59,  // 263: openshell.v1.OpenShell.CreateSandbox:output_type -> openshell.v1.SandboxResponse
	50,  // 264: openshell.v1.OpenShell.BeginRootfsTarStaging:output_type -> openshell.v1.BeginRootfsTarStagingResponse
	59,  // 265: openshell.v1.OpenShell.GetSandbox:output_type -> openshell.v1.SandboxResponse
	60,  // 266: openshell.v1.OpenShell.ListSandboxes:output_type -> openshell.v1.ListSandboxesResponse
	46,  // 267: openshell.v1.OpenShell.CreateSandboxTemplate:output_type -> openshell.v1.SandboxTemplateResponse
	46,  // 268: openshell.v1.OpenShell.GetSandboxTemplate:output_type -> openshell.v1.SandboxTemplateResponse
	47,  // 269: openshell.v1.OpenShell.ListSandboxTemplates:output_type -> openshell.v1.ListSandboxTemplatesResponse
	48,  // 270: openshell.v1.OpenShell.DeleteSandboxTemplate:output_type -> openshell.v1.DeleteSandboxTemplateResponse
	61,  // 271: openshell.v1.OpenShell.ListSandboxProviders:output_type -> openshell.v1.ListSandboxProvidersResponse
	62,  // 272: openshell.v1.OpenShell.AttachSandboxProvider:output_type -> openshell.v1.AttachSandboxProviderResponse
	63,  // 273: openshell.v1.OpenShell.DetachSandboxProvider:output_type -> openshell.v1.DetachSandboxProviderResponse
	64,  // 274: openshell.v1.OpenShell.DeleteSandbox:output_type -> openshell.v1.DeleteSandboxResponse
	59,  // 275: openshell.v1.OpenShell.StopSandbox:output_type -> openshell.v1.SandboxResponse
	59,  // 276: openshell.v1.OpenShell.StartSandbox:output_type -> openshell.v1.SandboxResponse
	66,  // 277: openshell.v1.OpenShell.CreateSshSession:output_type -> openshell.v1.CreateSshSessionResponse
	74,  // 278: openshell.v1.OpenShell.ExposeService:output_type -> openshell.v1.ServiceEndpointResponse
	74,  // 279: openshell.v1.OpenShell.GetService:output_type -> openshell.v1.ServiceEndpointResponse
	70,  // 280: openshell.v1.OpenShell.ListServices:output_type -> openshell.v1.ListServicesResponse
	72,  // 281: openshell.v1.OpenShell.DeleteService:output_type -> openshell.v1.DeleteServiceResponse
	76,  // 282: openshell.v1.OpenShell.RevokeSshSession:output_type -> openshell.v1.RevokeSshSessionResponse
	81,  // 283: openshell.v1.OpenShell.ExecSandbox:output_type -> openshell.v1.ExecSandboxEvent
	83,  // 284: openshell.v1.OpenShell.ForwardTcp:output_type -> openshell.v1.TcpForwardFrame
	81,  // 285: openshell.v1.OpenShell.ExecSandboxInteractive:output_type -> openshell.v1.ExecSandboxEvent
	96,  // 286: openshell.v1.OpenShell.CreateProvider:output_type -> openshell.v1.ProviderResponse
	96,  // 287: openshell.v1.OpenShell.GetProvider:output_type -> openshell.v1.ProviderResponse
	97,  // 288: openshell.v1.OpenShell.ListProviders:output_type -> openshell.v1.ListProvidersResponse
	124, // 289: openshell.v1.OpenShell.ListProviderProfiles:output_type -> openshell.v1.ListProviderProfilesResponse
	123, // 290: openshell.v1.OpenShell.GetProviderProfile:output_type -> openshell.v1.ProviderProfileResponse
	126, // 291: openshell.v1.OpenShell.ImportProviderProfiles:output_type -> openshell.v1.ImportProviderProfilesResponse
	128, // 292: openshell.v1.OpenShell.UpdateProviderProfiles:output_type -> openshell.v1.UpdateProviderProfilesResponse
	130, // 293: openshell.v1.OpenShell.LintProviderProfiles:output_type -> openshell.v1.LintProviderProfilesResponse
	96,  // 294: openshell.v1.OpenShell.UpdateProvider:output_type -> openshell.v1.ProviderResponse
	114, // 295: openshell.v1.OpenShell.GetProviderRefreshStatus:output_type -> openshell.v1.GetProviderRefreshStatusResponse
	116, // 296: openshell.v1.OpenShell.ConfigureProviderRefresh:output_type -> openshell.v1.ConfigureProviderRefreshResponse
	118, // 297: openshell.v1.OpenShell.RotateProviderCredential:output_type -> openshell.v1.RotateProviderCredentialResponse
	120, // 298: openshell.v1.OpenShell.DeleteProviderRefresh:output_type -> openshell.v1.DeleteProviderRefreshResponse
	131, // 299: openshell.v1.OpenShell.DeleteProvider:output_type -> openshell.v1.DeleteProviderResponse
	133, // 300: openshell.v1.OpenShell.DeleteProviderProfile:output_type -> openshell.v1.DeleteProviderProfileResponse
	266, // 301: openshell.v1.OpenShell.GetSandboxConfig:output_type -> openshell.sandbox.v1.GetSandboxConfigResponse
	267, // 302: openshell.v1.OpenShell.GetGatewayConfig:output_type -> openshell.sandbox.v1.GetGatewayConfigResponse
	148, // 303: openshell.v1.OpenShell.UpdateConfig:output_type -> openshell.v1.UpdateConfigResponse
	150, // 304: openshell.v1.OpenShell.GetSandboxPolicyStatus:output_type -> openshell.v1.GetSandboxPolicyStatusResponse
	152, // 305: openshell.v1.OpenShell.ListSandboxPolicies:output_type -> openshell.v1.ListSandboxPoliciesResponse
	154, // 306: openshell.v1.OpenShell.ReportPolicyStatus:output_type -> openshell.v1.ReportPolicyStatusResponse
	137, // 307: openshell.v1.OpenShell.GetSandboxProviderEnvironment:output_type -> openshell.v1.GetSandboxProviderEnvironmentResponse
	139, // 308: openshell.v1.OpenShell.ExchangeProviderSubjectToken:output_type -> openshell.v1.ExchangeProviderSubjectTokenResponse
	159, // 309: openshell.v1.OpenShell.GetSandboxLogs:output_type -> openshell.v1.GetSandboxLogsResponse
	158, // 310: openshell.v1.OpenShell.PushSandboxLogs:output_type -> openshell.v1.PushSandboxLogsResponse
	161, // 311: openshell.v1.OpenShell.ConnectSupervisor:output_type -> openshell.v1.GatewayMessage
	168, // 312: openshell.v1.OpenShell.ReportMainProcessExit:output_type -> openshell.v1.ReportMainProcessExitResponse
	170, // 313: openshell.v1.OpenShell.FinalizeMainProcessExit:output_type -> openshell.v1.FinalizeMainProcessExitResponse
	175, // 314: openshell.v1.OpenShell.RelayStream:output_type -> openshell.v1.RelayFrame
	88,  // 315: openshell.v1.OpenShell.WatchSandbox:output_type -> openshell.v1.SandboxStreamEvent
	185, // 316: openshell.v1.OpenShell.SubmitPolicyAnalysis:output_type -> openshell.v1.SubmitPolicyAnalysisResponse
	187, // 317: openshell.v1.OpenShell.GetDraftPolicy:output_type -> openshell.v1.GetDraftPolicyResponse
	189, // 318: openshell.v1.OpenShell.ApproveDraftChunk:output_type -> openshell.v1.ApproveDraftChunkResponse
	191, // 319: openshell.v1.OpenShell.RejectDraftChunk:output_type -> openshell.v1.RejectDraftChunkResponse
	194, // 320: openshell.v1.OpenShell.ApproveAllDraftChunks:output_type -> openshell.v1.ApproveAllDraftChunksResponse
	196, // 321: openshell.v1.OpenShell.EditDraftChunk:output_type -> openshell.v1.EditDraftChunkResponse
	198, // 322: openshell.v1.OpenShell.UndoDraftChunk:output_type -> openshell.v1.UndoDraftChunkResponse
	200, // 323: openshell.v1.OpenShell.ClearDraftChunks:output_type -> openshell.v1.ClearDraftChunksResponse
	203, // 324: openshell.v1.OpenShell.GetDraftHistory:output_type -> openshell.v1.GetDraftHistoryResponse
	9,   // 325: openshell.v1.OpenShell.IssueSandboxToken:output_type -> openshell.v1.IssueSandboxTokenResponse
	11,  // 326: openshell.v1.OpenShell.RegisterSupervisor:output_type -> openshell.v1.SupervisorActivationMessage
	13,  // 327: openshell.v1.OpenShell.RefreshSandboxToken:output_type -> openshell.v1.RefreshSandboxTokenResponse
	209, // 328: openshell.v1.OpenShell.CreateWorkspace:output_type -> openshell.v1.CreateWorkspaceResponse
	211, // 329: openshell.v1.OpenShell.GetWorkspace:output_type -> openshell.v1.GetWorkspaceResponse
	213, // 330: openshell.v1.OpenShell.ListWorkspaces:output_type -> openshell.v1.ListWorkspacesResponse
	215, // 331: openshell.v1.OpenShell.DeleteWorkspace:output_type -> openshell.v1.DeleteWorkspaceResponse
	218, // 332: openshell.v1.OpenShell.AddWorkspaceMember:output_type -> openshell.v1.AddWorkspaceMemberResponse
	220, // 333: openshell.v1.OpenShell.RemoveWorkspaceMember:output_type -> openshell.v1.RemoveWorkspaceMemberResponse
	222, // 334: openshell.v1.OpenShell.ListWorkspaceMembers:output_type -> openshell.v1.ListWorkspaceMembersResponse
...
func file_openshell_proto_init() {
	...
	file_openshell_proto_msgTypes[76].OneofWrappers = []any{
		(*ExecSandboxInput_Start)(nil),
		(*ExecSandboxInput_Stdin)(nil),
		(*ExecSandboxInput_Resize)(nil),
	}
	file_openshell_proto_msgTypes[80].OneofWrappers = []any{
	...
	file_openshell_proto_msgTypes[107].OneofWrappers = []any{}
