...
const (
	...
	// Gateway signs an app JWT and mints a scoped installation access token.
	ProviderCredentialRefreshStrategy_PROVIDER_CREDENTIAL_REFRESH_STRATEGY_GITHUB_APP_INSTALLATION ProviderCredentialRefreshStrategy = 7
)
...
var (
	ProviderCredentialRefreshStrategy_name = map[int32]string{
		...
		7: "PROVIDER_CREDENTIAL_REFRESH_STRATEGY_GITHUB_APP_INSTALLATION",
	}
	ProviderCredentialRefreshStrategy_value = map[string]int32{
		...
		"PROVIDER_CREDENTIAL_REFRESH_STRATEGY_GITHUB_APP_INSTALLATION":    7,
	}
)
...
const file_openshell_proto_rawDesc = "" +
	...
	"<PROVIDER_CREDENTIAL_REFRESH_STRATEGY_GITHUB_APP_INSTALLATION\x10\a*\xdb\x02\n" +
