...
type SandboxDelegatedIdentityRecord struct {
	state             protoimpl.MessageState    `protogen:"open.v1"`
	Metadata          *datamodelv1.ObjectMeta   `protobuf:"bytes,1,opt,name=metadata,proto3" json:"metadata,omitempty"`
	SandboxId         string                    `protobuf:"bytes,2,opt,name=sandbox_id,json=sandboxId,proto3" json:"sandbox_id,omitempty"`
	DelegatedIdentity *SandboxDelegatedIdentity `protobuf:"bytes,3,opt,name=delegated_identity,json=delegatedIdentity,proto3" json:"delegated_identity,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}

func (x *SandboxDelegatedIdentityRecord) Reset() {
	*x = SandboxDelegatedIdentityRecord{}
	mi := &file_openshell_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SandboxDelegatedIdentityRecord) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SandboxDelegatedIdentityRecord) ProtoMessage() {}

func (x *SandboxDelegatedIdentityRecord) ProtoReflect() protoreflect.Message {
	mi := &file_openshell_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SandboxDelegatedIdentityRecord.ProtoReflect.Descriptor instead.
func (*SandboxDelegatedIdentityRecord) Descriptor() ([]byte, []int) {
	return file_openshell_proto_rawDescGZIP(), []int{18}
}

func (x *SandboxDelegatedIdentityRecord) GetMetadata() *datamodelv1.ObjectMeta {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *SandboxDelegatedIdentityRecord) GetSandboxId() string {
	if x != nil {
		return x.SandboxId
	}
	return ""
...
func (x *SandboxDelegatedIdentityRecord) GetDelegatedIdentity() *SandboxDelegatedIdentity {
	if x != nil {
...
type CreateSandboxRequest struct {
	...
	DelegatedIdentity *DelegatedIdentityRequest `protobuf:"bytes,8,opt,name=delegated_identity,json=delegatedIdentity,proto3" json:"delegated_identity,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
type DelegatedIdentityRequest struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	DelegatedUntilMs int64                  `protobuf:"varint,1,opt,name=delegated_until_ms,json=delegatedUntilMs,proto3" json:"delegated_until_ms,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *DelegatedIdentityRequest) GetDelegatedUntilMs() int64 {
	if x != nil {
		return x.DelegatedUntilMs
	}
	return 0
...
func (x *GetSandboxDelegatedIdentityStatusRequest) GetWorkspace() string {
	if x != nil {
		return x.Workspace
	}
	return ""
...
func (x *WithdrawSandboxDelegatedIdentityRequest) GetWorkspace() string {
	if x != nil {
		return x.Workspace
	}
	return ""
...
func (x *ExtendSandboxDelegatedIdentityRequest) GetWorkspace() string {
	if x != nil {
		return x.Workspace
	}
	return ""
...
type CreateSandboxTemplateRequest struct {
	...
	// Workspace for the template. Empty defaults to "default".
	Workspace     string `protobuf:"bytes,2,opt,name=workspace,proto3" json:"workspace,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateSandboxTemplateRequest) GetWorkspace() string {
	if x != nil {
		return x.Workspace
	}
	return ""
...
func (x *GetSandboxTemplateRequest) GetWorkspace() string {
	if x != nil {
		return x.Workspace
	}
	return ""
...
func (x *ListSandboxTemplatesRequest) GetWorkspace() string {
	if x != nil {
		return x.Workspace
	}
	return ""
...
func (x *ListSandboxTemplatesRequest) GetAllWorkspaces() bool {
	if x != nil {
...
func (x *DeleteSandboxTemplateRequest) GetWorkspace() string {
	if x != nil {
		return x.Workspace
	}
	return ""
...
type BeginRootfsTarStagingRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Workspace that will own the sandbox created from this archive. Empty
	// defaults to "default", matching CreateSandboxRequest.workspace.
...
func (x *BeginRootfsTarStagingRequest) GetWorkspace() string {
	if x != nil {
		return x.Workspace
	}
	return ""
...
type DelegatedIdentityCredential struct {
	state                  protoimpl.MessageState  `protogen:"open.v1"`
	Metadata               *datamodelv1.ObjectMeta `protobuf:"bytes,1,opt,name=metadata,proto3" json:"metadata,omitempty"`
	...
	// Delegated OAuth material is stored through the active credential driver.
	// This generic record contains only opaque driver handles under fixed,
	// gateway-owned material names.
	SecretMaterialHandles map[string]*datamodelv1.CredentialHandle `protobuf:"bytes,12,rep,name=secret_material_handles,json=secretMaterialHandles,proto3" json:"secret_material_handles,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Superseded or revoked handles retained until credential-driver cleanup
	// succeeds. Keeping retry references here prevents silent secret orphans
	// across gateway restarts and temporary backend outages.
	PendingSecretDeletions []*StoredRefreshMaterialDeletion `protobuf:"bytes,13,rep,name=pending_secret_deletions,json=pendingSecretDeletions,proto3" json:"pending_secret_deletions,omitempty"`
	// Shared-store lease serializing refresh-token use across gateway replicas.
	RefreshLease  *DelegatedIdentityRefreshLease `protobuf:"bytes,14,opt,name=refresh_lease,json=refreshLease,proto3" json:"refresh_lease,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DelegatedIdentityCredential) Reset() {
	*x = DelegatedIdentityCredential{}
	mi := &file_openshell_proto_msgTypes[117]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DelegatedIdentityCredential) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DelegatedIdentityCredential) ProtoMessage() {}

func (x *DelegatedIdentityCredential) ProtoReflect() protoreflect.Message {
	mi := &file_openshell_proto_msgTypes[117]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DelegatedIdentityCredential.ProtoReflect.Descriptor instead.
func (*DelegatedIdentityCredential) Descriptor() ([]byte, []int) {
	return file_openshell_proto_rawDescGZIP(), []int{117}
}

func (x *DelegatedIdentityCredential) GetMetadata() *datamodelv1.ObjectMeta {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *DelegatedIdentityCredential) GetIssuer() string {
	if x != nil {
		return x.Issuer
	}
	return ""
...
func (x *DelegatedIdentityCredential) GetClientId() string {
	if x != nil {
		return x.ClientId
	}
	return ""
...
func (x *DelegatedIdentityCredential) GetPrincipalSubject() string {
	if x != nil {
		return x.PrincipalSubject
	}
	return ""
...
func (x *DelegatedIdentityCredential) GetAccessTokenExpiresAtMs() int64 {
	if x != nil {
...
func (x *DelegatedIdentityCredential) GetScopes() string {
	if x != nil {
		return x.Scopes
	}
	return ""
...
func (x *DelegatedIdentityCredential) GetAudience() string {
	if x != nil {
		return x.Audience
	}
	return ""
...
func (x *DelegatedIdentityCredential) GetLastRefreshAtMs() int64 {
	if x != nil {
		return x.LastRefreshAtMs
	}
	return 0
...
func (x *DelegatedIdentityCredential) GetRevokedAtMs() int64 {
	if x != nil {
...
func (x *DelegatedIdentityCredential) GetSecretMaterialHandles() map[string]*datamodelv1.CredentialHandle {
	if x != nil {
		return x.SecretMaterialHandles
	}
	return nil
...
func (x *DelegatedIdentityCredential) GetPendingSecretDeletions() []*StoredRefreshMaterialDeletion {
	if x != nil {
		return x.PendingSecretDeletions
	}
	return nil
...
func (x *DelegatedIdentityCredential) GetRefreshLease() *DelegatedIdentityRefreshLease {
	if x != nil {
		return x.RefreshLease
	}
	return nil
}

type DelegatedIdentityRefreshLease struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *DelegatedIdentityRefreshLease) Reset() {
	*x = DelegatedIdentityRefreshLease{}
	mi := &file_openshell_proto_msgTypes[118]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DelegatedIdentityRefreshLease) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DelegatedIdentityRefreshLease) ProtoMessage() {}

func (x *DelegatedIdentityRefreshLease) ProtoReflect() protoreflect.Message {
	mi := &file_openshell_proto_msgTypes[118]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DelegatedIdentityRefreshLease.ProtoReflect.Descriptor instead.
func (*DelegatedIdentityRefreshLease) Descriptor() ([]byte, []int) {
	return file_openshell_proto_rawDescGZIP(), []int{118}
}

func (x *DelegatedIdentityRefreshLease) GetOwnerId() string {
	if x != nil {
		return x.OwnerId
	}
	return ""
...
func (x *DelegatedIdentityRefreshLease) GetExpiresAtMs() int64 {
	if x != nil {
		return x.ExpiresAtMs
	}
	return 0
...
func (x *ListDelegatedIdentityCredentialsRequest) GetLimit() uint32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *ListDelegatedIdentityCredentialsRequest) GetOffset() uint32 {
	if x != nil {
		return x.Offset
	}
	return 0
...
const file_openshell_proto_rawDesc = "" +
	...
	"\x16workload_template_name\x18\a \x01(\tR\x14workloadTemplateName\x12U\n" +
	"\x12delegated_identity\x18\b \x01(\v2&.openshell.v1.DelegatedIdentityRequestR\x11delegatedIdentity\x1a9\n" +
	"\vLabelsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01\x1a>\n" +
	"\x10AnnotationsEntry\x12\x10\n" +
	...
	"\x12delegated_until_ms\x18\x01 \x01(\x03R\x10delegatedUntilMsJ\x04\b\x02\x10\x03J\x04\b\x03\x10\x04J\x04\b\x04\x10\x05J\x04\b\x05\x10\x06J\x04\b\x06\x10\aJ\x04\b\a\x10\bJ\x04\b\b\x10\tR\x06issuerR\tclient_idR\rrefresh_tokenR\faccess_tokenR\x1aaccess_token_expires_at_msR\x06scopesR\baudience\"\xe2\x01\n" +
	...
	"\asandbox\x18\x01 \x01(\v2\x15.openshell.v1.SandboxR\asandbox\"\x7f\n" +
	...
	"\x06handle\x18\x02 \x01(\v2(.openshell.datamodel.v1.CredentialHandleR\x06handle\"\xd4\x06\n" +
	...
	"\rrevoked_at_ms\x18\v \x01(\x03R\vrevokedAtMs\x12|\n" +
	"\x17secret_material_handles\x18\f \x03(\v2D.openshell.v1.DelegatedIdentityCredential.SecretMaterialHandlesEntryR\x15secretMaterialHandles\x12e\n" +
	"\x18pending_secret_deletions\x18\r \x03(\v2+.openshell.v1.StoredRefreshMaterialDeletionR\x16pendingSecretDeletions\x12P\n" +
	"\rrefresh_lease\x18\x0e \x01(\v2+.openshell.v1.DelegatedIdentityRefreshLeaseR\frefreshLease\x1ar\n" +
	"\x1aSecretMaterialHandlesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12>\n" +
	"\x05value\x18\x02 \x01(\v2(.openshell.datamodel.v1.CredentialHandleR\x05value:\x028\x01J\x04\b\x05\x10\x06J\x04\b\x06\x10\aR\rrefresh_tokenR\faccess_token\"^\n" +
	"\x1dDelegatedIdentityRefreshLease\x12\x19\n" +
	"\bowner_id\x18\x01 \x01(\tR\aownerId\x12\"\n" +
	"\rexpires_at_ms\x18\x02 \x01(\x03R\vexpiresAtMs\"\xed\x03\n" +
	...
	"7PROVIDER_CREDENTIAL_REFRESH_RECOVERY_ACTION_INVESTIGATE\x10\x042\xabZ\n" +
	"\tOpenShell\x12Z\n" +
...
var file_openshell_proto_goTypes = []any{
	...
	(*SandboxDelegatedIdentity)(nil),                        // 25: openshell.v1.SandboxDelegatedIdentity
	(*SandboxDelegatedIdentityRecord)(nil),                  // 26: openshell.v1.SandboxDelegatedIdentityRecord
	...
	(*StoredProviderCredentialRefreshState)(nil),            // 123: openshell.v1.StoredProviderCredentialRefreshState
	(*StoredRefreshMaterialDeletion)(nil),                   // 124: openshell.v1.StoredRefreshMaterialDeletion
	(*DelegatedIdentityCredential)(nil),                     // 125: openshell.v1.DelegatedIdentityCredential
	(*DelegatedIdentityRefreshLease)(nil),                   // 126: openshell.v1.DelegatedIdentityRefreshLease
	(*DelegatedIdentityCredentialSummary)(nil),              // 127: openshell.v1.DelegatedIdentityCredentialSummary
	(*ListDelegatedIdentityCredentialsRequest)(nil),         // 128: openshell.v1.ListDelegatedIdentityCredentialsRequest
	(*ListDelegatedIdentityCredentialsResponse)(nil),        // 129: openshell.v1.ListDelegatedIdentityCredentialsResponse
	(*GetDelegatedIdentityCredentialStatusRequest)(nil),     // 130: openshell.v1.GetDelegatedIdentityCredentialStatusRequest
	(*GetDelegatedIdentityCredentialStatusResponse)(nil),    // 131: openshell.v1.GetDelegatedIdentityCredentialStatusResponse
	(*RevokeDelegatedIdentityCredentialRequest)(nil),        // 132: openshell.v1.RevokeDelegatedIdentityCredentialRequest
	(*RevokeDelegatedIdentityCredentialResponse)(nil),       // 133: openshell.v1.RevokeDelegatedIdentityCredentialResponse
	(*DeleteDelegatedIdentityCredentialRequest)(nil),        // 134: openshell.v1.DeleteDelegatedIdentityCredentialRequest
	(*DeleteDelegatedIdentityCredentialResponse)(nil),       // 135: openshell.v1.DeleteDelegatedIdentityCredentialResponse
	...
	(*StoredProviderProfile)(nil),                           // 145: openshell.v1.StoredProviderProfile
	...
	(*AddDenyRules)(nil),                                    // 168: openshell.v1.AddDenyRules
	(*AddAllowRules)(nil),                                   // 169: openshell.v1.AddAllowRules
	(*RemoveNetworkBinary)(nil),                             // 170: openshell.v1.RemoveNetworkBinary
	(*UpdateConfigResponse)(nil),                            // 171: openshell.v1.UpdateConfigResponse
	(*GetSandboxPolicyStatusRequest)(nil),                   // 172: openshell.v1.GetSandboxPolicyStatusRequest
	(*GetSandboxPolicyStatusResponse)(nil),                  // 173: openshell.v1.GetSandboxPolicyStatusResponse
	(*ListSandboxPoliciesRequest)(nil),                      // 174: openshell.v1.ListSandboxPoliciesRequest
	(*ListSandboxPoliciesResponse)(nil),                     // 175: openshell.v1.ListSandboxPoliciesResponse
	(*ReportPolicyStatusRequest)(nil),                       // 176: openshell.v1.ReportPolicyStatusRequest
	(*ReportPolicyStatusResponse)(nil),                      // 177: openshell.v1.ReportPolicyStatusResponse
	...
	(*PolicyRevisionPayload)(nil),                           // 227: openshell.v1.PolicyRevisionPayload
	(*DraftChunkPayload)(nil),                               // 228: openshell.v1.DraftChunkPayload
	(*StoredPolicyRevision)(nil),                            // 229: openshell.v1.StoredPolicyRevision
	(*StoredDraftChunk)(nil),                                // 230: openshell.v1.StoredDraftChunk
	...
	nil,                                                     // 247: openshell.v1.SandboxSpec.EnvironmentEntry
	nil,                                                     // 248: openshell.v1.SandboxTemplate.LabelsEntry
	nil,                                                     // 249: openshell.v1.SandboxTemplate.AnnotationsEntry
	nil,                                                     // 250: openshell.v1.SandboxTemplate.EnvironmentEntry
	nil,                                                     // 251: openshell.v1.SandboxWorkloadConfig.EnvironmentEntry
	nil,                                                     // 252: openshell.v1.PlatformEvent.MetadataEntry
	nil,                                                     // 253: openshell.v1.CreateSandboxRequest.LabelsEntry
	nil,                                                     // 254: openshell.v1.CreateSandboxRequest.AnnotationsEntry
	nil,                                                     // 255: openshell.v1.ExecSandboxRequest.EnvironmentEntry
	nil,                                                     // 256: openshell.v1.SandboxLogLine.FieldsEntry
	nil,                                                     // 257: openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	nil,                                                     // 258: openshell.v1.StoredProviderCredentialRefreshState.MaterialEntry
	nil,                                                     // 259: openshell.v1.StoredProviderCredentialRefreshState.AdditionalOutputKeysEntry
	nil,                                                     // 260: openshell.v1.StoredProviderCredentialRefreshState.SecretMaterialHandlesEntry
	nil,                                                     // 261: openshell.v1.DelegatedIdentityCredential.SecretMaterialHandlesEntry
	...
	nil,                                                     // 265: openshell.v1.GetSandboxProviderEnvironmentResponse.CredentialExpiresAtMsEntry
	...
	nil,                                                     // 271: openshell.v1.PolicyRevisionPayload.ProvenanceEntry
	nil,                                                     // 272: openshell.v1.StoredPolicyRevision.ProvenanceEntry
	...
	(*datamodelv1.CredentialHandle)(nil),                    // 279: openshell.datamodel.v1.CredentialHandle
...
var file_openshell_proto_depIdxs = []int32{
	246, // 0: openshell.v1.RefreshSandboxTokenResponse.extension_credentials:type_name -> openshell.v1.ExtensionServiceCredential
	...
	274, // 9: openshell.v1.Sandbox.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	...
	274, // 13: openshell.v1.SandboxDelegatedIdentityRecord.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	25,  // 14: openshell.v1.SandboxDelegatedIdentityRecord.delegated_identity:type_name -> openshell.v1.SandboxDelegatedIdentity
	247, // 15: openshell.v1.SandboxSpec.environment:type_name -> openshell.v1.SandboxSpec.EnvironmentEntry
	30,  // 16: openshell.v1.SandboxSpec.template:type_name -> openshell.v1.SandboxTemplate
	275, // 17: openshell.v1.SandboxSpec.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	28,  // 18: openshell.v1.SandboxSpec.resource_requirements:type_name -> openshell.v1.ResourceRequirements
	29,  // 19: openshell.v1.ResourceRequirements.gpu:type_name -> openshell.v1.GpuResourceRequirements
	248, // 20: openshell.v1.SandboxTemplate.labels:type_name -> openshell.v1.SandboxTemplate.LabelsEntry
	249, // 21: openshell.v1.SandboxTemplate.annotations:type_name -> openshell.v1.SandboxTemplate.AnnotationsEntry
	250, // 22: openshell.v1.SandboxTemplate.environment:type_name -> openshell.v1.SandboxTemplate.EnvironmentEntry
	276, // 23: openshell.v1.SandboxTemplate.resources:type_name -> google.protobuf.Struct
	276, // 24: openshell.v1.SandboxTemplate.driver_config:type_name -> google.protobuf.Struct
	274, // 25: openshell.v1.SandboxWorkloadTemplate.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	32,  // 26: openshell.v1.SandboxWorkloadTemplate.spec:type_name -> openshell.v1.SandboxWorkloadTemplateSpec
	33,  // 27: openshell.v1.SandboxWorkloadTemplateSpec.workload:type_name -> openshell.v1.SandboxWorkloadConfig
	276, // 28: openshell.v1.SandboxWorkloadTemplateSpec.driver_config:type_name -> google.protobuf.Struct
	35,  // 29: openshell.v1.SandboxWorkloadTemplateSpec.desired_service_level:type_name -> openshell.v1.SandboxServiceLevel
	251, // 30: openshell.v1.SandboxWorkloadConfig.environment:type_name -> openshell.v1.SandboxWorkloadConfig.EnvironmentEntry
	34,  // 31: openshell.v1.SandboxWorkloadConfig.resources:type_name -> openshell.v1.SandboxResources
	29,  // 32: openshell.v1.SandboxResources.gpu:type_name -> openshell.v1.GpuResourceRequirements
	36,  // 33: openshell.v1.SandboxServiceLevel.startup:type_name -> openshell.v1.SandboxStartup
	277, // 34: openshell.v1.SandboxStartup.ready_within:type_name -> google.protobuf.Duration
	39,  // 35: openshell.v1.SandboxStatus.conditions:type_name -> openshell.v1.SandboxCondition
	0,   // 36: openshell.v1.SandboxStatus.phase:type_name -> openshell.v1.SandboxPhase
	252, // 37: openshell.v1.PlatformEvent.metadata:type_name -> openshell.v1.PlatformEvent.MetadataEntry
	27,  // 38: openshell.v1.CreateSandboxRequest.spec:type_name -> openshell.v1.SandboxSpec
	253, // 39: openshell.v1.CreateSandboxRequest.labels:type_name -> openshell.v1.CreateSandboxRequest.LabelsEntry
	254, // 40: openshell.v1.CreateSandboxRequest.annotations:type_name -> openshell.v1.CreateSandboxRequest.AnnotationsEntry
	42,  // 41: openshell.v1.CreateSandboxRequest.delegated_identity:type_name -> openshell.v1.DelegatedIdentityRequest
	127, // 42: openshell.v1.GetDelegatedIdentityAuthorizationStatusResponse.credential:type_name -> openshell.v1.DelegatedIdentityCredentialSummary
	43,  // 43: openshell.v1.AuthorizeDelegatedIdentityRequest.grant:type_name -> openshell.v1.DelegatedIdentityAuthorizationGrant
	127, // 44: openshell.v1.AuthorizeDelegatedIdentityResponse.credential:type_name -> openshell.v1.DelegatedIdentityCredentialSummary
	25,  // 45: openshell.v1.GetSandboxDelegatedIdentityStatusResponse.delegated_identity:type_name -> openshell.v1.SandboxDelegatedIdentity
	24,  // 46: openshell.v1.WithdrawSandboxDelegatedIdentityResponse.sandbox:type_name -> openshell.v1.Sandbox
	42,  // 47: openshell.v1.ExtendSandboxDelegatedIdentityRequest.delegated_identity:type_name -> openshell.v1.DelegatedIdentityRequest
	24,  // 48: openshell.v1.ExtendSandboxDelegatedIdentityResponse.sandbox:type_name -> openshell.v1.Sandbox
	31,  // 49: openshell.v1.CreateSandboxTemplateRequest.template:type_name -> openshell.v1.SandboxWorkloadTemplate
	31,  // 50: openshell.v1.SandboxTemplateResponse.template:type_name -> openshell.v1.SandboxWorkloadTemplate
	31,  // 51: openshell.v1.ListSandboxTemplatesResponse.templates:type_name -> openshell.v1.SandboxWorkloadTemplate
	24,  // 52: openshell.v1.SandboxResponse.sandbox:type_name -> openshell.v1.Sandbox
	24,  // 53: openshell.v1.ListSandboxesResponse.sandboxes:type_name -> openshell.v1.Sandbox
	278, // 54: openshell.v1.ListSandboxProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	24,  // 55: openshell.v1.AttachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	24,  // 56: openshell.v1.DetachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	86,  // 57: openshell.v1.ListServicesResponse.services:type_name -> openshell.v1.ServiceEndpointResponse
	274, // 58: openshell.v1.ServiceEndpoint.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	85,  // 59: openshell.v1.ServiceEndpointResponse.endpoint:type_name -> openshell.v1.ServiceEndpoint
	255, // 60: openshell.v1.ExecSandboxRequest.environment:type_name -> openshell.v1.ExecSandboxRequest.EnvironmentEntry
	90,  // 61: openshell.v1.ExecSandboxEvent.stdout:type_name -> openshell.v1.ExecSandboxStdout
	91,  // 62: openshell.v1.ExecSandboxEvent.stderr:type_name -> openshell.v1.ExecSandboxStderr
	92,  // 63: openshell.v1.ExecSandboxEvent.exit:type_name -> openshell.v1.ExecSandboxExit
	195, // 64: openshell.v1.TcpForwardInit.ssh:type_name -> openshell.v1.SshRelayTarget
	196, // 65: openshell.v1.TcpForwardInit.tcp:type_name -> openshell.v1.TcpRelayTarget
	94,  // 66: openshell.v1.TcpForwardFrame.init:type_name -> openshell.v1.TcpForwardInit
	89,  // 67: openshell.v1.ExecSandboxInput.start:type_name -> openshell.v1.ExecSandboxRequest
	97,  // 68: openshell.v1.ExecSandboxInput.resize:type_name -> openshell.v1.ExecSandboxWindowResize
	274, // 69: openshell.v1.SshSession.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	24,  // 70: openshell.v1.SandboxStreamEvent.sandbox:type_name -> openshell.v1.Sandbox
	101, // 71: openshell.v1.SandboxStreamEvent.log:type_name -> openshell.v1.SandboxLogLine
	40,  // 72: openshell.v1.SandboxStreamEvent.event:type_name -> openshell.v1.PlatformEvent
	102, // 73: openshell.v1.SandboxStreamEvent.warning:type_name -> openshell.v1.SandboxStreamWarning
	206, // 74: openshell.v1.SandboxStreamEvent.draft_policy_update:type_name -> openshell.v1.DraftPolicyUpdate
	256, // 75: openshell.v1.SandboxLogLine.fields:type_name -> openshell.v1.SandboxLogLine.FieldsEntry
	278, // 76: openshell.v1.CreateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	278, // 77: openshell.v1.UpdateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	257, // 78: openshell.v1.UpdateProviderRequest.credential_expires_at_ms:type_name -> openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	278, // 79: openshell.v1.ProviderResponse.provider:type_name -> openshell.datamodel.v1.Provider
	278, // 80: openshell.v1.ListProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	144, // 81: openshell.v1.ProviderProfileImportItem.profile:type_name -> openshell.v1.ProviderProfile
	114, // 82: openshell.v1.ProviderCredentialTokenGrant.audience_overrides:type_name -> openshell.v1.ProviderCredentialTokenGrantAudienceOverride
	1,   // 83: openshell.v1.ProviderCredentialTokenGrant.grant_type:type_name -> openshell.v1.ProviderCredentialTokenGrantType
	115, // 84: openshell.v1.ProviderCredentialTokenGrant.subject_token:type_name -> openshell.v1.ProviderCredentialTokenGrantSubjectToken
	120, // 85: openshell.v1.ProviderProfileCredential.refresh:type_name -> openshell.v1.ProviderCredentialRefresh
	116, // 86: openshell.v1.ProviderProfileCredential.token_grant:type_name -> openshell.v1.ProviderCredentialTokenGrant
	2,   // 87: openshell.v1.ProviderCredentialRefresh.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	118, // 88: openshell.v1.ProviderCredentialRefresh.material:type_name -> openshell.v1.ProviderCredentialRefreshMaterial
	119, // 89: openshell.v1.ProviderCredentialRefresh.additional_outputs:type_name -> openshell.v1.ProviderCredentialRefreshOutput
	2,   // 90: openshell.v1.ProviderCredentialRefreshStatus.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	7,   // 91: openshell.v1.ProviderCredentialRefreshStatus.recovery_action:type_name -> openshell.v1.ProviderCredentialRefreshRecoveryAction
	274, // 92: openshell.v1.StoredProviderCredentialRefreshState.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	2,   // 93: openshell.v1.StoredProviderCredentialRefreshState.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	258, // 94: openshell.v1.StoredProviderCredentialRefreshState.material:type_name -> openshell.v1.StoredProviderCredentialRefreshState.MaterialEntry
	259, // 95: openshell.v1.StoredProviderCredentialRefreshState.additional_output_keys:type_name -> openshell.v1.StoredProviderCredentialRefreshState.AdditionalOutputKeysEntry
	260, // 96: openshell.v1.StoredProviderCredentialRefreshState.secret_material_handles:type_name -> openshell.v1.StoredProviderCredentialRefreshState.SecretMaterialHandlesEntry
	124, // 97: openshell.v1.StoredProviderCredentialRefreshState.pending_secret_deletions:type_name -> openshell.v1.StoredRefreshMaterialDeletion
	7,   // 98: openshell.v1.StoredProviderCredentialRefreshState.recovery_action:type_name -> openshell.v1.ProviderCredentialRefreshRecoveryAction
	279, // 99: openshell.v1.StoredRefreshMaterialDeletion.handle:type_name -> openshell.datamodel.v1.CredentialHandle
	274, // 100: openshell.v1.DelegatedIdentityCredential.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	261, // 101: openshell.v1.DelegatedIdentityCredential.secret_material_handles:type_name -> openshell.v1.DelegatedIdentityCredential.SecretMaterialHandlesEntry
	124, // 102: openshell.v1.DelegatedIdentityCredential.pending_secret_deletions:type_name -> openshell.v1.StoredRefreshMaterialDeletion
	126, // 103: openshell.v1.DelegatedIdentityCredential.refresh_lease:type_name -> openshell.v1.DelegatedIdentityRefreshLease
	274, // 104: openshell.v1.DelegatedIdentityCredentialSummary.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	127, // 105: openshell.v1.ListDelegatedIdentityCredentialsResponse.credentials:type_name -> openshell.v1.DelegatedIdentityCredentialSummary
	127, // 106: openshell.v1.GetDelegatedIdentityCredentialStatusResponse.credential:type_name -> openshell.v1.DelegatedIdentityCredentialSummary
	121, // 107: openshell.v1.GetProviderRefreshStatusResponse.credentials:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	2,   // 108: openshell.v1.ConfigureProviderRefreshRequest.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	262, // 109: openshell.v1.ConfigureProviderRefreshRequest.material:type_name -> openshell.v1.ConfigureProviderRefreshRequest.MaterialEntry
	121, // 110: openshell.v1.ConfigureProviderRefreshResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	121, // 111: openshell.v1.RotateProviderCredentialResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	3,   // 112: openshell.v1.ProviderProfile.category:type_name -> openshell.v1.ProviderProfileCategory
	117, // 113: openshell.v1.ProviderProfile.credentials:type_name -> openshell.v1.ProviderProfileCredential
	280, // 114: openshell.v1.ProviderProfile.endpoints:type_name -> openshell.sandbox.v1.NetworkEndpoint
	281, // 115: openshell.v1.ProviderProfile.binaries:type_name -> openshell.sandbox.v1.NetworkBinary
	122, // 116: openshell.v1.ProviderProfile.discovery:type_name -> openshell.v1.ProviderProfileDiscovery
	263, // 117: openshell.v1.ProviderProfile.annotations:type_name -> openshell.v1.ProviderProfile.AnnotationsEntry
	274, // 118: openshell.v1.StoredProviderProfile.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	144, // 119: openshell.v1.StoredProviderProfile.profile:type_name -> openshell.v1.ProviderProfile
	144, // 120: openshell.v1.ProviderProfileResponse.profile:type_name -> openshell.v1.ProviderProfile
	144, // 121: openshell.v1.ListProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	112, // 122: openshell.v1.ImportProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	113, // 123: openshell.v1.ImportProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	144, // 124: openshell.v1.ImportProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	112, // 125: openshell.v1.UpdateProviderProfilesRequest.profile:type_name -> openshell.v1.ProviderProfileImportItem
	113, // 126: openshell.v1.UpdateProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	144, // 127: openshell.v1.UpdateProviderProfilesResponse.profile:type_name -> openshell.v1.ProviderProfile
	112, // 128: openshell.v1.LintProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	113, // 129: openshell.v1.LintProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	158, // 130: openshell.v1.StaticCredentialBinding.endpoints:type_name -> openshell.v1.StaticCredentialEndpointBinding
	264, // 131: openshell.v1.GetSandboxProviderEnvironmentResponse.environment:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.EnvironmentEntry
	265, // 132: openshell.v1.GetSandboxProviderEnvironmentResponse.credential_expires_at_ms:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.CredentialExpiresAtMsEntry
	266, // 133: openshell.v1.GetSandboxProviderEnvironmentResponse.dynamic_credentials:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry
	267, // 134: openshell.v1.GetSandboxProviderEnvironmentResponse.static_credential_bindings:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry
	275, // 135: openshell.v1.UpdateConfigRequest.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	282, // 136: openshell.v1.UpdateConfigRequest.setting_value:type_name -> openshell.sandbox.v1.SettingValue
	164, // 137: openshell.v1.UpdateConfigRequest.merge_operations:type_name -> openshell.v1.PolicyMergeOperation
	268, // 138: openshell.v1.UpdateConfigRequest.annotations:type_name -> openshell.v1.UpdateConfigRequest.AnnotationsEntry
	165, // 139: openshell.v1.PolicyMergeOperation.add_rule:type_name -> openshell.v1.AddNetworkRule
	166, // 140: openshell.v1.PolicyMergeOperation.remove_endpoint:type_name -> openshell.v1.RemoveNetworkEndpoint
	167, // 141: openshell.v1.PolicyMergeOperation.remove_rule:type_name -> openshell.v1.RemoveNetworkRule
	168, // 142: openshell.v1.PolicyMergeOperation.add_deny_rules:type_name -> openshell.v1.AddDenyRules
	169, // 143: openshell.v1.PolicyMergeOperation.add_allow_rules:type_name -> openshell.v1.AddAllowRules
	170, // 144: openshell.v1.PolicyMergeOperation.remove_binary:type_name -> openshell.v1.RemoveNetworkBinary
	283, // 145: openshell.v1.AddNetworkRule.rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	284, // 146: openshell.v1.AddDenyRules.deny_rules:type_name -> openshell.sandbox.v1.L7DenyRule
	285, // 147: openshell.v1.AddAllowRules.rules:type_name -> openshell.sandbox.v1.L7Rule
	269, // 148: openshell.v1.UpdateConfigResponse.annotations:type_name -> openshell.v1.UpdateConfigResponse.AnnotationsEntry
	178, // 149: openshell.v1.GetSandboxPolicyStatusResponse.revision:type_name -> openshell.v1.SandboxPolicyRevision
	178, // 150: openshell.v1.ListSandboxPoliciesResponse.revisions:type_name -> openshell.v1.SandboxPolicyRevision
	4,   // 151: openshell.v1.ReportPolicyStatusRequest.status:type_name -> openshell.v1.PolicyStatus
	4,   // 152: openshell.v1.SandboxPolicyRevision.status:type_name -> openshell.v1.PolicyStatus
	275, // 153: openshell.v1.SandboxPolicyRevision.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	270, // 154: openshell.v1.SandboxPolicyRevision.provenance:type_name -> openshell.v1.SandboxPolicyRevision.ProvenanceEntry
	101, // 155: openshell.v1.PushSandboxLogsRequest.logs:type_name -> openshell.v1.SandboxLogLine
	101, // 156: openshell.v1.GetSandboxLogsResponse.logs:type_name -> openshell.v1.SandboxLogLine
	185, // 157: openshell.v1.SupervisorMessage.hello:type_name -> openshell.v1.SupervisorHello
	188, // 158: openshell.v1.SupervisorMessage.heartbeat:type_name -> openshell.v1.SupervisorHeartbeat
	199, // 159: openshell.v1.SupervisorMessage.relay_open_result:type_name -> openshell.v1.RelayOpenResult
	200, // 160: openshell.v1.SupervisorMessage.relay_close:type_name -> openshell.v1.RelayClose
	186, // 161: openshell.v1.GatewayMessage.session_accepted:type_name -> openshell.v1.SessionAccepted
	187, // 162: openshell.v1.GatewayMessage.session_rejected:type_name -> openshell.v1.SessionRejected
	189, // 163: openshell.v1.GatewayMessage.heartbeat:type_name -> openshell.v1.GatewayHeartbeat
	194, // 164: openshell.v1.GatewayMessage.relay_open:type_name -> openshell.v1.RelayOpen
	200, // 165: openshell.v1.GatewayMessage.relay_close:type_name -> openshell.v1.RelayClose
	195, // 166: openshell.v1.RelayOpen.ssh:type_name -> openshell.v1.SshRelayTarget
	196, // 167: openshell.v1.RelayOpen.tcp:type_name -> openshell.v1.TcpRelayTarget
	197, // 168: openshell.v1.RelayFrame.init:type_name -> openshell.v1.RelayInit
	201, // 169: openshell.v1.DenialSummary.l7_request_samples:type_name -> openshell.v1.L7RequestSample
	203, // 170: openshell.v1.NetworkActivitySummary.denials_by_group:type_name -> openshell.v1.DenialGroupCount
	283, // 171: openshell.v1.PolicyChunk.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	275, // 172: openshell.v1.PolicyChunk.current_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	275, // 173: openshell.v1.PolicyChunk.candidate_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	202, // 174: openshell.v1.SubmitPolicyAnalysisRequest.summaries:type_name -> openshell.v1.DenialSummary
	205, // 175: openshell.v1.SubmitPolicyAnalysisRequest.proposed_chunks:type_name -> openshell.v1.PolicyChunk
	204, // 176: openshell.v1.SubmitPolicyAnalysisRequest.network_activity_summaries:type_name -> openshell.v1.NetworkActivitySummary
	205, // 177: openshell.v1.GetDraftPolicyResponse.chunks:type_name -> openshell.v1.PolicyChunk
	215, // 178: openshell.v1.ApproveAllDraftChunksRequest.approvals:type_name -> openshell.v1.DraftChunkApproval
	283, // 179: openshell.v1.EditDraftChunkRequest.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	225, // 180: openshell.v1.GetDraftHistoryResponse.entries:type_name -> openshell.v1.DraftHistoryEntry
	275, // 181: openshell.v1.PolicyRevisionPayload.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	271, // 182: openshell.v1.PolicyRevisionPayload.provenance:type_name -> openshell.v1.PolicyRevisionPayload.ProvenanceEntry
	283, // 183: openshell.v1.DraftChunkPayload.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	275, // 184: openshell.v1.DraftChunkPayload.current_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	275, // 185: openshell.v1.DraftChunkPayload.candidate_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	272, // 186: openshell.v1.StoredPolicyRevision.provenance:type_name -> openshell.v1.StoredPolicyRevision.ProvenanceEntry
	275, // 187: openshell.v1.StoredDraftChunk.current_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	275, // 188: openshell.v1.StoredDraftChunk.candidate_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	273, // 189: openshell.v1.CreateWorkspaceRequest.labels:type_name -> openshell.v1.CreateWorkspaceRequest.LabelsEntry
	286, // 190: openshell.v1.CreateWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	286, // 191: openshell.v1.GetWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	286, // 192: openshell.v1.ListWorkspacesResponse.workspaces:type_name -> openshell.datamodel.v1.Workspace
	274, // 193: openshell.v1.WorkspaceMember.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	6,   // 194: openshell.v1.WorkspaceMember.role:type_name -> openshell.v1.WorkspaceRole
	6,   // 195: openshell.v1.AddWorkspaceMemberRequest.role:type_name -> openshell.v1.WorkspaceRole
	239, // 196: openshell.v1.AddWorkspaceMemberResponse.member:type_name -> openshell.v1.WorkspaceMember
	239, // 197: openshell.v1.ListWorkspaceMembersResponse.members:type_name -> openshell.v1.WorkspaceMember
	279, // 198: openshell.v1.StoredProviderCredentialRefreshState.SecretMaterialHandlesEntry.value:type_name -> openshell.datamodel.v1.CredentialHandle
	279, // 199: openshell.v1.DelegatedIdentityCredential.SecretMaterialHandlesEntry.value:type_name -> openshell.datamodel.v1.CredentialHandle
	117, // 200: openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry.value:type_name -> openshell.v1.ProviderProfileCredential
	159, // 201: openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry.value:type_name -> openshell.v1.StaticCredentialBinding
	12,  // 202: openshell.v1.OpenShell.Health:input_type -> openshell.v1.HealthRequest
	14,  // 203: openshell.v1.OpenShell.GetCurrentUser:input_type -> openshell.v1.GetCurrentUserRequest
	16,  // 204: openshell.v1.OpenShell.GetGatewayInfo:input_type -> openshell.v1.GetGatewayInfoRequest
	41,  // 205: openshell.v1.OpenShell.CreateSandbox:input_type -> openshell.v1.CreateSandboxRequest
	61,  // 206: openshell.v1.OpenShell.BeginRootfsTarStaging:input_type -> openshell.v1.BeginRootfsTarStagingRequest
	44,  // 207: openshell.v1.OpenShell.GetDelegatedIdentityAuthorizationStatus:input_type -> openshell.v1.GetDelegatedIdentityAuthorizationStatusRequest
	46,  // 208: openshell.v1.OpenShell.AuthorizeDelegatedIdentity:input_type -> openshell.v1.AuthorizeDelegatedIdentityRequest
	48,  // 209: openshell.v1.OpenShell.GetSandboxDelegatedIdentityStatus:input_type -> openshell.v1.GetSandboxDelegatedIdentityStatusRequest
	50,  // 210: openshell.v1.OpenShell.WithdrawSandboxDelegatedIdentity:input_type -> openshell.v1.WithdrawSandboxDelegatedIdentityRequest
	52,  // 211: openshell.v1.OpenShell.ExtendSandboxDelegatedIdentity:input_type -> openshell.v1.ExtendSandboxDelegatedIdentityRequest
	63,  // 212: openshell.v1.OpenShell.GetSandbox:input_type -> openshell.v1.GetSandboxRequest
	64,  // 213: openshell.v1.OpenShell.ListSandboxes:input_type -> openshell.v1.ListSandboxesRequest
	54,  // 214: openshell.v1.OpenShell.CreateSandboxTemplate:input_type -> openshell.v1.CreateSandboxTemplateRequest
	55,  // 215: openshell.v1.OpenShell.GetSandboxTemplate:input_type -> openshell.v1.GetSandboxTemplateRequest
	56,  // 216: openshell.v1.OpenShell.ListSandboxTemplates:input_type -> openshell.v1.ListSandboxTemplatesRequest
	57,  // 217: openshell.v1.OpenShell.DeleteSandboxTemplate:input_type -> openshell.v1.DeleteSandboxTemplateRequest
	65,  // 218: openshell.v1.OpenShell.ListSandboxProviders:input_type -> openshell.v1.ListSandboxProvidersRequest
	66,  // 219: openshell.v1.OpenShell.AttachSandboxProvider:input_type -> openshell.v1.AttachSandboxProviderRequest
	67,  // 220: openshell.v1.OpenShell.DetachSandboxProvider:input_type -> openshell.v1.DetachSandboxProviderRequest
	68,  // 221: openshell.v1.OpenShell.DeleteSandbox:input_type -> openshell.v1.DeleteSandboxRequest
	69,  // 222: openshell.v1.OpenShell.StopSandbox:input_type -> openshell.v1.StopSandboxRequest
	70,  // 223: openshell.v1.OpenShell.StartSandbox:input_type -> openshell.v1.StartSandboxRequest
	77,  // 224: openshell.v1.OpenShell.CreateSshSession:input_type -> openshell.v1.CreateSshSessionRequest
	79,  // 225: openshell.v1.OpenShell.ExposeService:input_type -> openshell.v1.ExposeServiceRequest
	80,  // 226: openshell.v1.OpenShell.GetService:input_type -> openshell.v1.GetServiceRequest
	81,  // 227: openshell.v1.OpenShell.ListServices:input_type -> openshell.v1.ListServicesRequest
	83,  // 228: openshell.v1.OpenShell.DeleteService:input_type -> openshell.v1.DeleteServiceRequest
	87,  // 229: openshell.v1.OpenShell.RevokeSshSession:input_type -> openshell.v1.RevokeSshSessionRequest
	89,  // 230: openshell.v1.OpenShell.ExecSandbox:input_type -> openshell.v1.ExecSandboxRequest
	95,  // 231: openshell.v1.OpenShell.ForwardTcp:input_type -> openshell.v1.TcpForwardFrame
	96,  // 232: openshell.v1.OpenShell.ExecSandboxInteractive:input_type -> openshell.v1.ExecSandboxInput
	103, // 233: openshell.v1.OpenShell.CreateProvider:input_type -> openshell.v1.CreateProviderRequest
	104, // 234: openshell.v1.OpenShell.GetProvider:input_type -> openshell.v1.GetProviderRequest
	105, // 235: openshell.v1.OpenShell.ListProviders:input_type -> openshell.v1.ListProvidersRequest
	110, // 236: openshell.v1.OpenShell.ListProviderProfiles:input_type -> openshell.v1.ListProviderProfilesRequest
	111, // 237: openshell.v1.OpenShell.GetProviderProfile:input_type -> openshell.v1.GetProviderProfileRequest
	148, // 238: openshell.v1.OpenShell.ImportProviderProfiles:input_type -> openshell.v1.ImportProviderProfilesRequest
	150, // 239: openshell.v1.OpenShell.UpdateProviderProfiles:input_type -> openshell.v1.UpdateProviderProfilesRequest
	152, // 240: openshell.v1.OpenShell.LintProviderProfiles:input_type -> openshell.v1.LintProviderProfilesRequest
	106, // 241: openshell.v1.OpenShell.UpdateProvider:input_type -> openshell.v1.UpdateProviderRequest
	136, // 242: openshell.v1.OpenShell.GetProviderRefreshStatus:input_type -> openshell.v1.GetProviderRefreshStatusRequest
	138, // 243: openshell.v1.OpenShell.ConfigureProviderRefresh:input_type -> openshell.v1.ConfigureProviderRefreshRequest
	140, // 244: openshell.v1.OpenShell.RotateProviderCredential:input_type -> openshell.v1.RotateProviderCredentialRequest
	128, // 245: openshell.v1.OpenShell.ListDelegatedIdentityCredentials:input_type -> openshell.v1.ListDelegatedIdentityCredentialsRequest
	130, // 246: openshell.v1.OpenShell.GetDelegatedIdentityCredentialStatus:input_type -> openshell.v1.GetDelegatedIdentityCredentialStatusRequest
	132, // 247: openshell.v1.OpenShell.RevokeDelegatedIdentityCredential:input_type -> openshell.v1.RevokeDelegatedIdentityCredentialRequest
	134, // 248: openshell.v1.OpenShell.DeleteDelegatedIdentityCredential:input_type -> openshell.v1.DeleteDelegatedIdentityCredentialRequest
	142, // 249: openshell.v1.OpenShell.DeleteProviderRefresh:input_type -> openshell.v1.DeleteProviderRefreshRequest
	107, // 250: openshell.v1.OpenShell.DeleteProvider:input_type -> openshell.v1.DeleteProviderRequest
	155, // 251: openshell.v1.OpenShell.DeleteProviderProfile:input_type -> openshell.v1.DeleteProviderProfileRequest
	287, // 252: openshell.v1.OpenShell.GetSandboxConfig:input_type -> openshell.sandbox.v1.GetSandboxConfigRequest
	288, // 253: openshell.v1.OpenShell.GetGatewayConfig:input_type -> openshell.sandbox.v1.GetGatewayConfigRequest
	163, // 254: openshell.v1.OpenShell.UpdateConfig:input_type -> openshell.v1.UpdateConfigRequest
	172, // 255: openshell.v1.OpenShell.GetSandboxPolicyStatus:input_type -> openshell.v1.GetSandboxPolicyStatusRequest
	174, // 256: openshell.v1.OpenShell.ListSandboxPolicies:input_type -> openshell.v1.ListSandboxPoliciesRequest
	176, // 257: openshell.v1.OpenShell.ReportPolicyStatus:input_type -> openshell.v1.ReportPolicyStatusRequest
	157, // 258: openshell.v1.OpenShell.GetSandboxProviderEnvironment:input_type -> openshell.v1.GetSandboxProviderEnvironmentRequest
	161, // 259: openshell.v1.OpenShell.ExchangeProviderSubjectToken:input_type -> openshell.v1.ExchangeProviderSubjectTokenRequest
	179, // 260: openshell.v1.OpenShell.GetSandboxLogs:input_type -> openshell.v1.GetSandboxLogsRequest
	180, // 261: openshell.v1.OpenShell.PushSandboxLogs:input_type -> openshell.v1.PushSandboxLogsRequest
	183, // 262: openshell.v1.OpenShell.ConnectSupervisor:input_type -> openshell.v1.SupervisorMessage
	190, // 263: openshell.v1.OpenShell.ReportMainProcessExit:input_type -> openshell.v1.ReportMainProcessExitRequest
	192, // 264: openshell.v1.OpenShell.FinalizeMainProcessExit:input_type -> openshell.v1.FinalizeMainProcessExitRequest
	198, // 265: openshell.v1.OpenShell.RelayStream:input_type -> openshell.v1.RelayFrame
	99,  // 266: openshell.v1.OpenShell.WatchSandbox:input_type -> openshell.v1.WatchSandboxRequest
	207, // 267: openshell.v1.OpenShell.SubmitPolicyAnalysis:input_type -> openshell.v1.SubmitPolicyAnalysisRequest
	209, // 268: openshell.v1.OpenShell.GetDraftPolicy:input_type -> openshell.v1.GetDraftPolicyRequest
	211, // 269: openshell.v1.OpenShell.ApproveDraftChunk:input_type -> openshell.v1.ApproveDraftChunkRequest
	213, // 270: openshell.v1.OpenShell.RejectDraftChunk:input_type -> openshell.v1.RejectDraftChunkRequest
	216, // 271: openshell.v1.OpenShell.ApproveAllDraftChunks:input_type -> openshell.v1.ApproveAllDraftChunksRequest
	218, // 272: openshell.v1.OpenShell.EditDraftChunk:input_type -> openshell.v1.EditDraftChunkRequest
	220, // 273: openshell.v1.OpenShell.UndoDraftChunk:input_type -> openshell.v1.UndoDraftChunkRequest
	222, // 274: openshell.v1.OpenShell.ClearDraftChunks:input_type -> openshell.v1.ClearDraftChunksRequest
	224, // 275: openshell.v1.OpenShell.GetDraftHistory:input_type -> openshell.v1.GetDraftHistoryRequest
	8,   // 276: openshell.v1.OpenShell.IssueSandboxToken:input_type -> openshell.v1.IssueSandboxTokenRequest
	10,  // 277: openshell.v1.OpenShell.RefreshSandboxToken:input_type -> openshell.v1.RefreshSandboxTokenRequest
	231, // 278: openshell.v1.OpenShell.CreateWorkspace:input_type -> openshell.v1.CreateWorkspaceRequest
	233, // 279: openshell.v1.OpenShell.GetWorkspace:input_type -> openshell.v1.GetWorkspaceRequest
	235, // 280: openshell.v1.OpenShell.ListWorkspaces:input_type -> openshell.v1.ListWorkspacesRequest
	237, // 281: openshell.v1.OpenShell.DeleteWorkspace:input_type -> openshell.v1.DeleteWorkspaceRequest
	240, // 282: openshell.v1.OpenShell.AddWorkspaceMember:input_type -> openshell.v1.AddWorkspaceMemberRequest
	242, // 283: openshell.v1.OpenShell.RemoveWorkspaceMember:input_type -> openshell.v1.RemoveWorkspaceMemberRequest
	244, // 284: openshell.v1.OpenShell.ListWorkspaceMembers:input_type -> openshell.v1.ListWorkspaceMembersRequest
	13,  // 285: openshell.v1.OpenShell.Health:output_type -> openshell.v1.HealthResponse
	15,  // 286: openshell.v1.OpenShell.GetCurrentUser:output_type -> openshell.v1.GetCurrentUserResponse
	17,  // 287: openshell.v1.OpenShell.GetGatewayInfo:output_type -> openshell.v1.GetGatewayInfoResponse
	71,  // 288: openshell.v1.OpenShell.CreateSandbox:output_type -> openshell.v1.SandboxResponse
	62,  // 289: openshell.v1.OpenShell.BeginRootfsTarStaging:output_type -> openshell.v1.BeginRootfsTarStagingResponse
	45,  // 290: openshell.v1.OpenShell.GetDelegatedIdentityAuthorizationStatus:output_type -> openshell.v1.GetDelegatedIdentityAuthorizationStatusResponse
	47,  // 291: openshell.v1.OpenShell.AuthorizeDelegatedIdentity:output_type -> openshell.v1.AuthorizeDelegatedIdentityResponse
	49,  // 292: openshell.v1.OpenShell.GetSandboxDelegatedIdentityStatus:output_type -> openshell.v1.GetSandboxDelegatedIdentityStatusResponse
	51,  // 293: openshell.v1.OpenShell.WithdrawSandboxDelegatedIdentity:output_type -> openshell.v1.WithdrawSandboxDelegatedIdentityResponse
	53,  // 294: openshell.v1.OpenShell.ExtendSandboxDelegatedIdentity:output_type -> openshell.v1.ExtendSandboxDelegatedIdentityResponse
	71,  // 295: openshell.v1.OpenShell.GetSandbox:output_type -> openshell.v1.SandboxResponse
	72,  // 296: openshell.v1.OpenShell.ListSandboxes:output_type -> openshell.v1.ListSandboxesResponse
	58,  // 297: openshell.v1.OpenShell.CreateSandboxTemplate:output_type -> openshell.v1.SandboxTemplateResponse
	58,  // 298: openshell.v1.OpenShell.GetSandboxTemplate:output_type -> openshell.v1.SandboxTemplateResponse
	59,  // 299: openshell.v1.OpenShell.ListSandboxTemplates:output_type -> openshell.v1.ListSandboxTemplatesResponse
	60,  // 300: openshell.v1.OpenShell.DeleteSandboxTemplate:output_type -> openshell.v1.DeleteSandboxTemplateResponse
	73,  // 301: openshell.v1.OpenShell.ListSandboxProviders:output_type -> openshell.v1.ListSandboxProvidersResponse
	74,  // 302: openshell.v1.OpenShell.AttachSandboxProvider:output_type -> openshell.v1.AttachSandboxProviderResponse
	75,  // 303: openshell.v1.OpenShell.DetachSandboxProvider:output_type -> openshell.v1.DetachSandboxProviderResponse
	76,  // 304: openshell.v1.OpenShell.DeleteSandbox:output_type -> openshell.v1.DeleteSandboxResponse
	71,  // 305: openshell.v1.OpenShell.StopSandbox:output_type -> openshell.v1.SandboxResponse
	71,  // 306: openshell.v1.OpenShell.StartSandbox:output_type -> openshell.v1.SandboxResponse
	78,  // 307: openshell.v1.OpenShell.CreateSshSession:output_type -> openshell.v1.CreateSshSessionResponse
	86,  // 308: openshell.v1.OpenShell.ExposeService:output_type -> openshell.v1.ServiceEndpointResponse
	86,  // 309: openshell.v1.OpenShell.GetService:output_type -> openshell.v1.ServiceEndpointResponse
	82,  // 310: openshell.v1.OpenShell.ListServices:output_type -> openshell.v1.ListServicesResponse
	84,  // 311: openshell.v1.OpenShell.DeleteService:output_type -> openshell.v1.DeleteServiceResponse
	88,  // 312: openshell.v1.OpenShell.RevokeSshSession:output_type -> openshell.v1.RevokeSshSessionResponse
	93,  // 313: openshell.v1.OpenShell.ExecSandbox:output_type -> openshell.v1.ExecSandboxEvent
	95,  // 314: openshell.v1.OpenShell.ForwardTcp:output_type -> openshell.v1.TcpForwardFrame
	93,  // 315: openshell.v1.OpenShell.ExecSandboxInteractive:output_type -> openshell.v1.ExecSandboxEvent
	108, // 316: openshell.v1.OpenShell.CreateProvider:output_type -> openshell.v1.ProviderResponse
	108, // 317: openshell.v1.OpenShell.GetProvider:output_type -> openshell.v1.ProviderResponse
	109, // 318: openshell.v1.OpenShell.ListProviders:output_type -> openshell.v1.ListProvidersResponse
	147, // 319: openshell.v1.OpenShell.ListProviderProfiles:output_type -> openshell.v1.ListProviderProfilesResponse
	146, // 320: openshell.v1.OpenShell.GetProviderProfile:output_type -> openshell.v1.ProviderProfileResponse
	149, // 321: openshell.v1.OpenShell.ImportProviderProfiles:output_type -> openshell.v1.ImportProviderProfilesResponse
	151, // 322: openshell.v1.OpenShell.UpdateProviderProfiles:output_type -> openshell.v1.UpdateProviderProfilesResponse
	153, // 323: openshell.v1.OpenShell.LintProviderProfiles:output_type -> openshell.v1.LintProviderProfilesResponse
	108, // 324: openshell.v1.OpenShell.UpdateProvider:output_type -> openshell.v1.ProviderResponse
	137, // 325: openshell.v1.OpenShell.GetProviderRefreshStatus:output_type -> openshell.v1.GetProviderRefreshStatusResponse
	139, // 326: openshell.v1.OpenShell.ConfigureProviderRefresh:output_type -> openshell.v1.ConfigureProviderRefreshResponse
	141, // 327: openshell.v1.OpenShell.RotateProviderCredential:output_type -> openshell.v1.RotateProviderCredentialResponse
	129, // 328: openshell.v1.OpenShell.ListDelegatedIdentityCredentials:output_type -> openshell.v1.ListDelegatedIdentityCredentialsResponse
	131, // 329: openshell.v1.OpenShell.GetDelegatedIdentityCredentialStatus:output_type -> openshell.v1.GetDelegatedIdentityCredentialStatusResponse
	133, // 330: openshell.v1.OpenShell.RevokeDelegatedIdentityCredential:output_type -> openshell.v1.RevokeDelegatedIdentityCredentialResponse
	135, // 331: openshell.v1.OpenShell.DeleteDelegatedIdentityCredential:output_type -> openshell.v1.DeleteDelegatedIdentityCredentialResponse
	143, // 332: openshell.v1.OpenShell.DeleteProviderRefresh:output_type -> openshell.v1.DeleteProviderRefreshResponse
	154, // 333: openshell.v1.OpenShell.DeleteProvider:output_type -> openshell.v1.DeleteProviderResponse
	156, // 334: openshell.v1.OpenShell.DeleteProviderProfile:output_type -> openshell.v1.DeleteProviderProfileResponse
	289, // 335: openshell.v1.OpenShell.GetSandboxConfig:output_type -> openshell.sandbox.v1.GetSandboxConfigResponse
	290, // 336: openshell.v1.OpenShell.GetGatewayConfig:output_type -> openshell.sandbox.v1.GetGatewayConfigResponse
	171, // 337: openshell.v1.OpenShell.UpdateConfig:output_type -> openshell.v1.UpdateConfigResponse
	173, // 338: openshell.v1.OpenShell.GetSandboxPolicyStatus:output_type -> openshell.v1.GetSandboxPolicyStatusResponse
	175, // 339: openshell.v1.OpenShell.ListSandboxPolicies:output_type -> openshell.v1.ListSandboxPoliciesResponse
	177, // 340: openshell.v1.OpenShell.ReportPolicyStatus:output_type -> openshell.v1.ReportPolicyStatusResponse
	160, // 341: openshell.v1.OpenShell.GetSandboxProviderEnvironment:output_type -> openshell.v1.GetSandboxProviderEnvironmentResponse
	162, // 342: openshell.v1.OpenShell.ExchangeProviderSubjectToken:output_type -> openshell.v1.ExchangeProviderSubjectTokenResponse
	182, // 343: openshell.v1.OpenShell.GetSandboxLogs:output_type -> openshell.v1.GetSandboxLogsResponse
	181, // 344: openshell.v1.OpenShell.PushSandboxLogs:output_type -> openshell.v1.PushSandboxLogsResponse
	184, // 345: openshell.v1.OpenShell.ConnectSupervisor:output_type -> openshell.v1.GatewayMessage
	191, // 346: openshell.v1.OpenShell.ReportMainProcessExit:output_type -> openshell.v1.ReportMainProcessExitResponse
	193, // 347: openshell.v1.OpenShell.FinalizeMainProcessExit:output_type -> openshell.v1.FinalizeMainProcessExitResponse
	198, // 348: openshell.v1.OpenShell.RelayStream:output_type -> openshell.v1.RelayFrame
	100, // 349: openshell.v1.OpenShell.WatchSandbox:output_type -> openshell.v1.SandboxStreamEvent
	208, // 350: openshell.v1.OpenShell.SubmitPolicyAnalysis:output_type -> openshell.v1.SubmitPolicyAnalysisResponse
	210, // 351: openshell.v1.OpenShell.GetDraftPolicy:output_type -> openshell.v1.GetDraftPolicyResponse
	212, // 352: openshell.v1.OpenShell.ApproveDraftChunk:output_type -> openshell.v1.ApproveDraftChunkResponse
	214, // 353: openshell.v1.OpenShell.RejectDraftChunk:output_type -> openshell.v1.RejectDraftChunkResponse
	217, // 354: openshell.v1.OpenShell.ApproveAllDraftChunks:output_type -> openshell.v1.ApproveAllDraftChunksResponse
	219, // 355: openshell.v1.OpenShell.EditDraftChunk:output_type -> openshell.v1.EditDraftChunkResponse
	221, // 356: openshell.v1.OpenShell.UndoDraftChunk:output_type -> openshell.v1.UndoDraftChunkResponse
	223, // 357: openshell.v1.OpenShell.ClearDraftChunks:output_type -> openshell.v1.ClearDraftChunksResponse
	226, // 358: openshell.v1.OpenShell.GetDraftHistory:output_type -> openshell.v1.GetDraftHistoryResponse
	9,   // 359: openshell.v1.OpenShell.IssueSandboxToken:output_type -> openshell.v1.IssueSandboxTokenResponse
	11,  // 360: openshell.v1.OpenShell.RefreshSandboxToken:output_type -> openshell.v1.RefreshSandboxTokenResponse
	232, // 361: openshell.v1.OpenShell.CreateWorkspace:output_type -> openshell.v1.CreateWorkspaceResponse
	234, // 362: openshell.v1.OpenShell.GetWorkspace:output_type -> openshell.v1.GetWorkspaceResponse
	236, // 363: openshell.v1.OpenShell.ListWorkspaces:output_type -> openshell.v1.ListWorkspacesResponse
	238, // 364: openshell.v1.OpenShell.DeleteWorkspace:output_type -> openshell.v1.DeleteWorkspaceResponse
	241, // 365: openshell.v1.OpenShell.AddWorkspaceMember:output_type -> openshell.v1.AddWorkspaceMemberResponse
	243, // 366: openshell.v1.OpenShell.RemoveWorkspaceMember:output_type -> openshell.v1.RemoveWorkspaceMemberResponse
	245, // 367: openshell.v1.OpenShell.ListWorkspaceMembers:output_type -> openshell.v1.ListWorkspaceMembersResponse
	285, // [285:368] is the sub-list for method output_type
	202, // [202:285] is the sub-list for method input_type
...
func file_openshell_proto_init() {
	...
	file_openshell_proto_msgTypes[22].OneofWrappers = []any{}
	file_openshell_proto_msgTypes[30].OneofWrappers = []any{}
	...
	file_openshell_proto_msgTypes[156].OneofWrappers = []any{
	...
	file_openshell_proto_msgTypes[221].OneofWrappers = []any{}
	file_openshell_proto_msgTypes[222].OneofWrappers = []any{}
	type x struct{}
