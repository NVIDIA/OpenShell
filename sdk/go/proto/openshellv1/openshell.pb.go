...
// Lifecycle state of the canonical main process.
type MainProcessState int32

const (
	MainProcessState_MAIN_PROCESS_STATE_UNSPECIFIED MainProcessState = 0
	MainProcessState_MAIN_PROCESS_STATE_RUNNING     MainProcessState = 1
	MainProcessState_MAIN_PROCESS_STATE_EXITED      MainProcessState = 2
)

// Enum value maps for MainProcessState.
var (
	MainProcessState_name = map[int32]string{
		0: "MAIN_PROCESS_STATE_UNSPECIFIED",
		1: "MAIN_PROCESS_STATE_RUNNING",
		2: "MAIN_PROCESS_STATE_EXITED",
	}
	MainProcessState_value = map[string]int32{
		"MAIN_PROCESS_STATE_UNSPECIFIED": 0,
		"MAIN_PROCESS_STATE_RUNNING":     1,
		"MAIN_PROCESS_STATE_EXITED":      2,
	}
)

func (x MainProcessState) Enum() *MainProcessState {
	p := new(MainProcessState)
	*p = x
	return p
}

func (x MainProcessState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (MainProcessState) Descriptor() protoreflect.EnumDescriptor {
	return file_openshell_proto_enumTypes[0].Descriptor()
}

func (MainProcessState) Type() protoreflect.EnumType {
	return &file_openshell_proto_enumTypes[0]
}

func (x MainProcessState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use MainProcessState.Descriptor instead.
func (MainProcessState) EnumDescriptor() ([]byte, []int) {
...
type ComputeDriverCapabilities struct {
	...
	// Whether the driver can launch the exact canonical main-process contract.
	SupportsMainProcess bool `protobuf:"varint,3,opt,name=supports_main_process,json=supportsMainProcess,proto3" json:"supports_main_process,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *ComputeDriverCapabilities) GetSupportsMainProcess() bool {
	if x != nil {
		return x.SupportsMainProcess
	}
	return false
}
...
type SandboxSpec struct {
	...
	// Canonical process launched once by the sandbox supervisor. The gateway
	// normalizes an omitted value to the portable scratch login shell before
	// persisting a newly-created sandbox.
	MainProcess   *MainProcessSpec `protobuf:"bytes,12,opt,name=main_process,json=mainProcess,proto3" json:"main_process,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SandboxSpec) GetMainProcess() *MainProcessSpec {
	if x != nil {
		return x.MainProcess
	}
	return nil
}

// Exact, shell-free specification for the sandbox's canonical main process.
type MainProcessSpec struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Executable followed by its arguments. No shell parsing is performed.
	Command []string `protobuf:"bytes,1,rep,name=command,proto3" json:"command,omitempty"`
	// Non-secret environment overrides applied only to the main process.
	...
	// Optional absolute working directory inside the sandbox.
...
func (x *MainProcessSpec) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MainProcessSpec) ProtoMessage() {}

func (x *MainProcessSpec) ProtoReflect() protoreflect.Message {
	mi := &file_openshell_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MainProcessSpec.ProtoReflect.Descriptor instead.
func (*MainProcessSpec) Descriptor() ([]byte, []int) {
	return file_openshell_proto_rawDescGZIP(), []int{14}
}

func (x *MainProcessSpec) GetCommand() []string {
	if x != nil {
		return x.Command
	}
	return nil
...
func (x *MainProcessSpec) GetEnvironment() map[string]string {
	if x != nil {
		return x.Environment
	}
	return nil
...
func (x *MainProcessSpec) GetWorkingDirectory() string {
	if x != nil {
...
func (x *MainProcessSpec) GetTerminal() bool {
	if x != nil {
		return x.Terminal
	}
	return false
...
type SandboxStatus struct {
	...
	// Last observed state of the canonical main process.
	MainProcess   *MainProcessStatus `protobuf:"bytes,8,opt,name=main_process,json=mainProcess,proto3" json:"main_process,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SandboxStatus) GetMainProcess() *MainProcessStatus {
	if x != nil {
		return x.MainProcess
	}
	return nil
...
// Persisted result for the canonical main-process generation.
type MainProcessStatus struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	State MainProcessState       `protobuf:"varint,1,opt,name=state,proto3,enum=openshell.v1.MainProcessState" json:"state,omitempty"`
	// Supervisor instance identifier used to reject stale exit reports.
...
func (x *MainProcessStatus) Reset() {
	*x = MainProcessStatus{}
...
func (x *MainProcessStatus) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MainProcessStatus) ProtoMessage() {}

func (x *MainProcessStatus) ProtoReflect() protoreflect.Message {
	mi := &file_openshell_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MainProcessStatus.ProtoReflect.Descriptor instead.
func (*MainProcessStatus) Descriptor() ([]byte, []int) {
	return file_openshell_proto_rawDescGZIP(), []int{19}
}

func (x *MainProcessStatus) GetState() MainProcessState {
	if x != nil {
		return x.State
	}
	return MainProcessState_MAIN_PROCESS_STATE_UNSPECIFIED
}

func (x *MainProcessStatus) GetGeneration() string {
	if x != nil {
		return x.Generation
	}
	return ""
...
func (x *MainProcessStatus) GetExitCode() int32 {
...
func (x *MainProcessStatus) GetSignal() int32 {
...
func (x *MainProcessStatus) GetStartedAtMs() int64 {
	if x != nil {
...
func (x *MainProcessStatus) GetFinishedAtMs() int64 {
	if x != nil {
...
type SupervisorMessage struct {
	...
	//	*SupervisorMessage_MainProcessExit
...
func (x *SupervisorMessage) GetMainProcessExit() *MainProcessExit {
	if x != nil {
		if x, ok := x.Payload.(*SupervisorMessage_MainProcessExit); ok {
			return x.MainProcessExit
		}
	}
	return nil
}
...
type SupervisorMessage_MainProcessExit struct {
	MainProcessExit *MainProcessExit `protobuf:"bytes,5,opt,name=main_process_exit,json=mainProcessExit,proto3,oneof"`
}
...
func (*SupervisorMessage_MainProcessExit) isSupervisorMessage_Payload() {}
...
type GatewayMessage struct {
	...
	//	*GatewayMessage_MainProcessExitAck
...
func (x *GatewayMessage) GetMainProcessExitAck() *MainProcessExitAck {
	if x != nil {
		if x, ok := x.Payload.(*GatewayMessage_MainProcessExitAck); ok {
			return x.MainProcessExitAck
		}
	}
	return nil
}
...
type GatewayMessage_MainProcessExitAck struct {
	MainProcessExitAck *MainProcessExitAck `protobuf:"bytes,6,opt,name=main_process_exit_ack,json=mainProcessExitAck,proto3,oneof"`
}
...
type SupervisorHello struct {
	...
	// Short-lived terminal-result sessions authenticate an existing generation
	// but must not replace the active relay session or advertise readiness.
	ExitReportOnly bool `protobuf:"varint,3,opt,name=exit_report_only,json=exitReportOnly,proto3" json:"exit_report_only,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *SupervisorHello) GetExitReportOnly() bool {
	if x != nil {
		return x.ExitReportOnly
	}
	return false
}
...
// Terminal result reported before the supervisor shuts down. A missing exit
// code with a present signal represents signal termination.
type MainProcessExit struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *MainProcessExit) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MainProcessExit) ProtoMessage() {}

func (x *MainProcessExit) ProtoReflect() protoreflect.Message {
	mi := &file_openshell_proto_msgTypes[136]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MainProcessExit.ProtoReflect.Descriptor instead.
func (*MainProcessExit) Descriptor() ([]byte, []int) {
	return file_openshell_proto_rawDescGZIP(), []int{136}
}

func (x *MainProcessExit) GetGeneration() string {
	if x != nil {
		return x.Generation
	}
	return ""
...
func (x *MainProcessExit) GetExitCode() int32 {
	if x != nil && x.ExitCode != nil {
		return *x.ExitCode
	}
	return 0
...
func (x *MainProcessExit) GetSignal() int32 {
	if x != nil && x.Signal != nil {
		return *x.Signal
	}
	return 0
...
func (x *MainProcessExit) GetStartedAtMs() int64 {
	if x != nil {
		return x.StartedAtMs
	}
	return 0
...
func (x *MainProcessExit) GetFinishedAtMs() int64 {
	if x != nil {
		return x.FinishedAtMs
	}
	return 0
...
// Gateway acknowledgement that the terminal result has been durably handled.
type MainProcessExitAck struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Generation    string                 `protobuf:"bytes,1,opt,name=generation,proto3" json:"generation,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *MainProcessExitAck) Reset() {
	*x = MainProcessExitAck{}
	mi := &file_openshell_proto_msgTypes[137]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MainProcessExitAck) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MainProcessExitAck) ProtoMessage() {}

func (x *MainProcessExitAck) ProtoReflect() protoreflect.Message {
	mi := &file_openshell_proto_msgTypes[137]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MainProcessExitAck.ProtoReflect.Descriptor instead.
func (*MainProcessExitAck) Descriptor() ([]byte, []int) {
	return file_openshell_proto_rawDescGZIP(), []int{137}
}

func (x *MainProcessExitAck) GetGeneration() string {
	if x != nil {
		return x.Generation
	}
	return ""
...
var file_openshell_proto_msgTypes = make([]protoimpl.MessageInfo, 216)
var file_openshell_proto_goTypes = []any{
	(MainProcessState)(0),                                // 0: openshell.v1.MainProcessState
	...
	(*MainProcessSpec)(nil),                              // 21: openshell.v1.MainProcessSpec
	...
	(*MainProcessStatus)(nil),                            // 26: openshell.v1.MainProcessStatus
	...
	(*UpdateConfigRequest)(nil),                          // 116: openshell.v1.UpdateConfigRequest
	(*PolicyMergeOperation)(nil),                         // 117: openshell.v1.PolicyMergeOperation
	(*AddNetworkRule)(nil),                               // 118: openshell.v1.AddNetworkRule
	(*RemoveNetworkEndpoint)(nil),                        // 119: openshell.v1.RemoveNetworkEndpoint
	(*RemoveNetworkRule)(nil),                            // 120: openshell.v1.RemoveNetworkRule
	(*AddDenyRules)(nil),                                 // 121: openshell.v1.AddDenyRules
	(*AddAllowRules)(nil),                                // 122: openshell.v1.AddAllowRules
	(*RemoveNetworkBinary)(nil),                          // 123: openshell.v1.RemoveNetworkBinary
	(*UpdateConfigResponse)(nil),                         // 124: openshell.v1.UpdateConfigResponse
	(*GetSandboxPolicyStatusRequest)(nil),                // 125: openshell.v1.GetSandboxPolicyStatusRequest
	(*GetSandboxPolicyStatusResponse)(nil),               // 126: openshell.v1.GetSandboxPolicyStatusResponse
	(*ListSandboxPoliciesRequest)(nil),                   // 127: openshell.v1.ListSandboxPoliciesRequest
	(*ListSandboxPoliciesResponse)(nil),                  // 128: openshell.v1.ListSandboxPoliciesResponse
	(*ReportPolicyStatusRequest)(nil),                    // 129: openshell.v1.ReportPolicyStatusRequest
	(*ReportPolicyStatusResponse)(nil),                   // 130: openshell.v1.ReportPolicyStatusResponse
	(*SandboxPolicyRevision)(nil),                        // 131: openshell.v1.SandboxPolicyRevision
	(*GetSandboxLogsRequest)(nil),                        // 132: openshell.v1.GetSandboxLogsRequest
	(*PushSandboxLogsRequest)(nil),                       // 133: openshell.v1.PushSandboxLogsRequest
	(*PushSandboxLogsResponse)(nil),                      // 134: openshell.v1.PushSandboxLogsResponse
	(*GetSandboxLogsResponse)(nil),                       // 135: openshell.v1.GetSandboxLogsResponse
	(*SupervisorMessage)(nil),                            // 136: openshell.v1.SupervisorMessage
	(*GatewayMessage)(nil),                               // 137: openshell.v1.GatewayMessage
	(*SupervisorHello)(nil),                              // 138: openshell.v1.SupervisorHello
	(*SessionAccepted)(nil),                              // 139: openshell.v1.SessionAccepted
	(*SessionRejected)(nil),                              // 140: openshell.v1.SessionRejected
	(*SupervisorHeartbeat)(nil),                          // 141: openshell.v1.SupervisorHeartbeat
	(*GatewayHeartbeat)(nil),                             // 142: openshell.v1.GatewayHeartbeat
	(*MainProcessExit)(nil),                              // 143: openshell.v1.MainProcessExit
	(*MainProcessExitAck)(nil),                           // 144: openshell.v1.MainProcessExitAck
	(*RelayOpen)(nil),                                    // 145: openshell.v1.RelayOpen
	(*SshRelayTarget)(nil),                               // 146: openshell.v1.SshRelayTarget
	(*TcpRelayTarget)(nil),                               // 147: openshell.v1.TcpRelayTarget
	(*RelayInit)(nil),                                    // 148: openshell.v1.RelayInit
	(*RelayFrame)(nil),                                   // 149: openshell.v1.RelayFrame
	(*RelayOpenResult)(nil),                              // 150: openshell.v1.RelayOpenResult
	(*RelayClose)(nil),                                   // 151: openshell.v1.RelayClose
	(*L7RequestSample)(nil),                              // 152: openshell.v1.L7RequestSample
	(*DenialSummary)(nil),                                // 153: openshell.v1.DenialSummary
	(*DenialGroupCount)(nil),                             // 154: openshell.v1.DenialGroupCount
	(*NetworkActivitySummary)(nil),                       // 155: openshell.v1.NetworkActivitySummary
	(*PolicyChunk)(nil),                                  // 156: openshell.v1.PolicyChunk
	(*DraftPolicyUpdate)(nil),                            // 157: openshell.v1.DraftPolicyUpdate
	(*SubmitPolicyAnalysisRequest)(nil),                  // 158: openshell.v1.SubmitPolicyAnalysisRequest
	(*SubmitPolicyAnalysisResponse)(nil),                 // 159: openshell.v1.SubmitPolicyAnalysisResponse
	(*GetDraftPolicyRequest)(nil),                        // 160: openshell.v1.GetDraftPolicyRequest
	(*GetDraftPolicyResponse)(nil),                       // 161: openshell.v1.GetDraftPolicyResponse
	(*ApproveDraftChunkRequest)(nil),                     // 162: openshell.v1.ApproveDraftChunkRequest
	(*ApproveDraftChunkResponse)(nil),                    // 163: openshell.v1.ApproveDraftChunkResponse
	(*RejectDraftChunkRequest)(nil),                      // 164: openshell.v1.RejectDraftChunkRequest
	(*RejectDraftChunkResponse)(nil),                     // 165: openshell.v1.RejectDraftChunkResponse
	(*ApproveAllDraftChunksRequest)(nil),                 // 166: openshell.v1.ApproveAllDraftChunksRequest
	(*ApproveAllDraftChunksResponse)(nil),                // 167: openshell.v1.ApproveAllDraftChunksResponse
	(*EditDraftChunkRequest)(nil),                        // 168: openshell.v1.EditDraftChunkRequest
	(*EditDraftChunkResponse)(nil),                       // 169: openshell.v1.EditDraftChunkResponse
	(*UndoDraftChunkRequest)(nil),                        // 170: openshell.v1.UndoDraftChunkRequest
	(*UndoDraftChunkResponse)(nil),                       // 171: openshell.v1.UndoDraftChunkResponse
	(*ClearDraftChunksRequest)(nil),                      // 172: openshell.v1.ClearDraftChunksRequest
	(*ClearDraftChunksResponse)(nil),                     // 173: openshell.v1.ClearDraftChunksResponse
	(*GetDraftHistoryRequest)(nil),                       // 174: openshell.v1.GetDraftHistoryRequest
	(*DraftHistoryEntry)(nil),                            // 175: openshell.v1.DraftHistoryEntry
	(*GetDraftHistoryResponse)(nil),                      // 176: openshell.v1.GetDraftHistoryResponse
	(*PolicyRevisionPayload)(nil),                        // 177: openshell.v1.PolicyRevisionPayload
	(*DraftChunkPayload)(nil),                            // 178: openshell.v1.DraftChunkPayload
	(*StoredPolicyRevision)(nil),                         // 179: openshell.v1.StoredPolicyRevision
	(*StoredDraftChunk)(nil),                             // 180: openshell.v1.StoredDraftChunk
	(*CreateWorkspaceRequest)(nil),                       // 181: openshell.v1.CreateWorkspaceRequest
	(*CreateWorkspaceResponse)(nil),                      // 182: openshell.v1.CreateWorkspaceResponse
	(*GetWorkspaceRequest)(nil),                          // 183: openshell.v1.GetWorkspaceRequest
	(*GetWorkspaceResponse)(nil),                         // 184: openshell.v1.GetWorkspaceResponse
	(*ListWorkspacesRequest)(nil),                        // 185: openshell.v1.ListWorkspacesRequest
	(*ListWorkspacesResponse)(nil),                       // 186: openshell.v1.ListWorkspacesResponse
	(*DeleteWorkspaceRequest)(nil),                       // 187: openshell.v1.DeleteWorkspaceRequest
	(*DeleteWorkspaceResponse)(nil),                      // 188: openshell.v1.DeleteWorkspaceResponse
	(*WorkspaceMember)(nil),                              // 189: openshell.v1.WorkspaceMember
	(*AddWorkspaceMemberRequest)(nil),                    // 190: openshell.v1.AddWorkspaceMemberRequest
	(*AddWorkspaceMemberResponse)(nil),                   // 191: openshell.v1.AddWorkspaceMemberResponse
	(*RemoveWorkspaceMemberRequest)(nil),                 // 192: openshell.v1.RemoveWorkspaceMemberRequest
	(*RemoveWorkspaceMemberResponse)(nil),                // 193: openshell.v1.RemoveWorkspaceMemberResponse
	(*ListWorkspaceMembersRequest)(nil),                  // 194: openshell.v1.ListWorkspaceMembersRequest
	(*ListWorkspaceMembersResponse)(nil),                 // 195: openshell.v1.ListWorkspaceMembersResponse
	(*ExtensionServiceCredential)(nil),                   // 196: openshell.v1.ExtensionServiceCredential
	nil,                                                  // 197: openshell.v1.SandboxSpec.EnvironmentEntry
	nil,                                                  // 198: openshell.v1.MainProcessSpec.EnvironmentEntry
	nil,                                                  // 199: openshell.v1.SandboxTemplate.LabelsEntry
	nil,                                                  // 200: openshell.v1.SandboxTemplate.AnnotationsEntry
	nil,                                                  // 201: openshell.v1.SandboxTemplate.EnvironmentEntry
	nil,                                                  // 202: openshell.v1.PlatformEvent.MetadataEntry
	nil,                                                  // 203: openshell.v1.CreateSandboxRequest.LabelsEntry
	nil,                                                  // 204: openshell.v1.CreateSandboxRequest.AnnotationsEntry
	nil,                                                  // 205: openshell.v1.ExecSandboxRequest.EnvironmentEntry
	nil,                                                  // 206: openshell.v1.SandboxLogLine.FieldsEntry
	nil,                                                  // 207: openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	nil,                                                  // 208: openshell.v1.StoredProviderCredentialRefreshState.MaterialEntry
	nil,                                                  // 209: openshell.v1.StoredProviderCredentialRefreshState.AdditionalOutputKeysEntry
	nil,                                                  // 210: openshell.v1.StoredProviderCredentialRefreshState.SecretMaterialHandlesEntry
	...
	(*sandboxv1.SandboxPolicy)(nil),                      // 224: openshell.sandbox.v1.SandboxPolicy
	(*structpb.Struct)(nil),                              // 225: google.protobuf.Struct
	(*datamodelv1.Provider)(nil),                         // 226: openshell.datamodel.v1.Provider
	(*datamodelv1.CredentialHandle)(nil),                 // 227: openshell.datamodel.v1.CredentialHandle
...
var file_openshell_proto_depIdxs = []int32{
	196, // 0: openshell.v1.RefreshSandboxTokenResponse.extension_credentials:type_name -> openshell.v1.ExtensionServiceCredential
	...
	197, // 8: openshell.v1.SandboxSpec.environment:type_name -> openshell.v1.SandboxSpec.EnvironmentEntry
	24,  // 9: openshell.v1.SandboxSpec.template:type_name -> openshell.v1.SandboxTemplate
	224, // 10: openshell.v1.SandboxSpec.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	22,  // 11: openshell.v1.SandboxSpec.resource_requirements:type_name -> openshell.v1.ResourceRequirements
	21,  // 12: openshell.v1.SandboxSpec.main_process:type_name -> openshell.v1.MainProcessSpec
	198, // 13: openshell.v1.MainProcessSpec.environment:type_name -> openshell.v1.MainProcessSpec.EnvironmentEntry
	23,  // 14: openshell.v1.ResourceRequirements.gpu:type_name -> openshell.v1.GpuResourceRequirements
	199, // 15: openshell.v1.SandboxTemplate.labels:type_name -> openshell.v1.SandboxTemplate.LabelsEntry
	200, // 16: openshell.v1.SandboxTemplate.annotations:type_name -> openshell.v1.SandboxTemplate.AnnotationsEntry
	201, // 17: openshell.v1.SandboxTemplate.environment:type_name -> openshell.v1.SandboxTemplate.EnvironmentEntry
	225, // 18: openshell.v1.SandboxTemplate.resources:type_name -> google.protobuf.Struct
	225, // 19: openshell.v1.SandboxTemplate.driver_config:type_name -> google.protobuf.Struct
	27,  // 20: openshell.v1.SandboxStatus.conditions:type_name -> openshell.v1.SandboxCondition
	1,   // 21: openshell.v1.SandboxStatus.phase:type_name -> openshell.v1.SandboxPhase
	26,  // 22: openshell.v1.SandboxStatus.main_process:type_name -> openshell.v1.MainProcessStatus
	0,   // 23: openshell.v1.MainProcessStatus.state:type_name -> openshell.v1.MainProcessState
	202, // 24: openshell.v1.PlatformEvent.metadata:type_name -> openshell.v1.PlatformEvent.MetadataEntry
	20,  // 25: openshell.v1.CreateSandboxRequest.spec:type_name -> openshell.v1.SandboxSpec
	203, // 26: openshell.v1.CreateSandboxRequest.labels:type_name -> openshell.v1.CreateSandboxRequest.LabelsEntry
	204, // 27: openshell.v1.CreateSandboxRequest.annotations:type_name -> openshell.v1.CreateSandboxRequest.AnnotationsEntry
	19,  // 28: openshell.v1.SandboxResponse.sandbox:type_name -> openshell.v1.Sandbox
	19,  // 29: openshell.v1.ListSandboxesResponse.sandboxes:type_name -> openshell.v1.Sandbox
	226, // 30: openshell.v1.ListSandboxProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	19,  // 31: openshell.v1.AttachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	19,  // 32: openshell.v1.DetachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	53,  // 33: openshell.v1.ListServicesResponse.services:type_name -> openshell.v1.ServiceEndpointResponse
	223, // 34: openshell.v1.ServiceEndpoint.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	52,  // 35: openshell.v1.ServiceEndpointResponse.endpoint:type_name -> openshell.v1.ServiceEndpoint
	205, // 36: openshell.v1.ExecSandboxRequest.environment:type_name -> openshell.v1.ExecSandboxRequest.EnvironmentEntry
	57,  // 37: openshell.v1.ExecSandboxEvent.stdout:type_name -> openshell.v1.ExecSandboxStdout
	58,  // 38: openshell.v1.ExecSandboxEvent.stderr:type_name -> openshell.v1.ExecSandboxStderr
	59,  // 39: openshell.v1.ExecSandboxEvent.exit:type_name -> openshell.v1.ExecSandboxExit
	146, // 40: openshell.v1.TcpForwardInit.ssh:type_name -> openshell.v1.SshRelayTarget
	147, // 41: openshell.v1.TcpForwardInit.tcp:type_name -> openshell.v1.TcpRelayTarget
	61,  // 42: openshell.v1.TcpForwardFrame.init:type_name -> openshell.v1.TcpForwardInit
	56,  // 43: openshell.v1.ExecSandboxInput.start:type_name -> openshell.v1.ExecSandboxRequest
	64,  // 44: openshell.v1.ExecSandboxInput.resize:type_name -> openshell.v1.ExecSandboxWindowResize
	223, // 45: openshell.v1.SshSession.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	19,  // 46: openshell.v1.SandboxStreamEvent.sandbox:type_name -> openshell.v1.Sandbox
	68,  // 47: openshell.v1.SandboxStreamEvent.log:type_name -> openshell.v1.SandboxLogLine
	28,  // 48: openshell.v1.SandboxStreamEvent.event:type_name -> openshell.v1.PlatformEvent
	69,  // 49: openshell.v1.SandboxStreamEvent.warning:type_name -> openshell.v1.SandboxStreamWarning
	157, // 50: openshell.v1.SandboxStreamEvent.draft_policy_update:type_name -> openshell.v1.DraftPolicyUpdate
	206, // 51: openshell.v1.SandboxLogLine.fields:type_name -> openshell.v1.SandboxLogLine.FieldsEntry
	226, // 52: openshell.v1.CreateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	226, // 53: openshell.v1.UpdateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	207, // 54: openshell.v1.UpdateProviderRequest.credential_expires_at_ms:type_name -> openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	226, // 55: openshell.v1.ProviderResponse.provider:type_name -> openshell.datamodel.v1.Provider
	226, // 56: openshell.v1.ListProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	99,  // 57: openshell.v1.ProviderProfileImportItem.profile:type_name -> openshell.v1.ProviderProfile
	81,  // 58: openshell.v1.ProviderCredentialTokenGrant.audience_overrides:type_name -> openshell.v1.ProviderCredentialTokenGrantAudienceOverride
	86,  // 59: openshell.v1.ProviderProfileCredential.refresh:type_name -> openshell.v1.ProviderCredentialRefresh
	82,  // 60: openshell.v1.ProviderProfileCredential.token_grant:type_name -> openshell.v1.ProviderCredentialTokenGrant
	2,   // 61: openshell.v1.ProviderCredentialRefresh.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	84,  // 62: openshell.v1.ProviderCredentialRefresh.material:type_name -> openshell.v1.ProviderCredentialRefreshMaterial
	85,  // 63: openshell.v1.ProviderCredentialRefresh.additional_outputs:type_name -> openshell.v1.ProviderCredentialRefreshOutput
	2,   // 64: openshell.v1.ProviderCredentialRefreshStatus.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	223, // 65: openshell.v1.StoredProviderCredentialRefreshState.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	2,   // 66: openshell.v1.StoredProviderCredentialRefreshState.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	208, // 67: openshell.v1.StoredProviderCredentialRefreshState.material:type_name -> openshell.v1.StoredProviderCredentialRefreshState.MaterialEntry
	209, // 68: openshell.v1.StoredProviderCredentialRefreshState.additional_output_keys:type_name -> openshell.v1.StoredProviderCredentialRefreshState.AdditionalOutputKeysEntry
	210, // 69: openshell.v1.StoredProviderCredentialRefreshState.secret_material_handles:type_name -> openshell.v1.StoredProviderCredentialRefreshState.SecretMaterialHandlesEntry
	90,  // 70: openshell.v1.StoredProviderCredentialRefreshState.pending_secret_deletions:type_name -> openshell.v1.StoredRefreshMaterialDeletion
	227, // 71: openshell.v1.StoredRefreshMaterialDeletion.handle:type_name -> openshell.datamodel.v1.CredentialHandle
	...
	79,  // 87: openshell.v1.ImportProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	80,  // 88: openshell.v1.ImportProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	99,  // 89: openshell.v1.ImportProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	79,  // 90: openshell.v1.UpdateProviderProfilesRequest.profile:type_name -> openshell.v1.ProviderProfileImportItem
	80,  // 91: openshell.v1.UpdateProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	99,  // 92: openshell.v1.UpdateProviderProfilesResponse.profile:type_name -> openshell.v1.ProviderProfile
	79,  // 93: openshell.v1.LintProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	80,  // 94: openshell.v1.LintProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	...
	224, // 100: openshell.v1.UpdateConfigRequest.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	230, // 101: openshell.v1.UpdateConfigRequest.setting_value:type_name -> openshell.sandbox.v1.SettingValue
	117, // 102: openshell.v1.UpdateConfigRequest.merge_operations:type_name -> openshell.v1.PolicyMergeOperation
	217, // 103: openshell.v1.UpdateConfigRequest.annotations:type_name -> openshell.v1.UpdateConfigRequest.AnnotationsEntry
	118, // 104: openshell.v1.PolicyMergeOperation.add_rule:type_name -> openshell.v1.AddNetworkRule
	119, // 105: openshell.v1.PolicyMergeOperation.remove_endpoint:type_name -> openshell.v1.RemoveNetworkEndpoint
	120, // 106: openshell.v1.PolicyMergeOperation.remove_rule:type_name -> openshell.v1.RemoveNetworkRule
	121, // 107: openshell.v1.PolicyMergeOperation.add_deny_rules:type_name -> openshell.v1.AddDenyRules
	122, // 108: openshell.v1.PolicyMergeOperation.add_allow_rules:type_name -> openshell.v1.AddAllowRules
	123, // 109: openshell.v1.PolicyMergeOperation.remove_binary:type_name -> openshell.v1.RemoveNetworkBinary
	...
	131, // 114: openshell.v1.GetSandboxPolicyStatusResponse.revision:type_name -> openshell.v1.SandboxPolicyRevision
	131, // 115: openshell.v1.ListSandboxPoliciesResponse.revisions:type_name -> openshell.v1.SandboxPolicyRevision
	...
	224, // 118: openshell.v1.SandboxPolicyRevision.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	219, // 119: openshell.v1.SandboxPolicyRevision.provenance:type_name -> openshell.v1.SandboxPolicyRevision.ProvenanceEntry
	68,  // 120: openshell.v1.PushSandboxLogsRequest.logs:type_name -> openshell.v1.SandboxLogLine
	68,  // 121: openshell.v1.GetSandboxLogsResponse.logs:type_name -> openshell.v1.SandboxLogLine
	138, // 122: openshell.v1.SupervisorMessage.hello:type_name -> openshell.v1.SupervisorHello
	141, // 123: openshell.v1.SupervisorMessage.heartbeat:type_name -> openshell.v1.SupervisorHeartbeat
	150, // 124: openshell.v1.SupervisorMessage.relay_open_result:type_name -> openshell.v1.RelayOpenResult
	151, // 125: openshell.v1.SupervisorMessage.relay_close:type_name -> openshell.v1.RelayClose
	143, // 126: openshell.v1.SupervisorMessage.main_process_exit:type_name -> openshell.v1.MainProcessExit
	139, // 127: openshell.v1.GatewayMessage.session_accepted:type_name -> openshell.v1.SessionAccepted
	140, // 128: openshell.v1.GatewayMessage.session_rejected:type_name -> openshell.v1.SessionRejected
	142, // 129: openshell.v1.GatewayMessage.heartbeat:type_name -> openshell.v1.GatewayHeartbeat
	145, // 130: openshell.v1.GatewayMessage.relay_open:type_name -> openshell.v1.RelayOpen
	151, // 131: openshell.v1.GatewayMessage.relay_close:type_name -> openshell.v1.RelayClose
	144, // 132: openshell.v1.GatewayMessage.main_process_exit_ack:type_name -> openshell.v1.MainProcessExitAck
	146, // 133: openshell.v1.RelayOpen.ssh:type_name -> openshell.v1.SshRelayTarget
	147, // 134: openshell.v1.RelayOpen.tcp:type_name -> openshell.v1.TcpRelayTarget
	148, // 135: openshell.v1.RelayFrame.init:type_name -> openshell.v1.RelayInit
	152, // 136: openshell.v1.DenialSummary.l7_request_samples:type_name -> openshell.v1.L7RequestSample
	154, // 137: openshell.v1.NetworkActivitySummary.denials_by_group:type_name -> openshell.v1.DenialGroupCount
	231, // 138: openshell.v1.PolicyChunk.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	153, // 139: openshell.v1.SubmitPolicyAnalysisRequest.summaries:type_name -> openshell.v1.DenialSummary
	156, // 140: openshell.v1.SubmitPolicyAnalysisRequest.proposed_chunks:type_name -> openshell.v1.PolicyChunk
	155, // 141: openshell.v1.SubmitPolicyAnalysisRequest.network_activity_summaries:type_name -> openshell.v1.NetworkActivitySummary
	156, // 142: openshell.v1.GetDraftPolicyResponse.chunks:type_name -> openshell.v1.PolicyChunk
	231, // 143: openshell.v1.EditDraftChunkRequest.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	175, // 144: openshell.v1.GetDraftHistoryResponse.entries:type_name -> openshell.v1.DraftHistoryEntry
	224, // 145: openshell.v1.PolicyRevisionPayload.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	220, // 146: openshell.v1.PolicyRevisionPayload.provenance:type_name -> openshell.v1.PolicyRevisionPayload.ProvenanceEntry
	231, // 147: openshell.v1.DraftChunkPayload.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	221, // 148: openshell.v1.StoredPolicyRevision.provenance:type_name -> openshell.v1.StoredPolicyRevision.ProvenanceEntry
	222, // 149: openshell.v1.CreateWorkspaceRequest.labels:type_name -> openshell.v1.CreateWorkspaceRequest.LabelsEntry
	234, // 150: openshell.v1.CreateWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	234, // 151: openshell.v1.GetWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	234, // 152: openshell.v1.ListWorkspacesResponse.workspaces:type_name -> openshell.datamodel.v1.Workspace
	223, // 153: openshell.v1.WorkspaceMember.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	6,   // 154: openshell.v1.WorkspaceMember.role:type_name -> openshell.v1.WorkspaceRole
	6,   // 155: openshell.v1.AddWorkspaceMemberRequest.role:type_name -> openshell.v1.WorkspaceRole
	189, // 156: openshell.v1.AddWorkspaceMemberResponse.member:type_name -> openshell.v1.WorkspaceMember
	189, // 157: openshell.v1.ListWorkspaceMembersResponse.members:type_name -> openshell.v1.WorkspaceMember
	227, // 158: openshell.v1.StoredProviderCredentialRefreshState.SecretMaterialHandlesEntry.value:type_name -> openshell.datamodel.v1.CredentialHandle
	83,  // 159: openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry.value:type_name -> openshell.v1.ProviderProfileCredential
	114, // 160: openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry.value:type_name -> openshell.v1.StaticCredentialBinding
	11,  // 161: openshell.v1.OpenShell.Health:input_type -> openshell.v1.HealthRequest
	13,  // 162: openshell.v1.OpenShell.GetCurrentUser:input_type -> openshell.v1.GetCurrentUserRequest
	15,  // 163: openshell.v1.OpenShell.GetGatewayInfo:input_type -> openshell.v1.GetGatewayInfoRequest
	29,  // 164: openshell.v1.OpenShell.CreateSandbox:input_type -> openshell.v1.CreateSandboxRequest
	30,  // 165: openshell.v1.OpenShell.GetSandbox:input_type -> openshell.v1.GetSandboxRequest
	31,  // 166: openshell.v1.OpenShell.ListSandboxes:input_type -> openshell.v1.ListSandboxesRequest
	32,  // 167: openshell.v1.OpenShell.ListSandboxProviders:input_type -> openshell.v1.ListSandboxProvidersRequest
	33,  // 168: openshell.v1.OpenShell.AttachSandboxProvider:input_type -> openshell.v1.AttachSandboxProviderRequest
	34,  // 169: openshell.v1.OpenShell.DetachSandboxProvider:input_type -> openshell.v1.DetachSandboxProviderRequest
	35,  // 170: openshell.v1.OpenShell.DeleteSandbox:input_type -> openshell.v1.DeleteSandboxRequest
	36,  // 171: openshell.v1.OpenShell.StopSandbox:input_type -> openshell.v1.StopSandboxRequest
	37,  // 172: openshell.v1.OpenShell.StartSandbox:input_type -> openshell.v1.StartSandboxRequest
	44,  // 173: openshell.v1.OpenShell.CreateSshSession:input_type -> openshell.v1.CreateSshSessionRequest
	46,  // 174: openshell.v1.OpenShell.ExposeService:input_type -> openshell.v1.ExposeServiceRequest
	47,  // 175: openshell.v1.OpenShell.GetService:input_type -> openshell.v1.GetServiceRequest
	48,  // 176: openshell.v1.OpenShell.ListServices:input_type -> openshell.v1.ListServicesRequest
	50,  // 177: openshell.v1.OpenShell.DeleteService:input_type -> openshell.v1.DeleteServiceRequest
	54,  // 178: openshell.v1.OpenShell.RevokeSshSession:input_type -> openshell.v1.RevokeSshSessionRequest
	56,  // 179: openshell.v1.OpenShell.ExecSandbox:input_type -> openshell.v1.ExecSandboxRequest
	62,  // 180: openshell.v1.OpenShell.ForwardTcp:input_type -> openshell.v1.TcpForwardFrame
	63,  // 181: openshell.v1.OpenShell.ExecSandboxInteractive:input_type -> openshell.v1.ExecSandboxInput
	70,  // 182: openshell.v1.OpenShell.CreateProvider:input_type -> openshell.v1.CreateProviderRequest
	71,  // 183: openshell.v1.OpenShell.GetProvider:input_type -> openshell.v1.GetProviderRequest
	72,  // 184: openshell.v1.OpenShell.ListProviders:input_type -> openshell.v1.ListProvidersRequest
	77,  // 185: openshell.v1.OpenShell.ListProviderProfiles:input_type -> openshell.v1.ListProviderProfilesRequest
	78,  // 186: openshell.v1.OpenShell.GetProviderProfile:input_type -> openshell.v1.GetProviderProfileRequest
	103, // 187: openshell.v1.OpenShell.ImportProviderProfiles:input_type -> openshell.v1.ImportProviderProfilesRequest
	105, // 188: openshell.v1.OpenShell.UpdateProviderProfiles:input_type -> openshell.v1.UpdateProviderProfilesRequest
	107, // 189: openshell.v1.OpenShell.LintProviderProfiles:input_type -> openshell.v1.LintProviderProfilesRequest
	73,  // 190: openshell.v1.OpenShell.UpdateProvider:input_type -> openshell.v1.UpdateProviderRequest
	91,  // 191: openshell.v1.OpenShell.GetProviderRefreshStatus:input_type -> openshell.v1.GetProviderRefreshStatusRequest
	93,  // 192: openshell.v1.OpenShell.ConfigureProviderRefresh:input_type -> openshell.v1.ConfigureProviderRefreshRequest
	95,  // 193: openshell.v1.OpenShell.RotateProviderCredential:input_type -> openshell.v1.RotateProviderCredentialRequest
	97,  // 194: openshell.v1.OpenShell.DeleteProviderRefresh:input_type -> openshell.v1.DeleteProviderRefreshRequest
	74,  // 195: openshell.v1.OpenShell.DeleteProvider:input_type -> openshell.v1.DeleteProviderRequest
	110, // 196: openshell.v1.OpenShell.DeleteProviderProfile:input_type -> openshell.v1.DeleteProviderProfileRequest
	235, // 197: openshell.v1.OpenShell.GetSandboxConfig:input_type -> openshell.sandbox.v1.GetSandboxConfigRequest
	236, // 198: openshell.v1.OpenShell.GetGatewayConfig:input_type -> openshell.sandbox.v1.GetGatewayConfigRequest
	116, // 199: openshell.v1.OpenShell.UpdateConfig:input_type -> openshell.v1.UpdateConfigRequest
	125, // 200: openshell.v1.OpenShell.GetSandboxPolicyStatus:input_type -> openshell.v1.GetSandboxPolicyStatusRequest
	127, // 201: openshell.v1.OpenShell.ListSandboxPolicies:input_type -> openshell.v1.ListSandboxPoliciesRequest
	129, // 202: openshell.v1.OpenShell.ReportPolicyStatus:input_type -> openshell.v1.ReportPolicyStatusRequest
	112, // 203: openshell.v1.OpenShell.GetSandboxProviderEnvironment:input_type -> openshell.v1.GetSandboxProviderEnvironmentRequest
	132, // 204: openshell.v1.OpenShell.GetSandboxLogs:input_type -> openshell.v1.GetSandboxLogsRequest
	133, // 205: openshell.v1.OpenShell.PushSandboxLogs:input_type -> openshell.v1.PushSandboxLogsRequest
	136, // 206: openshell.v1.OpenShell.ConnectSupervisor:input_type -> openshell.v1.SupervisorMessage
	149, // 207: openshell.v1.OpenShell.RelayStream:input_type -> openshell.v1.RelayFrame
	66,  // 208: openshell.v1.OpenShell.WatchSandbox:input_type -> openshell.v1.WatchSandboxRequest
	158, // 209: openshell.v1.OpenShell.SubmitPolicyAnalysis:input_type -> openshell.v1.SubmitPolicyAnalysisRequest
	160, // 210: openshell.v1.OpenShell.GetDraftPolicy:input_type -> openshell.v1.GetDraftPolicyRequest
	162, // 211: openshell.v1.OpenShell.ApproveDraftChunk:input_type -> openshell.v1.ApproveDraftChunkRequest
	164, // 212: openshell.v1.OpenShell.RejectDraftChunk:input_type -> openshell.v1.RejectDraftChunkRequest
	166, // 213: openshell.v1.OpenShell.ApproveAllDraftChunks:input_type -> openshell.v1.ApproveAllDraftChunksRequest
	168, // 214: openshell.v1.OpenShell.EditDraftChunk:input_type -> openshell.v1.EditDraftChunkRequest
	170, // 215: openshell.v1.OpenShell.UndoDraftChunk:input_type -> openshell.v1.UndoDraftChunkRequest
	172, // 216: openshell.v1.OpenShell.ClearDraftChunks:input_type -> openshell.v1.ClearDraftChunksRequest
	174, // 217: openshell.v1.OpenShell.GetDraftHistory:input_type -> openshell.v1.GetDraftHistoryRequest
	7,   // 218: openshell.v1.OpenShell.IssueSandboxToken:input_type -> openshell.v1.IssueSandboxTokenRequest
	9,   // 219: openshell.v1.OpenShell.RefreshSandboxToken:input_type -> openshell.v1.RefreshSandboxTokenRequest
	181, // 220: openshell.v1.OpenShell.CreateWorkspace:input_type -> openshell.v1.CreateWorkspaceRequest
	183, // 221: openshell.v1.OpenShell.GetWorkspace:input_type -> openshell.v1.GetWorkspaceRequest
	185, // 222: openshell.v1.OpenShell.ListWorkspaces:input_type -> openshell.v1.ListWorkspacesRequest
	187, // 223: openshell.v1.OpenShell.DeleteWorkspace:input_type -> openshell.v1.DeleteWorkspaceRequest
	190, // 224: openshell.v1.OpenShell.AddWorkspaceMember:input_type -> openshell.v1.AddWorkspaceMemberRequest
	192, // 225: openshell.v1.OpenShell.RemoveWorkspaceMember:input_type -> openshell.v1.RemoveWorkspaceMemberRequest
	194, // 226: openshell.v1.OpenShell.ListWorkspaceMembers:input_type -> openshell.v1.ListWorkspaceMembersRequest
	12,  // 227: openshell.v1.OpenShell.Health:output_type -> openshell.v1.HealthResponse
	14,  // 228: openshell.v1.OpenShell.GetCurrentUser:output_type -> openshell.v1.GetCurrentUserResponse
	16,  // 229: openshell.v1.OpenShell.GetGatewayInfo:output_type -> openshell.v1.GetGatewayInfoResponse
	38,  // 230: openshell.v1.OpenShell.CreateSandbox:output_type -> openshell.v1.SandboxResponse
	38,  // 231: openshell.v1.OpenShell.GetSandbox:output_type -> openshell.v1.SandboxResponse
	39,  // 232: openshell.v1.OpenShell.ListSandboxes:output_type -> openshell.v1.ListSandboxesResponse
	40,  // 233: openshell.v1.OpenShell.ListSandboxProviders:output_type -> openshell.v1.ListSandboxProvidersResponse
	41,  // 234: openshell.v1.OpenShell.AttachSandboxProvider:output_type -> openshell.v1.AttachSandboxProviderResponse
	42,  // 235: openshell.v1.OpenShell.DetachSandboxProvider:output_type -> openshell.v1.DetachSandboxProviderResponse
	43,  // 236: openshell.v1.OpenShell.DeleteSandbox:output_type -> openshell.v1.DeleteSandboxResponse
	38,  // 237: openshell.v1.OpenShell.StopSandbox:output_type -> openshell.v1.SandboxResponse
	38,  // 238: openshell.v1.OpenShell.StartSandbox:output_type -> openshell.v1.SandboxResponse
	45,  // 239: openshell.v1.OpenShell.CreateSshSession:output_type -> openshell.v1.CreateSshSessionResponse
	53,  // 240: openshell.v1.OpenShell.ExposeService:output_type -> openshell.v1.ServiceEndpointResponse
	53,  // 241: openshell.v1.OpenShell.GetService:output_type -> openshell.v1.ServiceEndpointResponse
	49,  // 242: openshell.v1.OpenShell.ListServices:output_type -> openshell.v1.ListServicesResponse
	51,  // 243: openshell.v1.OpenShell.DeleteService:output_type -> openshell.v1.DeleteServiceResponse
	55,  // 244: openshell.v1.OpenShell.RevokeSshSession:output_type -> openshell.v1.RevokeSshSessionResponse
	60,  // 245: openshell.v1.OpenShell.ExecSandbox:output_type -> openshell.v1.ExecSandboxEvent
	62,  // 246: openshell.v1.OpenShell.ForwardTcp:output_type -> openshell.v1.TcpForwardFrame
	60,  // 247: openshell.v1.OpenShell.ExecSandboxInteractive:output_type -> openshell.v1.ExecSandboxEvent
	75,  // 248: openshell.v1.OpenShell.CreateProvider:output_type -> openshell.v1.ProviderResponse
	75,  // 249: openshell.v1.OpenShell.GetProvider:output_type -> openshell.v1.ProviderResponse
	76,  // 250: openshell.v1.OpenShell.ListProviders:output_type -> openshell.v1.ListProvidersResponse
	102, // 251: openshell.v1.OpenShell.ListProviderProfiles:output_type -> openshell.v1.ListProviderProfilesResponse
	101, // 252: openshell.v1.OpenShell.GetProviderProfile:output_type -> openshell.v1.ProviderProfileResponse
	104, // 253: openshell.v1.OpenShell.ImportProviderProfiles:output_type -> openshell.v1.ImportProviderProfilesResponse
	106, // 254: openshell.v1.OpenShell.UpdateProviderProfiles:output_type -> openshell.v1.UpdateProviderProfilesResponse
	108, // 255: openshell.v1.OpenShell.LintProviderProfiles:output_type -> openshell.v1.LintProviderProfilesResponse
	75,  // 256: openshell.v1.OpenShell.UpdateProvider:output_type -> openshell.v1.ProviderResponse
	92,  // 257: openshell.v1.OpenShell.GetProviderRefreshStatus:output_type -> openshell.v1.GetProviderRefreshStatusResponse
	94,  // 258: openshell.v1.OpenShell.ConfigureProviderRefresh:output_type -> openshell.v1.ConfigureProviderRefreshResponse
	96,  // 259: openshell.v1.OpenShell.RotateProviderCredential:output_type -> openshell.v1.RotateProviderCredentialResponse
	98,  // 260: openshell.v1.OpenShell.DeleteProviderRefresh:output_type -> openshell.v1.DeleteProviderRefreshResponse
	109, // 261: openshell.v1.OpenShell.DeleteProvider:output_type -> openshell.v1.DeleteProviderResponse
	111, // 262: openshell.v1.OpenShell.DeleteProviderProfile:output_type -> openshell.v1.DeleteProviderProfileResponse
	237, // 263: openshell.v1.OpenShell.GetSandboxConfig:output_type -> openshell.sandbox.v1.GetSandboxConfigResponse
	238, // 264: openshell.v1.OpenShell.GetGatewayConfig:output_type -> openshell.sandbox.v1.GetGatewayConfigResponse
	124, // 265: openshell.v1.OpenShell.UpdateConfig:output_type -> openshell.v1.UpdateConfigResponse
	126, // 266: openshell.v1.OpenShell.GetSandboxPolicyStatus:output_type -> openshell.v1.GetSandboxPolicyStatusResponse
	128, // 267: openshell.v1.OpenShell.ListSandboxPolicies:output_type -> openshell.v1.ListSandboxPoliciesResponse
	130, // 268: openshell.v1.OpenShell.ReportPolicyStatus:output_type -> openshell.v1.ReportPolicyStatusResponse
	115, // 269: openshell.v1.OpenShell.GetSandboxProviderEnvironment:output_type -> openshell.v1.GetSandboxProviderEnvironmentResponse
	135, // 270: openshell.v1.OpenShell.GetSandboxLogs:output_type -> openshell.v1.GetSandboxLogsResponse
	134, // 271: openshell.v1.OpenShell.PushSandboxLogs:output_type -> openshell.v1.PushSandboxLogsResponse
	137, // 272: openshell.v1.OpenShell.ConnectSupervisor:output_type -> openshell.v1.GatewayMessage
	149, // 273: openshell.v1.OpenShell.RelayStream:output_type -> openshell.v1.RelayFrame
	67,  // 274: openshell.v1.OpenShell.WatchSandbox:output_type -> openshell.v1.SandboxStreamEvent
	159, // 275: openshell.v1.OpenShell.SubmitPolicyAnalysis:output_type -> openshell.v1.SubmitPolicyAnalysisResponse
	161, // 276: openshell.v1.OpenShell.GetDraftPolicy:output_type -> openshell.v1.GetDraftPolicyResponse
	163, // 277: openshell.v1.OpenShell.ApproveDraftChunk:output_type -> openshell.v1.ApproveDraftChunkResponse
	165, // 278: openshell.v1.OpenShell.RejectDraftChunk:output_type -> openshell.v1.RejectDraftChunkResponse
	167, // 279: openshell.v1.OpenShell.ApproveAllDraftChunks:output_type -> openshell.v1.ApproveAllDraftChunksResponse
	169, // 280: openshell.v1.OpenShell.EditDraftChunk:output_type -> openshell.v1.EditDraftChunkResponse
	171, // 281: openshell.v1.OpenShell.UndoDraftChunk:output_type -> openshell.v1.UndoDraftChunkResponse
	173, // 282: openshell.v1.OpenShell.ClearDraftChunks:output_type -> openshell.v1.ClearDraftChunksResponse
	176, // 283: openshell.v1.OpenShell.GetDraftHistory:output_type -> openshell.v1.GetDraftHistoryResponse
	8,   // 284: openshell.v1.OpenShell.IssueSandboxToken:output_type -> openshell.v1.IssueSandboxTokenResponse
	10,  // 285: openshell.v1.OpenShell.RefreshSandboxToken:output_type -> openshell.v1.RefreshSandboxTokenResponse
	182, // 286: openshell.v1.OpenShell.CreateWorkspace:output_type -> openshell.v1.CreateWorkspaceResponse
	184, // 287: openshell.v1.OpenShell.GetWorkspace:output_type -> openshell.v1.GetWorkspaceResponse
	186, // 288: openshell.v1.OpenShell.ListWorkspaces:output_type -> openshell.v1.ListWorkspacesResponse
	188, // 289: openshell.v1.OpenShell.DeleteWorkspace:output_type -> openshell.v1.DeleteWorkspaceResponse
	191, // 290: openshell.v1.OpenShell.AddWorkspaceMember:output_type -> openshell.v1.AddWorkspaceMemberResponse
	193, // 291: openshell.v1.OpenShell.RemoveWorkspaceMember:output_type -> openshell.v1.RemoveWorkspaceMemberResponse
	195, // 292: openshell.v1.OpenShell.ListWorkspaceMembers:output_type -> openshell.v1.ListWorkspaceMembersResponse
...
func file_openshell_proto_init() {
	...
	file_openshell_proto_msgTypes[110].OneofWrappers = []any{
	...
	file_openshell_proto_msgTypes[129].OneofWrappers = []any{
		...
		(*SupervisorMessage_MainProcessExit)(nil),
	}
	file_openshell_proto_msgTypes[130].OneofWrappers = []any{
		...
		(*GatewayMessage_MainProcessExitAck)(nil),
	}
