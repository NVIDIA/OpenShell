...
type CpuResourceCapabilities struct {
	...
	// The driver accepts a portable CPU request independent of its limit.
	RequestSupported bool `protobuf:"varint,2,opt,name=request_supported,json=requestSupported,proto3" json:"request_supported,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *CpuResourceCapabilities) GetRequestSupported() bool {
	if x != nil {
		return x.RequestSupported
	}
	return false
}
...
type MemoryResourceCapabilities struct {
	...
	LimitSupported bool `protobuf:"varint,1,opt,name=limit_supported,json=limitSupported,proto3" json:"limit_supported,omitempty"`
	// The driver accepts a portable memory request independent of its limit.
	RequestSupported bool `protobuf:"varint,2,opt,name=request_supported,json=requestSupported,proto3" json:"request_supported,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *MemoryResourceCapabilities) GetRequestSupported() bool {
	if x != nil {
		return x.RequestSupported
	}
	return false
...
type ResourceRequirements struct {
	...
	Cpu *CpuResourceRequirements `protobuf:"bytes,2,opt,name=cpu,proto3" json:"cpu,omitempty"`
	// Memory requirements for the sandbox workload.
	Memory        *MemoryResourceRequirements `protobuf:"bytes,3,opt,name=memory,proto3" json:"memory,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ResourceRequirements) GetCpu() *CpuResourceRequirements {
	if x != nil {
		return x.Cpu
	}
	return nil
...
func (x *ResourceRequirements) GetMemory() *MemoryResourceRequirements {
	if x != nil {
		return x.Memory
	}
	return nil
...
// Public CPU resource requirements.
type CpuResourceRequirements struct {
	...
	// CPU request for the sandbox workload (e.g. "250m", "1").
	Request       *string `protobuf:"bytes,2,opt,name=request,proto3,oneof" json:"request,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CpuResourceRequirements) Reset() {
	*x = CpuResourceRequirements{}
	mi := &file_openshell_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CpuResourceRequirements) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CpuResourceRequirements) ProtoMessage() {}

func (x *CpuResourceRequirements) ProtoReflect() protoreflect.Message {
	mi := &file_openshell_proto_msgTypes[20]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CpuResourceRequirements.ProtoReflect.Descriptor instead.
func (*CpuResourceRequirements) Descriptor() ([]byte, []int) {
	return file_openshell_proto_rawDescGZIP(), []int{20}
}

func (x *CpuResourceRequirements) GetLimit() string {
...
func (x *CpuResourceRequirements) GetRequest() string {
...
// Public memory resource requirements.
type MemoryResourceRequirements struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Memory limit for the sandbox workload (e.g. "512Mi", "4Gi").
	Limit *string `protobuf:"bytes,1,opt,name=limit,proto3,oneof" json:"limit,omitempty"`
	// Memory request for the sandbox workload (e.g. "256Mi", "2Gi").
	Request       *string `protobuf:"bytes,2,opt,name=request,proto3,oneof" json:"request,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *MemoryResourceRequirements) Reset() {
	*x = MemoryResourceRequirements{}
	mi := &file_openshell_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MemoryResourceRequirements) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MemoryResourceRequirements) ProtoMessage() {}

func (x *MemoryResourceRequirements) ProtoReflect() protoreflect.Message {
	mi := &file_openshell_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MemoryResourceRequirements.ProtoReflect.Descriptor instead.
func (*MemoryResourceRequirements) Descriptor() ([]byte, []int) {
	return file_openshell_proto_rawDescGZIP(), []int{21}
}

func (x *MemoryResourceRequirements) GetLimit() string {
	if x != nil && x.Limit != nil {
		return *x.Limit
	}
	return ""
...
func (x *MemoryResourceRequirements) GetRequest() string {
	if x != nil && x.Request != nil {
		return *x.Request
	}
	return ""
...
type SandboxTemplate struct {
	...
	// Platform-specific resource passthrough. CPU and memory under
	// limits/requests are rejected; use ResourceRequirements.cpu/memory instead.
...
func (x *SandboxWorkloadConfig) GetResources() *ResourceRequirements {
	if x != nil {
		return x.Resources
	}
	return nil
...
const file_openshell_proto_rawDesc = "" +
	...
	"\x03gpu\x18\x03 \x01(\v2%.openshell.v1.GpuResourceCapabilitiesR\x03gpu\"o\n" +
	"\x17CpuResourceCapabilities\x12'\n" +
	"\x0flimit_supported\x18\x01 \x01(\bR\x0elimitSupported\x12+\n" +
	"\x11request_supported\x18\x02 \x01(\bR\x10requestSupported\"r\n" +
	"\x1aMemoryResourceCapabilities\x12'\n" +
	"\x0flimit_supported\x18\x01 \x01(\bR\x0elimitSupported\x12+\n" +
	"\x11request_supported\x18\x02 \x01(\bR\x10requestSupported\"\x95\x01\n" +
	...
	"\x06_count\"i\n" +
	"\x17CpuResourceRequirements\x12\x19\n" +
	"\x05limit\x18\x01 \x01(\tH\x00R\x05limit\x88\x01\x01\x12\x1d\n" +
	"\arequest\x18\x02 \x01(\tH\x01R\arequest\x88\x01\x01B\b\n" +
	"\x06_limitB\n" +
	"\n" +
	"\b_request\"l\n" +
	"\x1aMemoryResourceRequirements\x12\x19\n" +
	"\x05limit\x18\x01 \x01(\tH\x00R\x05limit\x88\x01\x01\x12\x1d\n" +
	"\arequest\x18\x02 \x01(\tH\x01R\arequest\x88\x01\x01B\b\n" +
	"\x06_limitB\n" +
	"\n" +
...
var file_openshell_proto_goTypes = []any{
	...
	(*CpuResourceRequirements)(nil),                      // 36: openshell.v1.CpuResourceRequirements
	(*MemoryResourceRequirements)(nil),                   // 37: openshell.v1.MemoryResourceRequirements
...
var file_openshell_proto_depIdxs = []int32{
	...
	36,  // 21: openshell.v1.ResourceRequirements.cpu:type_name -> openshell.v1.CpuResourceRequirements
	37,  // 22: openshell.v1.ResourceRequirements.memory:type_name -> openshell.v1.MemoryResourceRequirements
	240, // 23: openshell.v1.SandboxTemplate.labels:type_name -> openshell.v1.SandboxTemplate.LabelsEntry
	241, // 24: openshell.v1.SandboxTemplate.annotations:type_name -> openshell.v1.SandboxTemplate.AnnotationsEntry
	242, // 25: openshell.v1.SandboxTemplate.environment:type_name -> openshell.v1.SandboxTemplate.EnvironmentEntry
	263, // 26: openshell.v1.SandboxTemplate.resources:type_name -> google.protobuf.Struct
	263, // 27: openshell.v1.SandboxTemplate.driver_config:type_name -> google.protobuf.Struct
	261, // 28: openshell.v1.SandboxWorkloadTemplate.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	...
	263, // 31: openshell.v1.SandboxWorkloadTemplateSpec.driver_config:type_name -> google.protobuf.Struct
	42,  // 32: openshell.v1.SandboxWorkloadTemplateSpec.desired_service_level:type_name -> openshell.v1.SandboxServiceLevel
	243, // 33: openshell.v1.SandboxWorkloadConfig.environment:type_name -> openshell.v1.SandboxWorkloadConfig.EnvironmentEntry
	34,  // 34: openshell.v1.SandboxWorkloadConfig.resources:type_name -> openshell.v1.ResourceRequirements
	43,  // 35: openshell.v1.SandboxServiceLevel.startup:type_name -> openshell.v1.SandboxStartup
	264, // 36: openshell.v1.SandboxStartup.ready_within:type_name -> google.protobuf.Duration
	46,  // 37: openshell.v1.SandboxStatus.conditions:type_name -> openshell.v1.SandboxCondition
	0,   // 38: openshell.v1.SandboxStatus.phase:type_name -> openshell.v1.SandboxPhase
	238, // 39: openshell.v1.SandboxStatus.endpoint_statuses:type_name -> openshell.v1.EndpointStatus
	260, // 40: openshell.v1.SandboxCondition.transition_time:type_name -> google.protobuf.Timestamp
	260, // 41: openshell.v1.PlatformEvent.event_time:type_name -> google.protobuf.Timestamp
	244, // 42: openshell.v1.PlatformEvent.metadata:type_name -> openshell.v1.PlatformEvent.MetadataEntry
	33,  // 43: openshell.v1.CreateSandboxRequest.spec:type_name -> openshell.v1.SandboxSpec
	245, // 44: openshell.v1.CreateSandboxRequest.labels:type_name -> openshell.v1.CreateSandboxRequest.LabelsEntry
	246, // 45: openshell.v1.CreateSandboxRequest.annotations:type_name -> openshell.v1.CreateSandboxRequest.AnnotationsEntry
	265, // 46: openshell.v1.CreateSandboxRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	39,  // 47: openshell.v1.CreateSandboxTemplateRequest.template:type_name -> openshell.v1.SandboxWorkloadTemplate
	265, // 48: openshell.v1.CreateSandboxTemplateRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 49: openshell.v1.GetSandboxTemplateRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 50: openshell.v1.ListSandboxTemplatesRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 51: openshell.v1.DeleteSandboxTemplateRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	39,  // 52: openshell.v1.SandboxTemplateResponse.template:type_name -> openshell.v1.SandboxWorkloadTemplate
	39,  // 53: openshell.v1.ListSandboxTemplatesResponse.templates:type_name -> openshell.v1.SandboxWorkloadTemplate
	14,  // 54: openshell.v1.DeleteSandboxTemplateResponse.outcome:type_name -> openshell.v1.DeletionOutcome
	265, // 55: openshell.v1.BeginRootfsTarStagingRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	260, // 56: openshell.v1.BeginRootfsTarStagingResponse.expiration_time:type_name -> google.protobuf.Timestamp
	265, // 57: openshell.v1.GetSandboxRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 58: openshell.v1.ListSandboxesRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 59: openshell.v1.ListSandboxProvidersRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 60: openshell.v1.AttachSandboxProviderRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 61: openshell.v1.DetachSandboxProviderRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 62: openshell.v1.DeleteSandboxRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 63: openshell.v1.StopSandboxRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 64: openshell.v1.StartSandboxRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	32,  // 65: openshell.v1.SandboxResponse.sandbox:type_name -> openshell.v1.Sandbox
	32,  // 66: openshell.v1.ListSandboxesResponse.sandboxes:type_name -> openshell.v1.Sandbox
	266, // 67: openshell.v1.ListSandboxProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	32,  // 68: openshell.v1.AttachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	75,  // 69: openshell.v1.AttachSandboxProviderResponse.receipt:type_name -> openshell.v1.ProviderMutationReceipt
	32,  // 70: openshell.v1.DetachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	75,  // 71: openshell.v1.DetachSandboxProviderResponse.receipt:type_name -> openshell.v1.ProviderMutationReceipt
	73,  // 72: openshell.v1.ConfigSnapshotRevision.sandbox_config:type_name -> openshell.v1.SandboxConfigRevision
	71,  // 73: openshell.v1.ConfigSnapshotRevision.provider_target:type_name -> openshell.v1.ProviderDesiredIdentity
	267, // 74: openshell.v1.SandboxConfigRevision.policy_source:type_name -> openshell.sandbox.v1.PolicySource
	4,   // 75: openshell.v1.ConfigUpdateOperation.component:type_name -> openshell.v1.ConfigComponent
	72,  // 76: openshell.v1.ConfigUpdateOperation.target_revision:type_name -> openshell.v1.ConfigSnapshotRevision
	6,   // 77: openshell.v1.ConfigUpdateOperation.state:type_name -> openshell.v1.ConfigUpdateOperationState
	5,   // 78: openshell.v1.ConfigUpdateOperation.outcome:type_name -> openshell.v1.ConfigApplyOutcome
	260, // 79: openshell.v1.ConfigUpdateOperation.created_time:type_name -> google.protobuf.Timestamp
	260, // 80: openshell.v1.ConfigUpdateOperation.updated_time:type_name -> google.protobuf.Timestamp
	260, // 81: openshell.v1.ConfigUpdateOperation.completed_time:type_name -> google.protobuf.Timestamp
	1,   // 82: openshell.v1.ProviderMutationReceipt.kind:type_name -> openshell.v1.ProviderMutationKind
	71,  // 83: openshell.v1.ProviderMutationReceipt.desired:type_name -> openshell.v1.ProviderDesiredIdentity
	260, // 84: openshell.v1.ProviderMutationReceipt.persisted_time:type_name -> google.protobuf.Timestamp
	3,   // 85: openshell.v1.ProviderReadinessObservation.reason:type_name -> openshell.v1.ProviderReadinessReason
	75,  // 86: openshell.v1.ProviderReadinessStatus.receipt:type_name -> openshell.v1.ProviderMutationReceipt
	2,   // 87: openshell.v1.ProviderReadinessStatus.state:type_name -> openshell.v1.ProviderReadinessState
	3,   // 88: openshell.v1.ProviderReadinessStatus.reason:type_name -> openshell.v1.ProviderReadinessReason
	76,  // 89: openshell.v1.ProviderReadinessStatus.observed:type_name -> openshell.v1.ProviderReadinessObservation
	260, // 90: openshell.v1.ProviderReadinessStatus.observed_time:type_name -> google.protobuf.Timestamp
	260, // 91: openshell.v1.ProviderReadinessStatus.evaluated_time:type_name -> google.protobuf.Timestamp
	74,  // 92: openshell.v1.ProviderReadinessStatus.operation:type_name -> openshell.v1.ConfigUpdateOperation
	265, // 93: openshell.v1.GetSandboxProviderStatusRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	77,  // 94: openshell.v1.GetSandboxProviderStatusResponse.status:type_name -> openshell.v1.ProviderReadinessStatus
	76,  // 95: openshell.v1.ReportProviderReadinessRequest.observation:type_name -> openshell.v1.ProviderReadinessObservation
	264, // 96: openshell.v1.ReportProviderReadinessResponse.report_interval:type_name -> google.protobuf.Duration
	264, // 97: openshell.v1.ReportProviderReadinessResponse.observation_ttl:type_name -> google.protobuf.Duration
	14,  // 98: openshell.v1.DeleteSandboxResponse.outcome:type_name -> openshell.v1.DeletionOutcome
	260, // 99: openshell.v1.CreateSshSessionResponse.expiration_time:type_name -> google.protobuf.Timestamp
	265, // 100: openshell.v1.ExposeServiceRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 101: openshell.v1.GetServiceRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 102: openshell.v1.ListServicesRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	92,  // 103: openshell.v1.ListServicesResponse.services:type_name -> openshell.v1.ServiceEndpointResponse
	265, // 104: openshell.v1.DeleteServiceRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	14,  // 105: openshell.v1.DeleteServiceResponse.outcome:type_name -> openshell.v1.DeletionOutcome
	261, // 106: openshell.v1.ServiceEndpoint.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	91,  // 107: openshell.v1.ServiceEndpointResponse.endpoint:type_name -> openshell.v1.ServiceEndpoint
	14,  // 108: openshell.v1.RevokeSshSessionResponse.outcome:type_name -> openshell.v1.DeletionOutcome
	247, // 109: openshell.v1.ExecSandboxRequest.environment:type_name -> openshell.v1.ExecSandboxRequest.EnvironmentEntry
	264, // 110: openshell.v1.ExecSandboxRequest.execution_timeout:type_name -> google.protobuf.Duration
	96,  // 111: openshell.v1.ExecSandboxEvent.stdout:type_name -> openshell.v1.ExecSandboxStdout
	97,  // 112: openshell.v1.ExecSandboxEvent.stderr:type_name -> openshell.v1.ExecSandboxStderr
	98,  // 113: openshell.v1.ExecSandboxEvent.exit:type_name -> openshell.v1.ExecSandboxExit
	187, // 114: openshell.v1.TcpForwardInit.ssh:type_name -> openshell.v1.SshRelayTarget
	188, // 115: openshell.v1.TcpForwardInit.tcp:type_name -> openshell.v1.TcpRelayTarget
	100, // 116: openshell.v1.TcpForwardFrame.init:type_name -> openshell.v1.TcpForwardInit
	95,  // 117: openshell.v1.ExecSandboxInput.start:type_name -> openshell.v1.ExecSandboxRequest
	103, // 118: openshell.v1.ExecSandboxInput.resize:type_name -> openshell.v1.ExecSandboxWindowResize
	261, // 119: openshell.v1.SshSession.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	260, // 120: openshell.v1.SshSession.expiration_time:type_name -> google.protobuf.Timestamp
	260, // 121: openshell.v1.WatchSandboxRequest.since_time:type_name -> google.protobuf.Timestamp
	32,  // 122: openshell.v1.SandboxStreamEvent.sandbox:type_name -> openshell.v1.Sandbox
	107, // 123: openshell.v1.SandboxStreamEvent.log:type_name -> openshell.v1.SandboxLogLine
	47,  // 124: openshell.v1.SandboxStreamEvent.event:type_name -> openshell.v1.PlatformEvent
	108, // 125: openshell.v1.SandboxStreamEvent.warning:type_name -> openshell.v1.SandboxStreamWarning
	198, // 126: openshell.v1.SandboxStreamEvent.draft_policy_update:type_name -> openshell.v1.DraftPolicyUpdate
	260, // 127: openshell.v1.SandboxLogLine.event_time:type_name -> google.protobuf.Timestamp
	248, // 128: openshell.v1.SandboxLogLine.fields:type_name -> openshell.v1.SandboxLogLine.FieldsEntry
	266, // 129: openshell.v1.CreateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	265, // 130: openshell.v1.CreateProviderRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 131: openshell.v1.GetProviderRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 132: openshell.v1.ListProvidersRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	266, // 133: openshell.v1.UpdateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	249, // 134: openshell.v1.UpdateProviderRequest.credential_expiration_times:type_name -> openshell.v1.UpdateProviderRequest.CredentialExpirationTimesEntry
	265, // 135: openshell.v1.UpdateProviderRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 136: openshell.v1.DeleteProviderRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	266, // 137: openshell.v1.ProviderResponse.provider:type_name -> openshell.datamodel.v1.Provider
	75,  // 138: openshell.v1.ProviderResponse.target_receipts:type_name -> openshell.v1.ProviderMutationReceipt
	266, // 139: openshell.v1.ListProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	137, // 140: openshell.v1.ProviderProfileImportItem.profile:type_name -> openshell.v1.ProviderProfile
	264, // 141: openshell.v1.ProviderCredentialTokenGrant.cache_ttl:type_name -> google.protobuf.Duration
	120, // 142: openshell.v1.ProviderCredentialTokenGrant.audience_overrides:type_name -> openshell.v1.ProviderCredentialTokenGrantAudienceOverride
	7,   // 143: openshell.v1.ProviderCredentialTokenGrant.grant_type:type_name -> openshell.v1.ProviderCredentialTokenGrantType
	121, // 144: openshell.v1.ProviderCredentialTokenGrant.subject_token:type_name -> openshell.v1.ProviderCredentialTokenGrantSubjectToken
	126, // 145: openshell.v1.ProviderProfileCredential.refresh:type_name -> openshell.v1.ProviderCredentialRefresh
	122, // 146: openshell.v1.ProviderProfileCredential.token_grant:type_name -> openshell.v1.ProviderCredentialTokenGrant
	8,   // 147: openshell.v1.ProviderCredentialRefresh.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	264, // 148: openshell.v1.ProviderCredentialRefresh.refresh_before:type_name -> google.protobuf.Duration
	264, // 149: openshell.v1.ProviderCredentialRefresh.max_lifetime:type_name -> google.protobuf.Duration
	124, // 150: openshell.v1.ProviderCredentialRefresh.material:type_name -> openshell.v1.ProviderCredentialRefreshMaterial
	125, // 151: openshell.v1.ProviderCredentialRefresh.additional_outputs:type_name -> openshell.v1.ProviderCredentialRefreshOutput
	8,   // 152: openshell.v1.ProviderCredentialRefreshStatus.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	260, // 153: openshell.v1.ProviderCredentialRefreshStatus.expiration_time:type_name -> google.protobuf.Timestamp
	260, // 154: openshell.v1.ProviderCredentialRefreshStatus.next_refresh_time:type_name -> google.protobuf.Timestamp
	260, // 155: openshell.v1.ProviderCredentialRefreshStatus.last_refresh_time:type_name -> google.protobuf.Timestamp
	13,  // 156: openshell.v1.ProviderCredentialRefreshStatus.recovery_action:type_name -> openshell.v1.ProviderCredentialRefreshRecoveryAction
	260, // 157: openshell.v1.ProviderCredentialRefreshStatus.last_error_time:type_name -> google.protobuf.Timestamp
	265, // 158: openshell.v1.GetProviderRefreshStatusRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	127, // 159: openshell.v1.GetProviderRefreshStatusResponse.credentials:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	8,   // 160: openshell.v1.ConfigureProviderRefreshRequest.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	250, // 161: openshell.v1.ConfigureProviderRefreshRequest.material:type_name -> openshell.v1.ConfigureProviderRefreshRequest.MaterialEntry
	260, // 162: openshell.v1.ConfigureProviderRefreshRequest.expiration_time:type_name -> google.protobuf.Timestamp
	265, // 163: openshell.v1.ConfigureProviderRefreshRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	127, // 164: openshell.v1.ConfigureProviderRefreshResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	265, // 165: openshell.v1.RotateProviderCredentialRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	127, // 166: openshell.v1.RotateProviderCredentialResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	265, // 167: openshell.v1.DeleteProviderRefreshRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	14,  // 168: openshell.v1.DeleteProviderRefreshResponse.outcome:type_name -> openshell.v1.DeletionOutcome
	9,   // 169: openshell.v1.ProviderProfile.category:type_name -> openshell.v1.ProviderProfileCategory
	123, // 170: openshell.v1.ProviderProfile.credentials:type_name -> openshell.v1.ProviderProfileCredential
	268, // 171: openshell.v1.ProviderProfile.endpoints:type_name -> openshell.sandbox.v1.NetworkEndpoint
	269, // 172: openshell.v1.ProviderProfile.binaries:type_name -> openshell.sandbox.v1.NetworkBinary
	128, // 173: openshell.v1.ProviderProfile.discovery:type_name -> openshell.v1.ProviderProfileDiscovery
	251, // 174: openshell.v1.ProviderProfile.annotations:type_name -> openshell.v1.ProviderProfile.AnnotationsEntry
	137, // 175: openshell.v1.ProviderProfileResponse.profile:type_name -> openshell.v1.ProviderProfile
	137, // 176: openshell.v1.ListProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	118, // 177: openshell.v1.ImportProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	119, // 178: openshell.v1.ImportProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	137, // 179: openshell.v1.ImportProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	118, // 180: openshell.v1.UpdateProviderProfilesRequest.profile:type_name -> openshell.v1.ProviderProfileImportItem
	119, // 181: openshell.v1.UpdateProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	137, // 182: openshell.v1.UpdateProviderProfilesResponse.profile:type_name -> openshell.v1.ProviderProfile
	118, // 183: openshell.v1.LintProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	119, // 184: openshell.v1.LintProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	14,  // 185: openshell.v1.DeleteProviderResponse.outcome:type_name -> openshell.v1.DeletionOutcome
	14,  // 186: openshell.v1.DeleteProviderProfileResponse.outcome:type_name -> openshell.v1.DeletionOutcome
	150, // 187: openshell.v1.StaticCredentialBinding.endpoints:type_name -> openshell.v1.StaticCredentialEndpointBinding
	252, // 188: openshell.v1.GetSandboxProviderEnvironmentResponse.environment:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.EnvironmentEntry
	253, // 189: openshell.v1.GetSandboxProviderEnvironmentResponse.credential_expiration_times:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.CredentialExpirationTimesEntry
	254, // 190: openshell.v1.GetSandboxProviderEnvironmentResponse.dynamic_credentials:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry
	255, // 191: openshell.v1.GetSandboxProviderEnvironmentResponse.static_credential_bindings:type_name -> openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry
	3,   // 192: openshell.v1.GetSandboxProviderEnvironmentResponse.readiness_reason:type_name -> openshell.v1.ProviderReadinessReason
	264, // 193: openshell.v1.ExchangeProviderSubjectTokenResponse.expires_after:type_name -> google.protobuf.Duration
	262, // 194: openshell.v1.UpdateConfigRequest.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	270, // 195: openshell.v1.UpdateConfigRequest.setting_value:type_name -> openshell.sandbox.v1.SettingValue
	156, // 196: openshell.v1.UpdateConfigRequest.merge_operations:type_name -> openshell.v1.PolicyMergeOperation
	256, // 197: openshell.v1.UpdateConfigRequest.annotations:type_name -> openshell.v1.UpdateConfigRequest.AnnotationsEntry
	265, // 198: openshell.v1.UpdateConfigRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	157, // 199: openshell.v1.PolicyMergeOperation.add_rule:type_name -> openshell.v1.AddNetworkRule
	158, // 200: openshell.v1.PolicyMergeOperation.remove_endpoint:type_name -> openshell.v1.RemoveNetworkEndpoint
	159, // 201: openshell.v1.PolicyMergeOperation.remove_rule:type_name -> openshell.v1.RemoveNetworkRule
	160, // 202: openshell.v1.PolicyMergeOperation.add_deny_rules:type_name -> openshell.v1.AddDenyRules
	161, // 203: openshell.v1.PolicyMergeOperation.add_allow_rules:type_name -> openshell.v1.AddAllowRules
	162, // 204: openshell.v1.PolicyMergeOperation.remove_binary:type_name -> openshell.v1.RemoveNetworkBinary
	271, // 205: openshell.v1.AddNetworkRule.rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	272, // 206: openshell.v1.AddDenyRules.deny_rules:type_name -> openshell.sandbox.v1.L7DenyRule
	273, // 207: openshell.v1.AddAllowRules.rules:type_name -> openshell.sandbox.v1.L7Rule
	257, // 208: openshell.v1.UpdateConfigResponse.annotations:type_name -> openshell.v1.UpdateConfigResponse.AnnotationsEntry
	265, // 209: openshell.v1.GetSandboxPolicyStatusRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	170, // 210: openshell.v1.GetSandboxPolicyStatusResponse.revision:type_name -> openshell.v1.SandboxPolicyRevision
	265, // 211: openshell.v1.ListSandboxPoliciesRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	170, // 212: openshell.v1.ListSandboxPoliciesResponse.revisions:type_name -> openshell.v1.SandboxPolicyRevision
	10,  // 213: openshell.v1.ReportPolicyStatusRequest.status:type_name -> openshell.v1.PolicyStatus
	10,  // 214: openshell.v1.SandboxPolicyRevision.status:type_name -> openshell.v1.PolicyStatus
	260, // 215: openshell.v1.SandboxPolicyRevision.created_time:type_name -> google.protobuf.Timestamp
	260, // 216: openshell.v1.SandboxPolicyRevision.loaded_time:type_name -> google.protobuf.Timestamp
	262, // 217: openshell.v1.SandboxPolicyRevision.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	258, // 218: openshell.v1.SandboxPolicyRevision.provenance:type_name -> openshell.v1.SandboxPolicyRevision.ProvenanceEntry
	260, // 219: openshell.v1.GetSandboxLogsRequest.since_time:type_name -> google.protobuf.Timestamp
	265, // 220: openshell.v1.GetSandboxLogsRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	107, // 221: openshell.v1.PushSandboxLogsRequest.logs:type_name -> openshell.v1.SandboxLogLine
	107, // 222: openshell.v1.GetSandboxLogsResponse.logs:type_name -> openshell.v1.SandboxLogLine
	177, // 223: openshell.v1.SupervisorMessage.hello:type_name -> openshell.v1.SupervisorHello
	180, // 224: openshell.v1.SupervisorMessage.heartbeat:type_name -> openshell.v1.SupervisorHeartbeat
	191, // 225: openshell.v1.SupervisorMessage.relay_open_result:type_name -> openshell.v1.RelayOpenResult
	192, // 226: openshell.v1.SupervisorMessage.relay_close:type_name -> openshell.v1.RelayClose
	178, // 227: openshell.v1.GatewayMessage.session_accepted:type_name -> openshell.v1.SessionAccepted
	179, // 228: openshell.v1.GatewayMessage.session_rejected:type_name -> openshell.v1.SessionRejected
	181, // 229: openshell.v1.GatewayMessage.heartbeat:type_name -> openshell.v1.GatewayHeartbeat
	186, // 230: openshell.v1.GatewayMessage.relay_open:type_name -> openshell.v1.RelayOpen
	192, // 231: openshell.v1.GatewayMessage.relay_close:type_name -> openshell.v1.RelayClose
	264, // 232: openshell.v1.SessionAccepted.heartbeat_interval:type_name -> google.protobuf.Duration
	187, // 233: openshell.v1.RelayOpen.ssh:type_name -> openshell.v1.SshRelayTarget
	188, // 234: openshell.v1.RelayOpen.tcp:type_name -> openshell.v1.TcpRelayTarget
	189, // 235: openshell.v1.RelayFrame.init:type_name -> openshell.v1.RelayInit
	260, // 236: openshell.v1.DenialSummary.first_seen_time:type_name -> google.protobuf.Timestamp
	260, // 237: openshell.v1.DenialSummary.last_seen_time:type_name -> google.protobuf.Timestamp
	193, // 238: openshell.v1.DenialSummary.l7_request_samples:type_name -> openshell.v1.L7RequestSample
	195, // 239: openshell.v1.NetworkActivitySummary.denials_by_group:type_name -> openshell.v1.DenialGroupCount
	271, // 240: openshell.v1.PolicyChunk.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	260, // 241: openshell.v1.PolicyChunk.created_time:type_name -> google.protobuf.Timestamp
	260, // 242: openshell.v1.PolicyChunk.decided_time:type_name -> google.protobuf.Timestamp
	260, // 243: openshell.v1.PolicyChunk.first_seen_time:type_name -> google.protobuf.Timestamp
	260, // 244: openshell.v1.PolicyChunk.last_seen_time:type_name -> google.protobuf.Timestamp
	262, // 245: openshell.v1.PolicyChunk.current_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	262, // 246: openshell.v1.PolicyChunk.candidate_effective_policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	194, // 247: openshell.v1.SubmitPolicyAnalysisRequest.summaries:type_name -> openshell.v1.DenialSummary
	197, // 248: openshell.v1.SubmitPolicyAnalysisRequest.proposed_chunks:type_name -> openshell.v1.PolicyChunk
	196, // 249: openshell.v1.SubmitPolicyAnalysisRequest.network_activity_summaries:type_name -> openshell.v1.NetworkActivitySummary
	265, // 250: openshell.v1.GetDraftPolicyRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	197, // 251: openshell.v1.GetDraftPolicyResponse.chunks:type_name -> openshell.v1.PolicyChunk
	260, // 252: openshell.v1.GetDraftPolicyResponse.last_analyzed_time:type_name -> google.protobuf.Timestamp
	265, // 253: openshell.v1.ApproveDraftChunkRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 254: openshell.v1.RejectDraftChunkRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	207, // 255: openshell.v1.ApproveAllDraftChunksRequest.approvals:type_name -> openshell.v1.DraftChunkApproval
	265, // 256: openshell.v1.ApproveAllDraftChunksRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	271, // 257: openshell.v1.EditDraftChunkRequest.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	265, // 258: openshell.v1.EditDraftChunkRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 259: openshell.v1.UndoDraftChunkRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 260: openshell.v1.ClearDraftChunksRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	265, // 261: openshell.v1.GetDraftHistoryRequest.workspace_scope:type_name -> openshell.datamodel.v1.WorkspaceSelector
	260, // 262: openshell.v1.DraftHistoryEntry.event_time:type_name -> google.protobuf.Timestamp
	217, // 263: openshell.v1.GetDraftHistoryResponse.entries:type_name -> openshell.v1.DraftHistoryEntry
	259, // 264: openshell.v1.CreateWorkspaceRequest.labels:type_name -> openshell.v1.CreateWorkspaceRequest.LabelsEntry
	274, // 265: openshell.v1.CreateWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	274, // 266: openshell.v1.GetWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	274, // 267: openshell.v1.ListWorkspacesResponse.workspaces:type_name -> openshell.datamodel.v1.Workspace
	14,  // 268: openshell.v1.DeleteWorkspaceResponse.outcome:type_name -> openshell.v1.DeletionOutcome
	261, // 269: openshell.v1.WorkspaceMember.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	12,  // 270: openshell.v1.WorkspaceMember.role:type_name -> openshell.v1.WorkspaceRole
	12,  // 271: openshell.v1.AddWorkspaceMemberRequest.role:type_name -> openshell.v1.WorkspaceRole
	227, // 272: openshell.v1.AddWorkspaceMemberResponse.member:type_name -> openshell.v1.WorkspaceMember
	14,  // 273: openshell.v1.RemoveWorkspaceMemberResponse.outcome:type_name -> openshell.v1.DeletionOutcome
	227, // 274: openshell.v1.ListWorkspaceMembersResponse.members:type_name -> openshell.v1.WorkspaceMember
	260, // 275: openshell.v1.ExtensionServiceCredential.expiration_time:type_name -> google.protobuf.Timestamp
	15,  // 276: openshell.v1.EndpointObservation.result:type_name -> openshell.v1.EndpointResult
	235, // 277: openshell.v1.ReportEndpointStatusRequest.observations:type_name -> openshell.v1.EndpointObservation
	15,  // 278: openshell.v1.EndpointStatus.last_result:type_name -> openshell.v1.EndpointResult
	260, // 279: openshell.v1.EndpointStatus.last_reported_time:type_name -> google.protobuf.Timestamp
	260, // 280: openshell.v1.UpdateProviderRequest.CredentialExpirationTimesEntry.value:type_name -> google.protobuf.Timestamp
	260, // 281: openshell.v1.GetSandboxProviderEnvironmentResponse.CredentialExpirationTimesEntry.value:type_name -> google.protobuf.Timestamp
	123, // 282: openshell.v1.GetSandboxProviderEnvironmentResponse.DynamicCredentialsEntry.value:type_name -> openshell.v1.ProviderProfileCredential
	151, // 283: openshell.v1.GetSandboxProviderEnvironmentResponse.StaticCredentialBindingsEntry.value:type_name -> openshell.v1.StaticCredentialBinding
	20,  // 284: openshell.v1.OpenShell.Health:input_type -> openshell.v1.HealthRequest
	22,  // 285: openshell.v1.OpenShell.GetCurrentUser:input_type -> openshell.v1.GetCurrentUserRequest
	24,  // 286: openshell.v1.OpenShell.GetGatewayInfo:input_type -> openshell.v1.GetGatewayInfoRequest
	48,  // 287: openshell.v1.OpenShell.CreateSandbox:input_type -> openshell.v1.CreateSandboxRequest
	56,  // 288: openshell.v1.OpenShell.BeginRootfsTarStaging:input_type -> openshell.v1.BeginRootfsTarStagingRequest
	58,  // 289: openshell.v1.OpenShell.GetSandbox:input_type -> openshell.v1.GetSandboxRequest
	59,  // 290: openshell.v1.OpenShell.ListSandboxes:input_type -> openshell.v1.ListSandboxesRequest
	49,  // 291: openshell.v1.OpenShell.CreateSandboxTemplate:input_type -> openshell.v1.CreateSandboxTemplateRequest
	50,  // 292: openshell.v1.OpenShell.GetSandboxTemplate:input_type -> openshell.v1.GetSandboxTemplateRequest
	51,  // 293: openshell.v1.OpenShell.ListSandboxTemplates:input_type -> openshell.v1.ListSandboxTemplatesRequest
	52,  // 294: openshell.v1.OpenShell.DeleteSandboxTemplate:input_type -> openshell.v1.DeleteSandboxTemplateRequest
	60,  // 295: openshell.v1.OpenShell.ListSandboxProviders:input_type -> openshell.v1.ListSandboxProvidersRequest
	61,  // 296: openshell.v1.OpenShell.AttachSandboxProvider:input_type -> openshell.v1.AttachSandboxProviderRequest
	62,  // 297: openshell.v1.OpenShell.DetachSandboxProvider:input_type -> openshell.v1.DetachSandboxProviderRequest
	78,  // 298: openshell.v1.OpenShell.GetSandboxProviderStatus:input_type -> openshell.v1.GetSandboxProviderStatusRequest
	63,  // 299: openshell.v1.OpenShell.DeleteSandbox:input_type -> openshell.v1.DeleteSandboxRequest
	64,  // 300: openshell.v1.OpenShell.StopSandbox:input_type -> openshell.v1.StopSandboxRequest
	65,  // 301: openshell.v1.OpenShell.StartSandbox:input_type -> openshell.v1.StartSandboxRequest
	83,  // 302: openshell.v1.OpenShell.CreateSshSession:input_type -> openshell.v1.CreateSshSessionRequest
	85,  // 303: openshell.v1.OpenShell.ExposeService:input_type -> openshell.v1.ExposeServiceRequest
	86,  // 304: openshell.v1.OpenShell.GetService:input_type -> openshell.v1.GetServiceRequest
	87,  // 305: openshell.v1.OpenShell.ListServices:input_type -> openshell.v1.ListServicesRequest
	89,  // 306: openshell.v1.OpenShell.DeleteService:input_type -> openshell.v1.DeleteServiceRequest
	93,  // 307: openshell.v1.OpenShell.RevokeSshSession:input_type -> openshell.v1.RevokeSshSessionRequest
	95,  // 308: openshell.v1.OpenShell.ExecSandbox:input_type -> openshell.v1.ExecSandboxRequest
	101, // 309: openshell.v1.OpenShell.ForwardTcp:input_type -> openshell.v1.TcpForwardFrame
	102, // 310: openshell.v1.OpenShell.ExecSandboxInteractive:input_type -> openshell.v1.ExecSandboxInput
	109, // 311: openshell.v1.OpenShell.CreateProvider:input_type -> openshell.v1.CreateProviderRequest
	110, // 312: openshell.v1.OpenShell.GetProvider:input_type -> openshell.v1.GetProviderRequest
	111, // 313: openshell.v1.OpenShell.ListProviders:input_type -> openshell.v1.ListProvidersRequest
	116, // 314: openshell.v1.OpenShell.ListProviderProfiles:input_type -> openshell.v1.ListProviderProfilesRequest
	117, // 315: openshell.v1.OpenShell.GetProviderProfile:input_type -> openshell.v1.GetProviderProfileRequest
	140, // 316: openshell.v1.OpenShell.ImportProviderProfiles:input_type -> openshell.v1.ImportProviderProfilesRequest
	142, // 317: openshell.v1.OpenShell.UpdateProviderProfiles:input_type -> openshell.v1.UpdateProviderProfilesRequest
	144, // 318: openshell.v1.OpenShell.LintProviderProfiles:input_type -> openshell.v1.LintProviderProfilesRequest
	112, // 319: openshell.v1.OpenShell.UpdateProvider:input_type -> openshell.v1.UpdateProviderRequest
	129, // 320: openshell.v1.OpenShell.GetProviderRefreshStatus:input_type -> openshell.v1.GetProviderRefreshStatusRequest
	131, // 321: openshell.v1.OpenShell.ConfigureProviderRefresh:input_type -> openshell.v1.ConfigureProviderRefreshRequest
	133, // 322: openshell.v1.OpenShell.RotateProviderCredential:input_type -> openshell.v1.RotateProviderCredentialRequest
	135, // 323: openshell.v1.OpenShell.DeleteProviderRefresh:input_type -> openshell.v1.DeleteProviderRefreshRequest
	113, // 324: openshell.v1.OpenShell.DeleteProvider:input_type -> openshell.v1.DeleteProviderRequest
	147, // 325: openshell.v1.OpenShell.DeleteProviderProfile:input_type -> openshell.v1.DeleteProviderProfileRequest
	275, // 326: openshell.v1.OpenShell.GetSandboxConfig:input_type -> openshell.sandbox.v1.GetSandboxConfigRequest
	276, // 327: openshell.v1.OpenShell.GetGatewayConfig:input_type -> openshell.sandbox.v1.GetGatewayConfigRequest
	155, // 328: openshell.v1.OpenShell.UpdateConfig:input_type -> openshell.v1.UpdateConfigRequest
	164, // 329: openshell.v1.OpenShell.GetSandboxPolicyStatus:input_type -> openshell.v1.GetSandboxPolicyStatusRequest
	166, // 330: openshell.v1.OpenShell.ListSandboxPolicies:input_type -> openshell.v1.ListSandboxPoliciesRequest
	168, // 331: openshell.v1.OpenShell.ReportPolicyStatus:input_type -> openshell.v1.ReportPolicyStatusRequest
	236, // 332: openshell.v1.OpenShell.ReportEndpointStatus:input_type -> openshell.v1.ReportEndpointStatusRequest
	80,  // 333: openshell.v1.OpenShell.ReportProviderReadiness:input_type -> openshell.v1.ReportProviderReadinessRequest
	149, // 334: openshell.v1.OpenShell.GetSandboxProviderEnvironment:input_type -> openshell.v1.GetSandboxProviderEnvironmentRequest
	153, // 335: openshell.v1.OpenShell.ExchangeProviderSubjectToken:input_type -> openshell.v1.ExchangeProviderSubjectTokenRequest
	171, // 336: openshell.v1.OpenShell.GetSandboxLogs:input_type -> openshell.v1.GetSandboxLogsRequest
	172, // 337: openshell.v1.OpenShell.PushSandboxLogs:input_type -> openshell.v1.PushSandboxLogsRequest
	175, // 338: openshell.v1.OpenShell.ConnectSupervisor:input_type -> openshell.v1.SupervisorMessage
	182, // 339: openshell.v1.OpenShell.ReportMainProcessExit:input_type -> openshell.v1.ReportMainProcessExitRequest
	184, // 340: openshell.v1.OpenShell.FinalizeMainProcessExit:input_type -> openshell.v1.FinalizeMainProcessExitRequest
	190, // 341: openshell.v1.OpenShell.RelayStream:input_type -> openshell.v1.RelayFrame
	105, // 342: openshell.v1.OpenShell.WatchSandbox:input_type -> openshell.v1.WatchSandboxRequest
	199, // 343: openshell.v1.OpenShell.SubmitPolicyAnalysis:input_type -> openshell.v1.SubmitPolicyAnalysisRequest
	201, // 344: openshell.v1.OpenShell.GetDraftPolicy:input_type -> openshell.v1.GetDraftPolicyRequest
	203, // 345: openshell.v1.OpenShell.ApproveDraftChunk:input_type -> openshell.v1.ApproveDraftChunkRequest
	205, // 346: openshell.v1.OpenShell.RejectDraftChunk:input_type -> openshell.v1.RejectDraftChunkRequest
	208, // 347: openshell.v1.OpenShell.ApproveAllDraftChunks:input_type -> openshell.v1.ApproveAllDraftChunksRequest
	210, // 348: openshell.v1.OpenShell.EditDraftChunk:input_type -> openshell.v1.EditDraftChunkRequest
	212, // 349: openshell.v1.OpenShell.UndoDraftChunk:input_type -> openshell.v1.UndoDraftChunkRequest
	214, // 350: openshell.v1.OpenShell.ClearDraftChunks:input_type -> openshell.v1.ClearDraftChunksRequest
	216, // 351: openshell.v1.OpenShell.GetDraftHistory:input_type -> openshell.v1.GetDraftHistoryRequest
	16,  // 352: openshell.v1.OpenShell.IssueSandboxToken:input_type -> openshell.v1.IssueSandboxTokenRequest
	18,  // 353: openshell.v1.OpenShell.RefreshSandboxToken:input_type -> openshell.v1.RefreshSandboxTokenRequest
	219, // 354: openshell.v1.OpenShell.CreateWorkspace:input_type -> openshell.v1.CreateWorkspaceRequest
	221, // 355: openshell.v1.OpenShell.GetWorkspace:input_type -> openshell.v1.GetWorkspaceRequest
	223, // 356: openshell.v1.OpenShell.ListWorkspaces:input_type -> openshell.v1.ListWorkspacesRequest
	225, // 357: openshell.v1.OpenShell.DeleteWorkspace:input_type -> openshell.v1.DeleteWorkspaceRequest
	228, // 358: openshell.v1.OpenShell.AddWorkspaceMember:input_type -> openshell.v1.AddWorkspaceMemberRequest
	230, // 359: openshell.v1.OpenShell.RemoveWorkspaceMember:input_type -> openshell.v1.RemoveWorkspaceMemberRequest
	232, // 360: openshell.v1.OpenShell.ListWorkspaceMembers:input_type -> openshell.v1.ListWorkspaceMembersRequest
	21,  // 361: openshell.v1.OpenShell.Health:output_type -> openshell.v1.HealthResponse
	23,  // 362: openshell.v1.OpenShell.GetCurrentUser:output_type -> openshell.v1.GetCurrentUserResponse
	25,  // 363: openshell.v1.OpenShell.GetGatewayInfo:output_type -> openshell.v1.GetGatewayInfoResponse
	66,  // 364: openshell.v1.OpenShell.CreateSandbox:output_type -> openshell.v1.SandboxResponse
	57,  // 365: openshell.v1.OpenShell.BeginRootfsTarStaging:output_type -> openshell.v1.BeginRootfsTarStagingResponse
	66,  // 366: openshell.v1.OpenShell.GetSandbox:output_type -> openshell.v1.SandboxResponse
	67,  // 367: openshell.v1.OpenShell.ListSandboxes:output_type -> openshell.v1.ListSandboxesResponse
	53,  // 368: openshell.v1.OpenShell.CreateSandboxTemplate:output_type -> openshell.v1.SandboxTemplateResponse
	53,  // 369: openshell.v1.OpenShell.GetSandboxTemplate:output_type -> openshell.v1.SandboxTemplateResponse
	54,  // 370: openshell.v1.OpenShell.ListSandboxTemplates:output_type -> openshell.v1.ListSandboxTemplatesResponse
	55,  // 371: openshell.v1.OpenShell.DeleteSandboxTemplate:output_type -> openshell.v1.DeleteSandboxTemplateResponse
	68,  // 372: openshell.v1.OpenShell.ListSandboxProviders:output_type -> openshell.v1.ListSandboxProvidersResponse
	69,  // 373: openshell.v1.OpenShell.AttachSandboxProvider:output_type -> openshell.v1.AttachSandboxProviderResponse
	70,  // 374: openshell.v1.OpenShell.DetachSandboxProvider:output_type -> openshell.v1.DetachSandboxProviderResponse
	79,  // 375: openshell.v1.OpenShell.GetSandboxProviderStatus:output_type -> openshell.v1.GetSandboxProviderStatusResponse
	82,  // 376: openshell.v1.OpenShell.DeleteSandbox:output_type -> openshell.v1.DeleteSandboxResponse
	66,  // 377: openshell.v1.OpenShell.StopSandbox:output_type -> openshell.v1.SandboxResponse
	66,  // 378: openshell.v1.OpenShell.StartSandbox:output_type -> openshell.v1.SandboxResponse
	84,  // 379: openshell.v1.OpenShell.CreateSshSession:output_type -> openshell.v1.CreateSshSessionResponse
	92,  // 380: openshell.v1.OpenShell.ExposeService:output_type -> openshell.v1.ServiceEndpointResponse
	92,  // 381: openshell.v1.OpenShell.GetService:output_type -> openshell.v1.ServiceEndpointResponse
	88,  // 382: openshell.v1.OpenShell.ListServices:output_type -> openshell.v1.ListServicesResponse
	90,  // 383: openshell.v1.OpenShell.DeleteService:output_type -> openshell.v1.DeleteServiceResponse
	94,  // 384: openshell.v1.OpenShell.RevokeSshSession:output_type -> openshell.v1.RevokeSshSessionResponse
	99,  // 385: openshell.v1.OpenShell.ExecSandbox:output_type -> openshell.v1.ExecSandboxEvent
	101, // 386: openshell.v1.OpenShell.ForwardTcp:output_type -> openshell.v1.TcpForwardFrame
	99,  // 387: openshell.v1.OpenShell.ExecSandboxInteractive:output_type -> openshell.v1.ExecSandboxEvent
	114, // 388: openshell.v1.OpenShell.CreateProvider:output_type -> openshell.v1.ProviderResponse
	114, // 389: openshell.v1.OpenShell.GetProvider:output_type -> openshell.v1.ProviderResponse
	115, // 390: openshell.v1.OpenShell.ListProviders:output_type -> openshell.v1.ListProvidersResponse
	139, // 391: openshell.v1.OpenShell.ListProviderProfiles:output_type -> openshell.v1.ListProviderProfilesResponse
	138, // 392: openshell.v1.OpenShell.GetProviderProfile:output_type -> openshell.v1.ProviderProfileResponse
	141, // 393: openshell.v1.OpenShell.ImportProviderProfiles:output_type -> openshell.v1.ImportProviderProfilesResponse
	143, // 394: openshell.v1.OpenShell.UpdateProviderProfiles:output_type -> openshell.v1.UpdateProviderProfilesResponse
	145, // 395: openshell.v1.OpenShell.LintProviderProfiles:output_type -> openshell.v1.LintProviderProfilesResponse
	114, // 396: openshell.v1.OpenShell.UpdateProvider:output_type -> openshell.v1.ProviderResponse
	130, // 397: openshell.v1.OpenShell.GetProviderRefreshStatus:output_type -> openshell.v1.GetProviderRefreshStatusResponse
	132, // 398: openshell.v1.OpenShell.ConfigureProviderRefresh:output_type -> openshell.v1.ConfigureProviderRefreshResponse
	134, // 399: openshell.v1.OpenShell.RotateProviderCredential:output_type -> openshell.v1.RotateProviderCredentialResponse
	136, // 400: openshell.v1.OpenShell.DeleteProviderRefresh:output_type -> openshell.v1.DeleteProviderRefreshResponse
	146, // 401: openshell.v1.OpenShell.DeleteProvider:output_type -> openshell.v1.DeleteProviderResponse
	148, // 402: openshell.v1.OpenShell.DeleteProviderProfile:output_type -> openshell.v1.DeleteProviderProfileResponse
	277, // 403: openshell.v1.OpenShell.GetSandboxConfig:output_type -> openshell.sandbox.v1.GetSandboxConfigResponse
	278, // 404: openshell.v1.OpenShell.GetGatewayConfig:output_type -> openshell.sandbox.v1.GetGatewayConfigResponse
	163, // 405: openshell.v1.OpenShell.UpdateConfig:output_type -> openshell.v1.UpdateConfigResponse
	165, // 406: openshell.v1.OpenShell.GetSandboxPolicyStatus:output_type -> openshell.v1.GetSandboxPolicyStatusResponse
	167, // 407: openshell.v1.OpenShell.ListSandboxPolicies:output_type -> openshell.v1.ListSandboxPoliciesResponse
	169, // 408: openshell.v1.OpenShell.ReportPolicyStatus:output_type -> openshell.v1.ReportPolicyStatusResponse
	237, // 409: openshell.v1.OpenShell.ReportEndpointStatus:output_type -> openshell.v1.ReportEndpointStatusResponse
	81,  // 410: openshell.v1.OpenShell.ReportProviderReadiness:output_type -> openshell.v1.ReportProviderReadinessResponse
	152, // 411: openshell.v1.OpenShell.GetSandboxProviderEnvironment:output_type -> openshell.v1.GetSandboxProviderEnvironmentResponse
	154, // 412: openshell.v1.OpenShell.ExchangeProviderSubjectToken:output_type -> openshell.v1.ExchangeProviderSubjectTokenResponse
	174, // 413: openshell.v1.OpenShell.GetSandboxLogs:output_type -> openshell.v1.GetSandboxLogsResponse
	173, // 414: openshell.v1.OpenShell.PushSandboxLogs:output_type -> openshell.v1.PushSandboxLogsResponse
	176, // 415: openshell.v1.OpenShell.ConnectSupervisor:output_type -> openshell.v1.GatewayMessage
	183, // 416: openshell.v1.OpenShell.ReportMainProcessExit:output_type -> openshell.v1.ReportMainProcessExitResponse
	185, // 417: openshell.v1.OpenShell.FinalizeMainProcessExit:output_type -> openshell.v1.FinalizeMainProcessExitResponse
	190, // 418: openshell.v1.OpenShell.RelayStream:output_type -> openshell.v1.RelayFrame
	106, // 419: openshell.v1.OpenShell.WatchSandbox:output_type -> openshell.v1.SandboxStreamEvent
	200, // 420: openshell.v1.OpenShell.SubmitPolicyAnalysis:output_type -> openshell.v1.SubmitPolicyAnalysisResponse
	202, // 421: openshell.v1.OpenShell.GetDraftPolicy:output_type -> openshell.v1.GetDraftPolicyResponse
	204, // 422: openshell.v1.OpenShell.ApproveDraftChunk:output_type -> openshell.v1.ApproveDraftChunkResponse
	206, // 423: openshell.v1.OpenShell.RejectDraftChunk:output_type -> openshell.v1.RejectDraftChunkResponse
	209, // 424: openshell.v1.OpenShell.ApproveAllDraftChunks:output_type -> openshell.v1.ApproveAllDraftChunksResponse
	211, // 425: openshell.v1.OpenShell.EditDraftChunk:output_type -> openshell.v1.EditDraftChunkResponse
	213, // 426: openshell.v1.OpenShell.UndoDraftChunk:output_type -> openshell.v1.UndoDraftChunkResponse
	215, // 427: openshell.v1.OpenShell.ClearDraftChunks:output_type -> openshell.v1.ClearDraftChunksResponse
	218, // 428: openshell.v1.OpenShell.GetDraftHistory:output_type -> openshell.v1.GetDraftHistoryResponse
	17,  // 429: openshell.v1.OpenShell.IssueSandboxToken:output_type -> openshell.v1.IssueSandboxTokenResponse
	19,  // 430: openshell.v1.OpenShell.RefreshSandboxToken:output_type -> openshell.v1.RefreshSandboxTokenResponse
	220, // 431: openshell.v1.OpenShell.CreateWorkspace:output_type -> openshell.v1.CreateWorkspaceResponse
	222, // 432: openshell.v1.OpenShell.GetWorkspace:output_type -> openshell.v1.GetWorkspaceResponse
	224, // 433: openshell.v1.OpenShell.ListWorkspaces:output_type -> openshell.v1.ListWorkspacesResponse
	226, // 434: openshell.v1.OpenShell.DeleteWorkspace:output_type -> openshell.v1.DeleteWorkspaceResponse
	229, // 435: openshell.v1.OpenShell.AddWorkspaceMember:output_type -> openshell.v1.AddWorkspaceMemberResponse
	231, // 436: openshell.v1.OpenShell.RemoveWorkspaceMember:output_type -> openshell.v1.RemoveWorkspaceMemberResponse
	233, // 437: openshell.v1.OpenShell.ListWorkspaceMembers:output_type -> openshell.v1.ListWorkspaceMembersResponse
	361, // [361:438] is the sub-list for method output_type
	284, // [284:361] is the sub-list for method input_type
