...
var file_openshell_proto_goTypes = []any{
	...
	(*policyv1.PolicyDocument)(nil),                      // 273: openshell.policy.v1.PolicyDocument
	...
	(*policyv1.NetworkEndpoint)(nil),                     // 279: openshell.policy.v1.NetworkEndpoint
	(*policyv1.NetworkBinary)(nil),                       // 280: openshell.policy.v1.NetworkBinary
	(*sandboxv1.SettingValue)(nil),                       // 281: openshell.sandbox.v1.SettingValue
	(*policyv1.NetworkPolicyRule)(nil),                   // 282: openshell.policy.v1.NetworkPolicyRule
	(*policyv1.L7DenyRule)(nil),                          // 283: openshell.policy.v1.L7DenyRule
	(*policyv1.L7Rule)(nil),                              // 284: openshell.policy.v1.L7Rule
...
var file_openshell_proto_depIdxs = []int32{
	...
	273, // 20: openshell.v1.SandboxSpec.policy:type_name -> openshell.policy.v1.PolicyDocument
	...
	279, // 181: openshell.v1.ProviderProfile.endpoints:type_name -> openshell.policy.v1.NetworkEndpoint
	280, // 182: openshell.v1.ProviderProfile.binaries:type_name -> openshell.policy.v1.NetworkBinary
	...
	273, // 209: openshell.v1.UpdateConfigRequest.policy:type_name -> openshell.policy.v1.PolicyDocument
	...
	282, // 219: openshell.v1.AddNetworkRule.rule:type_name -> openshell.policy.v1.NetworkPolicyRule
	280, // 220: openshell.v1.L7RuleTarget.binaries:type_name -> openshell.policy.v1.NetworkBinary
	283, // 221: openshell.v1.AddDenyRules.deny_rules:type_name -> openshell.policy.v1.L7DenyRule
	162, // 222: openshell.v1.AddDenyRules.target:type_name -> openshell.v1.L7RuleTarget
	284, // 223: openshell.v1.AddAllowRules.rules:type_name -> openshell.policy.v1.L7Rule
	...
	273, // 236: openshell.v1.SandboxPolicyRevision.policy:type_name -> openshell.policy.v1.PolicyDocument
	...
	282, // 261: openshell.v1.PolicyChunk.proposed_rule:type_name -> openshell.policy.v1.NetworkPolicyRule
	...
	273, // 266: openshell.v1.PolicyChunk.current_effective_policy:type_name -> openshell.policy.v1.PolicyDocument
	273, // 267: openshell.v1.PolicyChunk.candidate_effective_policy:type_name -> openshell.policy.v1.PolicyDocument
	...
	282, // 280: openshell.v1.EditDraftChunkRequest.proposed_rule:type_name -> openshell.policy.v1.NetworkPolicyRule
