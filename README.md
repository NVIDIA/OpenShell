...
> [!IMPORTANT]
> **OpenShell 0.1.0 is coming soon.** This release exits alpha and establishes stable APIs and clear upgrade expectations. [Track the 0.1.0 milestone](https://github.com/NVIDIA/OpenShell/milestone/10), [read the prerelease documentation](https://docs.nvidia.com/openshell/dev/index.html), or [try the prerelease](#prerelease-and-development-builds).
