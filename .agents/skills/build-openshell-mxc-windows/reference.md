...
| `.github/workflows/windows-msvc.yml` | PR/merge-queue x64 lint and test, main/manual cache seeding followed by binary builds, and a disabled ARM64 scaffold with architecture-specific Rust caches. |
