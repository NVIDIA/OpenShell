...
<Tip>
For an end-to-end walkthrough that combines this policy with a GitHub credential provider and sandbox creation, refer to [GitHub Sandbox](/get-started/github-sandbox).
</Tip>
...
- To learn about policy structure and network access rules, refer to [About Sandboxes](/sandboxes/index).
