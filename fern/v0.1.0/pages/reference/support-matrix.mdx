...
description: "Platform, software, runtime, and kernel requirements for running OpenShell."
---
...
For the full list of supported agents and their default policy coverage, refer to the [Supported Agents](/sandboxes/index#supported-agents) table.
