...
For details, refer to [Built-in Default Policy](/sandboxes/index#built-in-default-policy) and [Customize Sandbox Policies](/sandboxes/policies).
...
- To learn how OpenShell enforces isolation across all protection layers, refer to [Sandboxes](/sandboxes/index).
