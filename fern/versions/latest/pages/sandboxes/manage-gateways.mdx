...
- To create a sandbox using the gateway, refer to [Manage Sandboxes](/latest/sandboxes/manage-sandboxes).
- To install the CLI and get started quickly, refer to the [Quickstart](/latest/get-started/quickstart).
