...
- **Need to supply API keys or tokens?** Set up [Manage Providers](/latest/sandboxes/manage-providers) for credential management.
- **Want to customize the sandbox policy?** Write custom rules in [Policies](/latest/sandboxes/policies).
