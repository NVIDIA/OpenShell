...
For the full breakdown of each default policy block and agent compatibility details, refer to [Default Policy](/latest/reference/default-policy).

For the full policy structure with annotated YAML examples, refer to [Policies](/latest/sandboxes/policies).

## Next Steps

Continue with one of the following:

- To create your first sandbox, refer to [Manage Sandboxes](/latest/sandboxes/manage-sandboxes).
