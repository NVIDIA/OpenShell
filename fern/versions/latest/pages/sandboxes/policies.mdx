...
Use this page to apply and iterate policy changes on running sandboxes. For a full field-by-field YAML definition, use the [Policy Schema Reference](/latest/reference/policy-schema).
...
<Tip>
For an end-to-end walkthrough that combines this policy with a GitHub credential provider and sandbox creation, refer to [Github Sandbox](/latest/tutorials/github-sandbox).
...
- To learn about network access rules and sandbox isolation layers, refer to [Index](/latest/sandboxes).
- To view the full field-by-field YAML definition, refer to the [Policy Schema Reference](/latest/reference/policy-schema).
- To review the default policy breakdown, refer to [Default Policy](/latest/reference/default-policy).
