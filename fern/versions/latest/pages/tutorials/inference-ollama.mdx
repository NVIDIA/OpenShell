...
- To learn more about managed inference, refer to [Index](/latest/inference).
- To configure a different self-hosted backend, refer to [Configure](/latest/inference/configure).
- To explore more community sandboxes, refer to [Community Sandboxes](/latest/sandboxes/community-sandboxes).
