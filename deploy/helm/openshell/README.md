...
| server.drivers.kubernetes.resourceAdmission.requiredLabels | string | `nil` | Replacement label map; null uses built-in attachable/workspace labels. Empty map is invalid when enabled. |
