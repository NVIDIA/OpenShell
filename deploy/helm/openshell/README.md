...
| `<semver>-pre` (e.g. `0.1.0-pre`) | Latest qualified candidate for a release train | Floating prerelease version. `appVersion` points to the matching `pre-<semver>` image tag. |
