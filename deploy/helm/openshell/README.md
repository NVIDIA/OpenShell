...
| server.drivers.kubernetes.warmPool | object | `{"enabled":true,"maxIdleSeconds":3600,"maxPairs":10,"preparationTimeoutSeconds":300}` | Prepare and claim single-use sandbox/proxy pairs for templates with startup hints. |
