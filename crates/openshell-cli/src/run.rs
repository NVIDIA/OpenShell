...
use openshell_core::proto::{
    ...
    DeleteSandboxTemplateRequest, DeleteServiceRequest, EndpointResult, EndpointStatus,
    ExecSandboxRequest, ExposeServiceRequest, GetCurrentUserRequest, GetDraftHistoryRequest,
    ...
    GetSandboxRequest, GetSandboxTemplateRequest, GetServiceRequest, GpuResourceRequirements,
    ListSandboxPoliciesRequest, ListSandboxTemplatesRequest, ListSandboxesRequest,
    ListServicesRequest, MemoryResourceRequirements, PolicySource, PolicyStatus,
    RejectDraftChunkRequest, ResourceRequirements, RevokeSshSessionRequest, Sandbox,
    SandboxCondition, SandboxPhase, SandboxPolicy, SandboxServiceLevel, SandboxSpec,
...
mod tests {
    use super::{
        ...
        build_memory_resource_requirements, format_endpoint, format_log_line, git_sync_files,
    ...
    use openshell_core::proto::{
        ...
        SandboxPolicy, SandboxPolicyRevision, SandboxStatus, SandboxWorkloadConfig,
