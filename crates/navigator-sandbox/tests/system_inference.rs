...
use navigator_router::config::{AuthHeader, ResolvedRoute};
use navigator_sandbox::proxy::InferenceContext;
...
async fn system_inference_routes_to_mock_backend() {
    ...
    let patterns = navigator_sandbox::l7::inference::default_patterns();
