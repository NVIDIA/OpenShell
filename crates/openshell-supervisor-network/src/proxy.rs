...
"#;
    ...
    // -- parse_target: CONNECT target parser regression tests (#1498) --
    ...
    // -- parse_proxy_uri: hostname parser regression tests (#1498) --
    ...
    // -- SSRF: malformed hostname resolution regression tests (#1498) --
