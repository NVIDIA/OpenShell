...
impl OpenShell for TestOpenShell {
    ...
    async fn get_delegated_identity_authorization_status(
        &self,
        _request: tonic::Request<proto::GetDelegatedIdentityAuthorizationStatusRequest>,
    ) -> Result<Response<proto::GetDelegatedIdentityAuthorizationStatusResponse>, Status> {
        Err(Status::unimplemented("unused"))
    }

    async fn authorize_delegated_identity(
        &self,
        _request: tonic::Request<proto::AuthorizeDelegatedIdentityRequest>,
    ) -> Result<Response<proto::AuthorizeDelegatedIdentityResponse>, Status> {
        Err(Status::unimplemented("unused"))
    }
