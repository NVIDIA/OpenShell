...
mod tests {
    ...
    use super::{
        ActiveMachine, ComputeDriverKind, Config, DEFAULT_SERVICE_ROUTING_DOMAIN, GatewayJwtConfig,
        detect_driver, docker_host_unix_socket_path, explicit_unix_container_host, is_unix_socket,
