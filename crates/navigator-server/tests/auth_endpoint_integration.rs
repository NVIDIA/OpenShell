...
// ---------------------------------------------------------------------------
// Minimal Navigator for test 7 (plaintext gRPC+HTTP)
// ---------------------------------------------------------------------------
...
#[tonic::async_trait]
impl navigator_core::proto::navigator_server::Navigator for TestNavigator {
    async fn health(
        &self,
        _request: tonic::Request<navigator_core::proto::HealthRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::HealthResponse>, tonic::Status> {
        Ok(tonic::Response::new(
            navigator_core::proto::HealthResponse {
                status: navigator_core::proto::ServiceStatus::Healthy.into(),
    ...
    async fn create_sandbox(
        &self,
        _: tonic::Request<navigator_core::proto::CreateSandboxRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::SandboxResponse>, tonic::Status> {
        Ok(tonic::Response::new(
    ...
    async fn get_sandbox(
        &self,
        _: tonic::Request<navigator_core::proto::GetSandboxRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::SandboxResponse>, tonic::Status> {
        Ok(tonic::Response::new(
            navigator_core::proto::SandboxResponse::default(),
        ))
    ...
    async fn list_sandboxes(
        &self,
        _: tonic::Request<navigator_core::proto::ListSandboxesRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::ListSandboxesResponse>, tonic::Status> {
        Ok(tonic::Response::new(
    ...
    async fn delete_sandbox(
        &self,
        _: tonic::Request<navigator_core::proto::DeleteSandboxRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::DeleteSandboxResponse>, tonic::Status> {
        Ok(tonic::Response::new(
    ...
    async fn get_sandbox_policy(
        &self,
        _: tonic::Request<navigator_core::proto::GetSandboxPolicyRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::GetSandboxPolicyResponse>, tonic::Status>
    {
        Ok(tonic::Response::new(
    ...
    async fn get_sandbox_provider_environment(
        &self,
        _: tonic::Request<navigator_core::proto::GetSandboxProviderEnvironmentRequest>,
    ) -> Result<
        tonic::Response<navigator_core::proto::GetSandboxProviderEnvironmentResponse>,
        tonic::Status,
    > {
        Ok(tonic::Response::new(
    ...
    async fn create_ssh_session(
        &self,
        _: tonic::Request<navigator_core::proto::CreateSshSessionRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::CreateSshSessionResponse>, tonic::Status>
    {
        Ok(tonic::Response::new(
            navigator_core::proto::CreateSshSessionResponse::default(),
        ))
    }

    async fn revoke_ssh_session(
        &self,
        _: tonic::Request<navigator_core::proto::RevokeSshSessionRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::RevokeSshSessionResponse>, tonic::Status>
    {
        Ok(tonic::Response::new(
    ...
    async fn create_provider(
        &self,
        _: tonic::Request<navigator_core::proto::CreateProviderRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::ProviderResponse>, tonic::Status> {
        Err(tonic::Status::unimplemented("test"))
    }

    async fn get_provider(
        &self,
        _: tonic::Request<navigator_core::proto::GetProviderRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::ProviderResponse>, tonic::Status> {
        Err(tonic::Status::unimplemented("test"))
    }
    ...
    async fn list_providers(
        &self,
        _: tonic::Request<navigator_core::proto::ListProvidersRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::ListProvidersResponse>, tonic::Status> {
        Err(tonic::Status::unimplemented("test"))
    }

    async fn update_provider(
        &self,
        _: tonic::Request<navigator_core::proto::UpdateProviderRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::ProviderResponse>, tonic::Status> {
        Err(tonic::Status::unimplemented("test"))
    }
    ...
    async fn delete_provider(
        &self,
        _: tonic::Request<navigator_core::proto::DeleteProviderRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::DeleteProviderResponse>, tonic::Status> {
        Err(tonic::Status::unimplemented("test"))
    }

    type WatchSandboxStream = tokio_stream::wrappers::ReceiverStream<
        Result<navigator_core::proto::SandboxStreamEvent, tonic::Status>,
    >;
    type ExecSandboxStream = tokio_stream::wrappers::ReceiverStream<
        Result<navigator_core::proto::ExecSandboxEvent, tonic::Status>,
    >;

    async fn watch_sandbox(
        &self,
        _: tonic::Request<navigator_core::proto::WatchSandboxRequest>,
    ...
    async fn exec_sandbox(
        &self,
        _: tonic::Request<navigator_core::proto::ExecSandboxRequest>,
    ...
    async fn update_sandbox_policy(
        &self,
        _: tonic::Request<navigator_core::proto::UpdateSandboxPolicyRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::UpdateSandboxPolicyResponse>, tonic::Status>
    {
        Err(tonic::Status::unimplemented("test"))
    }
    ...
    async fn get_sandbox_policy_status(
        &self,
        _: tonic::Request<navigator_core::proto::GetSandboxPolicyStatusRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::GetSandboxPolicyStatusResponse>, tonic::Status>
    {
        Err(tonic::Status::unimplemented("test"))
    }
    ...
    async fn list_sandbox_policies(
        &self,
        _: tonic::Request<navigator_core::proto::ListSandboxPoliciesRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::ListSandboxPoliciesResponse>, tonic::Status>
    {
        Err(tonic::Status::unimplemented("test"))
    }
    ...
    async fn report_policy_status(
        &self,
        _: tonic::Request<navigator_core::proto::ReportPolicyStatusRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::ReportPolicyStatusResponse>, tonic::Status>
    {
        Err(tonic::Status::unimplemented("test"))
    }
    ...
    async fn get_sandbox_logs(
        &self,
        _: tonic::Request<navigator_core::proto::GetSandboxLogsRequest>,
    ) -> Result<tonic::Response<navigator_core::proto::GetSandboxLogsResponse>, tonic::Status> {
        Err(tonic::Status::unimplemented("test"))
    }

    async fn push_sandbox_logs(
        &self,
        _: tonic::Request<tonic::Streaming<navigator_core::proto::PushSandboxLogsRequest>>,
    ) -> Result<tonic::Response<navigator_core::proto::PushSandboxLogsResponse>, tonic::Status>
    {
        Err(tonic::Status::unimplemented("test"))
    }
...
async fn plaintext_server_accepts_grpc_and_http() {
    use navigator_core::proto::{
        HealthRequest, ServiceStatus, navigator_client::NavigatorClient,
        navigator_server::NavigatorServer,
    };
