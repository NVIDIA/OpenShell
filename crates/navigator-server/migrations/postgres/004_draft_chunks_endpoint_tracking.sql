...
ALTER TABLE draft_policy_chunks ADD COLUMN first_seen_ms BIGINT NOT NULL DEFAULT 0;
ALTER TABLE draft_policy_chunks ADD COLUMN last_seen_ms BIGINT NOT NULL DEFAULT 0;
