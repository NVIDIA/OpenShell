...
pub async fn run_sandbox(
    ...
    let (mut policy, opa_engine, retained_proto, loaded_policy_origin) = if process_uses_sidecar_snapshots {
        ...
        let (policy, engine, proto) = load_policy_from_sidecar_snapshot(&snapshot_path)?;
        (
            policy,
            engine,
            proto,
