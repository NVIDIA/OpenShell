...
//! Non-GPU boot smoke tests for cloud-hypervisor and QEMU backends.
//!
...
//!
//! Gated on `OPENSHELL_VM_BACKEND` — set to `cloud-hypervisor` or `qemu` to
//! run the corresponding tests. Skipped when the env var is absent.
//!
