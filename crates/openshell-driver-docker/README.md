...
| `restart_policy = no` | Docker never silently restarts a canonical main-process exit; the gateway may explicitly replace the runtime according to sandbox restart policy. |
