...
| `PidsLimit` | Enforces the sandbox PID budget at the Docker cgroup layer. Omit `[openshell.drivers.docker].sandbox_pids_limit` to inherit the Docker/runtime default; explicit `0` is invalid. |
