...
use openshell_core::proto::compute::v1::{
    CpuResourceRequirements, DriverResourceRequirements, DriverSandboxSpec, DriverSandboxTemplate,
    GetGatewayListenerRequirementsRequest, GpuResourceRequirements, MemoryResourceRequirements,
    ResourceRequirements, WorkloadIdentityRequest, gateway_listener_requirement::Selector,
};
use std::fs;
