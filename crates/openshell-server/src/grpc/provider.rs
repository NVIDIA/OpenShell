...
pub(super) async fn create_provider_record_with_catalog(
    ...
    create_provider_record_validating(store, catalog, workspace, provider, None).await
}
...
async fn create_provider_record_validating(
    ...
    // Validate field sizes after credential offloading.
...
pub(super) async fn update_provider_record_with_catalog(
    ...
    update_provider_record_validating(store, catalog, workspace, provider, None).await
}
...
pub(super) async fn resolve_provider_environment(
    ...
    resolve_provider_environment_with_credentials(store, workspace, provider_names, &credentials)
        .await
}
...
pub(super) async fn resolve_provider_environment_with_credentials(
    ...
    let catalog = ProviderProfileSources::with_default_sources()
        .snapshot_catalog(store, workspace)
        .await?;
    resolve_provider_environment_with_catalog_and_credentials(
        store,
        &catalog,
        workspace,
        provider_names,
...
pub(super) async fn resolve_provider_environment_with_catalog_and_credentials(
    store: &Store,
    catalog: &EffectiveProviderProfileCatalog,
    workspace: &str,
    provider_names: &[String],
